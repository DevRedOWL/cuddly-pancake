...
public enum C0985a {
    ...
    /* renamed from: a */
    public byte mo13041a(byte[] bArr, int i, int i2) {
        byte b = 0;
        while (i <= i2) {
            b = this.f1123a[(b ^ bArr[i]) & 255];
            i++;
        }
        return b;
    }
