...
@Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u0006\u001a\u00020\u0005H\u0016J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\u0018\u0010\u0007\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, mo51343d2 = {"okio/Pipe$sink$1", "Lokio/Sink;", "timeout", "Lokio/Timeout;", "close", "", "flush", "write", "source", "Lokio/Buffer;", "byteCount", "", "jvm"}, mo51344k = 1, mo51345mv = {1, 1, 11})
...
public final class Pipe$sink$1 implements Sink {
    ...
    public void close() {
        /*
            ...
            boolean r2 = r2.getSinkClosed$jvm()     // Catch:{ all -> 0x00f7 }
            if (r2 == 0) goto L_0x0014
            monitor-exit(r1)
            return
        L_0x0014:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f7 }
            okio.Sink r2 = r2.getFoldedSink$jvm()     // Catch:{ all -> 0x00f7 }
            if (r2 == 0) goto L_0x001e
            r0 = r2
            goto L_0x0054
        L_0x001e:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f7 }
            boolean r2 = r2.getSourceClosed$jvm()     // Catch:{ all -> 0x00f7 }
            if (r2 == 0) goto L_0x0041
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f7 }
            okio.Buffer r2 = r2.getBuffer$jvm()     // Catch:{ all -> 0x00f7 }
        ...
        L_0x0041:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f7 }
            r3 = 1
            r2.setSinkClosed$jvm(r3)     // Catch:{ all -> 0x00f7 }
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f7 }
            okio.Buffer r2 = r2.getBuffer$jvm()     // Catch:{ all -> 0x00f7 }
