...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:50:0x00a4 A[EDGE_INSN: B:50:0x00a4->B:32:0x00a4 ?: BREAK  , SYNTHETIC] */
                    ...
                    while (i < i2) {
                        ...
                        if (charAt < 128) {
                            ...
                            if (charAt < 2048) {
                                ...
                                writableSegment$jvm2.data[writableSegment$jvm2.limit] = (byte) ((charAt >> 6) | JfifUtil.MARKER_SOFn);
                                ...
                                writableSegment$jvm3.data[writableSegment$jvm3.limit] = (byte) ((charAt >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
                                ...
                                if (charAt > 56319 || 56320 > c || 57343 < c) {
                                    ...
                                    writableSegment$jvm4.data[writableSegment$jvm4.limit] = (byte) ((i6 >> 18) | DimensionsKt.HDPI);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writableSegment$jvm.data[writableSegment$jvm.limit] = (byte) ((i >> 6) | JfifUtil.MARKER_SOFn);
            ...
            writableSegment$jvm2.data[writableSegment$jvm2.limit] = (byte) ((i >> 12) | CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
            ...
            writableSegment$jvm3.data[writableSegment$jvm3.limit] = (byte) ((i >> 18) | DimensionsKt.HDPI);
                ...
                if (segment != null) {
                    if (size() - j4 < j4) {
                        ...
                        while (j2 < j6) {
                            ...
                            long j7 = j6;
                            int min = (int) Math.min((long) segment2.limit, (((long) segment2.pos) + j6) - j2);
                            for (int i = (int) ((((long) segment2.pos) + j4) - j2); i < min; i++) {
                                if (bArr[i] == b) {
                                    if (rangeEquals(segment2, i + 1, internalArray$jvm, 1, size2)) {
                                        j3 = (long) (i - segment2.pos);
                                    }
                                }
                            }
                            j4 = ((long) (segment2.limit - segment2.pos)) + j2;
                    ...
                    long j9 = (buffer.size - ((long) size3)) + 1;
                    Segment segment3 = segment;
                    while (j2 < j9) {
                        byte[] bArr2 = segment3.data;
                        long j10 = j9;
                        int min2 = (int) Math.min((long) segment3.limit, (((long) segment3.pos) + j9) - j2);
                        for (int i2 = (int) ((((long) segment3.pos) + j4) - j2); i2 < min2; i2++) {
                            if (bArr2[i2] == b2) {
                                if (rangeEquals(segment3, i2 + 1, internalArray$jvm2, 1, size3)) {
                                    j3 = (long) (i2 - segment3.pos);
                                }
                            }
                        }
                        j4 = ((long) (segment3.limit - segment3.pos)) + j2;
    ...
    public Buffer clone() {
        ...
        for (Segment segment6 = segment5.next; segment6 != this.head; segment6 = segment6.next) {
            Segment segment7 = buffer.head;
            if (segment7 == null) {
                Intrinsics.throwNpe();
            }
            ...
            segment8.push(segment6.sharedCopy());
        }
    ...
    public final ByteString snapshot(int i) {
        return i == 0 ? ByteString.EMPTY : SegmentedByteString.Companion.mo55484of(this, i);
    }
    ...
    public final byte m8453deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m8454deprecated_size() {
        return this.size;
    }

    @Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\u000e\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0014\u001a\u00020\bJ\u000e\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\nJ\u000e\u0010\u0017\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, mo51343d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", "offset", "", "readWrite", "", "segment", "Lokio/Segment;", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "jvm"}, mo51344k = 1, mo51345mv = {1, 1, 11})
    /* compiled from: Buffer.kt */
    public static final class UnsafeCursor implements Closeable {
        ...
        public final int seek(long j) {
            ...
            if (buffer2 == null) {
                ...
                Object[] objArr = {Long.valueOf(j), Long.valueOf(buffer2.size())};
    ...
    @Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo51343d2 = {"Lokio/Buffer$Companion;", "", "()V", "DIGITS", "", "jvm"}, mo51344k = 1, mo51345mv = {1, 1, 11})
    /* compiled from: Buffer.kt */
