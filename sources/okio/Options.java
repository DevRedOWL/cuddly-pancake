...
@Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\b\u0018\u0000 \u00142\b\u0012\u0004\u0012\u00020\u00020\u00012\u00020\u0003:\u0001\u0014B\u001f\b\u0002\u0012\u000e\u0010\u0004\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0011\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\rH\u0002R\u001e\u0010\u0004\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0005X\u0004¢\u0006\n\n\u0002\u0010\u000b\u001a\u0004\b\t\u0010\nR\u0014\u0010\f\u001a\u00020\r8VX\u0004¢\u0006\u0006\u001a\u0004\b\u000e\u0010\u000fR\u0014\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, mo51343d2 = {"Lokio/Options;", "Ljava/util/AbstractList;", "Lokio/ByteString;", "Ljava/util/RandomAccess;", "byteStrings", "", "trie", "", "([Lokio/ByteString;[I)V", "getByteStrings$jvm", "()[Lokio/ByteString;", "[Lokio/ByteString;", "size", "", "getSize", "()I", "getTrie$jvm", "()[I", "get", "index", "Companion", "jvm"}, mo51344k = 1, mo51345mv = {1, 1, 11})
...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    @JvmStatic
    /* renamed from: of */
    public static final Options m6811of(ByteString... byteStringArr) {
        return Companion.mo55444of(byteStringArr);
    }
    ...
    @Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0010\u0011\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002JT\u0010\b\u001a\u00020\t2\b\b\u0002\u0010\n\u001a\u00020\u00042\u0006\u0010\u000b\u001a\u00020\u00052\b\b\u0002\u0010\f\u001a\u00020\r2\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f2\b\b\u0002\u0010\u0011\u001a\u00020\r2\b\b\u0002\u0010\u0012\u001a\u00020\r2\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\r0\u000fH\u0002J!\u0010\u0014\u001a\u00020\u00152\u0012\u0010\u000e\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00100\u0016\"\u00020\u0010H\u0007¢\u0006\u0002\u0010\u0017R\u0018\u0010\u0003\u001a\u00020\u0004*\u00020\u00058BX\u0004¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0018"}, mo51343d2 = {"Lokio/Options$Companion;", "", "()V", "intCount", "", "Lokio/Buffer;", "getIntCount", "(Lokio/Buffer;)J", "buildTrieRecursive", "", "nodeOffset", "node", "byteStringOffset", "", "byteStrings", "", "Lokio/ByteString;", "fromIndex", "toIndex", "indexes", "of", "Lokio/Options;", "", "([Lokio/ByteString;)Lokio/Options;", "jvm"}, mo51344k = 1, mo51345mv = {1, 1, 11})
    /* compiled from: Options.kt */
    public static final class Companion {
        ...
        @JvmStatic
        /* renamed from: of */
        public final Options mo55444of(ByteString... byteStringArr) {
        ...
        private final void buildTrieRecursive(long j, Buffer buffer, int i, List<? extends ByteString> list, int i2, int i3, List<Integer> list2) {
            ...
            if (i9 < i10) {
                ...
                ByteString byteString3 = (ByteString) list3.get(i10 - 1);
                if (i8 == byteString2.size()) {
                    i5 = list4.get(i9).intValue();
                    int i12 = i9 + 1;
                ...
                if (byteString.getByte(i8) != byteString3.getByte(i8)) {
                    ...
                    while (i4 < i10) {
                        ...
                        if (i16 == i6 && i8 + 1 == ((ByteString) list3.get(i4)).size()) {
                            ...
                            i7 = i6;
                            buffer2 = buffer4;
                            companion.buildTrieRecursive(intCount, buffer4, i8 + 1, list, i4, i6, list2);
                        }
                        i4 = i7;
                        buffer4 = buffer2;
                    }
                ...
                int i18 = i8;
                int i19 = 0;
                while (i18 < min && byteString.getByte(i18) == byteString3.getByte(i18)) {
                    i19++;
                    i18++;
                }
                Companion companion2 = this;
                long intCount2 = j + companion2.getIntCount(buffer3) + ((long) 2) + ((long) i19) + 1;
                ...
                buffer3.writeInt(((int) (companion2.getIntCount(buffer5) + intCount2)) * -1);
                companion2.buildTrieRecursive(intCount2, buffer5, i20, list, i4, i3, list2);
