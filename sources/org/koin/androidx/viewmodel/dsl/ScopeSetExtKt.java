...
public final class ScopeSetExtKt {
    ...
    private static final <T extends ViewModel> BeanDefinition<T> viewModel(ScopeSet scopeSet, Qualifier qualifier, boolean z, Function2<? super Scope, ? super DefinitionParameters, ? extends T> function2) {
        DefinitionFactory definitionFactory = DefinitionFactory.INSTANCE;
        Qualifier qualifier2 = scopeSet.getQualifier();
        Kind kind = Kind.Factory;
        Intrinsics.reifiedOperationMarker(4, "T");
