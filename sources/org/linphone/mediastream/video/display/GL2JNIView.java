...
public class GL2JNIView extends GLSurfaceView {
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            Log.m6907w("creating OpenGL ES 2.0 context");
    ...
    public static void checkEglError(String str, EGL10 egl10) {
        while (true) {
            ...
            if (eglGetError != 12288) {
                Log.m6903e(String.format("%s: EGL error: 0x%x", new Object[]{str, Integer.valueOf(eglGetError)}));
            } else {
                return;
            }
        }
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig[] eGLConfigArr) {
            ...
            Log.m6907w(String.format("%d configurations", new Object[]{Integer.valueOf(length)}));
            for (int i = 0; i < length; i++) {
                Log.m6907w(String.format("Configuration %d:\n", new Object[]{Integer.valueOf(i)}));
