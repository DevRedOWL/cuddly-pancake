...
public final class AnkoContextKt {
    ...
    /* renamed from: UI */
    public static final AnkoContext<Context> m6888UI(Context context, Function1<? super AnkoContext<? extends Context>, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(context, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "init");
        AnkoInternals ankoInternals = AnkoInternals.INSTANCE;
    ...
    /* renamed from: UI */
    public static final AnkoContext<Fragment> m6887UI(Fragment fragment, Function1<? super AnkoContext<? extends Fragment>, Unit> function1) {
