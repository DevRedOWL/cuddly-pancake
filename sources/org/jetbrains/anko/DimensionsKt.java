...
public final class DimensionsKt {
    ...
    /* renamed from: sp */
    public static final int m6893sp(Context context, int i) {
        Intrinsics.checkParameterIsNotNull(context, "$receiver");
        return (int) (((float) i) * context.getResources().getDisplayMetrics().scaledDensity);
    }

    /* renamed from: sp */
    public static final int m6892sp(Context context, float f) {
        Intrinsics.checkParameterIsNotNull(context, "$receiver");
    ...
    /* renamed from: sp */
    public static final int m6897sp(AnkoContext<?> ankoContext, int i) {
        Intrinsics.checkParameterIsNotNull(ankoContext, "$receiver");
        return m6893sp(ankoContext.getCtx(), i);
    }

    /* renamed from: sp */
    public static final int m6896sp(AnkoContext<?> ankoContext, float f) {
        Intrinsics.checkParameterIsNotNull(ankoContext, "$receiver");
        return m6892sp(ankoContext.getCtx(), f);
    }
    ...
    /* renamed from: sp */
    public static final int m6895sp(View view, int i) {
        Intrinsics.checkParameterIsNotNull(view, "$receiver");
        return m6893sp(view.getContext(), i);
    }

    /* renamed from: sp */
    public static final int m6894sp(View view, float f) {
        Intrinsics.checkParameterIsNotNull(view, "$receiver");
        return m6892sp(view.getContext(), f);
    }
    ...
    /* renamed from: sp */
    public static final int m6891sp(Fragment fragment, int i) {
        Intrinsics.checkParameterIsNotNull(fragment, "$receiver");
        return m6893sp((Context) fragment.getActivity(), i);
    }

    /* renamed from: sp */
    public static final int m6890sp(Fragment fragment, float f) {
        Intrinsics.checkParameterIsNotNull(fragment, "$receiver");
        return m6892sp((Context) fragment.getActivity(), f);
    }
