...
public class Core {
    ...
    public static final String NATIVE_LIBRARY_NAME = "opencv_java310";
    ...
    public static class MinMaxLocResult {
        ...
        public double maxVal = Utils.DOUBLE_EPSILON;
        public Point minLoc = new Point();
        public double minVal = Utils.DOUBLE_EPSILON;
    }
    ...
    public static MinMaxLocResult minMaxLoc(Mat mat, Mat mat2) {
        ...
        minMaxLocResult.minLoc.f6481x = n_minMaxLocManual[2];
        minMaxLocResult.minLoc.f6482y = n_minMaxLocManual[3];
        minMaxLocResult.maxLoc.f6481x = n_minMaxLocManual[4];
        minMaxLocResult.maxLoc.f6482y = n_minMaxLocManual[5];
