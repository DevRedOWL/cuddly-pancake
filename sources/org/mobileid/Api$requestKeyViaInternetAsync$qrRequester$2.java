...
public final class Api$requestKeyViaInternetAsync$qrRequester$2 extends Lambda implements Function0<DefinitionParameters> {
    public final /* synthetic */ CoroutineScope $scope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Api$requestKeyViaInternetAsync$qrRequester$2(CoroutineScope coroutineScope) {
        super(0);
