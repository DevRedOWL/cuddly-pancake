            ...
            for (ScanFilterData next : createScanFilterDataForBeaconParser(createScanFilterDataForBeaconParser)) {
                ...
                if (next.serviceUuid != null) {
                    ...
                    if (LogManager.isVerboseLoggingEnabled()) {
                        LogManager.m6834d(TAG, "making scan filter for service: " + format + " " + fromString, new Object[0]);
                        LogManager.m6834d(TAG, "making scan filter with service mask: " + "FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF" + " " + fromString2, new Object[0]);
                    }
                ...
                if (LogManager.isVerboseLoggingEnabled()) {
                    LogManager.m6834d(TAG, "Set up a scan filter: " + build, new Object[0]);
                }
                arrayList.add(build);
            }
        }
