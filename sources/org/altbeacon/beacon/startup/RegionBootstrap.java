...
public class RegionBootstrap {
    ...
    public RegionBootstrap(Context context2, MonitorNotifier monitorNotifier2, Region region) {
        if (context2 != null) {
            ...
            LogManager.m6834d(TAG, "Waiting for BeaconService connection", new Object[0]);
            return;
        }
    ...
    public void disable() {
        if (!this.disabled) {
            ...
            try {
                ...
                LogManager.m6837e(e, TAG, "Can't stop bootstrap regions", new Object[0]);
            }
        ...
        if (!this.regions.contains(region)) {
            if (this.serviceConnected) {
                try {
                    ...
                    LogManager.m6837e(e, TAG, "Can't add bootstrap region", new Object[0]);
                }
            } else {
                LogManager.m6842w(TAG, "Adding a region: service not yet Connected", new Object[0]);
            }
            this.regions.add(region);
        }
    }
        ...
        if (this.regions.contains(region)) {
            if (this.serviceConnected) {
                try {
                    ...
                    LogManager.m6837e(e, TAG, "Can't stop bootstrap region", new Object[0]);
                }
            } else {
                LogManager.m6842w(TAG, "Removing a region: service not yet Connected", new Object[0]);
            }
    ...
    private class InternalBeaconConsumer implements BeaconConsumer {
        ...
        public void onBeaconServiceConnect() {
            LogManager.m6834d(RegionBootstrap.TAG, "Activating background region monitoring", new Object[0]);
            RegionBootstrap.this.beaconManager.addMonitorNotifier(RegionBootstrap.this.monitorNotifier);
            boolean unused = RegionBootstrap.this.serviceConnected = true;
            try {
                for (Region region : RegionBootstrap.this.regions) {
                    LogManager.m6834d(RegionBootstrap.TAG, "Background region monitoring activated for region %s", region);
                    RegionBootstrap.this.beaconManager.startMonitoringBeaconsInRegion(region);
                }
            } catch (RemoteException e) {
                LogManager.m6837e(e, RegionBootstrap.TAG, "Can't set up bootstrap regions", new Object[0]);
            }
        }
        ...
        public void unbindService(ServiceConnection serviceConnection) {
            ...
            boolean unused = RegionBootstrap.this.serviceConnected = false;
        }
    }
}
