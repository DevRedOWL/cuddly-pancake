...
public class BluetoothCrashResolver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_FINISHED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth discovery finished", new Object[0]);
                    BluetoothCrashResolver.this.finishRecovery();
                } else {
                    LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth discovery finished (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_STARTED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    boolean unused = BluetoothCrashResolver.this.discoveryStartConfirmed = true;
                    LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth discovery started", new Object[0]);
                } else {
                    LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth discovery started (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.STATE_CHANGED")) {
                ...
                if (intExtra != Integer.MIN_VALUE) {
                    switch (intExtra) {
                        case 10:
                            LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth state is OFF", new Object[0]);
                        ...
                        case 11:
                            ...
                            LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth state is TURNING_ON", new Object[0]);
                            return;
                        case 12:
                            LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth state is ON", new Object[0]);
                            LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth was turned off for %s milliseconds", Long.valueOf(BluetoothCrashResolver.this.lastBluetoothTurningOnTime - BluetoothCrashResolver.this.lastBluetoothOffTime));
                    ...
                    LogManager.m6834d(BluetoothCrashResolver.TAG, "Bluetooth state is ERROR", new Object[0]);
                }
            }
        }
    };
    ...
    private int getCrashRiskDeviceCount() {
        return OlympusImageProcessingMakernoteDirectory.TagUnknownBlock2;
    }
    ...
    public BluetoothCrashResolver(Context context2) {
        ...
        LogManager.m6834d(TAG, "constructed", new Object[0]);
        loadState();
    }
    ...
    public void start() {
        ...
        LogManager.m6834d(TAG, "started listening for BluetoothAdapter events", new Object[0]);
    }

    public void stop() {
        this.context.unregisterReceiver(this.receiver);
        LogManager.m6834d(TAG, "stopped listening for BluetoothAdapter events", new Object[0]);
        saveState();
    }
    ...
    public void notifyScannedDevice(BluetoothDevice bluetoothDevice, BluetoothAdapter.LeScanCallback leScanCallback) {
        ...
        if (size != size2 && size2 % 100 == 0) {
            LogManager.m6834d(TAG, "Distinct Bluetooth devices seen: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        if (this.distinctBluetoothAddresses.size() > getCrashRiskDeviceCount() && !this.recoveryInProgress) {
            LogManager.m6842w(TAG, "Large number of Bluetooth devices detected: %s Proactively attempting to clear out address list to prevent a crash", Integer.valueOf(this.distinctBluetoothAddresses.size()));
            LogManager.m6842w(TAG, "Stopping LE Scan", new Object[0]);
    ...
    public void crashDetected() {
        if (Build.VERSION.SDK_INT < 18) {
            LogManager.m6834d(TAG, "Ignoring crashes before API 18, because BLE is unsupported.", new Object[0]);
            return;
        }
        LogManager.m6842w(TAG, "BluetoothService crash detected", new Object[0]);
        if (this.distinctBluetoothAddresses.size() > 0) {
            LogManager.m6834d(TAG, "Distinct Bluetooth devices seen at crash: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        this.lastBluetoothCrashDetectionTime = SystemClock.elapsedRealtime();
        this.detectedCrashCount++;
        if (this.recoveryInProgress) {
            LogManager.m6834d(TAG, "Ignoring Bluetooth crash because recovery is already in progress.", new Object[0]);
        } else {
            startRecovery();
        }
        processStateChange();
    ...
    private void startRecovery() {
        ...
        LogManager.m6834d(TAG, "about to check if discovery is active", new Object[0]);
        if (!defaultAdapter.isDiscovering()) {
            LogManager.m6842w(TAG, "Recovery attempt started", new Object[0]);
            this.recoveryInProgress = true;
            this.discoveryStartConfirmed = false;
            LogManager.m6834d(TAG, "about to command discovery", new Object[0]);
            if (!defaultAdapter.startDiscovery()) {
                LogManager.m6842w(TAG, "Can't start discovery.  Is Bluetooth turned on?", new Object[0]);
            }
            LogManager.m6834d(TAG, "startDiscovery commanded.  isDiscovering()=%s", Boolean.valueOf(defaultAdapter.isDiscovering()));
            LogManager.m6834d(TAG, "We will be cancelling this discovery in %s milliseconds.", Integer.valueOf(TIME_TO_LET_DISCOVERY_RUN_MILLIS));
            cancelDiscovery();
            return;
        }
        LogManager.m6842w(TAG, "Already discovering.  Recovery attempt abandoned.", new Object[0]);
    }

    /* access modifiers changed from: private */
    public void finishRecovery() {
        LogManager.m6842w(TAG, "Recovery attempt finished", new Object[0]);
        synchronized (this.distinctBluetoothAddresses) {
    ...
    private void saveState() {
        /*
            ...
            long r5 = r7.lastBluetoothCrashDetectionTime     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            ...
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r2.<init>()     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            int r3 = r7.detectedCrashCount     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r2.append(r3)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            java.lang.String r3 = "\n"
            r2.append(r3)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            java.lang.String r2 = r2.toString()     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            ...
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r2.<init>()     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            int r3 = r7.recoveryAttemptCount     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r2.append(r3)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            java.lang.String r3 = "\n"
            r2.append(r3)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            java.lang.String r2 = r2.toString()     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r4.write(r2)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            boolean r2 = r7.lastRecoverySucceeded     // Catch:{ IOException -> 0x008c, all -> 0x008a }
        ...
        L_0x0061:
            r4.write(r2)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            java.util.Set<java.lang.String> r2 = r7.distinctBluetoothAddresses     // Catch:{ IOException -> 0x008c, all -> 0x008a }
        ...
        L_0x0091:
            ...
            org.altbeacon.beacon.logging.LogManager.m6842w(r3, r4, r5)     // Catch:{ all -> 0x008e }
            if (r2 == 0) goto L_0x00a3
            r2.close()     // Catch:{ IOException -> 0x00a3 }
        L_0x00a3:
            java.lang.Object[] r0 = new java.lang.Object[r0]
            java.util.Set<java.lang.String> r2 = r7.distinctBluetoothAddresses
            int r2 = r2.size()
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)
            r0[r1] = r2
            java.lang.String r1 = "BluetoothCrashResolver"
            java.lang.String r2 = "Wrote %s Bluetooth addresses"
            org.altbeacon.beacon.logging.LogManager.m6834d(r1, r2, r0)
            return
        L_0x00b9:
    ...
    private void loadState() {
        /*
            ...
            r8.lastBluetoothCrashDetectionTime = r4     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
        L_0x0023:
            java.lang.String r4 = r6.readLine()     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            if (r4 == 0) goto L_0x002f
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            r8.detectedCrashCount = r4     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
        L_0x002f:
            java.lang.String r4 = r6.readLine()     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            if (r4 == 0) goto L_0x003b
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            r8.recoveryAttemptCount = r4     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
        L_0x003b:
            java.lang.String r4 = r6.readLine()     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            if (r4 == 0) goto L_0x004d
            r8.lastRecoverySucceeded = r2     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            java.lang.String r5 = "1"
            boolean r4 = r4.equals(r5)     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            if (r4 == 0) goto L_0x004d
            r8.lastRecoverySucceeded = r3     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
        L_0x004d:
            java.lang.String r4 = r6.readLine()     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
            if (r4 == 0) goto L_0x0059
            java.util.Set<java.lang.String> r5 = r8.distinctBluetoothAddresses     // Catch:{ IOException -> 0x0061, NumberFormatException -> 0x005f, all -> 0x005d }
        ...
        L_0x0066:
            ...
            org.altbeacon.beacon.logging.LogManager.m6842w(r0, r5, r6)     // Catch:{ all -> 0x0063 }
        ...
        L_0x0081:
            ...
            org.altbeacon.beacon.logging.LogManager.m6834d(r0, r2, r1)
            return
        L_0x0095:
    ...
    private void cancelDiscovery() {
        try {
            ...
            if (!this.discoveryStartConfirmed) {
                LogManager.m6842w(TAG, "BluetoothAdapter.ACTION_DISCOVERY_STARTED never received.  Recovery may fail.", new Object[0]);
            }
            BluetoothAdapter defaultAdapter = BluetoothAdapter.getDefaultAdapter();
            if (defaultAdapter.isDiscovering()) {
                LogManager.m6834d(TAG, "Cancelling discovery", new Object[0]);
                defaultAdapter.cancelDiscovery();
                return;
            }
            LogManager.m6834d(TAG, "Discovery not running.  Won't cancel it", new Object[0]);
        } catch (InterruptedException unused) {
            LogManager.m6834d(TAG, "DiscoveryCanceller sleep interrupted.", new Object[0]);
        }
    }
}
