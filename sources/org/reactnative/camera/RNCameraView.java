...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate, BarcodeDetectorAsyncTaskDelegate, TextRecognizerAsyncTaskDelegate, PictureSavedDelegate {
    ...
    public RNCameraView(ThemedReactContext themedReactContext) {
        ...
        addCallback(new CameraView.Callback() {
            ...
            public void onRecordingStart(CameraView cameraView, String str, int i, int i2) {
                ...
                createMap.putString(AlbumLoader.COLUMN_URI, RNFileUtils.uriFromFile(new File(str)).toString());
            ...
            public void onFramePreview(com.google.android.cameraview.CameraView r26, byte[] r27, int r28, int r29, int r30) {
                ...
                L_0x01fc:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.reactnative.camera.RNCameraView.C55481.onFramePreview(com.google.android.cameraview.CameraView, byte[], int, int, int):void");
            }
        });
    }
    ...
    public void record(final ReadableMap readableMap, final Promise promise, final File file) {
        this.mBgHandler.post(new Runnable() {
            public void run() {
                try {
                    String string = readableMap.hasKey(ClientCookie.PATH_ATTR) ? readableMap.getString(ClientCookie.PATH_ATTR) : RNFileUtils.getOutputFilePath(file, ".mp4");
