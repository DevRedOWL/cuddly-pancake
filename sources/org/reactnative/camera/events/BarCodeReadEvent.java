    ...
    private WritableMap serializeEventData() {
        ...
        for (ResultPoint resultPoint : this.mBarCode.getResultPoints()) {
            if (resultPoint != null) {
                ...
                createMap3.putString(MapPoint.JsonFields.f6911x, String.valueOf(resultPoint.getX()));
                createMap3.putString(MapPoint.JsonFields.f6912y, String.valueOf(resultPoint.getY()));
