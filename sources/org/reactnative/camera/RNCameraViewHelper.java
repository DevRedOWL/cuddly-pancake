...
public class RNCameraViewHelper {
    ...
    public static WritableMap getExifData(ExifInterface exifInterface) {
        ...
        for (String[] strArr : exifTags) {
            ...
            if (exifInterface.getAttribute(str) != null) {
                ...
                if (c == 0) {
                    ...
                    createMap.putDouble(str, exifInterface.getAttributeDouble(str, Utils.DOUBLE_EPSILON));
                }
            }
        }
        ...
        if (latLong != null) {
            ...
            createMap.putDouble(ExifInterface.TAG_GPS_ALTITUDE, exifInterface.getAltitude(Utils.DOUBLE_EPSILON));
        }
        return createMap;
    }
