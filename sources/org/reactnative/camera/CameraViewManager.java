...
public class CameraViewManager extends ViewGroupManager<RNCameraView> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        for (Events events : Events.values()) {
            builder.put(events.toString(), MapBuilder.m697of("registrationName", events.toString()));
        }
    ...
    public void setAutoFocusPointOfInterest(RNCameraView rNCameraView, ReadableMap readableMap) {
        if (readableMap != null) {
            rNCameraView.setAutoFocusPointOfInterest((float) readableMap.getDouble(MapPoint.JsonFields.f6911x), (float) readableMap.getDouble(MapPoint.JsonFields.f6912y));
        }
    }
