...
public class DurationFormatUtils {
    ...
    /* renamed from: H */
    static final Object f6290H = "H";
    public static final String ISO_EXTENDED_FORMAT_PATTERN = "'P'yyyy'Y'M'M'd'DT'H'H'm'M's.SSS'S'";

    /* renamed from: M */
    static final Object f6291M = "M";

    /* renamed from: S */
    static final Object f6292S = ExifInterface.LATITUDE_SOUTH;

    /* renamed from: d */
    static final Object f6293d = "d";

    /* renamed from: m */
    static final Object f6294m = "m";

    /* renamed from: s */
    static final Object f6295s = "s";

    /* renamed from: y */
    static final Object f6296y = MapPoint.JsonFields.f6912y;
    ...
    public static String formatDuration(long j, String str, boolean z) {
        ...
        Token[] lexx = lexx(str);
        if (Token.containsTokenWithValue(lexx, f6293d)) {
        ...
        if (Token.containsTokenWithValue(lexx, f6290H)) {
        ...
        if (Token.containsTokenWithValue(lexx, f6294m)) {
        ...
        if (Token.containsTokenWithValue(lexx, f6295s)) {
            long j11 = j3 / 1000;
            j6 = j3 - (1000 * j11);
            j7 = j11;
        } else {
    ...
    public static String formatPeriod(long j, long j2, String str, boolean z, TimeZone timeZone) {
        ...
        if (Token.containsTokenWithValue(lexx, f6291M)) {
            while (i6 < 0) {
            ...
            if (!Token.containsTokenWithValue(lexx, f6296y) && i8 != 0) {
                while (i8 != 0) {
                    i += i8 * 12;
                    i8 = 0;
                }
            ...
            if (!Token.containsTokenWithValue(lexx, f6296y)) {
