...
public class DisplayManager {
    ...
    public DisplayManager(Activity activity, LiveData<RendererItem> liveData, boolean z, boolean z2, boolean z3) {
        ...
        this.mMediaRouter = (MediaRouter) activity.getApplicationContext().getSystemService("media_router");
        this.mTextureView = z;
    ...
    public class SecondaryDisplay extends Presentation {
        ...
        public void onCreate(Bundle bundle) {
            ...
            setContentView(C5570R.layout.player_remote);
            this.mSurfaceFrame = (FrameLayout) findViewById(C5570R.C5573id.remote_player_surface_frame);
            this.mSurfaceView = (SurfaceView) this.mSurfaceFrame.findViewById(C5570R.C5573id.remote_player_surface);
            this.mSubtitlesSurfaceView = (SurfaceView) this.mSurfaceFrame.findViewById(C5570R.C5573id.remote_subtitles_surface);
