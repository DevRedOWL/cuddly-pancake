...
public class AWindow implements IVLCVout {
    ...
    private int registerNative(long r10) {
        /*
            ...
            monitor-enter(r2)
            long r3 = r9.mCallbackNativeHandle     // Catch:{ all -> 0x003f }
            ...
            return r10
        L_0x0012:
            r9.mCallbackNativeHandle = r10     // Catch:{ all -> 0x003f }
            int r10 = r9.mMouseAction     // Catch:{ all -> 0x003f }
            r11 = -1
            if (r10 == r11) goto L_0x0026
            long r3 = r9.mCallbackNativeHandle     // Catch:{ all -> 0x003f }
            int r5 = r9.mMouseAction     // Catch:{ all -> 0x003f }
            int r6 = r9.mMouseButton     // Catch:{ all -> 0x003f }
            int r7 = r9.mMouseX     // Catch:{ all -> 0x003f }
            int r8 = r9.mMouseY     // Catch:{ all -> 0x003f }
            nativeOnMouseEvent(r3, r5, r6, r7, r8)     // Catch:{ all -> 0x003f }
        L_0x0026:
            int r10 = r9.mWindowWidth     // Catch:{ all -> 0x003f }
            if (r10 == r11) goto L_0x0037
            int r10 = r9.mWindowHeight     // Catch:{ all -> 0x003f }
            if (r10 == r11) goto L_0x0037
            long r10 = r9.mCallbackNativeHandle     // Catch:{ all -> 0x003f }
            int r0 = r9.mWindowWidth     // Catch:{ all -> 0x003f }
            int r1 = r9.mWindowHeight     // Catch:{ all -> 0x003f }
            nativeOnWindowSize(r10, r0, r1)     // Catch:{ all -> 0x003f }
        L_0x0037:
            r10 = 1
            org.videolan.libvlc.IVLCVout$OnNewVideoLayoutListener r11 = r9.mOnNewVideoLayoutListener     // Catch:{ all -> 0x003f }
