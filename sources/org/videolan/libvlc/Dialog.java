...
public abstract class Dialog {
    ...
    private static void cancelFromNative(Dialog dialog) {
        sHandler.post(new Runnable(dialog) {
            ...
            public void run() {
                ...
                if (Dialog.sCallbacks != null && this.val$dialog != null) {
                    Dialog.sCallbacks.onCanceled(this.val$dialog);
                }
            }
        });
    }
    ...
    private static void updateProgressFromNative(Dialog dialog, final float f, final String str) {
        sHandler.post(new Runnable(dialog) {
            ...
            public void run() {
                if (this.val$dialog.getType() == 3) {
                    ProgressDialog progressDialog = (ProgressDialog) this.val$dialog;
