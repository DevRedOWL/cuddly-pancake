...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m6940constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
                if (Result.m6946isFailureimpl(obj)) {
                    obj = null;
                }
            ...
            obj = Result.m6940constructorimpl(ResultKt.createFailure(th));
        }
    }
    ...
    public final java.lang.String hierarchyToString(kotlinx.coroutines.Job r10) {
        ...
        L_0x001c:
            ...
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x00d1 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x00d1 }
        ...
        L_0x00a2:
            ...
            java.lang.String r7 = ""
            r5.build(r10, r6, r4, r7)     // Catch:{ all -> 0x00d1 }
    ...
    private final <R> java.util.List<R> dumpCoroutinesInfoImpl(kotlin.jvm.functions.Function2<? super kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner<?>, ? super kotlin.coroutines.CoroutineContext, ? extends R> r11) {
        ...
        L_0x001e:
            ...
            r0.lock()
            r4 = 1
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0098 }
            boolean r5 = r5.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0098 }
            if (r5 == 0) goto L_0x008a
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0098 }
            java.util.Set r5 = r5.getCapturedCoroutines()     // Catch:{ all -> 0x0098 }
            java.lang.Iterable r5 = (java.lang.Iterable) r5     // Catch:{ all -> 0x0098 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$1 r6 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$1     // Catch:{ all -> 0x0098 }
            r6.<init>()     // Catch:{ all -> 0x0098 }
            java.util.Comparator r6 = (java.util.Comparator) r6     // Catch:{ all -> 0x0098 }
            java.util.List r5 = kotlin.collections.CollectionsKt.sortedWith(r5, r6)     // Catch:{ all -> 0x0098 }
            java.lang.Iterable r5 = (java.lang.Iterable) r5     // Catch:{ all -> 0x0098 }
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0098 }
            r6.<init>()     // Catch:{ all -> 0x0098 }
            java.util.Collection r6 = (java.util.Collection) r6     // Catch:{ all -> 0x0098 }
            java.util.Iterator r5 = r5.iterator()     // Catch:{ all -> 0x0098 }
        L_0x004e:
            boolean r7 = r5.hasNext()     // Catch:{ all -> 0x0098 }
            if (r7 == 0) goto L_0x0076
            java.lang.Object r7 = r5.next()     // Catch:{ all -> 0x0098 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r7 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r7     // Catch:{ all -> 0x0098 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x0098 }
            boolean r8 = r8.isFinished(r7)     // Catch:{ all -> 0x0098 }
            r9 = 0
            if (r8 == 0) goto L_0x0064
            goto L_0x0070
        L_0x0064:
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r8 = r7.info     // Catch:{ all -> 0x0098 }
            kotlin.coroutines.CoroutineContext r8 = r8.getContext()     // Catch:{ all -> 0x0098 }
            if (r8 == 0) goto L_0x0070
            java.lang.Object r9 = r11.invoke(r7, r8)     // Catch:{ all -> 0x0098 }
        L_0x0070:
            if (r9 == 0) goto L_0x004e
            r6.add(r9)     // Catch:{ all -> 0x0098 }
            goto L_0x004e
        L_0x0076:
            java.util.List r6 = (java.util.List) r6     // Catch:{ all -> 0x0098 }
        ...
        L_0x008a:
            ...
            r5.<init>(r11)     // Catch:{ all -> 0x0098 }
            java.lang.Throwable r5 = (java.lang.Throwable) r5     // Catch:{ all -> 0x0098 }
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r13) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0122 }
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0122 }
            ...
            java.text.SimpleDateFormat r5 = dateFormat     // Catch:{ all -> 0x0122 }
            long r6 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0122 }
            java.lang.Long r6 = java.lang.Long.valueOf(r6)     // Catch:{ all -> 0x0122 }
            java.lang.String r5 = r5.format(r6)     // Catch:{ all -> 0x0122 }
            r4.append(r5)     // Catch:{ all -> 0x0122 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0122 }
            r13.print(r4)     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0122 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0122 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0122 }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r5 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x0122 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x0122 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.filter(r4, r5)     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$4 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$4     // Catch:{ all -> 0x0122 }
            r5.<init>()     // Catch:{ all -> 0x0122 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0122 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0122 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x0122 }
        L_0x0070:
            boolean r5 = r4.hasNext()     // Catch:{ all -> 0x0122 }
            if (r5 == 0) goto L_0x0106
            java.lang.Object r5 = r4.next()     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r5.info     // Catch:{ all -> 0x0122 }
            java.util.List r7 = r6.lastObservedStackTrace()     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x0122 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0122 }
            java.lang.Thread r10 = r6.lastObservedThread     // Catch:{ all -> 0x0122 }
            java.util.List r8 = r8.enhanceStackTraceWithThreadDumpImpl(r9, r10, r7)     // Catch:{ all -> 0x0122 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0122 }
            java.lang.String r10 = "RUNNING"
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r10)     // Catch:{ all -> 0x0122 }
            if (r9 == 0) goto L_0x00b2
            if (r8 != r7) goto L_0x00b2
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0122 }
            r9.<init>()     // Catch:{ all -> 0x0122 }
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x0122 }
            r9.append(r10)     // Catch:{ all -> 0x0122 }
            java.lang.String r10 = " (Last suspension stacktrace, not an actual stacktrace)"
            r9.append(r10)     // Catch:{ all -> 0x0122 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0122 }
            goto L_0x00b6
        L_0x00b2:
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x0122 }
        L_0x00b6:
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x0122 }
            r10.<init>()     // Catch:{ all -> 0x0122 }
            java.lang.String r11 = "\n\nCoroutine "
            r10.append(r11)     // Catch:{ all -> 0x0122 }
            kotlin.coroutines.Continuation<T> r5 = r5.delegate     // Catch:{ all -> 0x0122 }
            r10.append(r5)     // Catch:{ all -> 0x0122 }
            java.lang.String r5 = ", state: "
            r10.append(r5)     // Catch:{ all -> 0x0122 }
            r10.append(r9)     // Catch:{ all -> 0x0122 }
            java.lang.String r5 = r10.toString()     // Catch:{ all -> 0x0122 }
            r13.print(r5)     // Catch:{ all -> 0x0122 }
            boolean r5 = r7.isEmpty()     // Catch:{ all -> 0x0122 }
            if (r5 == 0) goto L_0x00ff
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0122 }
            r5.<init>()     // Catch:{ all -> 0x0122 }
            java.lang.String r7 = "\n\tat "
            r5.append(r7)     // Catch:{ all -> 0x0122 }
            java.lang.String r7 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r7 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r7)     // Catch:{ all -> 0x0122 }
            r5.append(r7)     // Catch:{ all -> 0x0122 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0122 }
            r13.print(r5)     // Catch:{ all -> 0x0122 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0122 }
            java.util.List r6 = r6.getCreationStackTrace()     // Catch:{ all -> 0x0122 }
            r5.printStackTrace(r13, r6)     // Catch:{ all -> 0x0122 }
            goto L_0x0070
        L_0x00ff:
            kotlinx.coroutines.debug.internal.DebugProbesImpl r5 = INSTANCE     // Catch:{ all -> 0x0122 }
            r5.printStackTrace(r13, r8)     // Catch:{ all -> 0x0122 }
            goto L_0x0070
        L_0x0106:
            kotlin.Unit r13 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0122 }
        L_0x0108:
        ...
        L_0x0114:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0122 }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x0122 }
            r4.<init>(r13)     // Catch:{ all -> 0x0122 }
            java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ all -> 0x0122 }
            throw r4     // Catch:{ all -> 0x0122 }
        L_0x0122:
            r13 = move-exception
        L_0x0123:
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        if (!(!Intrinsics.areEqual((Object) str, (Object) DebugCoroutineInfoImplKt.RUNNING)) && thread != null) {
            try {
                Result.Companion companion = Result.Companion;
                DebugProbesImpl debugProbesImpl = this;
                obj = Result.m6940constructorimpl(thread.getStackTrace());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                obj = Result.m6940constructorimpl(ResultKt.createFailure(th));
            }
    ...
    private final Pair<Integer, Boolean> findContinuationStartIndex(int i, StackTraceElement[] stackTraceElementArr, List<StackTraceElement> list) {
        ...
        if (findIndexOfFrame == -1) {
            return TuplesKt.m6787to(Integer.valueOf(findIndexOfFrame(i - 2, stackTraceElementArr, list)), true);
        }
        return TuplesKt.m6787to(Integer.valueOf(findIndexOfFrame), false);
    }
    ...
    public final java.util.List<kotlinx.coroutines.debug.internal.DebugCoroutineInfo> dumpCoroutinesInfo() {
        ...
        L_0x001e:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0094 }
            boolean r4 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x0094 }
            if (r4 == 0) goto L_0x0086
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x0094 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0094 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$2 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$2     // Catch:{ all -> 0x0094 }
            r5.<init>()     // Catch:{ all -> 0x0094 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0094 }
            java.util.List r4 = kotlin.collections.CollectionsKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0094 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0094 }
            java.util.ArrayList r5 = new java.util.ArrayList     // Catch:{ all -> 0x0094 }
            r5.<init>()     // Catch:{ all -> 0x0094 }
            java.util.Collection r5 = (java.util.Collection) r5     // Catch:{ all -> 0x0094 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x0094 }
        L_0x004d:
            boolean r6 = r4.hasNext()     // Catch:{ all -> 0x0094 }
            if (r6 == 0) goto L_0x0078
            java.lang.Object r6 = r4.next()     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r6 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r6     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r7 = INSTANCE     // Catch:{ all -> 0x0094 }
            boolean r7 = r7.isFinished(r6)     // Catch:{ all -> 0x0094 }
            r8 = 0
            if (r7 == 0) goto L_0x0063
            goto L_0x0072
        L_0x0063:
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r7 = r6.info     // Catch:{ all -> 0x0094 }
            kotlin.coroutines.CoroutineContext r7 = r7.getContext()     // Catch:{ all -> 0x0094 }
            if (r7 == 0) goto L_0x0072
            kotlinx.coroutines.debug.internal.DebugCoroutineInfo r8 = new kotlinx.coroutines.debug.internal.DebugCoroutineInfo     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r6.info     // Catch:{ all -> 0x0094 }
            r8.<init>(r6, r7)     // Catch:{ all -> 0x0094 }
        L_0x0072:
            if (r8 == 0) goto L_0x004d
            r5.add(r8)     // Catch:{ all -> 0x0094 }
            goto L_0x004d
        L_0x0078:
            java.util.List r5 = (java.util.List) r5     // Catch:{ all -> 0x0094 }
        L_0x007a:
        ...
        L_0x0086:
            ...
            java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0094 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0094 }
            r5.<init>(r4)     // Catch:{ all -> 0x0094 }
            java.lang.Throwable r5 = (java.lang.Throwable) r5     // Catch:{ all -> 0x0094 }
    ...
    public final java.util.List<kotlinx.coroutines.debug.internal.DebuggerInfo> dumpDebuggerInfo() {
        ...
        L_0x001e:
            ...
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x0094 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$3 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$$special$$inlined$sortedBy$3     // Catch:{ all -> 0x0094 }
            r5.<init>()     // Catch:{ all -> 0x0094 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x0094 }
            java.util.List r4 = kotlin.collections.CollectionsKt.sortedWith(r4, r5)     // Catch:{ all -> 0x0094 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0094 }
        ...
        L_0x0063:
            ...
            kotlin.coroutines.CoroutineContext r7 = r7.getContext()     // Catch:{ all -> 0x0094 }
            if (r7 == 0) goto L_0x0072
            kotlinx.coroutines.debug.internal.DebuggerInfo r8 = new kotlinx.coroutines.debug.internal.DebuggerInfo     // Catch:{ all -> 0x0094 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r6.info     // Catch:{ all -> 0x0094 }
            r8.<init>(r6, r7)     // Catch:{ all -> 0x0094 }
        L_0x0072:
            if (r8 == 0) goto L_0x004d
