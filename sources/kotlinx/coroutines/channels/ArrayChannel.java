...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51344k = 3, mo51345mv = {1, 4, 0})
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x005e, code lost:
        if (r7 != kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()) goto L_0x006c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x006e, code lost:
        if ((r7 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x0075;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x009b A[Catch:{ all -> 0x00d6 }] */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00a9 A[Catch:{ all -> 0x00d6 }] */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r2.lock()
            int r3 = r8.size     // Catch:{ all -> 0x00d6 }
            if (r3 != 0) goto L_0x001c
            kotlinx.coroutines.channels.Closed r9 = r8.getClosedForSend()     // Catch:{ all -> 0x00d6 }
            if (r9 == 0) goto L_0x0016
            goto L_0x0018
        L_0x0016:
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d6 }
        L_0x0018:
            r2.unlock()
            return r9
        L_0x001c:
            java.lang.Object[] r4 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r5 = r8.head     // Catch:{ all -> 0x00d6 }
            r4 = r4[r5]     // Catch:{ all -> 0x00d6 }
            java.lang.Object[] r5 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r6 = r8.head     // Catch:{ all -> 0x00d6 }
            r5[r6] = r0     // Catch:{ all -> 0x00d6 }
            int r0 = r3 + -1
            r8.size = r0     // Catch:{ all -> 0x00d6 }
            kotlinx.coroutines.internal.Symbol r0 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d6 }
            int r5 = r8.capacity     // Catch:{ all -> 0x00d6 }
            r6 = 1
            if (r3 != r5) goto L_0x0092
        L_0x0033:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r5 = r8.describeTryPoll()     // Catch:{ all -> 0x00d6 }
            r7 = r5
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00d6 }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00d6 }
            if (r7 != 0) goto L_0x0050
            java.lang.Object r0 = r5.getResult()     // Catch:{ all -> 0x00d6 }
            r1 = r0
            kotlinx.coroutines.channels.Send r1 = (kotlinx.coroutines.channels.Send) r1     // Catch:{ all -> 0x00d6 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x00d6 }
            java.lang.Object r0 = r1.getPollResult()     // Catch:{ all -> 0x00d6 }
        L_0x004e:
            r5 = 1
            goto L_0x0093
        L_0x0050:
            kotlinx.coroutines.internal.Symbol r5 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d6 }
            if (r7 != r5) goto L_0x0055
            goto L_0x0092
        L_0x0055:
            java.lang.Object r5 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00d6 }
            if (r7 != r5) goto L_0x005a
            goto L_0x0033
        L_0x005a:
            java.lang.Object r0 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d6 }
            if (r7 != r0) goto L_0x006c
            r8.size = r3     // Catch:{ all -> 0x00d6 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r0 = r8.head     // Catch:{ all -> 0x00d6 }
            r9[r0] = r4     // Catch:{ all -> 0x00d6 }
            r2.unlock()
            return r7
        L_0x006c:
            boolean r0 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d6 }
        ...
        L_0x0075:
            ...
            r9.append(r7)     // Catch:{ all -> 0x00d6 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x00d6 }
            java.lang.IllegalStateException r0 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00d6 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x00d6 }
            r0.<init>(r9)     // Catch:{ all -> 0x00d6 }
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x00d6 }
            throw r0     // Catch:{ all -> 0x00d6 }
        L_0x0092:
            r5 = 0
        L_0x0093:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d6 }
            if (r0 == r7) goto L_0x00a9
            boolean r7 = r0 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d6 }
            if (r7 != 0) goto L_0x00a9
            r8.size = r3     // Catch:{ all -> 0x00d6 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r7 = r8.head     // Catch:{ all -> 0x00d6 }
            int r7 = r7 + r3
            java.lang.Object[] r3 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r3 = r3.length     // Catch:{ all -> 0x00d6 }
            int r7 = r7 % r3
            r9[r7] = r0     // Catch:{ all -> 0x00d6 }
            goto L_0x00bf
        L_0x00a9:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00d6 }
            if (r9 != 0) goto L_0x00bf
            r8.size = r3     // Catch:{ all -> 0x00d6 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r0 = r8.head     // Catch:{ all -> 0x00d6 }
            r9[r0] = r4     // Catch:{ all -> 0x00d6 }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d6 }
            r2.unlock()
            return r9
        L_0x00bf:
            int r9 = r8.head     // Catch:{ all -> 0x00d6 }
            int r9 = r9 + r6
            java.lang.Object[] r0 = r8.buffer     // Catch:{ all -> 0x00d6 }
            int r0 = r0.length     // Catch:{ all -> 0x00d6 }
            int r9 = r9 % r0
            r8.head = r9     // Catch:{ all -> 0x00d6 }
            kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00d6 }
            r2.unlock()
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (!(function1 == null || obj == AbstractChannelKt.EMPTY)) {
                    undeliveredElementException2 = OnUndeliveredElementKt.callUndeliveredElementCatchingException(function1, obj, undeliveredElementException2);
                }
