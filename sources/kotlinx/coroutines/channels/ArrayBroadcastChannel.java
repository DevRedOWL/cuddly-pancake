    ...
    private static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        public java.lang.Object pollInternal() {
            /*
                ...
                r0.lock()
                java.lang.Object r1 = r8.peekUnderLock()     // Catch:{ all -> 0x0046 }
            ...
            L_0x0015:
                ...
                goto L_0x0022
            L_0x0017:
                long r4 = r8.getSubHead()     // Catch:{ all -> 0x0046 }
                r6 = 1
                long r4 = r4 + r6
                r8.setSubHead(r4)     // Catch:{ all -> 0x0046 }
                r2 = 1
            L_0x0022:
                r0.unlock()
