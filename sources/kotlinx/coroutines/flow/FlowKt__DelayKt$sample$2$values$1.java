...
@DebugMetadata(mo52052c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", mo52053f = "Delay.kt", mo52054i = {0, 0}, mo52055l = {352}, mo52056m = "invokeSuspend", mo52057n = {"$this$produce", "$this$collect$iv"}, mo52058s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$sample$2$values$1.f6219p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f6219p$;
            Flow flow = this.this$0.$this_sample;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C4916xe7e632(producerScope), this) == coroutine_suspended) {
