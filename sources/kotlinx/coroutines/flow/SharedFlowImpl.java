...
final class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: type inference failed for: r10v6, types: [kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:24:0x0077  */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00ae A[Catch:{ all -> 0x0075 }] */
    /* JADX WARNING: Removed duplicated region for block: B:41:0x00c6 A[Catch:{ all -> 0x0075 }] */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x0064:
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch:{ all -> 0x0075 }
            goto L_0x0098
        L_0x0075:
            r9 = move-exception
            goto L_0x00db
        L_0x0077:
            ...
            r2 = r10
            kotlinx.coroutines.flow.SharedFlowSlot r2 = (kotlinx.coroutines.flow.SharedFlowSlot) r2
            boolean r10 = r9 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00d9 }
            if (r10 == 0) goto L_0x0097
            r10 = r9
            kotlinx.coroutines.flow.SubscribedFlowCollector r10 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r10     // Catch:{ all -> 0x00d9 }
            r0.L$0 = r8     // Catch:{ all -> 0x00d9 }
            r0.L$1 = r9     // Catch:{ all -> 0x00d9 }
            r0.L$2 = r2     // Catch:{ all -> 0x00d9 }
            r0.label = r5     // Catch:{ all -> 0x00d9 }
            java.lang.Object r10 = r10.onSubscription(r0)     // Catch:{ all -> 0x00d9 }
            if (r10 != r1) goto L_0x0097
            return r1
        L_0x0097:
            r5 = r8
        L_0x0098:
            kotlin.coroutines.CoroutineContext r10 = r0.getContext()     // Catch:{ all -> 0x0075 }
            kotlinx.coroutines.Job$Key r6 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x0075 }
            kotlin.coroutines.CoroutineContext$Key r6 = (kotlin.coroutines.CoroutineContext.Key) r6     // Catch:{ all -> 0x0075 }
            kotlin.coroutines.CoroutineContext$Element r10 = r10.get(r6)     // Catch:{ all -> 0x0075 }
            kotlinx.coroutines.Job r10 = (kotlinx.coroutines.Job) r10     // Catch:{ all -> 0x0075 }
        L_0x00a6:
            java.lang.Object r6 = r5.tryTakeValue(r2)     // Catch:{ all -> 0x0075 }
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE     // Catch:{ all -> 0x0075 }
            if (r6 == r7) goto L_0x00c6
            if (r10 == 0) goto L_0x00b3
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r10)     // Catch:{ all -> 0x0075 }
        L_0x00b3:
            r0.L$0 = r5     // Catch:{ all -> 0x0075 }
            r0.L$1 = r9     // Catch:{ all -> 0x0075 }
            r0.L$2 = r2     // Catch:{ all -> 0x0075 }
            r0.L$3 = r10     // Catch:{ all -> 0x0075 }
            r0.L$4 = r6     // Catch:{ all -> 0x0075 }
            r0.label = r3     // Catch:{ all -> 0x0075 }
            java.lang.Object r6 = r9.emit(r6, r0)     // Catch:{ all -> 0x0075 }
        ...
        L_0x00c6:
            ...
            java.lang.Object r6 = r5.awaitValue(r2, r0)     // Catch:{ all -> 0x0075 }
            if (r6 != r1) goto L_0x00a6
            return r1
        L_0x00d9:
            r9 = move-exception
    ...
    public boolean tryEmit(T t) {
        ...
        for (Continuation<Unit> continuation : continuationArr) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m6940constructorimpl(unit));
            }
        }
        return z;
    }
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long j) {
        ...
        long max = Math.max(this.replayIndex, j3 - ((long) Math.min(this.replay, i4)));
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B1\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0002\u0010\u000bJ\b\u0010\f\u001a\u00020\nH\u0016R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo51343d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", "value", "", "cont", "Lkotlin/coroutines/Continuation;", "", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, mo51344k = 1, mo51345mv = {1, 4, 0})
    /* compiled from: SharedFlow.kt */
    ...
    public final /* synthetic */ Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Unit unit = Unit.INSTANCE;
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m6940constructorimpl(unit));
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m6940constructorimpl(unit2));
            }
        }
