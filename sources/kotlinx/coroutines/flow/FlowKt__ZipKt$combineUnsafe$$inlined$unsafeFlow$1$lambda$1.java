...
@DebugMetadata(mo52052c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1", mo52053f = "Zip.kt", mo52054i = {0, 0, 1, 1}, mo52055l = {262, 262}, mo52056m = "invokeSuspend", mo52057n = {"$this$combineInternal", "it", "$this$combineInternal", "it"}, mo52058s = {"L$0", "L$1", "L$0", "L$1"})
...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        flowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1$lambda$1.f6249p$ = flowCollector;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        FlowCollector flowCollector = this.f6249p$;
