...
@DebugMetadata(mo52052c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", mo52053f = "Merge.kt", mo52054i = {0, 0, 1, 1}, mo52055l = {214, 214}, mo52056m = "invokeSuspend", mo52057n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, mo52058s = {"L$0", "L$1", "L$0", "L$1"})
...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f6226p$ = flowCollector;
