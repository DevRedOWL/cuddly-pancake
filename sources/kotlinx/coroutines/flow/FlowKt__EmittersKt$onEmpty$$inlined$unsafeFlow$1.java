...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r9, kotlin.coroutines.Continuation r10) {
        /*
            r8 = this;
            boolean r0 = r10 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C49181
            if (r0 == 0) goto L_0x0014
            r0 = r10
            kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C49181) r0
            int r1 = r0.label
        ...
        L_0x009e:
            ...
            r7.<init>(r2, r4)
            kotlin.jvm.functions.Function2 r4 = r6.$action$inlined     // Catch:{ all -> 0x00cf }
            r0.L$0 = r6     // Catch:{ all -> 0x00cf }
            r0.L$1 = r5     // Catch:{ all -> 0x00cf }
            r0.L$2 = r10     // Catch:{ all -> 0x00cf }
            r0.L$3 = r2     // Catch:{ all -> 0x00cf }
            r0.L$4 = r9     // Catch:{ all -> 0x00cf }
            r0.L$5 = r7     // Catch:{ all -> 0x00cf }
            r0.label = r3     // Catch:{ all -> 0x00cf }
            r9 = 6
            kotlin.jvm.internal.InlineMarker.mark((int) r9)     // Catch:{ all -> 0x00cf }
            java.lang.Object r9 = r4.invoke(r7, r0)     // Catch:{ all -> 0x00cf }
            r10 = 7
            kotlin.jvm.internal.InlineMarker.mark((int) r10)     // Catch:{ all -> 0x00cf }
