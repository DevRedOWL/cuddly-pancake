...
public final class LintKt {
    ...
    private static final <T> Flow<T> m8294catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        if (sharedFlow != null) {
            return FlowKt.m8288catch(sharedFlow, function3);
        }
    ...
    static /* synthetic */ Flow retry$default(SharedFlow sharedFlow, long j, Function2 function2, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            function2 = new LintKt$retry$1((Continuation) null);
        }
        if (sharedFlow != null) {
