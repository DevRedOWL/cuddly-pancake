...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m8291debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.debounce(flow, DelayKt.m8268toDelayMillisLRDsOJo(d));
    }
    ...
    public static final <T> Flow<T> m8292sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.sample(flow, DelayKt.m8268toDelayMillisLRDsOJo(d));
    }
}
