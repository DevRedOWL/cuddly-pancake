...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0045, code lost:
        if (r5.sequence != r6) goto L_0x004c;
     */
    ...
    private final boolean updateState(java.lang.Object r6, java.lang.Object r7) {
        /*
            r5 = this;
            kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot[] r0 = r5.getSlots()
            kotlinx.coroutines.flow.StateFlowSlot[] r0 = (kotlinx.coroutines.flow.StateFlowSlot[]) r0
            monitor-enter(r5)
            java.lang.Object r0 = r5._state     // Catch:{ all -> 0x0061 }
            r1 = 0
            r2 = 1
            if (r6 == 0) goto L_0x0016
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r0, (java.lang.Object) r6)     // Catch:{ all -> 0x0061 }
            r6 = r6 ^ r2
            if (r6 == 0) goto L_0x0016
            monitor-exit(r5)
            return r1
        L_0x0016:
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r0, (java.lang.Object) r7)     // Catch:{ all -> 0x0061 }
            if (r6 == 0) goto L_0x001e
            monitor-exit(r5)
            return r2
        L_0x001e:
            r5._state = r7     // Catch:{ all -> 0x0061 }
            int r6 = r5.sequence     // Catch:{ all -> 0x0061 }
            r7 = r6 & 1
            if (r7 != 0) goto L_0x005b
            int r6 = r6 + r2
            r5.sequence = r6     // Catch:{ all -> 0x0061 }
            kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot[] r7 = r5.getSlots()     // Catch:{ all -> 0x0061 }
            kotlinx.coroutines.flow.StateFlowSlot[] r7 = (kotlinx.coroutines.flow.StateFlowSlot[]) r7     // Catch:{ all -> 0x0061 }
        ...
        L_0x0042:
            monitor-enter(r5)
            int r7 = r5.sequence     // Catch:{ all -> 0x0058 }
            if (r7 != r6) goto L_0x004c
            int r6 = r6 + r2
            r5.sequence = r6     // Catch:{ all -> 0x0058 }
            monitor-exit(r5)
            return r2
        L_0x004c:
            int r6 = r5.sequence     // Catch:{ all -> 0x0058 }
            kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot[] r7 = r5.getSlots()     // Catch:{ all -> 0x0058 }
            kotlinx.coroutines.flow.StateFlowSlot[] r7 = (kotlinx.coroutines.flow.StateFlowSlot[]) r7     // Catch:{ all -> 0x0058 }
    ...
    /* JADX WARNING: type inference failed for: r13v8, types: [kotlinx.coroutines.flow.internal.AbstractSharedFlowSlot] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00b9 A[Catch:{ all -> 0x0081 }] */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00c9 A[Catch:{ all -> 0x0081 }] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x00cb A[Catch:{ all -> 0x0081 }] */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x00e0 A[Catch:{ all -> 0x0081 }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:53:0x00e8 A[Catch:{ all -> 0x0081 }] */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L_0x0019:
            ...
            kotlin.ResultKt.throwOnFailure(r13)     // Catch:{ all -> 0x006c }
            r13 = r2
            r2 = r9
            goto L_0x00b5
        L_0x0048:
        ...
        L_0x0070:
            ...
            kotlin.ResultKt.throwOnFailure(r13)     // Catch:{ all -> 0x0081 }
            goto L_0x00a5
        L_0x0081:
            r12 = move-exception
            goto L_0x00ff
        L_0x0084:
            ...
            r7 = r13
            kotlinx.coroutines.flow.StateFlowSlot r7 = (kotlinx.coroutines.flow.StateFlowSlot) r7
            boolean r13 = r12 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00fd }
            if (r13 == 0) goto L_0x00a4
            r13 = r12
            kotlinx.coroutines.flow.SubscribedFlowCollector r13 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r13     // Catch:{ all -> 0x00fd }
            r0.L$0 = r11     // Catch:{ all -> 0x00fd }
            r0.L$1 = r12     // Catch:{ all -> 0x00fd }
            r0.L$2 = r7     // Catch:{ all -> 0x00fd }
            r0.label = r6     // Catch:{ all -> 0x00fd }
            java.lang.Object r13 = r13.onSubscription(r0)     // Catch:{ all -> 0x00fd }
            if (r13 != r1) goto L_0x00a4
            return r1
        L_0x00a4:
            r2 = r11
        L_0x00a5:
            kotlin.coroutines.CoroutineContext r13 = r0.getContext()     // Catch:{ all -> 0x0081 }
            kotlinx.coroutines.Job$Key r8 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x0081 }
            kotlin.coroutines.CoroutineContext$Key r8 = (kotlin.coroutines.CoroutineContext.Key) r8     // Catch:{ all -> 0x0081 }
            kotlin.coroutines.CoroutineContext$Element r13 = r13.get(r8)     // Catch:{ all -> 0x0081 }
            kotlinx.coroutines.Job r13 = (kotlinx.coroutines.Job) r13     // Catch:{ all -> 0x0081 }
            r8 = r12
            r12 = r3
        L_0x00b5:
            java.lang.Object r9 = r2._state     // Catch:{ all -> 0x0081 }
            if (r13 == 0) goto L_0x00bc
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r13)     // Catch:{ all -> 0x0081 }
        L_0x00bc:
            if (r12 == 0) goto L_0x00c5
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r12, (java.lang.Object) r9)     // Catch:{ all -> 0x0081 }
            r10 = r10 ^ r6
            if (r10 == 0) goto L_0x00e2
        L_0x00c5:
            kotlinx.coroutines.internal.Symbol r10 = kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL     // Catch:{ all -> 0x0081 }
        ...
        L_0x00cb:
            r10 = r9
        L_0x00cc:
            r0.L$0 = r2     // Catch:{ all -> 0x0081 }
            r0.L$1 = r8     // Catch:{ all -> 0x0081 }
            r0.L$2 = r7     // Catch:{ all -> 0x0081 }
            r0.L$3 = r13     // Catch:{ all -> 0x0081 }
            r0.L$4 = r12     // Catch:{ all -> 0x0081 }
            r0.L$5 = r9     // Catch:{ all -> 0x0081 }
            r0.label = r5     // Catch:{ all -> 0x0081 }
            java.lang.Object r12 = r8.emit(r10, r0)     // Catch:{ all -> 0x0081 }
            if (r12 != r1) goto L_0x00e1
            return r1
        L_0x00e1:
            r12 = r9
        L_0x00e2:
            boolean r10 = r7.takePending()     // Catch:{ all -> 0x0081 }
            ...
            java.lang.Object r9 = r7.awaitPending(r0)     // Catch:{ all -> 0x0081 }
