...
final class SubjectSubscriptionManager<T> extends AtomicReference<State<T>> implements Observable.OnSubscribe<T> {
    ...
    public void remove(p059rx.subjects.SubjectSubscriptionManager.SubjectObserver<T> r3) {
        /*
            r2 = this;
        L_0x0000:
            java.lang.Object r0 = r2.get()
            rx.subjects.SubjectSubscriptionManager$State r0 = (p059rx.subjects.SubjectSubscriptionManager.State) r0
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p059rx.subjects.SubjectSubscriptionManager.remove(rx.subjects.SubjectSubscriptionManager$SubjectObserver):void");
    }
    ...
    protected static final class SubjectObserver<T> implements Observer<T> {
        ...
        public void emitNext(java.lang.Object r2) {
            ...
            L_0x0026:
                ...
                p059rx.internal.operators.NotificationLite.accept(r0, r2)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p059rx.subjects.SubjectSubscriptionManager.SubjectObserver.emitNext(java.lang.Object):void");
        }
        ...
        public void emitFirst(java.lang.Object r2) {
            ...
            L_0x001c:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p059rx.subjects.SubjectSubscriptionManager.SubjectObserver.emitFirst(java.lang.Object):void");
        }
