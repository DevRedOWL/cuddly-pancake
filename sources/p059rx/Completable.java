...
import p059rx.internal.operators.CompletableFromEmitter;
import p059rx.internal.operators.CompletableOnSubscribeConcat;
import p059rx.internal.operators.CompletableOnSubscribeConcatArray;
import p059rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p059rx.internal.operators.CompletableOnSubscribeMerge;
import p059rx.internal.operators.CompletableOnSubscribeMergeArray;
import p059rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p059rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p059rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p059rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p059rx.observers.SafeCompletableSubscriber;
...
import p059rx.subscriptions.MultipleAssignmentSubscription;
...
public class Completable {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                C61561 r2 = new CompletableSubscriber() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    C61691 r3 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C61191 r0 = new Subscriber<Object>() {
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C61211 r0 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) mo77063to(transformer);
    }
    ...
    /* renamed from: to */
    public final <R> R mo77063to(Func1<? super Completable, R> func1) {
