...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
    ...
    public void connect(p059rx.functions.Action1<? super p059rx.Subscription> r5) {
        ...
        L_0x0000:
            ...
            rx.internal.operators.OperatorPublish$PublishSubscriber r0 = (p059rx.internal.operators.OperatorPublish.PublishSubscriber) r0
        ...
        L_0x0042:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p059rx.internal.operators.OperatorPublish.connect(rx.functions.Action1):void");
    }
    ...
    static final class PublishSubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:47:0x008e, code lost:
            r6 = p059rx.internal.operators.NotificationLite.getValue(r8);
            r7 = r5.length;
            r8 = 0;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:57:0x00aa, code lost:
            r2.unsubscribe();
            p059rx.exceptions.Exceptions.throwOrReport(r0, (p059rx.Observer<?>) r2.child, r6);
         */
        ...
        public void dispatch() {
            ...
            L_0x0021:
                ...
                r5 = r0
                rx.internal.operators.OperatorPublish$InnerProducer[] r5 = (p059rx.internal.operators.OperatorPublish.InnerProducer[]) r5     // Catch:{ all -> 0x00e2 }
            ...
            L_0x008b:
                ...
                goto L_0x00bc
            L_0x008e:
                java.lang.Object r6 = p059rx.internal.operators.NotificationLite.getValue(r8)     // Catch:{ all -> 0x00e2 }
            ...
            L_0x0094:
                ...
                rx.Subscriber<? super T> r0 = r2.child     // Catch:{ all -> 0x00a9 }
                r0.onNext(r6)     // Catch:{ all -> 0x00a9 }
            ...
            L_0x00a9:
                ...
                p059rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r0, (p059rx.Observer<?>) r2, (java.lang.Object) r6)     // Catch:{ all -> 0x00e2 }
            L_0x00b2:
                int r8 = r8 + 1
                r2 = 1
                goto L_0x0094
            ...
            L_0x00ef:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p059rx.internal.operators.OperatorPublish.PublishSubscriber.dispatch():void");
        }
    }
