...
public final class OnSubscribePublishMulticast<T> extends AtomicInteger implements Observable.OnSubscribe<T>, Observer<T>, Subscription {
    ...
    public void remove(p059rx.internal.operators.OnSubscribePublishMulticast.PublishProducer<T> r7) {
        /*
            r6 = this;
        ...
        L_0x002a:
            ...
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer[] r7 = (p059rx.internal.operators.OnSubscribePublishMulticast.PublishProducer[]) r7     // Catch:{ all -> 0x0047 }
            goto L_0x0041
        L_0x0032:
            int r4 = r2 + -1
            rx.internal.operators.OnSubscribePublishMulticast$PublishProducer[] r4 = new p059rx.internal.operators.OnSubscribePublishMulticast.PublishProducer[r4]     // Catch:{ all -> 0x0047 }
        ...
        L_0x004a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p059rx.internal.operators.OnSubscribePublishMulticast.remove(rx.internal.operators.OnSubscribePublishMulticast$PublishProducer):void");
    }
