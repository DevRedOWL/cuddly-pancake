...
import p059rx.internal.schedulers.SchedulePeriodicHelper;
...
public class TestScheduler extends Scheduler {
    ...
    final class InnerTestScheduler extends Scheduler.Worker implements SchedulePeriodicHelper.NowNanoSupplier {
        ...
        /* renamed from: s */
        private final BooleanSubscription f6998s = new BooleanSubscription();

        InnerTestScheduler() {
        }

        public void unsubscribe() {
            this.f6998s.unsubscribe();
        }

        public boolean isUnsubscribed() {
            return this.f6998s.isUnsubscribed();
        }
