...
import p059rx.internal.operators.CompletableFlatMapSingleToCompletable;
import p059rx.internal.operators.SingleDelay;
import p059rx.internal.operators.SingleDoAfterTerminate;
import p059rx.internal.operators.SingleDoOnEvent;
import p059rx.internal.operators.SingleDoOnSubscribe;
import p059rx.internal.operators.SingleDoOnUnsubscribe;
import p059rx.internal.operators.SingleFromCallable;
import p059rx.internal.operators.SingleFromEmitter;
import p059rx.internal.operators.SingleFromFuture;
import p059rx.internal.operators.SingleFromObservable;
import p059rx.internal.operators.SingleLiftObservableOperator;
import p059rx.internal.operators.SingleObserveOn;
import p059rx.internal.operators.SingleOnErrorReturn;
import p059rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p059rx.internal.operators.SingleOnSubscribeMap;
import p059rx.internal.operators.SingleOnSubscribeUsing;
import p059rx.internal.operators.SingleOperatorCast;
import p059rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p059rx.internal.operators.SingleOperatorZip;
import p059rx.internal.operators.SingleTakeUntilCompletable;
import p059rx.internal.operators.SingleTakeUntilObservable;
import p059rx.internal.operators.SingleTakeUntilSingle;
import p059rx.internal.operators.SingleTimeout;
import p059rx.internal.operators.SingleToObservable;
import p059rx.internal.util.ScalarSynchronousSingle;
...
import p059rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                C61921 r0 = new SingleSubscriber<Single<? extends T>>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        C61811 r0 = new SingleSubscriber<T>() {
                            public void onSuccess(T t) {
                                try {
    ...
    /* renamed from: to */
    public final <R> R mo77448to(Func1<? super Single<T>, R> func1) {
    ...
    public final Single<T> unsubscribeOn(final Scheduler scheduler) {
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                final C61881 r0 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        singleSubscriber.onSuccess(t);
                    }
