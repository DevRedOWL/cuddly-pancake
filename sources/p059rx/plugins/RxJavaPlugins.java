...
public class RxJavaPlugins {
    ...
    static java.lang.Object getPluginImplementationViaProperty(java.lang.Class<?> r10, java.util.Properties r11) {
        /*
            ...
            java.util.Set r5 = r11.entrySet()     // Catch:{ SecurityException -> 0x00af }
            java.util.Iterator r5 = r5.iterator()     // Catch:{ SecurityException -> 0x00af }
        L_0x0032:
            boolean r6 = r5.hasNext()     // Catch:{ SecurityException -> 0x00af }
            if (r6 == 0) goto L_0x00b3
            java.lang.Object r6 = r5.next()     // Catch:{ SecurityException -> 0x00af }
            java.util.Map$Entry r6 = (java.util.Map.Entry) r6     // Catch:{ SecurityException -> 0x00af }
            java.lang.Object r7 = r6.getKey()     // Catch:{ SecurityException -> 0x00af }
            java.lang.String r7 = r7.toString()     // Catch:{ SecurityException -> 0x00af }
            boolean r8 = r7.startsWith(r2)     // Catch:{ SecurityException -> 0x00af }
            if (r8 == 0) goto L_0x0032
            boolean r8 = r7.endsWith(r3)     // Catch:{ SecurityException -> 0x00af }
            if (r8 == 0) goto L_0x0032
            java.lang.Object r6 = r6.getValue()     // Catch:{ SecurityException -> 0x00af }
            java.lang.String r6 = r6.toString()     // Catch:{ SecurityException -> 0x00af }
            boolean r6 = r0.equals(r6)     // Catch:{ SecurityException -> 0x00af }
            if (r6 == 0) goto L_0x0032
            r3 = 0
            int r5 = r7.length()     // Catch:{ SecurityException -> 0x00af }
            int r5 = r5 + -6
            java.lang.String r3 = r7.substring(r3, r5)     // Catch:{ SecurityException -> 0x00af }
            r5 = 14
            java.lang.String r3 = r3.substring(r5)     // Catch:{ SecurityException -> 0x00af }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ SecurityException -> 0x00af }
            r5.<init>()     // Catch:{ SecurityException -> 0x00af }
            r5.append(r2)     // Catch:{ SecurityException -> 0x00af }
            r5.append(r3)     // Catch:{ SecurityException -> 0x00af }
            r5.append(r4)     // Catch:{ SecurityException -> 0x00af }
            java.lang.String r2 = r5.toString()     // Catch:{ SecurityException -> 0x00af }
            java.lang.String r11 = r11.getProperty(r2)     // Catch:{ SecurityException -> 0x00af }
            if (r11 == 0) goto L_0x008b
            r1 = r11
            goto L_0x00b3
        L_0x008b:
            java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ SecurityException -> 0x00aa }
            ...
            r3.append(r4)     // Catch:{ SecurityException -> 0x00aa }
            r3.append(r2)     // Catch:{ SecurityException -> 0x00aa }
            java.lang.String r2 = r3.toString()     // Catch:{ SecurityException -> 0x00aa }
            r1.<init>(r2)     // Catch:{ SecurityException -> 0x00aa }
            throw r1     // Catch:{ SecurityException -> 0x00aa }
        L_0x00aa:
            r1 = move-exception
            r9 = r1
            r1 = r11
        ...
        L_0x0136:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p059rx.plugins.RxJavaPlugins.getPluginImplementationViaProperty(java.lang.Class, java.util.Properties):java.lang.Object");
    }
