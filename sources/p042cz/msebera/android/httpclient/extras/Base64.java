package p042cz.msebera.android.httpclient.extras;
...
public class Base64 {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        } else if (decoder.f5688op == decoder.output.length) {
            return decoder.output;
        } else {
            byte[] bArr2 = new byte[decoder.f5688op];
            System.arraycopy(decoder.output, 0, bArr2, 0, decoder.f5688op);
            return bArr2;
        }
    }
    ...
    static class Decoder extends Coder {
        ...
        public boolean process(byte[] r17, int r18, int r19, boolean r20) {
            ...
            L_0x0123:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.extras.Base64.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    static class Encoder extends Coder {
        ...
        public boolean process(byte[] r18, int r19, int r20, boolean r21) {
            ...
            L_0x01e7:
                ...
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.extras.Base64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
