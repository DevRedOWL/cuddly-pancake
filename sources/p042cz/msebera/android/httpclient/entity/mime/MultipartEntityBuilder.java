...
import p042cz.msebera.android.httpclient.entity.mime.content.ByteArrayBody;
import p042cz.msebera.android.httpclient.entity.mime.content.ContentBody;
import p042cz.msebera.android.httpclient.entity.mime.content.FileBody;
import p042cz.msebera.android.httpclient.entity.mime.content.InputStreamBody;
import p042cz.msebera.android.httpclient.entity.mime.content.StringBody;
...
public class MultipartEntityBuilder {
    ...
    public MultipartFormEntity buildEntity() {
        ...
        int i = C44611.f5686xc867cd5c[httpMultipartMode.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C44611 {

        /* renamed from: $SwitchMap$cz$msebera$android$httpclient$entity$mime$HttpMultipartMode */
        static final /* synthetic */ int[] f5686xc867cd5c = new int[HttpMultipartMode.values().length];
        ...
        static {
            /*
                cz.msebera.android.httpclient.entity.mime.HttpMultipartMode[] r0 = p042cz.msebera.android.httpclient.entity.mime.HttpMultipartMode.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f5686xc867cd5c = r0
                int[] r0 = f5686xc867cd5c     // Catch:{ NoSuchFieldError -> 0x0014 }
                cz.msebera.android.httpclient.entity.mime.HttpMultipartMode r1 = p042cz.msebera.android.httpclient.entity.mime.HttpMultipartMode.BROWSER_COMPATIBLE     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f5686xc867cd5c     // Catch:{ NoSuchFieldError -> 0x001f }
                cz.msebera.android.httpclient.entity.mime.HttpMultipartMode r1 = p042cz.msebera.android.httpclient.entity.mime.HttpMultipartMode.RFC6532     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.entity.mime.MultipartEntityBuilder.C44611.<clinit>():void");
        }
    }
