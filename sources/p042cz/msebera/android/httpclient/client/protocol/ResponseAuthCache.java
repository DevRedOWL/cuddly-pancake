...
import p042cz.msebera.android.httpclient.client.AuthCache;
...
import p042cz.msebera.android.httpclient.impl.client.BasicAuthCache;
import p042cz.msebera.android.httpclient.protocol.ExecutionContext;
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (!(httpHost == null || authState == null)) {
            ...
            if (isCachable(authState)) {
                ...
                int i = C44561.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState.getState().ordinal()];
                if (i == 1) {
        ...
        if (httpHost2 != null && authState2 != null) {
            ...
            if (isCachable(authState2)) {
                ...
                int i2 = C44561.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState2.getState().ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class C44561 {
        ...
        static {
            ...
            L_0x0014:
                ...
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.FAILURE     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.client.protocol.ResponseAuthCache.C44561.<clinit>():void");
        }
    }
