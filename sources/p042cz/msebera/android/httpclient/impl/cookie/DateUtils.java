...
public final class DateUtils {
    ...
    public static Date parseDate(String str, String[] strArr, Date date) throws DateParseException {
        Date parseDate = p042cz.msebera.android.httpclient.client.utils.DateUtils.parseDate(str, strArr, date);
        if (parseDate != null) {
            return parseDate;
        }
    ...
    public static String formatDate(Date date) {
        return p042cz.msebera.android.httpclient.client.utils.DateUtils.formatDate(date);
    }

    public static String formatDate(Date date, String str) {
        return p042cz.msebera.android.httpclient.client.utils.DateUtils.formatDate(date, str);
    }
