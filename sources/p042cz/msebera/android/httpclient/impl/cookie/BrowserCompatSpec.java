...
import p042cz.msebera.android.httpclient.message.BasicHeaderElement;
import p042cz.msebera.android.httpclient.message.BasicHeaderValueFormatter;
...
public class BrowserCompatSpec extends CookieSpecBase {
    ...
    public BrowserCompatSpec(String[] strArr, BrowserCompatSpecFactory.SecurityLevel securityLevel) {
        ...
        int i = C44802.f5701xa779815d[securityLevel.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C44802 {

        /* renamed from: $SwitchMap$cz$msebera$android$httpclient$impl$cookie$BrowserCompatSpecFactory$SecurityLevel */
        static final /* synthetic */ int[] f5701xa779815d = new int[BrowserCompatSpecFactory.SecurityLevel.values().length];
        ...
        static {
            /*
                cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory$SecurityLevel[] r0 = p042cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory.SecurityLevel.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f5701xa779815d = r0
                int[] r0 = f5701xa779815d     // Catch:{ NoSuchFieldError -> 0x0014 }
                cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory$SecurityLevel r1 = p042cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory.SecurityLevel.SECURITYLEVEL_DEFAULT     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f5701xa779815d     // Catch:{ NoSuchFieldError -> 0x001f }
                cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory$SecurityLevel r1 = p042cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory.SecurityLevel.SECURITYLEVEL_IE_MEDIUM     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpec.C44802.<clinit>():void");
        }
    }
