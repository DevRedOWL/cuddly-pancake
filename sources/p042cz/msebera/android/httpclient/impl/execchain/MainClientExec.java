...
import p042cz.msebera.android.httpclient.conn.routing.BasicRouteDirector;
import p042cz.msebera.android.httpclient.conn.routing.HttpRoute;
import p042cz.msebera.android.httpclient.conn.routing.HttpRouteDirector;
import p042cz.msebera.android.httpclient.conn.routing.RouteTracker;
import p042cz.msebera.android.httpclient.extras.HttpClientAndroidLog;
import p042cz.msebera.android.httpclient.impl.auth.HttpAuthenticator;
...
import p042cz.msebera.android.httpclient.protocol.ImmutableHttpProcessor;
...
public class MainClientExec implements ClientExecChain {
    ...
    public p042cz.msebera.android.httpclient.client.methods.CloseableHttpResponse execute(p042cz.msebera.android.httpclient.conn.routing.HttpRoute r25, p042cz.msebera.android.httpclient.client.methods.HttpRequestWrapper r26, p042cz.msebera.android.httpclient.client.protocol.HttpClientContext r27, p042cz.msebera.android.httpclient.client.methods.HttpExecutionAware r28) throws java.io.IOException, p042cz.msebera.android.httpclient.HttpException {
        /*
            r24 = this;
            r7 = r24
            r8 = r25
            ...
            p042cz.msebera.android.httpclient.util.Args.notNull(r8, r1)
            java.lang.String r1 = "HTTP request"
            p042cz.msebera.android.httpclient.util.Args.notNull(r9, r1)
            java.lang.String r1 = "HTTP context"
            p042cz.msebera.android.httpclient.util.Args.notNull(r10, r1)
        ...
        L_0x003e:
            r15 = r1
            boolean r1 = r9 instanceof p042cz.msebera.android.httpclient.HttpEntityEnclosingRequest
            if (r1 == 0) goto L_0x0049
            r1 = r9
            cz.msebera.android.httpclient.HttpEntityEnclosingRequest r1 = (p042cz.msebera.android.httpclient.HttpEntityEnclosingRequest) r1
            p042cz.msebera.android.httpclient.impl.execchain.RequestEntityProxy.enhance(r1)
        L_0x0049:
        ...
        L_0x00cc:
            ...
            boolean r19 = p042cz.msebera.android.httpclient.impl.execchain.RequestEntityProxy.isRepeatable(r26)     // Catch:{ ConnectionShutdownException -> 0x00c6, HttpException -> 0x00c1, IOException -> 0x00bc, RuntimeException -> 0x00b7 }
        ...
        L_0x0268:
            ...
            p042cz.msebera.android.httpclient.util.EntityUtils.consume(r1)     // Catch:{ ConnectionShutdownException -> 0x00c6, HttpException -> 0x030b, IOException -> 0x0309, RuntimeException -> 0x0307 }
            goto L_0x02d1
        L_0x028a:
            ...
            cz.msebera.android.httpclient.auth.AuthProtocolState r2 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.SUCCESS     // Catch:{ ConnectionShutdownException -> 0x00c6, HttpException -> 0x030b, IOException -> 0x0309, RuntimeException -> 0x0307 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0093, code lost:
        if (r0.reuseStrategy.keepAlive(r3, r8) == false) goto L_0x00a4;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0095, code lost:
        r0.log.debug("Connection kept alive");
        p042cz.msebera.android.httpclient.util.EntityUtils.consume(r3.getEntity());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x00a4, code lost:
        r18.close();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean createTunnelToTarget(p042cz.msebera.android.httpclient.auth.AuthState r17, p042cz.msebera.android.httpclient.HttpClientConnection r18, p042cz.msebera.android.httpclient.conn.routing.HttpRoute r19, p042cz.msebera.android.httpclient.HttpRequest r20, p042cz.msebera.android.httpclient.client.protocol.HttpClientContext r21) throws p042cz.msebera.android.httpclient.HttpException, java.io.IOException {
        /*
            r16 = this;
            r0 = r16
            r1 = r18
        ...
        L_0x0044:
            ...
            p042cz.msebera.android.httpclient.util.EntityUtils.consume(r2)
            goto L_0x002d
        L_0x00a4:
            r18.close()
            goto L_0x002d
