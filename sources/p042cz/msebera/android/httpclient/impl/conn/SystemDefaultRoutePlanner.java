...
public class SystemDefaultRoutePlanner extends DefaultRoutePlanner {
    ...
    private Proxy chooseProxy(List<Proxy> list) {
        ...
        while (proxy == null && i < list.size()) {
            ...
            int i2 = C44751.$SwitchMap$java$net$Proxy$Type[proxy2.type().ordinal()];
            if (i2 == 1 || i2 == 2) {
                proxy = proxy2;
            }
            i++;
    ...
    static /* synthetic */ class C44751 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.impl.conn.SystemDefaultRoutePlanner.C44751.<clinit>():void");
        }
    }
}
