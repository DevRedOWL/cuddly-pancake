...
import p042cz.msebera.android.httpclient.auth.AuthOption;
import p042cz.msebera.android.httpclient.auth.AuthProtocolState;
...
import p042cz.msebera.android.httpclient.auth.ContextAwareAuthScheme;
...
public class HttpAuthenticator {
    ...
    public boolean isAuthenticationRequested(HttpHost httpHost, HttpResponse httpResponse, AuthenticationStrategy authenticationStrategy, AuthState authState, HttpContext httpContext) {
        ...
        int i = C44621.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState.getState().ordinal()];
        if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C44621 {
        ...
        static {
            /*
                cz.msebera.android.httpclient.auth.AuthProtocolState[] r0 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.CHALLENGED     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState     // Catch:{ NoSuchFieldError -> 0x001f }
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.HANDSHAKE     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState     // Catch:{ NoSuchFieldError -> 0x002a }
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.SUCCESS     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = $SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState     // Catch:{ NoSuchFieldError -> 0x0035 }
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.FAILURE     // Catch:{ NoSuchFieldError -> 0x0035 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0035 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0035 }
            L_0x0035:
                int[] r0 = $SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState     // Catch:{ NoSuchFieldError -> 0x0040 }
                cz.msebera.android.httpclient.auth.AuthProtocolState r1 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.UNCHALLENGED     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.impl.auth.HttpAuthenticator.C44621.<clinit>():void");
        }
    }
    ...
    public boolean handleAuthChallenge(p042cz.msebera.android.httpclient.HttpHost r7, p042cz.msebera.android.httpclient.HttpResponse r8, p042cz.msebera.android.httpclient.client.AuthenticationStrategy r9, p042cz.msebera.android.httpclient.auth.AuthState r10, p042cz.msebera.android.httpclient.protocol.HttpContext r11) {
        /*
            r6 = this;
            r0 = 0
        ...
        L_0x0035:
            ...
            int[] r3 = p042cz.msebera.android.httpclient.impl.auth.HttpAuthenticator.C44621.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState     // Catch:{ MalformedChallengeException -> 0x00e8 }
        ...
        L_0x005a:
            ...
            r10.reset()     // Catch:{ MalformedChallengeException -> 0x00e8 }
            cz.msebera.android.httpclient.auth.AuthProtocolState r7 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.FAILURE     // Catch:{ MalformedChallengeException -> 0x00e8 }
        ...
        L_0x0070:
            ...
            cz.msebera.android.httpclient.Header r3 = (p042cz.msebera.android.httpclient.Header) r3     // Catch:{ MalformedChallengeException -> 0x00e8 }
            ...
            return r0
        L_0x00ab:
            cz.msebera.android.httpclient.auth.AuthProtocolState r7 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.HANDSHAKE     // Catch:{ MalformedChallengeException -> 0x00e8 }
            r10.setState(r7)     // Catch:{ MalformedChallengeException -> 0x00e8 }
            return r4
        L_0x00b1:
            r10.reset()     // Catch:{ MalformedChallengeException -> 0x00e8 }
        ...
        L_0x00de:
            cz.msebera.android.httpclient.auth.AuthProtocolState r8 = p042cz.msebera.android.httpclient.auth.AuthProtocolState.CHALLENGED     // Catch:{ MalformedChallengeException -> 0x00e8 }
