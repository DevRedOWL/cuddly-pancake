...
import p042cz.msebera.android.httpclient.auth.ChallengeState;
...
import p042cz.msebera.android.httpclient.message.BasicNameValuePair;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    /* renamed from: a1 */
    private String f5689a1;

    /* renamed from: a2 */
    private String f5690a2;
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest, HttpContext httpContext) throws AuthenticationException {
        ...
        if (getParameter("realm") == null) {
            ...
            getParameters().put(AlbumLoader.COLUMN_URI, httpRequest.getRequestLine().getUri());
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest httpRequest) throws AuthenticationException {
        ...
        String parameter = getParameter(AlbumLoader.COLUMN_URI);
        ...
        if (c != 65535) {
            ...
            try {
                ...
                String str12 = AlbumLoader.COLUMN_URI;
                ...
                String encode2 = encode(createMessageDigest.digest(EncodingUtils.getBytes(this.f5689a1, parameter8)));
                if (c == 2) {
                    this.f5690a2 = str16 + ':' + parameter;
                    str3 = str15;
                } else {
                    String str17 = str16;
                    if (c == 1) {
                        ...
                        if (entity == null || entity.isRepeatable()) {
                            ...
                            this.f5690a2 = str17 + ':' + parameter + ':' + encode(httpEntityDigester.getDigest());
                        } else {
                            str3 = str15;
                            if (hashSet2.contains(str3)) {
                                this.f5690a2 = str17 + ':' + parameter;
                                c = 2;
                            } else {
                ...
                String encode3 = encode(createMessageDigest.digest(EncodingUtils.getBytes(this.f5690a2, parameter8)));
                if (c == 0) {
                    sb.setLength(0);
                    sb.append(encode2);
                    sb.append(':');
