...
import p042cz.msebera.android.httpclient.extras.Base64;
import p042cz.msebera.android.httpclient.util.EncodingUtils;
...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    /* renamed from: F */
    static int m6729F(int i, int i2, int i3) {
        return ((~i) & i3) | (i2 & i);
    }

    /* renamed from: G */
    static int m6730G(int i, int i2, int i3) {
        return (i & i3) | (i & i2) | (i2 & i3);
    }

    /* renamed from: H */
    static int m6731H(int i, int i2, int i3) {
        return (i ^ i2) ^ i3;
    }
    ...
    static class MD4 {
        ...
        /* renamed from: A */
        protected int f5691A = 1732584193;

        /* renamed from: B */
        protected int f5692B = -271733879;

        /* renamed from: C */
        protected int f5693C = -1732584194;

        /* renamed from: D */
        protected int f5694D = 271733878;
        ...
        public byte[] getOutput() {
            ...
            update(bArr);
            byte[] bArr2 = new byte[16];
            NTLMEngineImpl.writeULong(bArr2, this.f5691A, 0);
            NTLMEngineImpl.writeULong(bArr2, this.f5692B, 4);
            NTLMEngineImpl.writeULong(bArr2, this.f5693C, 8);
            NTLMEngineImpl.writeULong(bArr2, this.f5694D, 12);
            return bArr2;
        }
        ...
        public void round1(int[] iArr) {
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6729F(this.f5692B, this.f5693C, this.f5694D) + iArr[0], 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6729F(this.f5691A, this.f5692B, this.f5693C) + iArr[1], 7);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6729F(this.f5694D, this.f5691A, this.f5692B) + iArr[2], 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6729F(this.f5693C, this.f5694D, this.f5691A) + iArr[3], 19);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6729F(this.f5692B, this.f5693C, this.f5694D) + iArr[4], 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6729F(this.f5691A, this.f5692B, this.f5693C) + iArr[5], 7);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6729F(this.f5694D, this.f5691A, this.f5692B) + iArr[6], 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6729F(this.f5693C, this.f5694D, this.f5691A) + iArr[7], 19);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6729F(this.f5692B, this.f5693C, this.f5694D) + iArr[8], 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6729F(this.f5691A, this.f5692B, this.f5693C) + iArr[9], 7);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6729F(this.f5694D, this.f5691A, this.f5692B) + iArr[10], 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6729F(this.f5693C, this.f5694D, this.f5691A) + iArr[11], 19);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6729F(this.f5692B, this.f5693C, this.f5694D) + iArr[12], 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6729F(this.f5691A, this.f5692B, this.f5693C) + iArr[13], 7);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6729F(this.f5694D, this.f5691A, this.f5692B) + iArr[14], 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6729F(this.f5693C, this.f5694D, this.f5691A) + iArr[15], 19);
        }

        /* access modifiers changed from: protected */
        public void round2(int[] iArr) {
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6730G(this.f5692B, this.f5693C, this.f5694D) + iArr[0] + 1518500249, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6730G(this.f5691A, this.f5692B, this.f5693C) + iArr[4] + 1518500249, 5);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6730G(this.f5694D, this.f5691A, this.f5692B) + iArr[8] + 1518500249, 9);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6730G(this.f5693C, this.f5694D, this.f5691A) + iArr[12] + 1518500249, 13);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6730G(this.f5692B, this.f5693C, this.f5694D) + iArr[1] + 1518500249, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6730G(this.f5691A, this.f5692B, this.f5693C) + iArr[5] + 1518500249, 5);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6730G(this.f5694D, this.f5691A, this.f5692B) + iArr[9] + 1518500249, 9);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6730G(this.f5693C, this.f5694D, this.f5691A) + iArr[13] + 1518500249, 13);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6730G(this.f5692B, this.f5693C, this.f5694D) + iArr[2] + 1518500249, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6730G(this.f5691A, this.f5692B, this.f5693C) + iArr[6] + 1518500249, 5);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6730G(this.f5694D, this.f5691A, this.f5692B) + iArr[10] + 1518500249, 9);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6730G(this.f5693C, this.f5694D, this.f5691A) + iArr[14] + 1518500249, 13);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6730G(this.f5692B, this.f5693C, this.f5694D) + iArr[3] + 1518500249, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6730G(this.f5691A, this.f5692B, this.f5693C) + iArr[7] + 1518500249, 5);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6730G(this.f5694D, this.f5691A, this.f5692B) + iArr[11] + 1518500249, 9);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6730G(this.f5693C, this.f5694D, this.f5691A) + iArr[15] + 1518500249, 13);
        }

        /* access modifiers changed from: protected */
        public void round3(int[] iArr) {
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6731H(this.f5692B, this.f5693C, this.f5694D) + iArr[0] + 1859775393, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6731H(this.f5691A, this.f5692B, this.f5693C) + iArr[8] + 1859775393, 9);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6731H(this.f5694D, this.f5691A, this.f5692B) + iArr[4] + 1859775393, 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6731H(this.f5693C, this.f5694D, this.f5691A) + iArr[12] + 1859775393, 15);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6731H(this.f5692B, this.f5693C, this.f5694D) + iArr[2] + 1859775393, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6731H(this.f5691A, this.f5692B, this.f5693C) + iArr[10] + 1859775393, 9);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6731H(this.f5694D, this.f5691A, this.f5692B) + iArr[6] + 1859775393, 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6731H(this.f5693C, this.f5694D, this.f5691A) + iArr[14] + 1859775393, 15);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6731H(this.f5692B, this.f5693C, this.f5694D) + iArr[1] + 1859775393, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6731H(this.f5691A, this.f5692B, this.f5693C) + iArr[9] + 1859775393, 9);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6731H(this.f5694D, this.f5691A, this.f5692B) + iArr[5] + 1859775393, 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6731H(this.f5693C, this.f5694D, this.f5691A) + iArr[13] + 1859775393, 15);
            this.f5691A = NTLMEngineImpl.rotintlft(this.f5691A + NTLMEngineImpl.m6731H(this.f5692B, this.f5693C, this.f5694D) + iArr[3] + 1859775393, 3);
            this.f5694D = NTLMEngineImpl.rotintlft(this.f5694D + NTLMEngineImpl.m6731H(this.f5691A, this.f5692B, this.f5693C) + iArr[11] + 1859775393, 9);
            this.f5693C = NTLMEngineImpl.rotintlft(this.f5693C + NTLMEngineImpl.m6731H(this.f5694D, this.f5691A, this.f5692B) + iArr[7] + 1859775393, 11);
            this.f5692B = NTLMEngineImpl.rotintlft(this.f5692B + NTLMEngineImpl.m6731H(this.f5693C, this.f5694D, this.f5691A) + iArr[15] + 1859775393, 15);
        }
    }
