...
import p042cz.msebera.android.httpclient.entity.AbstractHttpEntity;
...
import p042cz.msebera.android.httpclient.message.BasicStatusLine;
...
class RequestProtocolCompliance {
    ...
    static /* synthetic */ class C44671 {

        /* renamed from: $SwitchMap$cz$msebera$android$httpclient$impl$client$cache$RequestProtocolError */
        static final /* synthetic */ int[] f5696x3102a434 = new int[RequestProtocolError.values().length];
        ...
        static {
            /*
                cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError[] r0 = p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f5696x3102a434 = r0
                int[] r0 = f5696x3102a434     // Catch:{ NoSuchFieldError -> 0x0014 }
                cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError r1 = p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError.BODY_BUT_NO_LENGTH_ERROR     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f5696x3102a434     // Catch:{ NoSuchFieldError -> 0x001f }
                cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError r1 = p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError.WEAK_ETAG_AND_RANGE_ERROR     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = f5696x3102a434     // Catch:{ NoSuchFieldError -> 0x002a }
                cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError r1 = p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError.WEAK_ETAG_ON_PUTDELETE_METHOD_ERROR     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = f5696x3102a434     // Catch:{ NoSuchFieldError -> 0x0035 }
                cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError r1 = p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolError.NO_CACHE_DIRECTIVE_WITH_FIELD_NAME     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p042cz.msebera.android.httpclient.impl.client.cache.RequestProtocolCompliance.C44671.<clinit>():void");
        }
    }

    public HttpResponse getErrorForRequest(RequestProtocolError requestProtocolError) {
        int i = C44671.f5696x3102a434[requestProtocolError.ordinal()];
        if (i == 1) {
