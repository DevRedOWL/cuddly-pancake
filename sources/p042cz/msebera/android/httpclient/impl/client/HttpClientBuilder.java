...
import p042cz.msebera.android.httpclient.client.config.CookieSpecs;
import p042cz.msebera.android.httpclient.client.config.RequestConfig;
import p042cz.msebera.android.httpclient.client.params.CookiePolicy;
...
import p042cz.msebera.android.httpclient.client.protocol.RequestExpectContinue;
...
import p042cz.msebera.android.httpclient.config.Lookup;
import p042cz.msebera.android.httpclient.config.Registry;
import p042cz.msebera.android.httpclient.config.RegistryBuilder;
import p042cz.msebera.android.httpclient.config.SocketConfig;
...
import p042cz.msebera.android.httpclient.conn.socket.ConnectionSocketFactory;
import p042cz.msebera.android.httpclient.conn.socket.LayeredConnectionSocketFactory;
import p042cz.msebera.android.httpclient.conn.socket.PlainConnectionSocketFactory;
import p042cz.msebera.android.httpclient.conn.ssl.SSLConnectionSocketFactory;
import p042cz.msebera.android.httpclient.conn.ssl.SSLContexts;
import p042cz.msebera.android.httpclient.conn.ssl.X509HostnameVerifier;
...
import p042cz.msebera.android.httpclient.impl.auth.BasicSchemeFactory;
import p042cz.msebera.android.httpclient.impl.auth.DigestSchemeFactory;
import p042cz.msebera.android.httpclient.impl.auth.NTLMSchemeFactory;
import p042cz.msebera.android.httpclient.impl.conn.DefaultProxyRoutePlanner;
import p042cz.msebera.android.httpclient.impl.conn.DefaultRoutePlanner;
import p042cz.msebera.android.httpclient.impl.conn.DefaultSchemePortResolver;
import p042cz.msebera.android.httpclient.impl.conn.PoolingHttpClientConnectionManager;
import p042cz.msebera.android.httpclient.impl.conn.SystemDefaultRoutePlanner;
import p042cz.msebera.android.httpclient.impl.cookie.BestMatchSpecFactory;
import p042cz.msebera.android.httpclient.impl.cookie.BrowserCompatSpecFactory;
import p042cz.msebera.android.httpclient.impl.cookie.IgnoreSpecFactory;
import p042cz.msebera.android.httpclient.impl.cookie.NetscapeDraftSpecFactory;
import p042cz.msebera.android.httpclient.impl.cookie.RFC2109SpecFactory;
import p042cz.msebera.android.httpclient.impl.cookie.RFC2965SpecFactory;
import p042cz.msebera.android.httpclient.impl.execchain.BackoffStrategyExec;
import p042cz.msebera.android.httpclient.impl.execchain.ClientExecChain;
import p042cz.msebera.android.httpclient.impl.execchain.MainClientExec;
import p042cz.msebera.android.httpclient.impl.execchain.ProtocolExec;
import p042cz.msebera.android.httpclient.impl.execchain.RedirectExec;
import p042cz.msebera.android.httpclient.impl.execchain.RetryExec;
import p042cz.msebera.android.httpclient.impl.execchain.ServiceUnavailableRetryExec;
import p042cz.msebera.android.httpclient.protocol.HttpProcessor;
import p042cz.msebera.android.httpclient.protocol.HttpProcessorBuilder;
...
import p042cz.msebera.android.httpclient.util.VersionInfo;
...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager == null) {
            ...
            PoolingHttpClientConnectionManager poolingHttpClientConnectionManager2 = new PoolingHttpClientConnectionManager((Registry<ConnectionSocketFactory>) RegistryBuilder.create().register("http", PlainConnectionSocketFactory.getSocketFactory()).register(UriUtil.HTTPS_SCHEME, obj).build());
