...
import p042cz.msebera.android.httpclient.auth.NTCredentials;
...
public class SystemDefaultCredentialsProvider implements CredentialsProvider {
    ...
    private static PasswordAuthentication getSystemCreds(AuthScope authScope, Authenticator.RequestorType requestorType) {
        ...
        return Authenticator.requestPasswordAuthentication(host, (InetAddress) null, port, port == 443 ? UriUtil.HTTPS_SCHEME : "http", (String) null, translateScheme(authScope.getScheme()), (URL) null, requestorType);
    }
