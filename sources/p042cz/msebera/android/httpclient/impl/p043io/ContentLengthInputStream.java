...
public class ContentLengthInputStream extends InputStream {
    ...
    /* renamed from: in */
    private SessionInputBuffer f5703in = null;
    private long pos = 0;

    public ContentLengthInputStream(SessionInputBuffer sessionInputBuffer, long j) {
        this.f5703in = (SessionInputBuffer) Args.notNull(sessionInputBuffer, "Session input buffer");
    ...
    public int available() throws IOException {
        SessionInputBuffer sessionInputBuffer = this.f5703in;
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        if (!this.closed) {
            ...
            int read = this.f5703in.read(bArr, i, i2);
