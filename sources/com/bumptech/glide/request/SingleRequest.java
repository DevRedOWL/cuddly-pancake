...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00b5 }
            r7.append(r8)     // Catch:{ all -> 0x00b5 }
        ...
        L_0x0056:
            return
        L_0x0057:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r1)     // Catch:{ all -> 0x00b5 }
            return
        L_0x005c:
            r5.resource = r0     // Catch:{ all -> 0x00bd }
            ...
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00bd }
            r8.append(r0)     // Catch:{ all -> 0x00bd }
            java.lang.String r0 = " but instead got "
            r8.append(r0)     // Catch:{ all -> 0x00bd }
            if (r2 == 0) goto L_0x007b
            java.lang.Class r0 = r2.getClass()     // Catch:{ all -> 0x00bd }
            goto L_0x007d
        L_0x007b:
            java.lang.String r0 = ""
        L_0x007d:
        ...
        L_0x009f:
            r8.append(r0)     // Catch:{ all -> 0x00bd }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00bd }
    ...
    private void onLoadFailed(GlideException glideException, int i) {
        ...
        synchronized (this.requestLock) {
            ...
            if (logLevel <= i) {
                Log.w(GLIDE_TAG, "Load failed for " + this.model + " with size [" + this.width + MapPoint.JsonFields.f6911x + this.height + "]", glideException);
                if (logLevel <= 4) {
