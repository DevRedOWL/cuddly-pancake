...
public final class Util {
    ...
    public static int getBitmapByteSize(Bitmap bitmap) {
        ...
        throw new IllegalStateException("Cannot obtain size for recycled Bitmap: " + bitmap + "[" + bitmap.getWidth() + MapPoint.JsonFields.f6911x + bitmap.getHeight() + "] " + bitmap.getConfig());
    }
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C11681.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    static /* synthetic */ class C11681 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C11681.<clinit>():void");
        }
    }
