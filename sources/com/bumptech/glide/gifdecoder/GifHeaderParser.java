...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1194ix = readShort();
        this.header.currentFrame.f1195iy = readShort();
        this.header.currentFrame.f1193iw = readShort();
        this.header.currentFrame.f1192ih = readShort();
        int read = read();
        boolean z = false;
