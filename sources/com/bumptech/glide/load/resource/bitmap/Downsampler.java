...
public final class Downsampler {
            ...
            if (downsampler.shouldUsePool(imageType2)) {
                if (i14 < 0 || i13 < 0 || !z2 || !z5) {
                    ...
                    if (Log.isLoggable(TAG, 2)) {
                        Log.v(TAG, "Calculated target [" + i7 + MapPoint.JsonFields.f6911x + i6 + "] for source [" + i14 + MapPoint.JsonFields.f6911x + i13 + "], sampleSize: " + i15 + ", targetDensity: " + options3.inTargetDensity + ", density: " + options3.inDensity + ", density multiplier: " + f);
                    }
                } else {
                    i7 = i3;
                    i6 = i11;
    ...
    private static void calculateScaling(ImageHeaderParser.ImageType imageType, ImageReader imageReader, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool2, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, BitmapFactory.Options options) throws IOException {
        ...
        BitmapFactory.Options options2 = options;
        if (i12 <= 0 || i13 <= 0) {
            String str = MapPoint.JsonFields.f6911x;
        ...
        if (scaleFactor > 0.0f) {
            ...
            if (sampleSizeRounding != null) {
                ...
                String str2 = MapPoint.JsonFields.f6911x;
        ...
        String str4 = MapPoint.JsonFields.f6911x;
        int i18 = i12;
        throw new IllegalArgumentException("Cannot scale with factor: " + scaleFactor + " from: " + downsampleStrategy2 + ", source: [" + i18 + str4 + i13 + "], target: [" + i14 + str4 + i15 + "]");
    }
    ...
    private static void logDecode(int i, int i2, String str, BitmapFactory.Options options, Bitmap bitmap, int i3, int i4, long j) {
        Log.v(TAG, "Decoded " + getBitmapString(bitmap) + " from [" + i + MapPoint.JsonFields.f6911x + i2 + "] " + str + " with inBitmap " + getInBitmapString(options) + " for [" + i3 + MapPoint.JsonFields.f6911x + i4 + "], sample size: " + options.inSampleSize + ", density: " + options.inDensity + ", target density: " + options.inTargetDensity + ", thread: " + Thread.currentThread().getName() + ", duration: " + LogTime.getElapsedMillis(j));
    }
    ...
    private static String getBitmapString(Bitmap bitmap) {
        ...
        return "[" + bitmap.getWidth() + MapPoint.JsonFields.f6911x + bitmap.getHeight() + "] " + bitmap.getConfig() + str;
    }
