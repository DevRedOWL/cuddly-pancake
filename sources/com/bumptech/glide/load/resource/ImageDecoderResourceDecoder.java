        ...
        return decode(source, i, i2, (ImageDecoder.OnHeaderDecodedListener) new ImageDecoder.OnHeaderDecodedListener() {
            public void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
                ...
                if (Log.isLoggable(ImageDecoderResourceDecoder.TAG, 2)) {
                    Log.v(ImageDecoderResourceDecoder.TAG, "Resizing from [" + size.getWidth() + MapPoint.JsonFields.f6911x + size.getHeight() + "] to [" + round + MapPoint.JsonFields.f6911x + round2 + "] scaleFactor: " + scaleFactor);
                }
