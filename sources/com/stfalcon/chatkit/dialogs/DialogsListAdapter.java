...
public class DialogsListAdapter<DIALOG extends IDialog> extends RecyclerView.Adapter<BaseDialogViewHolder> {
    ...
    public DialogsListAdapter(ImageLoader imageLoader2) {
        this(C2908R.layout.item_dialog, DialogViewHolder.class, imageLoader2);
    }
    ...
    public BaseDialogViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        try {
            Constructor<? extends BaseDialogViewHolder> declaredConstructor = this.holderClass.getDeclaredConstructor(new Class[]{View.class});
    ...
    public void moveItem(int i, int i2) {
        this.items.add(i2, (IDialog) this.items.remove(i));
    ...
    public void upsertItem(DIALOG dialog) {
        ...
        while (true) {
            if (i >= this.items.size()) {
                break;
            } else if (((IDialog) this.items.get(i)).getId().equals(dialog.getId())) {
                this.items.set(i, dialog);
                notifyItemChanged(i);
                z = true;
                break;
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        public DialogViewHolder(View view) {
            super(view);
            this.root = (ViewGroup) view.findViewById(C2908R.C2911id.dialogRootLayout);
            this.container = (ViewGroup) view.findViewById(C2908R.C2911id.dialogContainer);
            this.tvName = (TextView) view.findViewById(C2908R.C2911id.dialogName);
            this.tvDate = (TextView) view.findViewById(C2908R.C2911id.dialogDate);
            this.tvLastMessage = (TextView) view.findViewById(C2908R.C2911id.dialogLastMessage);
            this.tvBubble = (TextView) view.findViewById(C2908R.C2911id.dialogUnreadBubble);
            this.ivLastMessageUser = (ImageView) view.findViewById(C2908R.C2911id.dialogLastMessageUserAvatar);
            this.ivAvatar = (ImageView) view.findViewById(C2908R.C2911id.dialogAvatar);
            this.dividerContainer = (ViewGroup) view.findViewById(C2908R.C2911id.dialogDividerContainer);
            this.divider = view.findViewById(C2908R.C2911id.dialogDivider);
        }
        ...
        public void onBind(final DIALOG dialog) {
            ...
            if (this.imageLoader != null) {
                this.imageLoader.loadImage(this.ivAvatar, dialog.getDialogPhoto(), (Object) null);
            }
            if (!(this.imageLoader == null || dialog.getLastMessage() == null)) {
                this.imageLoader.loadImage(this.ivLastMessageUser, dialog.getLastMessage().getUser().getAvatar(), (Object) null);
            }
            int i = 0;
