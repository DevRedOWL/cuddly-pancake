...
public class RoundedImageView extends AppCompatImageView {
    ...
    private static class RoundedCornerDrawable extends Drawable {
        ...
        public static RoundedCornerDrawable fromBitmap(Bitmap bitmap, Resources resources) {
            if (bitmap != null) {
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources resources) {
            ...
            return drawableToBitmap != null ? new RoundedCornerDrawable(drawableToBitmap, resources) : drawable;
        }
