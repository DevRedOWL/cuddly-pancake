...
public class BallGridBeatIndicator extends Indicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        int[] iArr2 = {360, 400, 680, HttpStatus.SC_GONE, 710, -150, -120, 10, DimensionsKt.XHDPI};
        for (final int i = 0; i < 9; i++) {
            ValueAnimator ofInt = ValueAnimator.ofInt(new int[]{255, NikonType2MakernoteDirectory.TAG_FLASH_INFO, 255});
