...
public class BallGridPulseIndicator extends Indicator {
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        int[] iArr = {720, PointerIconCompat.TYPE_GRAB, 1280, 1420, 1450, 1180, 870, 1450, PhotoshopDirectory.TAG_XMP_DATA};
        int[] iArr2 = {-60, 250, -170, DimensionsKt.XXHDPI, 310, 30, 460, 780, 450};
