...
public class C2797RCTCamera {
    ...
    public static C2797RCTCamera getInstance() {
        return ourInstance;
    }

    public static void createInstance(int i) {
        ourInstance = new C2797RCTCamera(i);
    }
