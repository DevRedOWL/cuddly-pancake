...
public class RCTCameraView extends ViewGroup {
    ...
    public RCTCameraView(Context context) {
        ...
        C2797RCTCamera.createInstance(getDeviceOrientation(context));
    ...
    public void setCameraType(int i) {
        ...
        if (rCTCameraViewFinder != null) {
            ...
            C2797RCTCamera.getInstance().adjustPreviewLayout(i);
            return;
        }
    ...
    public void setOrientation(int i) {
        C2797RCTCamera.getInstance().setOrientation(i);
    ...
    public void setBarcodeScannerEnabled(boolean z) {
        C2797RCTCamera.getInstance().setBarcodeScannerEnabled(z);
    }

    public void setBarCodeTypes(List<String> list) {
        C2797RCTCamera.getInstance().setBarCodeTypes(list);
    }
    ...
    public boolean setActualDeviceOrientation(Context context) {
        ...
        C2797RCTCamera.getInstance().setActualDeviceOrientation(this._actualDeviceOrientation);
        return true;
    }
    ...
    private void layoutViewFinder(int r6, int r7, int r8, int r9) {
        ...
        L_0x0032:
            ...
            float r2 = r2 / r1
            int r1 = (int) r2
            com.lwansbrough.RCTCamera.RCTCamera r2 = com.lwansbrough.RCTCamera.C2797RCTCamera.getInstance()
