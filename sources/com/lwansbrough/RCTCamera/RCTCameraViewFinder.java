...
class RCTCameraViewFinder extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    public RCTCameraViewFinder(Context context, int i) {
        ...
        this._cameraType = i;
        initBarcodeReader(C2797RCTCamera.getInstance().getBarCodeTypes());
    }
    ...
    public double getRatio() {
        return (double) (((float) C2797RCTCamera.getInstance().getPreviewWidth(this._cameraType)) / ((float) C2797RCTCamera.getInstance().getPreviewHeight(this._cameraType)));
    }
    ...
    public void setCaptureMode(int i) {
        C2797RCTCamera.getInstance().setCaptureMode(this._cameraType, i);
        this._captureMode = i;
    }

    public void setCaptureQuality(String str) {
        C2797RCTCamera.getInstance().setCaptureQuality(this._cameraType, str);
    }

    public void setTorchMode(int i) {
        C2797RCTCamera.getInstance().setTorchMode(this._cameraType, i);
    }

    public void setFlashMode(int i) {
        C2797RCTCamera.getInstance().setFlashMode(this._cameraType, i);
    }
    ...
    public void setZoom(int i) {
        C2797RCTCamera.getInstance().setZoom(this._cameraType, i);
    }
    ...
    private synchronized void startCamera() {
        ...
        if (!this._isStarting) {
            ...
            try {
                this._camera = C2797RCTCamera.getInstance().acquireCameraInstance(this._cameraType);
                ...
                if (z2) {
                    ...
                    list = C2797RCTCamera.getInstance().getSupportedVideoSizes(this._camera);
                } else {
                    throw new RuntimeException("Unsupported capture mode:" + this._captureMode);
                }
                Camera.Size bestSize = C2797RCTCamera.getInstance().getBestSize(list, Integer.MAX_VALUE, Integer.MAX_VALUE);
        ...
        if (!this._isStopping) {
            ...
            try {
                if (this._camera != null) {
                    ...
                    C2797RCTCamera.getInstance().releaseCameraInstance(this._cameraType);
                    this._camera = null;
                }
            } catch (Exception e) {
                try {
    ...
    public void onPreviewFrame(byte[] bArr, Camera camera) {
        if (C2797RCTCamera.getInstance().isBarcodeScannerEnabled() && !barcodeScannerTaskLock) {
                ...
                if (barcodeAnyOrientation != null) {
                    ...
                    if (resultPoints != null) {
                        for (ResultPoint resultPoint : resultPoints) {
                            ...
                            createMap2.putString(MapPoint.JsonFields.f6911x, String.valueOf(resultPoint.getX()));
                            createMap2.putString(MapPoint.JsonFields.f6912y, String.valueOf(resultPoint.getY()));
