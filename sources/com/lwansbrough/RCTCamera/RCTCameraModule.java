...
public class RCTCameraModule extends ReactContextBaseJavaModule implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener, LifecycleEventListener {
    ...
    private Throwable prepareMediaRecorder(ReadableMap readableMap, int i) {
        CamcorderProfile captureVideoQuality = C2797RCTCamera.getInstance().setCaptureVideoQuality(readableMap.getInt("type"), readableMap.getString("quality"));
    ...
    private void record(ReadableMap readableMap, Promise promise, int i) {
        if (this.mRecordingPromise == null) {
            this.mCamera = C2797RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt("type"));
    ...
    public void capture(final ReadableMap readableMap, final Promise promise) {
        if (C2797RCTCamera.getInstance() == null) {
            promise.reject("Camera is not ready yet.");
            return;
        }
        int i = readableMap.hasKey("orientation") ? readableMap.getInt("orientation") : C2797RCTCamera.getInstance().getOrientation();
    ...
    public void captureWithOrientation(final ReadableMap readableMap, final Promise promise, int i) {
        final Camera acquireCameraInstance = C2797RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt("type"));
        if (acquireCameraInstance == null) {
            promise.reject("No camera found.");
        } else if (readableMap.getInt("mode") == 1) {
            record(readableMap, promise, i);
        } else {
            C2797RCTCamera.getInstance().setCaptureQuality(readableMap.getInt("type"), readableMap.getString("quality"));
            ...
            C2797RCTCamera.getInstance().adjustCameraRotationToDeviceOrientation(readableMap.getInt("type"), i);
            acquireCameraInstance.setPreviewCallback((Camera.PreviewCallback) null);
            C28093 r1 = new Camera.PictureCallback() {
            ...
            C28114 r7 = new Camera.ShutterCallback() {
    ...
    public synchronized void processImage(com.lwansbrough.RCTCamera.MutableImage r12, com.facebook.react.bridge.ReadableMap r13, com.facebook.react.bridge.Promise r14) {
        ...
        L_0x0022:
            ...
            com.lwansbrough.RCTCamera.RCTCamera r7 = com.lwansbrough.RCTCamera.C2797RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x005d }
            ...
            com.lwansbrough.RCTCamera.RCTCamera r9 = com.lwansbrough.RCTCamera.C2797RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x005d }
    ...
    public void hasFlash(ReadableMap readableMap, Promise promise) {
        Camera acquireCameraInstance = C2797RCTCamera.getInstance().acquireCameraInstance(readableMap.getInt("type"));
        if (acquireCameraInstance == null) {
            promise.reject("No camera found.");
            return;
        }
    ...
    public void setZoom(ReadableMap readableMap, int i) {
        ...
        C2797RCTCamera instance = C2797RCTCamera.getInstance();
    ...
    private void resolveImage(File file, int i, int i2, final Promise promise, boolean z) {
        ...
        writableNativeMap.putString(ClientCookie.PATH_ATTR, Uri.fromFile(file).toString());
