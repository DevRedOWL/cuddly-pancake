...
class MinuteIntervalSnappableTimePickerDialog extends TimePickerDialog {
    ...
    public boolean pickerIsInTextInputMode() {
        View findViewById = findViewById(this.mContext.getResources().getIdentifier("input_mode", "id", AbstractSpiCall.ANDROID_CLIENT_TYPE));
    ...
    private void setupPickerDialog() {
        this.mTimePicker = (TimePicker) findViewById(this.mContext.getResources().getIdentifier("timePicker", "id", AbstractSpiCall.ANDROID_CLIENT_TYPE));
    ...
    private void setSpinnerDisplayedValues() {
        NumberPicker numberPicker = (NumberPicker) findViewById(this.mContext.getResources().getIdentifier("minute", "id", AbstractSpiCall.ANDROID_CLIENT_TYPE));
