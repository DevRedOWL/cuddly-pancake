...
public class RNDatePickerDialogFragment extends DialogFragment {
    ...
    static DatePickerDialog getDialog(Bundle bundle, Context context, DatePickerDialog.OnDateSetListener onDateSetListener) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            int i = C28611.f2300x8ff92e2[valueOf.ordinal()];
            if (i != 1 && i != 2) {
                return new RNDismissableDatePickerDialog(context, onDateSetListener, year, month, day, valueOf);
            }
            return new RNDismissableDatePickerDialog(context, context.getResources().getIdentifier(valueOf == RNDatePickerDisplay.CALENDAR ? "CalendarDatePickerDialog" : "SpinnerDatePickerDialog", ButtonField.JsonFields.style, context.getPackageName()), onDateSetListener, year, month, day, valueOf);
        }
        ...
        int i2 = C28611.f2300x8ff92e2[valueOf.ordinal()];
        if (i2 == 1) {
    ...
    static /* synthetic */ class C28611 {
        ...
        static final /* synthetic */ int[] f2300x8ff92e2 = new int[RNDatePickerDisplay.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f2300x8ff92e2 = r0
                int[] r0 = f2300x8ff92e2     // Catch:{ NoSuchFieldError -> 0x0014 }
                com.reactcommunity.rndatetimepicker.RNDatePickerDisplay r1 = com.reactcommunity.rndatetimepicker.RNDatePickerDisplay.CALENDAR     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f2300x8ff92e2     // Catch:{ NoSuchFieldError -> 0x001f }
                com.reactcommunity.rndatetimepicker.RNDatePickerDisplay r1 = com.reactcommunity.rndatetimepicker.RNDatePickerDisplay.SPINNER     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.reactcommunity.rndatetimepicker.RNDatePickerDialogFragment.C28611.<clinit>():void");
        }
    }
