...
public abstract class MaterialSpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        TextView textView;
        if (view == null) {
            view = LayoutInflater.from(this.context).inflate(C2739R.layout.ms__list_item, viewGroup, false);
            textView = (TextView) view.findViewById(C2739R.C2741id.tv_tinted_spinner);
