...
class PropHelper {
    ...
    static class PathParser {
        ...
        private WritableMap getPointMap(float f, float f2) {
            ...
            createMap.putDouble(MapPoint.JsonFields.f6911x, (double) (f * this.mScale));
            createMap.putDouble(MapPoint.JsonFields.f6912y, (double) (f2 * this.mScale));
            return createMap;
        }

        private WritableMap clonePointMap(WritableMap writableMap) {
            WritableMap createMap = Arguments.createMap();
            createMap.putDouble(MapPoint.JsonFields.f6911x, writableMap.getDouble(MapPoint.JsonFields.f6911x));
            createMap.putDouble(MapPoint.JsonFields.f6912y, writableMap.getDouble(MapPoint.JsonFields.f6912y));
            return createMap;
        }
        ...
        private void arcTo(float f, float f2, float f3, boolean z, boolean z2, float f4, float f5) {
            ...
            if (f31 == f32 && radians == 0.0f) {
                ...
                float f39 = this.mScale;
                this.mPath.arcTo(new RectF((f35 - f31) * f39, (f36 - f31) * f39, (f35 + f31) * f39, (f36 + f31) * f39), degrees, abs3);
                return;
            }
            arcToBezier(f35, f36, f31, f32, atan2, atan22, z2, radians);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:11:0x006b A[LOOP:0: B:10:0x0069->B:11:0x006b, LOOP_END] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
