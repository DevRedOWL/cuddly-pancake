...
public final class FreeState extends State {
    ...
    public Next accept(char c) {
        if (this.ownCharacter == c) {
            return new Next(nextState(), Character.valueOf(c), true, (Character) null);
        }
        return new Next(nextState(), Character.valueOf(this.ownCharacter), false, (Character) null);
    }
