...
public final class Compiler {
    ...
    public final State compile(String str) throws FormatError {
        ...
        return compile(new FormatSanitizer().sanitize(str), false, false, (Character) null);
    }
