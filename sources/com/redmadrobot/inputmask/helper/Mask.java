...
public final class Mask {
        ...
        public boolean equals(Object obj) {
            if (this != obj) {
                if (obj instanceof Result) {
                    ...
                    if (Intrinsics.areEqual((Object) this.formattedText, (Object) result.formattedText) && Intrinsics.areEqual((Object) this.extractedValue, (Object) result.extractedValue)) {
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001c\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u00052\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\nJ\u001c\u0010\f\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u00052\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\nR\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, mo51343d2 = {"Lcom/redmadrobot/inputmask/helper/Mask$Factory;", "", "()V", "cache", "", "", "Lcom/redmadrobot/inputmask/helper/Mask;", "getOrCreate", "format", "customNotations", "", "Lcom/redmadrobot/inputmask/model/Notation;", "isValid", "", "input-mask-android_release"}, mo51344k = 1, mo51345mv = {1, 1, 13})
    /* compiled from: Mask.kt */
    ...
    public final Result apply(CaretString caretString, boolean z) {
        ...
        CaretStringIterator caretStringIterator = new CaretStringIterator(caretString, 0, 2, (DefaultConstructorMarker) null);
        ...
        while (next != null) {
            ...
            if (accept != null) {
                ...
                if (accept.getPass()) {
                    ...
                    ch = caretStringIterator.next();
                    i2++;
                } else {
                    if (z3 && accept.getInsert() != null) {
                        i++;
                    }
                    i2--;
                }
