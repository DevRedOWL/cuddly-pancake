...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1668R.styleable.FloatingActionMenu, 0, 0);
        this.mButtonSpacing = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_buttonSpacing, this.mButtonSpacing);
        this.mLabelsMargin = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_margin, this.mLabelsMargin);
        this.mLabelsPosition = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_labels_position, 0);
        this.mLabelsShowAnimation = obtainStyledAttributes.getResourceId(C1668R.styleable.FloatingActionMenu_menu_labels_showAnimation, this.mLabelsPosition == 0 ? C1668R.anim.fab_slide_in_from_right : C1668R.anim.fab_slide_in_from_left);
        this.mLabelsHideAnimation = obtainStyledAttributes.getResourceId(C1668R.styleable.FloatingActionMenu_menu_labels_hideAnimation, this.mLabelsPosition == 0 ? C1668R.anim.fab_slide_out_to_right : C1668R.anim.fab_slide_out_to_left);
        this.mLabelsPaddingTop = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_paddingTop, this.mLabelsPaddingTop);
        this.mLabelsPaddingRight = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_paddingRight, this.mLabelsPaddingRight);
        this.mLabelsPaddingBottom = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_paddingBottom, this.mLabelsPaddingBottom);
        this.mLabelsPaddingLeft = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_paddingLeft, this.mLabelsPaddingLeft);
        this.mLabelsTextColor = obtainStyledAttributes.getColorStateList(C1668R.styleable.FloatingActionMenu_menu_labels_textColor);
        if (this.mLabelsTextColor == null) {
            this.mLabelsTextColor = ColorStateList.valueOf(-1);
        }
        this.mLabelsTextSize = obtainStyledAttributes.getDimension(C1668R.styleable.FloatingActionMenu_menu_labels_textSize, getResources().getDimension(C1668R.dimen.labels_text_size));
        this.mLabelsCornerRadius = obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_cornerRadius, this.mLabelsCornerRadius);
        this.mLabelsShowShadow = obtainStyledAttributes.getBoolean(C1668R.styleable.FloatingActionMenu_menu_labels_showShadow, true);
        this.mLabelsColorNormal = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_labels_colorNormal, -13421773);
        this.mLabelsColorPressed = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_labels_colorPressed, -12303292);
        this.mLabelsColorRipple = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_labels_colorRipple, 1728053247);
        this.mMenuShowShadow = obtainStyledAttributes.getBoolean(C1668R.styleable.FloatingActionMenu_menu_showShadow, true);
        this.mMenuShadowColor = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_shadowColor, 1711276032);
        this.mMenuShadowRadius = obtainStyledAttributes.getDimension(C1668R.styleable.FloatingActionMenu_menu_shadowRadius, this.mMenuShadowRadius);
        this.mMenuShadowXOffset = obtainStyledAttributes.getDimension(C1668R.styleable.FloatingActionMenu_menu_shadowXOffset, this.mMenuShadowXOffset);
        this.mMenuShadowYOffset = obtainStyledAttributes.getDimension(C1668R.styleable.FloatingActionMenu_menu_shadowYOffset, this.mMenuShadowYOffset);
        this.mMenuColorNormal = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_colorNormal, -2473162);
        this.mMenuColorPressed = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_colorPressed, -1617853);
        this.mMenuColorRipple = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_colorRipple, -1711276033);
        this.mAnimationDelayPerItem = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_animationDelayPerItem, 50);
        this.mIcon = obtainStyledAttributes.getDrawable(C1668R.styleable.FloatingActionMenu_menu_icon);
        if (this.mIcon == null) {
            this.mIcon = getResources().getDrawable(C1668R.C1669drawable.fab_add);
        }
        this.mLabelsSingleLine = obtainStyledAttributes.getBoolean(C1668R.styleable.FloatingActionMenu_menu_labels_singleLine, false);
        this.mLabelsEllipsize = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_labels_ellipsize, 0);
        this.mLabelsMaxLines = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_labels_maxLines, -1);
        this.mMenuFabSize = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_fab_size, 0);
        this.mLabelsStyle = obtainStyledAttributes.getResourceId(C1668R.styleable.FloatingActionMenu_menu_labels_style, 0);
        String string = obtainStyledAttributes.getString(C1668R.styleable.FloatingActionMenu_menu_labels_customFont);
        try {
            if (!TextUtils.isEmpty(string)) {
                this.mCustomTypefaceFromFont = Typeface.createFromAsset(getContext().getAssets(), string);
            }
            this.mOpenDirection = obtainStyledAttributes.getInt(C1668R.styleable.FloatingActionMenu_menu_openDirection, 0);
            this.mBackgroundColor = obtainStyledAttributes.getColor(C1668R.styleable.FloatingActionMenu_menu_backgroundColor, 0);
            if (obtainStyledAttributes.hasValue(C1668R.styleable.FloatingActionMenu_menu_fab_label)) {
                this.mUsingMenuLabel = true;
                this.mMenuLabelText = obtainStyledAttributes.getString(C1668R.styleable.FloatingActionMenu_menu_fab_label);
            }
            if (obtainStyledAttributes.hasValue(C1668R.styleable.FloatingActionMenu_menu_labels_padding)) {
                initPadding(obtainStyledAttributes.getDimensionPixelSize(C1668R.styleable.FloatingActionMenu_menu_labels_padding, 0));
            }
    ...
    private void initMenuButtonAnimations(TypedArray typedArray) {
        int resourceId = typedArray.getResourceId(C1668R.styleable.FloatingActionMenu_menu_fab_show_animation, C1668R.anim.fab_scale_up);
        setMenuButtonShowAnimation(AnimationUtils.loadAnimation(getContext(), resourceId));
        this.mImageToggleShowAnimation = AnimationUtils.loadAnimation(getContext(), resourceId);
        int resourceId2 = typedArray.getResourceId(C1668R.styleable.FloatingActionMenu_menu_fab_hide_animation, C1668R.anim.fab_scale_down);
    ...
    private void createMenuButton() {
        ...
        boolean z = this.mMenuShowShadow;
        floatingActionButton.mShowShadow = z;
        if (z) {
            floatingActionButton.mShadowRadius = Util.dpToPx(getContext(), this.mMenuShadowRadius);
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (!(childAt2.getVisibility() == 8 || childAt2 == this.mImageToggle)) {
                ...
                Label label = (Label) childAt2.getTag(C1668R.C1670id.fab_label);
                if (label != null) {
        ...
        for (int i8 = this.mButtonsCount - 1; i8 >= 0; i8--) {
            ...
            if (childAt != this.mImageToggle) {
                ...
                if (floatingActionButton2.getVisibility() != 8) {
                    ...
                    View view = (View) floatingActionButton2.getTag(C1668R.C1670id.fab_label);
                    if (view != null) {
    ...
    private void createLabels() {
        for (int i = 0; i < this.mButtonsCount; i++) {
            if (getChildAt(i) != this.mImageToggle) {
                ...
                if (floatingActionButton.getTag(C1668R.C1670id.fab_label) == null) {
    ...
    private void addLabel(FloatingActionButton floatingActionButton) {
        ...
        if (!TextUtils.isEmpty(labelText)) {
            ...
            addView(label);
            floatingActionButton.setTag(C1668R.C1670id.fab_label, label);
        }
    }
                    ...
                    this.mUiHandler.postDelayed(new Runnable() {
                        public void run() {
                            if (!FloatingActionMenu.this.isOpened()) {
                                ...
                                Label label = (Label) floatingActionButton.getTag(C1668R.C1670id.fab_label);
