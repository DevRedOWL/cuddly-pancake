...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        if (this.mData != null) {
            ...
            this.mCircleBox.set((centerOffsets.f1365x - diameter) + selectionShift, (centerOffsets.f1366y - diameter) + selectionShift, (centerOffsets.f1365x + diameter) - selectionShift, (centerOffsets.f1366y + diameter) - selectionShift);
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = (double) f2;
        float cos = (float) ((Math.cos(Math.toRadians((double) (((this.mAbsoluteAngles[x] + rotationAngle) - f3) * this.mAnimator.getPhaseY()))) * d) + ((double) centerCircleBox.f1365x));
        MPPointF.recycleInstance(centerCircleBox);
        return new float[]{cos, (float) ((d * Math.sin(Math.toRadians((double) (((rotationAngle + this.mAbsoluteAngles[x]) - f3) * this.mAnimator.getPhaseY())))) + ((double) centerCircleBox.f1366y))};
    }
    ...
    public void setCenterTextOffset(float f, float f2) {
        this.mCenterTextOffset.f1365x = Utils.convertDpToPixel(f);
        this.mCenterTextOffset.f1366y = Utils.convertDpToPixel(f2);
    }

    public MPPointF getCenterTextOffset() {
        return MPPointF.getInstance(this.mCenterTextOffset.f1365x, this.mCenterTextOffset.f1366y);
    }
