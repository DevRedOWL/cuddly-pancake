...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>> extends Chart<T> {
    ...
    public void calculateOffsets() {
        /*
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C17052.f1342x9c9dbef
            com.github.mikephil.charting.components.Legend r3 = r11.mLegend
        ...
        L_0x0054:
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C17052.f1343xc926f1ec
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
        ...
        L_0x0126:
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C17052.f1341x2787f53e
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
            ...
            goto L_0x014e
        L_0x013c:
            int[] r0 = com.github.mikephil.charting.charts.PieRadarChartBase.C17052.f1343xc926f1ec
            com.github.mikephil.charting.components.Legend r2 = r11.mLegend
            com.github.mikephil.charting.components.Legend$LegendVerticalAlignment r2 = r2.getVerticalAlignment()
            int r2 = r2.ordinal()
            r0 = r0[r2]
    ...
    static /* synthetic */ class C17052 {
        ...
        static final /* synthetic */ int[] f1341x2787f53e = new int[Legend.LegendHorizontalAlignment.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendOrientation */
        static final /* synthetic */ int[] f1342x9c9dbef = new int[Legend.LegendOrientation.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendVerticalAlignment */
        static final /* synthetic */ int[] f1343xc926f1ec = new int[Legend.LegendVerticalAlignment.values().length];
        ...
        static {
            /*
                ...
                f1342x9c9dbef = r0
                r0 = 1
                int[] r1 = f1342x9c9dbef     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f1342x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                ...
                int[] r2 = new int[r2]
                f1341x2787f53e = r2
                int[] r2 = f1341x2787f53e     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r2 = f1341x2787f53e     // Catch:{ NoSuchFieldError -> 0x003c }
            ...
            L_0x003c:
                int[] r2 = f1341x2787f53e     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                ...
                int[] r2 = new int[r2]
                f1343xc926f1ec = r2
                int[] r2 = f1343xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005a }
            ...
            L_0x005a:
                int[] r0 = f1343xc926f1ec     // Catch:{ NoSuchFieldError -> 0x0064 }
            ...
            L_0x0064:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.PieRadarChartBase.C17052.<clinit>():void");
        }
    }

    public float getAngleForPoint(float f, float f2) {
        MPPointF centerOffsets = getCenterOffsets();
        double d = (double) (f - centerOffsets.f1365x);
        double d2 = (double) (f2 - centerOffsets.f1366y);
        float degrees = (float) Math.toDegrees(Math.acos(d2 / Math.sqrt((d * d) + (d2 * d2))));
        if (f > centerOffsets.f1365x) {
    ...
    public void getPosition(MPPointF mPPointF, float f, float f2, MPPointF mPPointF2) {
        double d = (double) f;
        double d2 = (double) f2;
        mPPointF2.f1365x = (float) (((double) mPPointF.f1365x) + (Math.cos(Math.toRadians(d2)) * d));
        mPPointF2.f1366y = (float) (((double) mPPointF.f1366y) + (d * Math.sin(Math.toRadians(d2))));
    }
    ...
    public float distanceToCenter(float f, float f2) {
        ...
        MPPointF centerOffsets = getCenterOffsets();
        if (f > centerOffsets.f1365x) {
            f3 = f - centerOffsets.f1365x;
        } else {
            f3 = centerOffsets.f1365x - f;
        }
        if (f2 > centerOffsets.f1366y) {
            f4 = f2 - centerOffsets.f1366y;
        } else {
            f4 = centerOffsets.f1366y - f2;
        }
