...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public void init() {
        ...
        this.mInfoPaint.setColor(Color.rgb(247, NikonType2MakernoteDirectory.TAG_UNKNOWN_50, 51));
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f1365x, center.f1366y, this.mInfoPaint);
            }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C17032.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
    ...
    static /* synthetic */ class C17032 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.Chart.C17032.<clinit>():void");
        }
    }
