...
public class Approximator {
    ...
    private class Line {
        ...
        /* renamed from: dx */
        private float f1350dx;

        /* renamed from: dy */
        private float f1351dy;
        private float exsy;
        ...
        public Line(float f, float f2, float f3, float f4) {
            ...
            this.sxey = f * f4;
            this.exsy = f3 * f2;
            float f5 = this.f1350dx;
            float f6 = this.f1351dy;
            this.length = (float) Math.sqrt((double) ((f5 * f5) + (f6 * f6)));
            this.points = new float[]{f, f2, f3, f4};
        }

        public float distance(float f, float f2) {
            return Math.abs((((this.f1351dy * f) - (this.f1350dx * f2)) + this.sxey) - this.exsy) / this.length;
        }
