...
public class MarkerImage implements IMarker {
    ...
    public MPPointF getOffsetForDrawingAtPoint(float f, float f2) {
        ...
        } else if (chartView != null && f + f3 + this.mOffset2.f1365x > ((float) chartView.getWidth())) {
            this.mOffset2.f1365x = (((float) chartView.getWidth()) - f) - f3;
        }
        if (this.mOffset2.f1366y + f2 < 0.0f) {
            this.mOffset2.f1366y = -f2;
        } else if (chartView != null && f2 + f4 + this.mOffset2.f1366y > ((float) chartView.getHeight())) {
            this.mOffset2.f1366y = (((float) chartView.getHeight()) - f2) - f4;
        }
