...
public class Legend extends ComponentBase {
    ...
    public void calculateDimensions(Paint paint, ViewPortHandler viewPortHandler) {
        ...
        int i2 = C17061.f1345x9c9dbef[this.mOrientation.ordinal()];
        if (i2 == 1) {
            ...
            while (i4 < length) {
                ...
                if (str2 != null || i4 == length - 1) {
                    ...
                    if (!z || i6 == 0 || contentWidth - f19 >= f20 + f4) {
                        f5 = f12;
                        f6 = f19 + f20 + f4;
                    } else {
    ...
    static /* synthetic */ class C17061 {
        ...
        static final /* synthetic */ int[] f1345x9c9dbef = new int[LegendOrientation.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1345x9c9dbef = r0
                int[] r0 = f1345x9c9dbef     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1345x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.components.Legend.C17061.<clinit>():void");
        }
    }
}
