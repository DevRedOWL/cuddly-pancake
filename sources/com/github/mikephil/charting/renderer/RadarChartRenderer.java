...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public void drawDataSet(Canvas canvas, IRadarDataSet iRadarDataSet, int i) {
        ...
        for (int i2 = 0; i2 < iRadarDataSet.getEntryCount(); i2++) {
            ...
            if (!Float.isNaN(instance.f1365x)) {
                if (!z) {
                    path.moveTo(instance.f1365x, instance.f1366y);
                    z = true;
                } else {
                    path.lineTo(instance.f1365x, instance.f1366y);
                }
            }
        }
        if (iRadarDataSet.getEntryCount() > i) {
            path.lineTo(centerOffsets.f1365x, centerOffsets.f1366y);
        }
        path.close();
    ...
    public void drawValues(Canvas canvas) {
        ...
        while (i4 < ((RadarData) this.mChart.getData()).getDataSetCount()) {
            ...
            if (!shouldDrawValues(iRadarDataSet2)) {
                ...
                instance3.f1365x = Utils.convertDpToPixel(instance3.f1365x);
                instance3.f1366y = Utils.convertDpToPixel(instance3.f1366y);
                int i5 = 0;
                while (i5 < iRadarDataSet2.getEntryCount()) {
                    ...
                    if (iRadarDataSet2.isDrawValuesEnabled()) {
                        ...
                        float f4 = instance.f1365x;
                        radarEntry = radarEntry2;
                        float f5 = instance.f1366y - convertDpToPixel;
                    ...
                    if (radarEntry.getIcon() != null && iRadarDataSet.isDrawIconsEnabled()) {
                        ...
                        Utils.getPosition(centerOffsets, (radarEntry.getY() * factor * phaseY) + mPPointF.f1366y, f3 + this.mChart.getRotationAngle(), instance2);
                        instance2.f1366y += mPPointF.f1365x;
                        Utils.drawImage(canvas, icon, (int) instance2.f1365x, (int) instance2.f1366y, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                    }
                    i5 = i2 + 1;
                    instance3 = mPPointF;
    ...
    public void drawWeb(Canvas canvas) {
        ...
        for (int i = 0; i < entryCount; i += skipWebLineCount) {
            ...
            canvas.drawLine(centerOffsets.f1365x, centerOffsets.f1366y, instance.f1365x, instance.f1366y, this.mWebPaint);
        }
        MPPointF.recycleInstance(instance);
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            while (i4 < ((RadarData) this.mChart.getData()).getEntryCount()) {
                ...
                canvas.drawLine(instance2.f1365x, instance2.f1366y, instance3.f1365x, instance3.f1366y, this.mWebPaint);
            }
        }
        MPPointF.recycleInstance(instance2);
        MPPointF.recycleInstance(instance3);
        ...
        while (i3 < length) {
            ...
            if (iRadarDataSet != null && iRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(radarEntry, iRadarDataSet)) {
                    ...
                    highlight.setDraw(instance.f1365x, instance.f1366y);
                    drawHighlightLines(canvas, instance.f1365x, instance.f1366y, iRadarDataSet);
                    if (iRadarDataSet.isDrawHighlightCircleEnabled() && !Float.isNaN(instance.f1365x) && !Float.isNaN(instance.f1366y)) {
    ...
    public void drawHighlightCircle(Canvas canvas, MPPointF mPPointF, float f, float f2, int i, int i2, float f3) {
        ...
        if (i != 1122867) {
            ...
            path.reset();
            path.addCircle(mPPointF.f1365x, mPPointF.f1366y, convertDpToPixel, Path.Direction.CW);
            if (convertDpToPixel2 > 0.0f) {
                path.addCircle(mPPointF.f1365x, mPPointF.f1366y, convertDpToPixel2, Path.Direction.CCW);
            }
        ...
        if (i2 != 1122867) {
            ...
            canvas.drawCircle(mPPointF.f1365x, mPPointF.f1366y, convertDpToPixel, this.mHighlightCirclePaint);
        }
        canvas.restore();
    }
}
