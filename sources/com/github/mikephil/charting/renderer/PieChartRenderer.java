...
public class PieChartRenderer extends DataRenderer {
    ...
    public float calculateMinimumRadiusForSpacedSlice(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float cos = mPPointF2.f1365x + (((float) Math.cos(d)) * f);
        float sin = mPPointF2.f1366y + (((float) Math.sin(d)) * f);
        double d2 = (double) ((f5 + (f6 / 2.0f)) * 0.017453292f);
        return (float) (((double) (f - ((float) ((Math.sqrt(Math.pow((double) (cos - f3), 2.0d) + Math.pow((double) (sin - f4), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) f2)) / 2.0d) * 0.017453292519943295d))))) - Math.sqrt(Math.pow((double) ((mPPointF2.f1365x + (((float) Math.cos(d2)) * f)) - ((cos + f3) / 2.0f)), 2.0d) + Math.pow((double) ((mPPointF2.f1366y + (((float) Math.sin(d2)) * f)) - ((sin + f4) / 2.0f)), 2.0d)));
    }
        ...
        while (i9 < entryCount) {
            ...
            if (Math.abs(iPieDataSet2.getEntryForIndex(i9).getY()) > Utils.FLOAT_EPSILON && (!pieChartRenderer.mChart.needsHighlight(i9) || z2)) {
                ...
                if (z2) {
                    ...
                    i = entryCount;
                    fArr = drawAngles;
                    float cos = centerCircleBox.f1365x + (((float) Math.cos(d)) * f16);
                    float sin = centerCircleBox.f1366y + (f16 * ((float) Math.sin(d)));
                ...
                f3 = rotationAngle;
                f2 = phaseX;
                float cos2 = centerCircleBox.f1365x + (((float) Math.cos(d2)) * radius);
                float sin2 = centerCircleBox.f1366y + (((float) Math.sin(d2)) * radius);
                ...
                if (i10 < 0 || f15 % 360.0f > Utils.FLOAT_EPSILON) {
                    ...
                    pieChartRenderer.mPathBuffer.addCircle(centerCircleBox.f1365x, centerCircleBox.f1366y, radius, Path.Direction.CW);
                }
                float f17 = f15;
                pieChartRenderer.mInnerRectBuffer.set(centerCircleBox.f1365x - holeRadius, centerCircleBox.f1366y - holeRadius, centerCircleBox.f1365x + holeRadius, centerCircleBox.f1366y + holeRadius);
                if (!z) {
                    f8 = holeRadius;
                    f9 = radius;
                    ...
                    if (i10 < 0 || f10 % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        if (z2) {
                            ...
                            float cos3 = mPPointF2.f1365x + (((float) Math.cos(d3)) * f23);
                            float sin3 = mPPointF2.f1366y + (f23 * ((float) Math.sin(d3)));
                            rectF3 = rectF6;
                            ...
                            pieChartRenderer.mPathBuffer.lineTo(mPPointF2.f1365x + (((float) Math.cos(d4)) * holeRadius), mPPointF2.f1366y + (holeRadius * ((float) Math.sin(d4))));
                        }
                        pieChartRenderer.mPathBuffer.arcTo(pieChartRenderer.mInnerRectBuffer, f22, -f21);
                    } else {
                        pieChartRenderer = this;
                        pieChartRenderer.mPathBuffer.addCircle(mPPointF2.f1365x, mPPointF2.f1366y, holeRadius, Path.Direction.CCW);
                        rectF3 = rectF6;
                    }
                    mPPointF = mPPointF2;
                    rectF2 = rectF3;
                ...
                if (f6 % f7 > Utils.FLOAT_EPSILON) {
                    if (z3) {
                        ...
                        pieChartRenderer.mPathBuffer.lineTo(mPPointF.f1365x + (((float) Math.cos(d5)) * calculateMinimumRadiusForSpacedSlice2), mPPointF.f1366y + (calculateMinimumRadiusForSpacedSlice2 * ((float) Math.sin(d5))));
                    } else {
                        rectF2 = rectF3;
                        pieChartRenderer.mPathBuffer.lineTo(mPPointF.f1365x, mPPointF.f1366y);
                    }
                    pieChartRenderer.mPathBuffer.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.mPathBuffer, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
    ...
    public void drawHole(Canvas canvas) {
        if (this.mChart.isDrawHoleEnabled() && this.mBitmapCanvas != null) {
            ...
            if (Color.alpha(this.mHolePaint.getColor()) > 0) {
                this.mBitmapCanvas.drawCircle(centerCircleBox.f1365x, centerCircleBox.f1366y, holeRadius, this.mHolePaint);
            }
            if (Color.alpha(this.mTransparentCirclePaint.getColor()) > 0 && this.mChart.getTransparentCircleRadius() > this.mChart.getHoleRadius()) {
                ...
                this.mHoleCirclePath.addCircle(centerCircleBox.f1365x, centerCircleBox.f1366y, transparentCircleRadius, Path.Direction.CW);
                this.mHoleCirclePath.addCircle(centerCircleBox.f1365x, centerCircleBox.f1366y, holeRadius, Path.Direction.CCW);
    ...
    public void drawCenterText(Canvas canvas) {
        ...
        if (this.mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            float f2 = centerCircleBox.f1365x + centerTextOffset.f1365x;
            float f3 = centerCircleBox.f1366y + centerTextOffset.f1366y;
            ...
            while (i4 < highlightArr2.length) {
                ...
                if (x < drawAngles.length && (dataSetByIndex = ((PieData) this.mChart.getData()).getDataSetByIndex(highlightArr2[i4].getDataSetIndex())) != null && dataSetByIndex.isHighlightEnabled()) {
                    ...
                    if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        i3 = i5;
                        z = z2;
                        this.mPathBuffer.moveTo(centerCircleBox.f1365x + (((float) Math.cos(d)) * f10), centerCircleBox.f1366y + (f10 * ((float) Math.sin(d))));
                        this.mPathBuffer.arcTo(rectF2, f18, f19);
                    } else {
                        this.mPathBuffer.addCircle(centerCircleBox.f1365x, centerCircleBox.f1366y, f10, Path.Direction.CW);
                        fArr2 = drawAngles;
                        f6 = f4;
                        i3 = i5;
                        z = z2;
                    ...
                    if (z3) {
                        ...
                        mPPointF = centerCircleBox;
                        fArr = fArr2;
                        f7 = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f9 * phaseY, (((float) Math.cos(d2)) * radius) + centerCircleBox.f1365x, centerCircleBox.f1366y + (((float) Math.sin(d2)) * radius), f15, f17);
                    } else {
                        rectF = rectF2;
                        mPPointF = centerCircleBox;
                        i = i7;
                    ...
                    this.mInnerRectBuffer.set(mPPointF.f1365x - f2, mPPointF.f1366y - f2, mPPointF.f1365x + f2, mPPointF.f1366y + f2);
                    if (!z || (f2 <= 0.0f && !z3)) {
                        f3 = phaseX;
                        f = phaseY;
                        if (f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            if (z3) {
                                ...
                                this.mPathBuffer.lineTo(mPPointF.f1365x + (((float) Math.cos(d3)) * f7), mPPointF.f1366y + (f7 * ((float) Math.sin(d3))));
                            } else {
                                this.mPathBuffer.lineTo(mPPointF.f1365x, mPPointF.f1366y);
                            }
                        }
                    } else {
                        if (z3) {
                        ...
                        if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            ...
                            f3 = phaseX;
                            f = phaseY;
                            this.mPathBuffer.lineTo(mPPointF.f1365x + (((float) Math.cos(d4)) * f8), mPPointF.f1366y + (f8 * ((float) Math.sin(d4))));
                            this.mPathBuffer.arcTo(this.mInnerRectBuffer, f23, -f22);
                        } else {
                            this.mPathBuffer.addCircle(mPPointF.f1365x, mPPointF.f1366y, f8, Path.Direction.CCW);
                            f3 = phaseX;
                            f = phaseY;
                        }
                    }
            ...
            if (dataSet.isVisible()) {
                ...
                while (i < dataSet.getEntryCount()) {
                    ...
                    if (Math.abs(dataSet.getEntryForIndex(i).getY()) > Utils.FLOAT_EPSILON) {
                        ...
                        fArr = drawAngles;
                        f2 = rotationAngle;
                        float cos = (float) (((double) centerCircleBox.f1365x) + (Math.cos(Math.toRadians(d2)) * d));
                        float sin = (float) ((d * Math.sin(Math.toRadians(d2))) + ((double) centerCircleBox.f1366y));
