...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    public void drawDataSet(Canvas canvas, ILineDataSet iLineDataSet) {
        if (iLineDataSet.getEntryCount() >= 1) {
            ...
            int i = C17111.$SwitchMap$com$github$mikephil$charting$data$LineDataSet$Mode[iLineDataSet.getMode().ordinal()];
            if (i == 3) {
    ...
    static /* synthetic */ class C17111 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.renderer.LineChartRenderer.C17111.<clinit>():void");
        }
    }
        ...
        if (this.mXBounds.range >= 1) {
            ...
            if (entryForIndex2 != null) {
                ...
                while (i5 <= this.mXBounds.range + this.mXBounds.min) {
                    if (i4 != i5) {
                        entry = iLineDataSet2.getEntryForIndex(i5);
                    }
                    int i6 = i5 + 1;
                    ...
                    while (i4 < generateTransformedValuesLine.length) {
                        ...
                        if (!this.mViewPortHandler.isInBoundsLeft(f) || !this.mViewPortHandler.isInBoundsY(f2)) {
                            ...
                            if (entry.getIcon() != null && iLineDataSet.isDrawIconsEnabled()) {
                                ...
                                Utils.drawImage(canvas, icon, (int) (f + instance.f1365x), (int) (f2 + instance.f1366y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        }
                        i4 += 2;
        ...
        while (i < dataSets.size()) {
            ...
            if (iLineDataSet.isVisible() && iLineDataSet.isDrawCirclesEnabled() && iLineDataSet.getEntryCount() != 0) {
                ...
                if (this.mImageCaches.containsKey(iLineDataSet)) {
                    ...
                    dataSetImageCache = new DataSetImageCache(this, (C17111) null);
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iLineDataSet != null && iLineDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iLineDataSet)) {
                    ...
                    highlight.setDraw((float) pixelForValues.f1363x, (float) pixelForValues.f1364y);
                    drawHighlightLines(canvas, (float) pixelForValues.f1363x, (float) pixelForValues.f1364y, iLineDataSet);
                }
            }
        }
    }
    ...
    private class DataSetImageCache {
        ...
        /* synthetic */ DataSetImageCache(LineChartRenderer lineChartRenderer, C17111 r2) {
            this();
        }
