...
public class YAxisRendererRadarChart extends YAxisRenderer {
    ...
    public void computeAxisValues(float f, float f2) {
        ...
        if (this.mAxis.isForceLabelsEnabled()) {
            ...
            int i3 = (roundToNextSignificant > Utils.DOUBLE_EPSILON ? 1 : (roundToNextSignificant == Utils.DOUBLE_EPSILON ? 0 : -1));
            if (i3 == 0) {
        ...
        if (isCenterAxisLabelsEnabled) {
            ...
            for (int i5 = 0; i5 < i; i5++) {
                this.mAxis.mCenteredEntries[i5] = this.mAxis.mEntries[i5] + f7;
            }
        }
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            for (int i2 = !this.mYAxis.isDrawBottomYLabelEntryEnabled(); i2 < i; i2++) {
                ...
                canvas.drawText(this.mYAxis.getFormattedLabel(i2), instance.f1365x + 10.0f, instance.f1366y, this.mAxisLabelPaint);
            }
