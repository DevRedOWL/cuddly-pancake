...
public final class Vector3 {
    ...
    public final void add(Vector3 vector3) {
        this.f1355x += vector3.f1355x;
        this.f1356y += vector3.f1356y;
        this.f1357z += vector3.f1357z;
    }
    ...
    public final void subtractMultiple(Vector3 vector3, float f) {
        this.f1355x -= vector3.f1355x * f;
        this.f1356y -= vector3.f1356y * f;
        this.f1357z -= vector3.f1357z * f;
    }
    ...
    public final float dot(Vector3 vector3) {
        return (this.f1355x * vector3.f1355x) + (this.f1356y * vector3.f1356y) + (this.f1357z * vector3.f1357z);
    }

    public final Vector3 cross(Vector3 vector3) {
        float f = this.f1356y;
        float f2 = vector3.f1357z;
        float f3 = this.f1357z;
        float f4 = vector3.f1356y;
        float f5 = (f * f2) - (f3 * f4);
        float f6 = vector3.f1355x;
        float f7 = this.f1355x;
    ...
    public final float length2() {
        float f = this.f1355x;
        float f2 = this.f1356y;
        float f3 = (f * f) + (f2 * f2);
        float f4 = this.f1357z;
        return f3 + (f4 * f4);
    }

    public final float distance2(Vector3 vector3) {
        float f = this.f1355x - vector3.f1355x;
        float f2 = this.f1356y - vector3.f1356y;
        float f3 = this.f1357z - vector3.f1357z;
