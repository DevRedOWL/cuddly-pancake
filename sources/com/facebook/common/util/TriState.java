    ...
    static /* synthetic */ class C12271 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C12271.<clinit>():void");
        }
    }

    public boolean asBoolean() {
        int i = C12271.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
