...
public abstract class PlatformBitmapFactory {
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C12551.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C12551 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C12551.<clinit>():void");
        }
    }
