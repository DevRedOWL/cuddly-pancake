            ...
            if (closeableReference != null) {
                try {
                    ...
                    if (listener.requiresExtraMap(id)) {
                        map = ImmutableMap.m594of("cached_value_found", "true");
                    }
                ...
                listener.onProducerFinishWithSuccess(id, PRODUCER_NAME, listener.requiresExtraMap(id) ? ImmutableMap.m594of("cached_value_found", "false") : null);
