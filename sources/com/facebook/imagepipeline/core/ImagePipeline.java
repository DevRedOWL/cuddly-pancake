...
public class ImagePipeline {
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(final ImageRequest imageRequest, final Object obj, final ImageRequest.RequestLevel requestLevel) {
        return new Supplier<DataSource<CloseableReference<CloseableImage>>>() {
            ...
            public String toString() {
                return Objects.toStringHelper((Object) this).add(AlbumLoader.COLUMN_URI, (Object) imageRequest.getSourceUri()).toString();
            }
        };
    }
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(ImageRequest imageRequest, Object obj, ImageRequest.RequestLevel requestLevel, @Nullable RequestListener requestListener) {
        ...
        return new Supplier<DataSource<CloseableReference<CloseableImage>>>() {
            ...
            public String toString() {
                return Objects.toStringHelper((Object) this).add(AlbumLoader.COLUMN_URI, (Object) imageRequest2.getSourceUri()).toString();
            }
        };
    }
    ...
    public void clearMemoryCaches() {
        C12744 r0 = new Predicate<CacheKey>() {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, (Object) null);
        int i = C12788.f1313x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C12788 {

        /* renamed from: $SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice */
        static final /* synthetic */ int[] f1313x9ce557aa = new int[ImageRequest.CacheChoice.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1313x9ce557aa = r0
                int[] r0 = f1313x9ce557aa     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1313x9ce557aa     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.core.ImagePipeline.C12788.<clinit>():void");
        }
    }
