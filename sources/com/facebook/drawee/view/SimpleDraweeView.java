...
import com.facebook.drawee.C1235R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (attributeSet != null) {
                obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1235R.styleable.SimpleDraweeView);
                if (obtainStyledAttributes.hasValue(C1235R.styleable.SimpleDraweeView_actualImageUri)) {
                    setImageURI(Uri.parse(obtainStyledAttributes.getString(C1235R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                } else if (obtainStyledAttributes.hasValue(C1235R.styleable.SimpleDraweeView_actualImageResource) && (resourceId = obtainStyledAttributes.getResourceId(C1235R.styleable.SimpleDraweeView_actualImageResource, -1)) != -1) {
                    if (isInEditMode()) {
