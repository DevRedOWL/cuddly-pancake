...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private final MutableYogaValue mTempYogaValue = new MutableYogaValue((C15751) null);

    private static class MutableYogaValue {
        YogaUnit unit;
        float value;

        /* synthetic */ MutableYogaValue(C15751 r1) {
            this();
        }
    ...
    public void setWidth(Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            int i = C15751.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C15751 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.uimanager.LayoutShadowNode.C15751.<clinit>():void");
        }
    }
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C15751.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 == 1 || i2 == 2) {
