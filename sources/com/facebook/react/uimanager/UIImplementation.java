...
public class UIImplementation {
    ...
    public void updateRootView(int i, int i2, int i3) {
        ...
        if (node == null) {
            FLog.m662w(ReactConstants.TAG, "Tried to update non-existent root tag: " + i);
            return;
        }
    ...
    public void updateNodeSize(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m662w(ReactConstants.TAG, "Tried to update size of non-existent tag: " + i);
            return;
        }
    ...
    public void setViewLocalData(int i, Object obj) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m662w(ReactConstants.TAG, "Attempt to set local data for view with unknown tag: " + i);
            return;
        }
    ...
    public void updateViewHierarchy() {
        /*
            ...
            r3 = 0
        L_0x000b:
            com.facebook.react.uimanager.ShadowNodeRegistry r4 = r7.mShadowNodeRegistry     // Catch:{ all -> 0x007a }
            int r4 = r4.getRootNodeCount()     // Catch:{ all -> 0x007a }
            if (r3 >= r4) goto L_0x0076
            com.facebook.react.uimanager.ShadowNodeRegistry r4 = r7.mShadowNodeRegistry     // Catch:{ all -> 0x007a }
            int r4 = r4.getRootTag(r3)     // Catch:{ all -> 0x007a }
            com.facebook.react.uimanager.ShadowNodeRegistry r5 = r7.mShadowNodeRegistry     // Catch:{ all -> 0x007a }
            com.facebook.react.uimanager.ReactShadowNode r4 = r5.getNode(r4)     // Catch:{ all -> 0x007a }
            java.lang.Integer r5 = r4.getWidthMeasureSpec()     // Catch:{ all -> 0x007a }
            if (r5 == 0) goto L_0x0073
            java.lang.Integer r5 = r4.getHeightMeasureSpec()     // Catch:{ all -> 0x007a }
            if (r5 == 0) goto L_0x0073
            java.lang.String r5 = "UIImplementation.notifyOnBeforeLayoutRecursive"
            com.facebook.systrace.SystraceMessage$Builder r5 = com.facebook.systrace.SystraceMessage.beginSection(r1, r5)     // Catch:{ all -> 0x007a }
            int r6 = r4.getReactTag()     // Catch:{ all -> 0x007a }
            com.facebook.systrace.SystraceMessage$Builder r5 = r5.arg((java.lang.String) r0, (int) r6)     // Catch:{ all -> 0x007a }
            r5.flush()     // Catch:{ all -> 0x007a }
            r7.notifyOnBeforeLayoutRecursive(r4)     // Catch:{ all -> 0x006e }
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007a }
            r7.calculateRootLayout(r4)     // Catch:{ all -> 0x007a }
            ...
            r5.flush()     // Catch:{ all -> 0x007a }
            r5 = 0
            r7.applyUpdatesRecursive(r4, r5, r5)     // Catch:{ all -> 0x0069 }
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007a }
            com.facebook.react.uimanager.UIImplementation$LayoutUpdateListener r5 = r7.mLayoutUpdateListener     // Catch:{ all -> 0x007a }
            if (r5 == 0) goto L_0x0073
            com.facebook.react.uimanager.UIViewOperationQueue r5 = r7.mOperationsQueue     // Catch:{ all -> 0x007a }
            com.facebook.react.uimanager.UIImplementation$LayoutUpdateListener r6 = r7.mLayoutUpdateListener     // Catch:{ all -> 0x007a }
            r5.enqueueLayoutUpdateFinished(r4, r6)     // Catch:{ all -> 0x007a }
            goto L_0x0073
        L_0x0069:
            r0 = move-exception
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x007a }
    ...
    public int resolveRootTagFromReactTag(int i) {
        ...
        FLog.m662w(ReactConstants.TAG, "Warning : attempted to resolve a non-existent react shadow node. reactTag=" + i);
        return 0;
    }
