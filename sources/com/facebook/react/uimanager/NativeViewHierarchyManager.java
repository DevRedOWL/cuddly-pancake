...
public class NativeViewHierarchyManager {
    ...
    public synchronized void updateInstanceHandle(int i, long j) {
        ...
        try {
            ...
            String str = TAG;
            FLog.m623e(str, "Unable to update properties for view tag " + i, (Throwable) e);
        }
        return;
    }
    ...
    private void updateInstanceHandle(View view, long j) {
        UiThreadUtil.assertOnUiThread();
        view.setTag(C1345R.C1348id.view_tag_instance_handle, Long.valueOf(j));
    }

    public long getInstanceHandle(int i) {
        View view = this.mTagsToViews.get(i);
        if (view != null) {
            Long l = (Long) view.getTag(C1345R.C1348id.view_tag_instance_handle);
            if (l != null) {
                return l.longValue();
            }
    ...
    public synchronized void manageChildren(int r17, int[] r18, com.facebook.react.uimanager.ViewAtIndex[] r19, int[] r20, int[] r21) {
        /*
            r16 = this;
            r8 = r16
            r0 = r17
    ...
    public final synchronized void addRootViewGroup(int i, View view) {
        if (view.getId() != -1) {
            String str = TAG;
            FLog.m622e(str, "Trying to add a root view with an explicit id (" + view.getId() + ") already set. React Native uses the id field to track react tags and will overwrite this field. If that is fine, explicitly overwrite the id field to View.NO_ID before calling addRootView.");
        }
            ...
            if (this.mTagsToViewManagers.get(view.getId()) != null) {
                ...
                if ((view instanceof ViewGroup) && (viewManager instanceof ViewGroupManager)) {
                    ...
                    for (int childCount = viewGroupManager.getChildCount(viewGroup) - 1; childCount >= 0; childCount--) {
                        ...
                        if (childAt == null) {
                            FLog.m622e(TAG, "Unable to drop null child view");
