...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, String str) {
        ...
        if (DEBUG) {
            FLog.m612d(TAG, "Starting surface for module: %s and reactTag: %d", (Object) jSModuleName, (Object) Integer.valueOf(nextRootViewTag));
        }
    ...
    public <T extends View> int startSurface(T t, String str, WritableMap writableMap, int i, int i2) {
        ...
        ThemedReactContext themedReactContext = new ThemedReactContext(this.mReactApplicationContext, t.getContext());
        if (DEBUG) {
            FLog.m612d(TAG, "Starting surface for module: %s and reactTag: %d", (Object) str, (Object) Integer.valueOf(nextRootViewTag));
        }
        this.mMountingManager.addRootView(nextRootViewTag, t);
        this.mReactContextForRootTag.put(Integer.valueOf(nextRootViewTag), themedReactContext);
    ...
    public void onCatalystInstanceDestroy() {
        if (DEBUG) {
            FLog.m610d(TAG, "Destroying Catalyst Instance");
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0096, code lost:
        r6 = TAG;
        com.facebook.common.logging.FLog.m610d(r6, "dispatchMountItems: Executing mountItem: " + r1);
     */
    ...
    public void dispatchMountItems() {
        ...
        L_0x0086:
            ...
            com.facebook.common.logging.FLog.m610d((java.lang.String) r6, (java.lang.String) r7)
        L_0x00ac:
    ...
    public void updateRootLayoutSpecs(int i, int i2, int i3) {
        if (DEBUG) {
            FLog.m610d(TAG, "Updating Root Layout Specs");
        }
    ...
    public void receiveEvent(int i, String str, WritableMap writableMap) {
        ...
        if (eventEmitter == null) {
            String str2 = TAG;
            FLog.m610d(str2, "Unable to invoke event: " + str + " for reactTag: " + i);
            return;
        }
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            if (!FabricUIManager.this.mIsMountingEnabled) {
                FLog.m662w(ReactConstants.TAG, "Not flushing pending UI operations because of previously thrown Exception");
                return;
            }
            try {
                ...
                FLog.m639i(ReactConstants.TAG, "Exception thrown when executing UIFrameGuarded", (Throwable) e);
