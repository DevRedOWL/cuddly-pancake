...
public class ReactTextView extends AppCompatTextView implements ReactCompoundView {
    ...
    private WritableMap inlineViewJson(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (i == 8) {
            createMap.putString(Key.VISIBILITY, "gone");
            createMap.putInt(FirebaseAnalytics.Param.INDEX, i2);
        } else if (i == 0) {
            createMap.putString(Key.VISIBILITY, ViewProps.VISIBLE);
            createMap.putInt(FirebaseAnalytics.Param.INDEX, i2);
            ...
            createMap.putString(Key.VISIBILITY, EnvironmentCompat.MEDIA_UNKNOWN);
            createMap.putInt(FirebaseAnalytics.Param.INDEX, i2);
        }
        return createMap;
    }
    ...
    public int reactTagForTouch(float f, float f2) {
        ...
        if ((text instanceof Spanned) && i2 >= lineLeft && i2 <= lineRight) {
            ...
            try {
                ...
                FLog.m622e(ReactConstants.TAG, "Crash in HorizontalMeasurementProvider: " + e.getMessage());
            }
        }
        return id;
    }
