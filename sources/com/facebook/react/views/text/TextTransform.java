...
public enum TextTransform {
    ...
    static /* synthetic */ class C16181 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.views.text.TextTransform.C16181.<clinit>():void");
        }
    }
    ...
    public static String apply(String str, TextTransform textTransform) {
        ...
        int i = C16181.$SwitchMap$com$facebook$react$views$text$TextTransform[textTransform.ordinal()];
        if (i == 1) {
