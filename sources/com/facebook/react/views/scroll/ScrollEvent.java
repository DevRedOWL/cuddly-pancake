...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private WritableMap serializeEventData() {
        ...
        createMap2.putDouble(MapPoint.JsonFields.f6911x, (double) PixelUtil.toDIPFromPixel((float) this.mScrollX));
        createMap2.putDouble(MapPoint.JsonFields.f6912y, (double) PixelUtil.toDIPFromPixel((float) this.mScrollY));
        ...
        createMap5.putDouble(MapPoint.JsonFields.f6911x, this.mXVelocity);
        createMap5.putDouble(MapPoint.JsonFields.f6912y, this.mYVelocity);
