...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> {
    ...
    public void setElevation(ReactDrawerLayout reactDrawerLayout, float f) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            try {
                ...
                FLog.m663w(ReactConstants.TAG, "setDrawerElevation is not available in this version of the support lib.", (Throwable) e);
            }
        }
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m698of("openDrawer", 1, "closeDrawer", 2);
    }
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m697of("DrawerPosition", MapBuilder.m698of("Left", Integer.valueOf(GravityCompat.START), "Right", Integer.valueOf(GravityCompat.END)));
    }

    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m700of(DrawerSlideEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onDrawerSlide"), DrawerOpenedEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onDrawerOpen"), DrawerClosedEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onDrawerClose"), DrawerStateChangedEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onDrawerStateChanged"));
    }
