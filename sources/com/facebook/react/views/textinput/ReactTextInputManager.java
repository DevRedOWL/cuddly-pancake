...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder().put("topSubmitEditing", MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onSubmitEditing", "captured", "onSubmitEditingCapture"))).put("topEndEditing", MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onEndEditing", "captured", "onEndEditingCapture"))).put(ReactTextInputEvent.EVENT_NAME, MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onTextInput", "captured", "onTextInputCapture"))).put("topFocus", MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onFocus", "captured", "onFocusCapture"))).put("topBlur", MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onBlur", "captured", "onBlurCapture"))).put(ReactTextInputKeyPressEvent.EVENT_NAME, MapBuilder.m697of("phasedRegistrationNames", MapBuilder.m698of("bubbled", "onKeyPress", "captured", "onKeyPressCapture"))).build();
    }

    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.m697of("registrationName", "onScroll")).build();
    }

    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m698of("focusTextInput", 1, "blurTextInput", 2);
    }
    ...
    public void receiveCommand(com.facebook.react.views.textinput.ReactEditText r4, java.lang.String r5, com.facebook.react.bridge.ReadableArray r6) {
        /*
            r3 = this;
            int r6 = r5.hashCode()
            r0 = 3
    ...
    public void setUnderlineColor(ReactEditText reactEditText, Integer num) {
        ...
        if (background.getConstantState() != null) {
            try {
                ...
                FLog.m623e(TAG, "NullPointerException when setting underlineColorAndroid for TextInput", (Throwable) e);
            }
        }
        if (num == null) {
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m697of("AutoCapitalizationType", MapBuilder.m700of("none", 0, "characters", 4096, "words", 8192, "sentences", 16384));
    }
}
