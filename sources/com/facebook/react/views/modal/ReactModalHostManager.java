...
public class ReactModalHostManager extends ViewGroupManager<ReactModalHostView> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(RequestCloseEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onRequestClose")).put(ShowEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onShow")).build();
    }
