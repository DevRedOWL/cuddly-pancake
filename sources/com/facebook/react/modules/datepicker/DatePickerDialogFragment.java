...
public class DatePickerDialogFragment extends DialogFragment {
    ...
    static Dialog createDialog(Bundle bundle, Context context, DatePickerDialog.OnDateSetListener onDateSetListener) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            int i4 = C15271.$SwitchMap$com$facebook$react$modules$datepicker$DatePickerMode[datePickerMode2.ordinal()];
            if (i4 == 1) {
                dismissableDatePickerDialog = new DismissableDatePickerDialog(context, context.getResources().getIdentifier("CalendarDatePickerDialog", ButtonField.JsonFields.style, context.getPackageName()), onDateSetListener, i, i2, i3);
            } else if (i4 != 2) {
            ...
            int i5 = C15271.$SwitchMap$com$facebook$react$modules$datepicker$DatePickerMode[datePickerMode2.ordinal()];
            if (i5 == 1) {
    ...
    static /* synthetic */ class C15271 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.modules.datepicker.DatePickerDialogFragment.C15271.<clinit>():void");
        }
    }
