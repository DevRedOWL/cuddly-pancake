...
public class ImageEditingManager extends ReactContextBaseJavaModule {
    ...
    public void cropImage(String str, ReadableMap readableMap, Callback callback, Callback callback2) {
        ...
        if (map == null || readableMap3 == null || !map.hasKey(MapPoint.JsonFields.f6911x) || !map.hasKey(MapPoint.JsonFields.f6912y) || !readableMap3.hasKey("width") || !readableMap3.hasKey("height")) {
            throw new JSApplicationIllegalArgumentException("Please specify offset and size");
        } else if (str == null || str.isEmpty()) {
            throw new JSApplicationIllegalArgumentException("Please specify a URI");
        } else {
            CropTask cropTask = new CropTask(getReactApplicationContext(), str, (int) map.getDouble(MapPoint.JsonFields.f6911x), (int) map.getDouble(MapPoint.JsonFields.f6912y), (int) readableMap3.getDouble("width"), (int) readableMap3.getDouble("height"), callback, callback2);
    ...
    private static class CropTask extends GuardedAsyncTask<Void, Void> {
        ...
        private Bitmap crop(BitmapFactory.Options options) throws IOException {
            ...
            try {
                return newInstance.decodeRegion(new Rect(this.f1325mX, this.f1326mY, this.f1325mX + this.mWidth, this.f1326mY + this.mHeight), options);
            } finally {
        ...
        private Bitmap cropAndResize(int i, int i2, BitmapFactory.Options options) throws IOException {
            ...
            try {
                ...
                if (((float) i5) / ((float) i6) > f8) {
                    f4 = ((float) i6) * f8;
                    f3 = (float) i6;
                    f = ((float) this.f1325mX) + ((((float) i5) - f4) / 2.0f);
                    f5 = (float) this.f1326mY;
                    f2 = f7 / ((float) i6);
                } else {
                    f4 = (float) i5;
                    float f9 = ((float) i5) / f8;
                    f = (float) this.f1325mX;
                    float f10 = (((float) i6) - f9) / 2.0f;
                    float f11 = f6 / ((float) i5);
                    f3 = f9;
                    f2 = f11;
                    f5 = f10 + ((float) this.f1326mY);
                }
    ...
    public static void copyExif(Context context, Uri uri, File file) throws IOException {
        ...
        if (fileFromUri == null) {
            FLog.m662w(ReactConstants.TAG, "Couldn't get real path for uri: " + uri);
            return;
        }
