...
public class CameraRollManager extends ReactContextBaseJavaModule {
    ...
    private static class SaveToCameraRoll extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(java.lang.Void... r14) {
            ...
            L_0x006a:
                r14 = move-exception
                com.facebook.common.logging.FLog.m623e((java.lang.String) r1, (java.lang.String) r0, (java.lang.Throwable) r14)
            L_0x006e:
                return
            L_0x006f:
            ...
            L_0x0115:
                r3 = move-exception
                com.facebook.common.logging.FLog.m623e((java.lang.String) r1, (java.lang.String) r0, (java.lang.Throwable) r3)
            L_0x0119:
            ...
            L_0x014c:
                r2 = move-exception
                com.facebook.common.logging.FLog.m623e((java.lang.String) r1, (java.lang.String) r0, (java.lang.Throwable) r2)
            L_0x0150:
            ...
            L_0x015c:
                r0 = move-exception
                com.facebook.common.logging.FLog.m623e((java.lang.String) r1, (java.lang.String) r14, (java.lang.Throwable) r0)
            L_0x0160:
                return
            L_0x0161:
                r2 = move-exception
            ...
            L_0x0171:
                r4 = move-exception
                com.facebook.common.logging.FLog.m623e((java.lang.String) r1, (java.lang.String) r0, (java.lang.Throwable) r4)
            L_0x0175:
    ...
    private static class GetMediaTask extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            if (c == 0) {
                ...
                promise.reject(CameraRollManager.ERROR_UNABLE_TO_FILTER, "Invalid filter option: '" + this.mAssetType + "'. Expected one of '" + CameraRollManager.ASSET_TYPE_PHOTOS + "', '" + CameraRollManager.ASSET_TYPE_VIDEOS + "' or '" + "All" + "'.");
                return;
            } else {
    ...
    private static boolean putImageInfo(ContentResolver contentResolver, Cursor cursor, WritableMap writableMap, int i, int i2, int i3, int i4, int i5) {
        ...
        writableNativeMap.putString(AlbumLoader.COLUMN_URI, parse.toString());
            ...
            try {
                ...
                if (f <= 0.0f || f2 <= 0.0f) {
                    try {
                        ...
                        FLog.m623e(ReactConstants.TAG, "Number format exception occurred while trying to fetch video metadata for " + parse.toString(), (Throwable) e);
                ...
                FLog.m623e(ReactConstants.TAG, "Could not get video metadata for " + parse.toString(), (Throwable) e2);
                return false;
            } catch (Throwable th) {
                mediaMetadataRetriever.release();
                openAssetFileDescriptor.close();
        ...
        if (f <= 0.0f || f2 <= 0.0f) {
            try {
                ...
                FLog.m623e(ReactConstants.TAG, "Could not get width/height for " + parse.toString(), (Throwable) e3);
                return false;
            }
        }
