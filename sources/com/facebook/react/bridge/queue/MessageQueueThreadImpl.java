...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public void runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            FLog.m662w(ReactConstants.TAG, "Tried to enqueue runnable on already finished thread: '" + getName() + "... dropping Runnable.");
        }
    ...
    static /* synthetic */ class C14295 {

        /* renamed from: $SwitchMap$com$facebook$react$bridge$queue$MessageQueueThreadSpec$ThreadType */
        static final /* synthetic */ int[] f1319x16463f8b = new int[MessageQueueThreadSpec.ThreadType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1319x16463f8b = r0
                int[] r0 = f1319x16463f8b     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1319x16463f8b     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.queue.MessageQueueThreadImpl.C14295.<clinit>():void");
        }
    }
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        int i = C14295.f1319x16463f8b[messageQueueThreadSpec.getThreadType().ordinal()];
        if (i == 1) {
