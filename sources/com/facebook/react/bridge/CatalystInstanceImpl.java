...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            ...
            FLog.m662w(ReactConstants.TAG, "Calling JS function after bridge has been destroyed: " + pendingJSCall2);
            return;
        }
    ...
    public void invokeCallback(int i, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            FLog.m662w(ReactConstants.TAG, "Invoking JS callback after bridge has been destroyed.");
        } else {
