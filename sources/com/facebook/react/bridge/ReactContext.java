...
public class ReactContext extends ContextWrapper {
    ...
    public void addLifecycleEventListener(final LifecycleEventListener lifecycleEventListener) {
        ...
        if (hasActiveCatalystInstance() && (i = C14222.$SwitchMap$com$facebook$react$common$LifecycleState[this.mLifecycleState.ordinal()]) != 1 && i != 2) {
            if (i == 3) {
    ...
    static /* synthetic */ class C14222 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.ReactContext.C14222.<clinit>():void");
        }
    }
