...
public class DevLoadingViewController {
    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                URL url = new URL(str);
                int i = C1345R.string.catalyst_loading_from_url;
                showMessage(context.getString(i, new Object[]{url.getHost() + ":" + url.getPort()}));
            } catch (MalformedURLException e) {
                FLog.m622e(ReactConstants.TAG, "Bundle url format is invalid. \n\n" + e.toString());
            }
        }
    }
    ...
    public void showForRemoteJSEnabled() {
        Context context = getContext();
        if (context != null) {
            showMessage(context.getString(C1345R.string.catalyst_debug_connecting));
        }
    }
    ...
    public void showInternal(String str) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            if (currentActivity == null) {
                FLog.m622e(ReactConstants.TAG, "Unable to display loading message because react activity isn't available");
                return;
            }
            Rect rect = new Rect();
            currentActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
            int i = rect.top;
            this.mDevLoadingView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C1345R.layout.dev_loading_view, (ViewGroup) null);
