...
public abstract class BundleDeltaClient {
    ...
    static /* synthetic */ class C14321 {
        ...
        static final /* synthetic */ int[] f1320xca7c22d2 = new int[ClientType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1320xca7c22d2 = r0
                int[] r0 = f1320xca7c22d2     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1320xca7c22d2     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.devsupport.BundleDeltaClient.C14321.<clinit>():void");
        }
    }

    static BundleDeltaClient create(ClientType clientType) {
        int i = C14321.f1320xca7c22d2[clientType.ordinal()];
        if (i == 1) {
            return new BundleDeltaJavaClient((C14321) null);
        }
        if (i != 2) {
            return null;
        }
        return new BundleDeltaNativeClient((C14321) null);
    }
    ...
    private static class BundleDeltaJavaClient extends BundleDeltaClient {
        ...
        /* synthetic */ BundleDeltaJavaClient(C14321 r1) {
            this();
        }
    ...
    private static class BundleDeltaNativeClient extends BundleDeltaClient {
        ...
        /* synthetic */ BundleDeltaNativeClient(C14321 r1) {
            this();
        }
