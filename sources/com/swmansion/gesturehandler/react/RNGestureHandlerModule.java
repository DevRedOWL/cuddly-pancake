...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
    ...
    private static class TapGestureHandlerFactory extends HandlerFactory<TapGestureHandler> {
        ...
        public void extractEventData(TapGestureHandler tapGestureHandler, WritableMap writableMap) {
            ...
            writableMap.putDouble(MapPoint.JsonFields.f6911x, (double) PixelUtil.toDIPFromPixel(tapGestureHandler.getLastRelativePositionX()));
            writableMap.putDouble(MapPoint.JsonFields.f6912y, (double) PixelUtil.toDIPFromPixel(tapGestureHandler.getLastRelativePositionY()));
    ...
    private static class LongPressGestureHandlerFactory extends HandlerFactory<LongPressGestureHandler> {
        ...
        public void extractEventData(LongPressGestureHandler longPressGestureHandler, WritableMap writableMap) {
            ...
            writableMap.putDouble(MapPoint.JsonFields.f6911x, (double) PixelUtil.toDIPFromPixel(longPressGestureHandler.getLastRelativePositionX()));
            writableMap.putDouble(MapPoint.JsonFields.f6912y, (double) PixelUtil.toDIPFromPixel(longPressGestureHandler.getLastRelativePositionY()));
    ...
    private static class PanGestureHandlerFactory extends HandlerFactory<PanGestureHandler> {
        ...
        public void extractEventData(PanGestureHandler panGestureHandler, WritableMap writableMap) {
            ...
            writableMap.putDouble(MapPoint.JsonFields.f6911x, (double) PixelUtil.toDIPFromPixel(panGestureHandler.getLastRelativePositionX()));
            writableMap.putDouble(MapPoint.JsonFields.f6912y, (double) PixelUtil.toDIPFromPixel(panGestureHandler.getLastRelativePositionY()));
            ...
            writableMap.putDouble(Key.TRANSLATION_X, (double) PixelUtil.toDIPFromPixel(panGestureHandler.getTranslationX()));
            writableMap.putDouble(Key.TRANSLATION_Y, (double) PixelUtil.toDIPFromPixel(panGestureHandler.getTranslationY()));
    ...
    private static class FlingGestureHandlerFactory extends HandlerFactory<FlingGestureHandler> {
        ...
        public void extractEventData(FlingGestureHandler flingGestureHandler, WritableMap writableMap) {
            ...
            writableMap.putDouble(MapPoint.JsonFields.f6911x, (double) PixelUtil.toDIPFromPixel(flingGestureHandler.getLastRelativePositionX()));
            writableMap.putDouble(MapPoint.JsonFields.f6912y, (double) PixelUtil.toDIPFromPixel(flingGestureHandler.getLastRelativePositionY()));
    ...
    public Map getConstants() {
        return MapBuilder.m698of(C4656xbdeaa6ca.ClassNameHelper.INTERNAL_CLASS_NAME, MapBuilder.m702of("UNDETERMINED", 0, "BEGAN", 2, "ACTIVE", 4, "CANCELLED", 3, "FAILED", 1, "END", 5), "Direction", MapBuilder.m700of("RIGHT", 1, "LEFT", 2, "UP", 4, "DOWN", 8));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        r0.addUIBlock(new com.swmansion.gesturehandler.react.RNGestureHandlerModule.C29332(r5));
     */
