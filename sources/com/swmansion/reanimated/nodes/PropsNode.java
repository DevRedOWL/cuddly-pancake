        ...
        for (Map.Entry next : this.mMapping.entrySet()) {
            ...
            if (findNodeById instanceof StyleNode) {
                ...
                while (keySetIterator.hasNextKey()) {
                    ...
                    int i = C29791.$SwitchMap$com$facebook$react$bridge$ReadableType[type.ordinal()];
                    if (i == 1) {
    ...
    static /* synthetic */ class C29791 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.swmansion.reanimated.nodes.PropsNode.C29791.<clinit>():void");
        }
    }
