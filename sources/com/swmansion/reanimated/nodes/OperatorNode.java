...
public class OperatorNode extends Node {
    ...
    /* renamed from: EQ */
    private static final Operator f2315EQ = new CompOperator() {
    ...
    /* renamed from: OR */
    private static final Operator f2316OR = new Operator() {
        public double evaluate(Node[] nodeArr) {
            boolean access$200 = OperatorNode.truthy(nodeArr[0].value());
            for (int i = 1; i < nodeArr.length && !access$200; i++) {
                access$200 = access$200 || OperatorNode.truthy(nodeArr[i].value());
    ...
    public OperatorNode(int i, ReadableMap readableMap, NodesManager nodesManager) {
        ...
        this.mInputIDs = com.swmansion.reanimated.Utils.processIntArray(readableMap.getArray("input"));
        String string = readableMap.getString("op");
        if (Scenario.ADD.equals(string)) {
            this.mOperator = ADD;
