...
public class ScreenViewManager extends ViewGroupManager<Screen> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m699of(ScreenDismissedEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onDismissed"), ScreenAppearEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onAppear"), StackFinishTransitioningEvent.EVENT_NAME, MapBuilder.m697of("registrationName", "onFinishTransitioning"));
    }
}
