...
import p042cz.msebera.android.httpclient.client.entity.UrlEncodedFormEntity;
...
public class RequestParams implements Serializable {
    ...
    public void setContentEncoding(String str) {
        if (str != null) {
            ...
            AsyncHttpClient.log.mo37604d(LOG_TAG, "setContentEncoding called with null attribute");
        }
    }
    ...
    private HttpEntity createFormEntity() {
        try {
            return new UrlEncodedFormEntity((List<? extends NameValuePair>) getParamsList(), this.contentEncoding);
        } catch (UnsupportedEncodingException e) {
            AsyncHttpClient.log.mo37607e(LOG_TAG, "createFormEntity failed", e);
            return null;
        }
    }
    ...
    public String getParamString() {
        return URLEncodedUtils.format((List<? extends NameValuePair>) getParamsList(), this.contentEncoding);
    }
