...
public class SVG {
    ...
    public Set<String> getViewList() {
        if (this.rootElement != null) {
            ...
            while (it.hasNext()) {
                ...
                if (view.f1242id != null) {
                    hashSet.add(view.f1242id);
                } else {
    ...
    static class Length implements Cloneable {
        ...
        public float floatValue(float f) {
            int i = C11751.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    /* renamed from: com.caverock.androidsvg.SVG$Image */
    static class C1176Image extends SvgPreserveAspectRatioContainer implements HasTransform {
        Length height;
        String href;
        Matrix transform;
        Length width;
    ...
    public SvgElementBase getElementById(String str) {
        ...
        if (str.equals(this.rootElement.f1242id)) {
            return this.rootElement;
        }
    ...
    private SvgElementBase getElementById(SvgContainer svgContainer, String str) {
        ...
        if (str.equals(svgElementBase.f1242id)) {
        ...
        for (SvgObject next : svgContainer.getChildren()) {
            if (next instanceof SvgElementBase) {
                ...
                if (str.equals(svgElementBase2.f1242id)) {
