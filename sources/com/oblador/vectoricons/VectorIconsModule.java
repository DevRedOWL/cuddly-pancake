...
public class VectorIconsModule extends ReactContextBaseJavaModule {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:36:0x016e A[SYNTHETIC, Splitter:B:36:0x016e] */
    /* JADX WARNING: Removed duplicated region for block: B:43:? A[RETURN, SYNTHETIC] */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:22:0x0144=Splitter:B:22:0x0144, B:28:0x0156=Splitter:B:28:0x0156} */
    ...
    public void getImageForFont(java.lang.String r9, java.lang.String r10, java.lang.Integer r11, java.lang.Integer r12, com.facebook.react.bridge.Callback r13) {
        ...
        L_0x00cd:
            ...
            java.io.FileOutputStream r9 = new java.io.FileOutputStream     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            r9.<init>(r3)     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            android.graphics.Bitmap$CompressFormat r10 = android.graphics.Bitmap.CompressFormat.PNG     // Catch:{ FileNotFoundException -> 0x013d, IOException -> 0x0139, all -> 0x0135 }
            r11 = 100
            r12.compress(r10, r11, r9)     // Catch:{ FileNotFoundException -> 0x013d, IOException -> 0x0139, all -> 0x0135 }
            r9.flush()     // Catch:{ FileNotFoundException -> 0x013d, IOException -> 0x0139, all -> 0x0135 }
            r9.close()     // Catch:{ FileNotFoundException -> 0x013d, IOException -> 0x0139, all -> 0x0135 }
            java.lang.Object[] r9 = new java.lang.Object[r4]     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            r9[r7] = r5     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            r9[r6] = r1     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            r13.invoke(r9)     // Catch:{ FileNotFoundException -> 0x0155, IOException -> 0x0143 }
            goto L_0x016b
        L_0x0135:
            r10 = move-exception
            r5 = r9
        ...
        L_0x0143:
            r9 = move-exception
        L_0x0144:
            java.lang.Object[] r10 = new java.lang.Object[r6]     // Catch:{ all -> 0x0141 }
            java.lang.String r9 = r9.getMessage()     // Catch:{ all -> 0x0141 }
            r10[r7] = r9     // Catch:{ all -> 0x0141 }
            r13.invoke(r10)     // Catch:{ all -> 0x0141 }
