...
public class ApkLibraryInstaller implements ReLinker.LibraryInstaller {
    ...
    public void installLibrary(android.content.Context r11, java.lang.String[] r12, java.lang.String r13, java.io.File r14, com.getkeepsafe.relinker.ReLinkerInstance r15) {
        /*
            r10 = this;
            r0 = 0
            com.getkeepsafe.relinker.ApkLibraryInstaller$ZipFileInZipEntry r11 = r10.findAPKWithLibrary(r11, r12, r13, r15)     // Catch:{ all -> 0x00a1 }
        ...
        L_0x0009:
            ...
            r15.log(r1, r4)     // Catch:{ all -> 0x009f }
            ...
            goto L_0x0086
        L_0x0026:
            java.util.zip.ZipFile r1 = r11.zipFile     // Catch:{ FileNotFoundException -> 0x0080, IOException -> 0x007a, all -> 0x0071 }
            java.util.zip.ZipEntry r4 = r11.zipEntry     // Catch:{ FileNotFoundException -> 0x0080, IOException -> 0x007a, all -> 0x0071 }
            ...
            long r5 = r10.copy(r1, r4)     // Catch:{ FileNotFoundException -> 0x0082, IOException -> 0x007c, all -> 0x0068 }
            ...
            r10.closeSilently(r1)     // Catch:{ all -> 0x009f }
        L_0x0049:
        ...
        L_0x0088:
            ...
            r15.log((java.lang.String) r12)     // Catch:{ all -> 0x009f }
            if (r11 == 0) goto L_0x0098
            java.util.zip.ZipFile r12 = r11.zipFile     // Catch:{ IOException -> 0x0098 }
            if (r12 == 0) goto L_0x0098
            java.util.zip.ZipFile r11 = r11.zipFile     // Catch:{ IOException -> 0x0098 }
        ...
        L_0x00a3:
            ...
            java.util.zip.ZipFile r13 = r11.zipFile     // Catch:{ IOException -> 0x00ae }
            if (r13 == 0) goto L_0x00ae
            java.util.zip.ZipFile r11 = r11.zipFile     // Catch:{ IOException -> 0x00ae }
