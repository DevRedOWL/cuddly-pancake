package com.zhihu.matisse.internal.p040ui.adapter;
...
import com.zhihu.matisse.internal.p040ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends RecyclerViewCursorAdapter<RecyclerView.ViewHolder> implements MediaGrid.OnMediaGridClickListener {
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedItemCollection, RecyclerView recyclerView) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(new int[]{C4433R.attr.item_placeholder});
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == 1) {
            CaptureViewHolder captureViewHolder = new CaptureViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C4433R.layout.photo_capture_item, viewGroup, false));
            ...
            return new MediaViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C4433R.layout.media_grid_item, viewGroup, false));
        } else {
            return null;
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, Cursor cursor) {
        ...
        if (viewHolder instanceof CaptureViewHolder) {
            ...
            TypedArray obtainStyledAttributes = viewHolder.itemView.getContext().getTheme().obtainStyledAttributes(new int[]{C4433R.attr.capture_textColor});
    ...
    private int getImageResize(Context context) {
        if (this.mImageResize == 0) {
            ...
            this.mImageResize = (context.getResources().getDisplayMetrics().widthPixels - (context.getResources().getDimensionPixelSize(C4433R.dimen.media_grid_spacing) * (spanCount - 1))) / spanCount;
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View view) {
            super(view);
            this.mHint = (TextView) view.findViewById(C4433R.C4436id.hint);
        }
    }
}
