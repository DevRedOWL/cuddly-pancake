package com.zhihu.matisse.internal.p040ui;
...
import com.zhihu.matisse.internal.p040ui.adapter.PreviewPagerAdapter;
import com.zhihu.matisse.internal.p040ui.widget.CheckRadioView;
import com.zhihu.matisse.internal.p040ui.widget.CheckView;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, OnFragmentInteractionListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C4433R.layout.activity_media_preview);
        ...
        this.mButtonBack = (TextView) findViewById(C4433R.C4436id.button_back);
        this.mButtonApply = (TextView) findViewById(C4433R.C4436id.button_apply);
        this.mSize = (TextView) findViewById(C4433R.C4436id.size);
        this.mButtonBack.setOnClickListener(this);
        this.mButtonApply.setOnClickListener(this);
        this.mPager = (ViewPager) findViewById(C4433R.C4436id.pager);
        ...
        this.mCheckView = (CheckView) findViewById(C4433R.C4436id.check_view);
        this.mCheckView.setCountable(this.mSpec.countable);
        this.mBottomToolbar = (FrameLayout) findViewById(C4433R.C4436id.bottom_toolbar);
        this.mTopToolbar = (FrameLayout) findViewById(C4433R.C4436id.top_toolbar);
        ...
        this.mOriginalLayout.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (access$200 > 0) {
                    IncapableDialog.newInstance("", BasePreviewActivity.this.getString(C4433R.string.error_over_original_count, new Object[]{Integer.valueOf(access$200), Integer.valueOf(BasePreviewActivity.this.mSpec.originalMaxSize)})).show(BasePreviewActivity.this.getSupportFragmentManager(), IncapableDialog.class.getName());
                    return;
                }
    ...
    public void onClick(View view) {
        if (view.getId() == C4433R.C4436id.button_back) {
            onBackPressed();
