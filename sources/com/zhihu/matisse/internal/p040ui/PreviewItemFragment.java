...
import p048it.sephiroth.android.library.imagezoom.ImageViewTouch;
import p048it.sephiroth.android.library.imagezoom.ImageViewTouchBase;
...
public class PreviewItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C4433R.layout.fragment_preview_item, viewGroup, false);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (item != null) {
            View findViewById = view.findViewById(C4433R.C4436id.video_play_button);
            if (item.isVideo()) {
                ...
                findViewById.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            Toast.makeText(PreviewItemFragment.this.getContext(), C4433R.string.error_no_video_activity, 0).show();
                        }
                    }
                });
            } else {
            ...
            ImageViewTouch imageViewTouch = (ImageViewTouch) view.findViewById(C4433R.C4436id.image_view);
    ...
    public void resetView() {
        if (getView() != null) {
            ((ImageViewTouch) getView().findViewById(C4433R.C4436id.image_view)).resetMatrix();
        }
    }
