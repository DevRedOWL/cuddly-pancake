...
public class CheckView extends View {
    ...
    public void onMeasure(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (this.mDensity * 48.0f), BasicMeasure.EXACTLY);
    ...
    private void init(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(new int[]{C4433R.attr.item_checkCircle_borderColor});
        int color = obtainStyledAttributes.getColor(0, ResourcesCompat.getColor(getResources(), C4433R.C4434color.zhihu_item_checkCircle_borderColor, getContext().getTheme()));
        obtainStyledAttributes.recycle();
        this.mStrokePaint.setColor(color);
        this.mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(), C4433R.C4435drawable.ic_check_white_18dp, context.getTheme());
    }
    ...
    private void initShadowPaint() {
        if (this.mShadowPaint == null) {
            ...
            float f4 = 19.0f * f;
            paint.setShader(new RadialGradient(f2, f3, f4, new int[]{Color.parseColor("#00000000"), Color.parseColor("#0D000000"), Color.parseColor("#0D000000"), Color.parseColor("#00000000")}, fArr, Shader.TileMode.CLAMP));
        }
    }
    ...
    private void initBackgroundPaint() {
        if (this.mBackgroundPaint == null) {
            ...
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(new int[]{C4433R.attr.item_checkCircle_backgroundColor});
            int color = obtainStyledAttributes.getColor(0, ResourcesCompat.getColor(getResources(), C4433R.C4434color.zhihu_item_checkCircle_backgroundColor, getContext().getTheme()));
            obtainStyledAttributes.recycle();
