...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(C4433R.layout.media_grid_content, this, true);
        this.mThumbnail = (ImageView) findViewById(C4433R.C4436id.media_thumbnail);
        this.mCheckView = (CheckView) findViewById(C4433R.C4436id.check_view);
        this.mGifTag = (ImageView) findViewById(C4433R.C4436id.gif);
        this.mVideoDuration = (TextView) findViewById(C4433R.C4436id.video_duration);
