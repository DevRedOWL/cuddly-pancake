...
public class AlbumsSpinner {
    ...
    public AlbumsSpinner(Context context) {
        this.mListPopupWindow = new ListPopupWindow(context, (AttributeSet) null, C4433R.attr.listPopupWindowStyle);
    ...
    public void setSelectedTextView(TextView textView) {
        ...
        TypedArray obtainStyledAttributes = this.mSelected.getContext().getTheme().obtainStyledAttributes(new int[]{C4433R.attr.album_element_color});
        ...
        this.mSelected.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                int i;
                int dimensionPixelSize = view.getResources().getDimensionPixelSize(C4433R.dimen.album_item_height);
