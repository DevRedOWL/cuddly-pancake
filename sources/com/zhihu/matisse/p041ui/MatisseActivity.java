package com.zhihu.matisse.p041ui;
...
import com.zhihu.matisse.internal.p040ui.AlbumPreviewActivity;
import com.zhihu.matisse.internal.p040ui.BasePreviewActivity;
import com.zhihu.matisse.internal.p040ui.MediaSelectionFragment;
import com.zhihu.matisse.internal.p040ui.SelectedPreviewActivity;
import com.zhihu.matisse.internal.p040ui.adapter.AlbumMediaAdapter;
import com.zhihu.matisse.internal.p040ui.adapter.AlbumsAdapter;
import com.zhihu.matisse.internal.p040ui.widget.AlbumsSpinner;
import com.zhihu.matisse.internal.p040ui.widget.CheckRadioView;
import com.zhihu.matisse.internal.p040ui.widget.IncapableDialog;
...
public class MatisseActivity extends AppCompatActivity implements AlbumCollection.AlbumCallbacks, AdapterView.OnItemSelectedListener, MediaSelectionFragment.SelectionProvider, View.OnClickListener, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener, AlbumMediaAdapter.OnPhotoCapture {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C4433R.layout.activity_matisse);
        ...
        Toolbar toolbar = (Toolbar) findViewById(C4433R.C4436id.toolbar);
        setSupportActionBar(toolbar);
        ActionBar supportActionBar = getSupportActionBar();
        supportActionBar.setDisplayShowTitleEnabled(false);
        supportActionBar.setDisplayHomeAsUpEnabled(true);
        Drawable navigationIcon = toolbar.getNavigationIcon();
        TypedArray obtainStyledAttributes = getTheme().obtainStyledAttributes(new int[]{C4433R.attr.album_element_color});
        int color = obtainStyledAttributes.getColor(0, 0);
        obtainStyledAttributes.recycle();
        navigationIcon.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        this.mButtonPreview = (TextView) findViewById(C4433R.C4436id.button_preview);
        this.mButtonApply = (TextView) findViewById(C4433R.C4436id.button_apply);
        this.mButtonPreview.setOnClickListener(this);
        this.mButtonApply.setOnClickListener(this);
        this.mContainer = findViewById(C4433R.C4436id.container);
        this.mEmptyView = findViewById(C4433R.C4436id.empty_view);
        this.mOriginalLayout = (LinearLayout) findViewById(C4433R.C4436id.originalLayout);
        this.mOriginal = (CheckRadioView) findViewById(C4433R.C4436id.original);
        ...
        this.mAlbumsSpinner.setSelectedTextView((TextView) findViewById(C4433R.C4436id.selected_album));
        this.mAlbumsSpinner.setPopupAnchorView(findViewById(C4433R.C4436id.toolbar));
    ...
    private void updateBottomToolbar() {
        ...
        if (count == 0) {
            ...
            this.mButtonApply.setText(getString(C4433R.string.button_apply_default));
        } else if (count != 1 || !this.mSpec.singleSelectionModeEnabled()) {
            this.mButtonPreview.setEnabled(true);
            this.mButtonApply.setEnabled(true);
            this.mButtonApply.setText(getString(C4433R.string.button_apply, new Object[]{Integer.valueOf(count)}));
        } else {
            this.mButtonPreview.setEnabled(true);
            this.mButtonApply.setText(C4433R.string.button_apply_default);
            this.mButtonApply.setEnabled(true);
        }
    ...
    private void updateOriginalState() {
        ...
        if (countOverMaxSize() > 0 && this.mOriginalEnable) {
            IncapableDialog.newInstance("", getString(C4433R.string.error_over_original_size, new Object[]{Integer.valueOf(this.mSpec.originalMaxSize)})).show(getSupportFragmentManager(), IncapableDialog.class.getName());
    ...
    public void onClick(View view) {
        if (view.getId() == C4433R.C4436id.button_preview) {
        ...
        } else if (view.getId() == C4433R.C4436id.button_apply) {
            Intent intent2 = new Intent();
            ...
            setResult(-1, intent2);
            finish();
        } else if (view.getId() == C4433R.C4436id.originalLayout) {
            int countOverMaxSize = countOverMaxSize();
            if (countOverMaxSize > 0) {
                IncapableDialog.newInstance("", getString(C4433R.string.error_over_original_count, new Object[]{Integer.valueOf(countOverMaxSize), Integer.valueOf(this.mSpec.originalMaxSize)})).show(getSupportFragmentManager(), IncapableDialog.class.getName());
                return;
            }
    ...
    public void onAlbumSelected(Album album) {
        if (!album.isAll() || !album.isEmpty()) {
            ...
            getSupportFragmentManager().beginTransaction().replace(C4433R.C4436id.container, (Fragment) MediaSelectionFragment.newInstance(album), MediaSelectionFragment.class.getSimpleName()).commitAllowingStateLoss();
            return;
        }
