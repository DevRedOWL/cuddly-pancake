package com.p034BV.LinearGradient;
    ...
    private void drawGradient() {
        ...
        if (iArr != null) {
            ...
            if (fArr == null || iArr.length == fArr.length) {
                ...
                this.mShader = new LinearGradient(f2, f3, fArr3[0] * ((float) iArr2[0]), fArr3[1] * ((float) iArr2[1]), this.mColors, this.mLocations, Shader.TileMode.CLAMP);
