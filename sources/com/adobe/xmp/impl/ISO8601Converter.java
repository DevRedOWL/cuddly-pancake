            ...
            if (xMPDateTime.hasTime()) {
                ...
                if (xMPDateTime.hasTimeZone()) {
                    ...
                    if (offset == 0) {
                        ...
                        int abs = Math.abs((offset % 3600000) / BeaconHelper.PUSH_LIVE_TIME_IN_MILLIS);
