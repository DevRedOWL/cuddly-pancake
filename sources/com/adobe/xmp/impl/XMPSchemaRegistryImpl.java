...
public final class XMPSchemaRegistryImpl implements XMPSchemaRegistry, XMPConst {
    ...
    /* renamed from: p */
    private Pattern f1136p = Pattern.compile("[/*?\\[\\]]");
    ...
    private void registerStandardAliases() throws XMPException {
        ...
        registerAlias("http://ns.adobe.com/xap/1.0/", ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME, "http://purl.org/dc/elements/1.1/", "creator", arrayOrdered);
        ...
        registerAlias(XMPConst.NS_PDF, ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME, "http://purl.org/dc/elements/1.1/", "creator", arrayOrdered);
        ...
        registerAlias(XMPConst.NS_PHOTOSHOP, ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME, "http://purl.org/dc/elements/1.1/", "creator", arrayOrdered);
        ...
        registerAlias(XMPConst.NS_PNG, ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME, "http://purl.org/dc/elements/1.1/", "creator", arrayOrdered);
    ...
    private void registerStandardNamespaces() throws XMPException {
        ...
        registerNamespace(XMPConst.NS_X, MapPoint.JsonFields.f6911x);
    ...
    public synchronized void registerAlias(String str, String str2, String str3, String str4, AliasOptions aliasOptions) throws XMPException {
        ...
        if (this.f1136p.matcher(str2).find() || this.f1136p.matcher(str4).find()) {
