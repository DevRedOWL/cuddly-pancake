...
public final class DotsIndicator extends LinearLayout {
    ...
    public DotsIndicator(Context context, AttributeSet attributeSet) {
        ...
        this.lastPosition = -1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1061R.styleable.DotsIndicator);
        try {
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C1061R.styleable.DotsIndicator_dot_width, -1);
            int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(C1061R.styleable.DotsIndicator_dot_height, -1);
            int dimensionPixelSize3 = obtainStyledAttributes.getDimensionPixelSize(C1061R.styleable.DotsIndicator_dot_margin, -1);
            int i = obtainStyledAttributes.getInt(C1061R.styleable.DotsIndicator_dots_orientation, -1);
            int i2 = obtainStyledAttributes.getInt(C1061R.styleable.DotsIndicator_dots_gravity, -1);
            this.animatorResId = obtainStyledAttributes.getResourceId(C1061R.styleable.DotsIndicator_dots_animator, C1061R.animator.scale_with_alpha);
            int i3 = 0;
            this.animatorReverseResId = obtainStyledAttributes.getResourceId(C1061R.styleable.DotsIndicator_dots_animator_reverse, 0);
            this.backgroundResId = obtainStyledAttributes.getResourceId(C1061R.styleable.DotsIndicator_dot_drawable, C1061R.C1063drawable.black_dot);
            this.unselectedBackgroundId = obtainStyledAttributes.getResourceId(C1061R.styleable.DotsIndicator_dot_drawable_unselected, this.backgroundResId);
            this.dotTint = obtainStyledAttributes.getColor(C1061R.styleable.DotsIndicator_dot_tint, 0);
            ...
            this.indicatorMargin = dimensionPixelSize3 >= 0 ? dimensionPixelSize3 : applyDimension;
            ...
            this.immediateAnimatorOut.setDuration(0);
            this.animatorIn = createAnimatorIn();
            this.immediateAnimatorIn = createAnimatorIn();
            this.immediateAnimatorIn.setDuration(0);
            int i4 = this.backgroundResId;
            this.indicatorBackgroundResId = i4 == 0 ? C1061R.C1063drawable.black_dot : i4;
    ...
    public final void attachViewPager(ViewPager viewPager2) {
        ...
        if (viewPager3 != null && viewPager3.getAdapter() != null) {
            this.lastPosition = -1;
            createIndicators();
            viewPager3.removeOnPageChangeListener(this.internalPageChangeListener);
            viewPager3.addOnPageChangeListener(this.internalPageChangeListener);
            this.internalPageChangeListener.onPageSelected(viewPager3.getCurrentItem());
        }
    }
    ...
    @Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¨\u0006\u0006"}, mo51343d2 = {"Lcom/afollestad/viewpagerdots/DotsIndicator$ReverseInterpolator;", "Landroid/view/animation/Interpolator;", "(Lcom/afollestad/viewpagerdots/DotsIndicator;)V", "getInterpolation", "", "value", "com.afollestad.viewpagerdots"}, mo51344k = 1, mo51345mv = {1, 1, 11})
    /* compiled from: DotsIndicator.kt */
    ...
    @Metadata(mo51341bv = {1, 0, 2}, mo51342d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo51343d2 = {"Lcom/afollestad/viewpagerdots/DotsIndicator$Companion;", "", "()V", "DEFAULT_INDICATOR_WIDTH", "", "com.afollestad.viewpagerdots"}, mo51344k = 1, mo51345mv = {1, 1, 11})
    /* compiled from: DotsIndicator.kt */
