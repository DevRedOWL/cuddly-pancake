...
public final class DialogListExtKt {
    ...
    public static final Drawable getItemSelector(MaterialDialog materialDialog) {
        ...
        Drawable resolveDrawable$default = MDUtil.resolveDrawable$default(mDUtil, context, (Integer) null, Integer.valueOf(C1036R.attr.md_item_selector), (Drawable) null, 10, (Object) null);
        if (Build.VERSION.SDK_INT >= 21 && (resolveDrawable$default instanceof RippleDrawable)) {
            MDUtil mDUtil2 = MDUtil.INSTANCE;
            int resolveColor$default = ColorsKt.resolveColor$default(materialDialog, (Integer) null, Integer.valueOf(C1036R.attr.md_ripple_color), (Function0) null, 5, (Object) null);
