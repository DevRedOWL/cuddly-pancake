...
public final class PlainListDialogAdapter extends RecyclerView.Adapter<PlainListViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, ? extends Unit>> {
    ...
    public PlainListViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        PlainListViewHolder plainListViewHolder = new PlainListViewHolder(MDUtil.INSTANCE.inflate(viewGroup, this.dialog.getWindowContext(), C1036R.layout.md_listitem), this);
        MDUtil.maybeSetTextColor$default(MDUtil.INSTANCE, plainListViewHolder.getTitleView(), this.dialog.getWindowContext(), Integer.valueOf(C1036R.attr.md_color_content), (Integer) null, 4, (Object) null);
