...
public final class MultiChoiceDialogAdapter extends RecyclerView.Adapter<MultiChoiceViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super int[], ? super List<? extends CharSequence>, ? extends Unit>> {
    ...
    public MultiChoiceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        MultiChoiceViewHolder multiChoiceViewHolder = new MultiChoiceViewHolder(MDUtil.INSTANCE.inflate(viewGroup, this.dialog.getWindowContext(), C1036R.layout.md_listitem_multichoice), this);
        MDUtil.maybeSetTextColor$default(MDUtil.INSTANCE, multiChoiceViewHolder.getTitleView(), this.dialog.getWindowContext(), Integer.valueOf(C1036R.attr.md_color_content), (Integer) null, 4, (Object) null);
