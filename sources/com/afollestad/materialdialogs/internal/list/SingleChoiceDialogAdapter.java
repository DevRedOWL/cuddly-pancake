...
public final class SingleChoiceDialogAdapter extends RecyclerView.Adapter<SingleChoiceViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, ? extends Unit>> {
    ...
    public SingleChoiceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        SingleChoiceViewHolder singleChoiceViewHolder = new SingleChoiceViewHolder(MDUtil.INSTANCE.inflate(viewGroup, this.dialog.getWindowContext(), C1036R.layout.md_listitem_singlechoice), this);
        MDUtil.maybeSetTextColor$default(MDUtil.INSTANCE, singleChoiceViewHolder.getTitleView(), this.dialog.getWindowContext(), Integer.valueOf(C1036R.attr.md_color_content), (Integer) null, 4, (Object) null);
        int[] resolveColors$default = ColorsKt.resolveColors$default(this.dialog, new int[]{C1036R.attr.md_color_widget, C1036R.attr.md_color_widget_unchecked}, (Function1) null, 2, (Object) null);
