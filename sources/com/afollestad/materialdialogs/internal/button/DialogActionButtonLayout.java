...
public final class DialogActionButtonLayout extends BaseSubLayout {
    ...
    public DialogActionButtonLayout(Context context, AttributeSet attributeSet) {
        ...
        this.buttonFramePadding = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_action_button_frame_padding) - MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_action_button_inset_horizontal);
        this.buttonFramePaddingNeutral = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_action_button_frame_padding_neutral);
        this.buttonFrameSpecHeight = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_action_button_frame_spec_height);
        this.checkBoxPromptMarginVertical = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_checkbox_prompt_margin_vertical);
        this.checkBoxPromptMarginHorizontal = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_checkbox_prompt_margin_horizontal);
    }

    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0007"}, mo51343d2 = {"Lcom/afollestad/materialdialogs/internal/button/DialogActionButtonLayout$Companion;", "", "()V", "INDEX_NEGATIVE", "", "INDEX_NEUTRAL", "INDEX_POSITIVE", "core"}, mo51344k = 1, mo51345mv = {1, 1, 16})
    /* compiled from: DialogActionButtonLayout.kt */
    ...
    public void onFinishInflate() {
        ...
        View findViewById = findViewById(C1036R.C1039id.md_button_positive);
        Intrinsics.checkExpressionValueIsNotNull(findViewById, "findViewById(R.id.md_button_positive)");
        View findViewById2 = findViewById(C1036R.C1039id.md_button_negative);
        Intrinsics.checkExpressionValueIsNotNull(findViewById2, "findViewById(R.id.md_button_negative)");
        View findViewById3 = findViewById(C1036R.C1039id.md_button_neutral);
        ...
        View findViewById4 = findViewById(C1036R.C1039id.md_checkbox_prompt);
        ...
        for (int i = 0; i < length; i++) {
            dialogActionButtonArr[i].setOnClickListener(new DialogActionButtonLayout$onFinishInflate$1(this, WhichButton.Companion.fromIndex(i)));
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (DialogActionButton dialogActionButton : getVisibleButtons()) {
            ...
            if (this.stackButtons) {
                dialogActionButton.measure(View.MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
            } else {
                dialogActionButton.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
            }
        }
        if ((!(getVisibleButtons().length == 0)) && !this.stackButtons) {
            ...
            if (i4 >= size && !this.stackButtons) {
                ...
                for (DialogActionButton dialogActionButton2 : getVisibleButtons()) {
                    ...
                    dialogActionButton2.measure(View.MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
                }
            }
        }
