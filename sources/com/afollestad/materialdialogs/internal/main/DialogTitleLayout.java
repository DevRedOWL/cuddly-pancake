...
public final class DialogTitleLayout extends BaseSubLayout {
    ...
    public DialogTitleLayout(Context context, AttributeSet attributeSet) {
        ...
        this.frameMarginVertical = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_dialog_frame_margin_vertical);
        this.titleMarginBottom = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_dialog_title_layout_margin_bottom);
        this.frameMarginHorizontal = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_dialog_frame_margin_horizontal);
        this.iconMargin = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_icon_margin);
        this.iconSize = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_icon_size);
    }
    ...
    public void onFinishInflate() {
        ...
        View findViewById = findViewById(C1036R.C1039id.md_icon_title);
        Intrinsics.checkExpressionValueIsNotNull(findViewById, "findViewById(R.id.md_icon_title)");
        this.iconView = (ImageView) findViewById;
        View findViewById2 = findViewById(C1036R.C1039id.md_text_title);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i10;
        if (!shouldNotBeVisible()) {
            int i11 = this.frameMarginVertical;
            ...
            int additionalPaddingForFont = i14 + mDUtil.additionalPaddingForFont(textView2);
            ...
            if (ViewsKt.isVisible(imageView)) {
                ...
                if (ViewsKt.isRtl(this)) {
                    ...
                    int measuredWidth = i5 - imageView3.getMeasuredWidth();
                    int i17 = measuredWidth - this.iconMargin;
                    TextView textView5 = this.titleView;
                    if (textView5 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("titleView");
                    }
                    int measuredWidth2 = i17 - textView5.getMeasuredWidth();
                    i7 = i5;
                    i9 = i17;
                    i8 = measuredWidth;
                    i10 = measuredWidth2;
                    ...
                    int i18 = this.iconMargin + measuredWidth3;
                    TextView textView6 = this.titleView;
                    if (textView6 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("titleView");
                    }
                    int measuredWidth4 = textView6.getMeasuredWidth() + i18;
                    i7 = measuredWidth3;
                    i9 = measuredWidth4;
                    int i19 = i18;
                    i8 = i6;
            ...
            textView7.layout(i6, i13, i5, additionalPaddingForFont);
        }
    }
