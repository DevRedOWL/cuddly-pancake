...
public final class DialogLayout extends FrameLayout {
    ...
    private final int frameMarginVertical = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_dialog_frame_margin_vertical);
    private final int frameMarginVerticalLess = MDUtil.INSTANCE.dimenPx(this, C1036R.dimen.md_dialog_frame_margin_vertical_less);
    ...
    public final void setLayoutMode(LayoutMode layoutMode2) {
    ...
    public void onFinishInflate() {
        ...
        View findViewById = findViewById(C1036R.C1039id.md_title_layout);
        ...
        View findViewById2 = findViewById(C1036R.C1039id.md_content_layout);
        ...
        this.buttonsLayout = (DialogActionButtonLayout) findViewById(C1036R.C1039id.md_button_layout);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.debugMode) {
            ...
            verticalLine$default(this, canvas2, -16776961, DimensKt.m587dp(this, 24), 0.0f, 4, (Object) null);
            horizontalLine$default(this, canvas2, -16776961, DimensKt.m587dp(this, 24), 0.0f, 4, (Object) null);
            verticalLine$default(this, canvas, -16776961, ((float) getMeasuredWidth()) - DimensKt.m587dp(this, 24), 0.0f, 4, (Object) null);
            DialogTitleLayout dialogTitleLayout = this.titleLayout;
            if (dialogTitleLayout == null) {
                Intrinsics.throwUninitializedPropertyAccessException("titleLayout");
            }
            if (ViewsKt.isVisible(dialogTitleLayout)) {
                ...
                horizontalLine$default(this, canvas, SupportMenu.CATEGORY_MASK, (float) dialogTitleLayout2.getBottom(), 0.0f, 4, (Object) null);
            }
            DialogContentLayout dialogContentLayout = this.contentLayout;
            if (dialogContentLayout == null) {
                Intrinsics.throwUninitializedPropertyAccessException("contentLayout");
            ...
            if (ViewsKt.isVisible(dialogContentLayout)) {
                ...
                horizontalLine$default(this, canvas, InputDeviceCompat.SOURCE_ANY, (float) dialogContentLayout2.getTop(), 0.0f, 4, (Object) null);
            }
            if (DialogActionButtonLayoutKt.shouldBeVisible(this.buttonsLayout)) {
                if (ViewsKt.isRtl(this)) {
                    f = DimensKt.m587dp(this, 8);
                } else {
                    f = ((float) getMeasuredWidth()) - DimensKt.m587dp(this, 8);
                }
                ...
                if (dialogActionButtonLayout == null || !dialogActionButtonLayout.getStackButtons$core()) {
                    ...
                    if (dialogActionButtonLayout2 != null) {
                        ...
                        for (DialogActionButton dialogActionButton : dialogActionButtonLayout2.getVisibleButtons()) {
                            ...
                            float top = ((float) dialogActionButtonLayout3.getTop()) + ((float) dialogActionButton.getTop()) + DimensKt.m587dp(this, 8);
                            DialogActionButtonLayout dialogActionButtonLayout4 = this.buttonsLayout;
                            if (dialogActionButtonLayout4 == null) {
                                Intrinsics.throwNpe();
                            }
                            box(canvas, -16711681, 0.4f, ((float) dialogActionButton.getLeft()) + DimensKt.m587dp(this, 4), ((float) dialogActionButton.getRight()) - DimensKt.m587dp(this, 4), top, ((float) dialogActionButtonLayout4.getBottom()) - DimensKt.m587dp(this, 8));
                        }
                        ...
                        float measuredHeight = ((float) getMeasuredHeight()) - (DimensKt.m587dp(this, 52) - DimensKt.m587dp(this, 8));
                        float measuredHeight2 = ((float) getMeasuredHeight()) - DimensKt.m587dp(this, 8);
                        Canvas canvas3 = canvas;
                        horizontalLine$default(this, canvas3, SupportMenu.CATEGORY_MASK, measuredHeight, 0.0f, 4, (Object) null);
                        horizontalLine$default(this, canvas3, SupportMenu.CATEGORY_MASK, measuredHeight2, 0.0f, 4, (Object) null);
                        horizontalLine$default(this, canvas3, -16776961, measuredHeight - DimensKt.m587dp(this, 8), 0.0f, 4, (Object) null);
                        return;
                    }
                    return;
                }
                ...
                float top2 = ((float) dialogActionButtonLayout6.getTop()) + DimensKt.m587dp(this, 8);
                ...
                for (DialogActionButton left : dialogActionButtonLayout7.getVisibleButtons()) {
                    float dp = f2 + DimensKt.m587dp(this, 36);
                    box(canvas, -16711681, 0.4f, (float) left.getLeft(), ((float) getMeasuredWidth()) - DimensKt.m587dp(this, 8), f2, dp);
                    f2 = dp + DimensKt.m587dp(this, 16);
                }
                ...
                float top3 = ((float) dialogActionButtonLayout9.getTop()) + DimensKt.m587dp(this, 8);
                float measuredHeight3 = ((float) getMeasuredHeight()) - DimensKt.m587dp(this, 8);
                Canvas canvas4 = canvas;
                horizontalLine$default(this, canvas4, SupportMenu.CATEGORY_MASK, top3, 0.0f, 4, (Object) null);
                horizontalLine$default(this, canvas4, SupportMenu.CATEGORY_MASK, measuredHeight3, 0.0f, 4, (Object) null);
            }
        }
    }
    ...
    private final Paint paint(int i, float f) {
        if (this.debugPaint == null) {
            ...
            paint.setStrokeWidth(DimensKt.m587dp(this, 1));
    ...
    private final void box(Canvas canvas, int i, float f, float f2, float f3, float f4, float f5) {
