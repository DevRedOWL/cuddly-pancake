...
public final class MDUtil {
    ...
    public final ColorStateList createColorSelector(Context context, int i, int i2) {
        ...
        Intrinsics.checkParameterIsNotNull(context, "context");
        if (i2 == 0) {
            i3 = resolveColor$default(this, context, (Integer) null, Integer.valueOf(C1036R.attr.colorControlActivated), (Function0) null, 10, (Object) null);
        } else {
            i3 = i2;
        }
        ...
        int[] iArr2 = new int[3];
        if (i == 0) {
            i4 = resolveColor$default(this, context, (Integer) null, Integer.valueOf(C1036R.attr.colorControlNormal), (Function0) null, 10, (Object) null);
        } else {
            i4 = i;
        }
        iArr2[0] = i4;
