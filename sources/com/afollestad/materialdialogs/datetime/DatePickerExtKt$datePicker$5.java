...
final class DatePickerExtKt$datePicker$5 extends Lambda implements Function1<MaterialDialog, Unit> {
    final /* synthetic */ TimeChangeListener $changeListener;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DatePickerExtKt$datePicker$5(TimeChangeListener timeChangeListener) {
        super(1);
