...
public final class Util {
    ...
    public final ColorStateList createTextSelector(Context context, int i, boolean z) {
        ...
        if (z) {
            i = ColorsKt.isColorDark$default(i, Utils.DOUBLE_EPSILON, 1, (Object) null) ? -1 : ViewCompat.MEASURED_STATE_MASK;
        }
        iArr2[2] = i;
