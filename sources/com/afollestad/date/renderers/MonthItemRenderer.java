...
public final class MonthItemRenderer {
    ...
    public MonthItemRenderer(Context context2, TypedArray typedArray, Typeface typeface, MinMaxController minMaxController2) {
        ...
        this.selectionColor = AttrsKt.color(typedArray, C1027R.styleable.DatePicker_date_picker_selection_color, new MonthItemRenderer$selectionColor$1(this));
        this.disabledBackgroundColor = AttrsKt.color(typedArray, C1027R.styleable.DatePicker_date_picker_disabled_background_color, new MonthItemRenderer$disabledBackgroundColor$1(this));
    }
    ...
    public final void render(MonthItem monthItem, View view, TextView textView, Function1<? super MonthItem.DayOfMonth, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(monthItem, "item");
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo51343d2 = {"Lcom/afollestad/date/renderers/MonthItemRenderer$Companion;", "", "()V", "DEFAULT_DISABLED_BACKGROUND_OPACITY", "", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: MonthItemRenderer.kt */
