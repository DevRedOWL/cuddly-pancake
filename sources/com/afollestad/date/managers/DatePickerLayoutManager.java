...
public final class DatePickerLayoutManager {
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, mo51343d2 = {"Lcom/afollestad/date/managers/DatePickerLayoutManager$Mode;", "", "(Ljava/lang/String;I)V", "CALENDAR", "MONTH_LIST", "YEAR_LIST", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: DatePickerLayoutManager.kt */
    public enum Mode {
        CALENDAR,
        MONTH_LIST,
    ...
    public final /* synthetic */ class WhenMappings {
        ...
        static {
            $EnumSwitchMapping$0[Mode.CALENDAR.ordinal()] = 1;
    ...
    public DatePickerLayoutManager(Context context, TypedArray typedArray, ViewGroup viewGroup, VibratorController vibratorController) {
        ...
        this.selectionColor = AttrsKt.color(typedArray, C1027R.styleable.DatePicker_date_picker_selection_color, new DatePickerLayoutManager$selectionColor$1(context));
        this.headerBackgroundColor = AttrsKt.color(typedArray, C1027R.styleable.DatePicker_date_picker_header_background_color, new DatePickerLayoutManager$headerBackgroundColor$1(context));
        this.normalFont = AttrsKt.font(typedArray, context, C1027R.styleable.DatePicker_date_picker_normal_font, DatePickerLayoutManager$normalFont$1.INSTANCE);
        this.mediumFont = AttrsKt.font(typedArray, context, C1027R.styleable.DatePicker_date_picker_medium_font, DatePickerLayoutManager$mediumFont$1.INSTANCE);
        this.calendarHorizontalPadding = typedArray.getDimensionPixelSize(C1027R.styleable.DatePicker_date_picker_calendar_horizontal_padding, 0);
        View findViewById = viewGroup.findViewById(C1027R.C1030id.current_year);
        ...
        View findViewById2 = viewGroup.findViewById(C1027R.C1030id.current_date);
        ...
        View findViewById3 = viewGroup.findViewById(C1027R.C1030id.left_chevron);
        ...
        View findViewById4 = viewGroup.findViewById(C1027R.C1030id.current_month);
        ...
        View findViewById5 = viewGroup.findViewById(C1027R.C1030id.right_chevron);
        ...
        View findViewById6 = viewGroup.findViewById(C1027R.C1030id.year_month_list_divider);
        ...
        View findViewById7 = viewGroup.findViewById(C1027R.C1030id.day_list);
        ...
        View findViewById8 = viewGroup.findViewById(C1027R.C1030id.year_list);
        ...
        View findViewById9 = viewGroup.findViewById(C1027R.C1030id.month_list);
        ...
        this.currentMonthTopMargin = context.getResources().getDimensionPixelSize(C1027R.dimen.current_month_top_margin);
        this.chevronsTopMargin = context.getResources().getDimensionPixelSize(C1027R.dimen.chevrons_top_margin);
        this.currentMonthHeight = context.getResources().getDimensionPixelSize(C1027R.dimen.current_month_header_height);
        this.dividerHeight = context.getResources().getDimensionPixelSize(C1027R.dimen.divider_height);
        this.headersWithFactor = context.getResources().getInteger(C1027R.integer.headers_width_factor);
    ...
    public final Size onMeasure(int i, int i2) {
        ...
        this.selectedYearView.measure(View.MeasureSpec.makeMeasureSpec(i7, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(0, 0));
        ...
        if (size3 <= 0 || this.orientation == Orientation.PORTRAIT) {
            ...
            i3 = View.MeasureSpec.makeMeasureSpec(size3 - this.selectedYearView.getMeasuredHeight(), BasicMeasure.EXACTLY);
        }
        textView.measure(makeMeasureSpec, i3);
        int i8 = this.orientation == Orientation.PORTRAIT ? size2 : size2 - i7;
        this.visibleMonthView.measure(View.MeasureSpec.makeMeasureSpec(i8, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(this.currentMonthHeight, BasicMeasure.EXACTLY));
        this.listsDividerView.measure(View.MeasureSpec.makeMeasureSpec(i8, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.dividerHeight, BasicMeasure.EXACTLY));
        ...
        int i11 = i10 / 7;
        this.goPreviousMonthView.measure(View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY));
        this.goNextMonthView.measure(View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(i11, BasicMeasure.EXACTLY));
        this.yearsRecyclerView.measure(View.MeasureSpec.makeMeasureSpec(this.daysRecyclerView.getMeasuredWidth(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.daysRecyclerView.getMeasuredHeight(), BasicMeasure.EXACTLY));
        this.monthRecyclerView.measure(View.MeasureSpec.makeMeasureSpec(this.daysRecyclerView.getMeasuredWidth(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.daysRecyclerView.getMeasuredHeight(), BasicMeasure.EXACTLY));
    ...
    private final void setupNavigationViews() {
        ...
        DebouncerKt.onClickDebounced(textView, new C1034xe517edd(this));
    ...
    private final void setupListViews() {
        RecyclerView recyclerView = this.daysRecyclerView;
        recyclerView.setLayoutManager(new GridLayoutManager(recyclerView.getContext(), recyclerView.getResources().getInteger(C1027R.integer.day_grid_span)));
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0001\u0018\u0000 \u00052\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\u0005B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0006"}, mo51343d2 = {"Lcom/afollestad/date/managers/DatePickerLayoutManager$Orientation;", "", "(Ljava/lang/String;I)V", "PORTRAIT", "LANDSCAPE", "Companion", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: DatePickerLayoutManager.kt */
    public enum Orientation {
        ...
        @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, mo51343d2 = {"Lcom/afollestad/date/managers/DatePickerLayoutManager$Orientation$Companion;", "", "()V", "get", "Lcom/afollestad/date/managers/DatePickerLayoutManager$Orientation;", "context", "Landroid/content/Context;", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
        /* compiled from: DatePickerLayoutManager.kt */
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\f\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\b\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0002\u0010\u0005J\t\u0010\f\u001a\u00020\u0003HÆ\u0003J\t\u0010\r\u001a\u00020\u0003HÆ\u0003J\u001d\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0012\u001a\u00020\u0003HÖ\u0001J\t\u0010\u0013\u001a\u00020\u0014HÖ\u0001R\u001a\u0010\u0004\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\tR\u001a\u0010\u0002\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0007\"\u0004\b\u000b\u0010\t¨\u0006\u0015"}, mo51343d2 = {"Lcom/afollestad/date/managers/DatePickerLayoutManager$Size;", "", "width", "", "height", "(II)V", "getHeight", "()I", "setHeight", "(I)V", "getWidth", "setWidth", "component1", "component2", "copy", "equals", "", "other", "hashCode", "toString", "", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: DatePickerLayoutManager.kt */
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\r"}, mo51343d2 = {"Lcom/afollestad/date/managers/DatePickerLayoutManager$Companion;", "", "()V", "DAYS_IN_WEEK", "", "inflateInto", "Lcom/afollestad/date/managers/DatePickerLayoutManager;", "context", "Landroid/content/Context;", "typedArray", "Landroid/content/res/TypedArray;", "container", "Landroid/view/ViewGroup;", "com.afollestad.date-picker"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: DatePickerLayoutManager.kt */
    public static final class Companion {
        private Companion() {
        }
        ...
        public final DatePickerLayoutManager inflateInto(Context context, TypedArray typedArray, ViewGroup viewGroup) {
            ...
            View.inflate(context, C1027R.layout.date_picker, viewGroup);
