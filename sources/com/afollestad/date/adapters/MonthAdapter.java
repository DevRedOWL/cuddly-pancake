...
public final class MonthAdapter extends RecyclerView.Adapter<MonthViewHolder> {
    ...
    public MonthViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        MonthViewHolder monthViewHolder = new MonthViewHolder(ViewsKt.inflate(viewGroup, C1027R.layout.year_list_row), this);
    ...
    public void onBindViewHolder(MonthViewHolder monthViewHolder, int i) {
        ...
        TextView textView = monthViewHolder.getTextView();
        if (z) {
            i2 = C1027R.dimen.year_month_list_text_size_selected;
        } else {
            i2 = C1027R.dimen.year_month_list_text_size;
        }
    ...
    private final String nameOfMonth(int i) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(calendar2, DatePickerField.JsonFields.fieldName);
        CalendarsKt.setMonth(calendar2, i);
        DateFormatter dateFormatter2 = this.dateFormatter;
        Calendar calendar3 = this.calendar;
        Intrinsics.checkExpressionValueIsNotNull(calendar3, DatePickerField.JsonFields.fieldName);
