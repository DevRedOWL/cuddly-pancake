...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f2246FS = '\u001c';

    /* renamed from: GS */
    private static final char f2247GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f2248NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f2249RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f2247GS + format + f2247GS + format2 + f2247GS);
            } else {
                sb.insert(0, str + f2247GS + format + f2247GS + format2 + f2247GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, Pdu.GATT_SERVICE_UUID_PDU_TYPE, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{21, Pdu.GATT_SERVICE_UUID_PDU_TYPE, 23, 24, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
