...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.chip = (Chip) from.inflate(C1803R.layout.material_time_chip, this, false);
        this.textInputLayout = (TextInputLayout) from.inflate(C1803R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C1803R.C1806id.material_label);
    }
