...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1803R.attr.materialClockStyle);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1803R.styleable.ClockFaceView, i, C1803R.style.Widget_MaterialComponents_TimePicker_Clock);
        Resources resources = getResources();
        this.textColor = MaterialResources.getColorStateList(context, obtainStyledAttributes, C1803R.styleable.ClockFaceView_clockNumberTextColor);
        LayoutInflater.from(context).inflate(C1803R.layout.material_clockface_view, this, true);
        this.clockHandView = (ClockHandView) findViewById(C1803R.C1806id.material_clock_hand);
        this.clockHandPadding = resources.getDimensionPixelSize(C1803R.dimen.material_clock_hand_padding);
        ...
        int defaultColor = AppCompatResources.getColorStateList(context, C1803R.C1804color.material_timepicker_clockface).getDefaultColor();
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(context, obtainStyledAttributes, C1803R.styleable.ClockFaceView_clockFaceBackgroundColor);
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                int intValue = ((Integer) view.getTag(C1803R.C1806id.material_value_index)).intValue();
                if (intValue > 0) {
    ...
    private void updateTextViews(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, this.textViewPool.size()); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                if (textView == null) {
                    textView = (TextView) from.inflate(C1803R.layout.material_clockface_textview, this, false);
                    addView(textView);
                    this.textViewPool.put(i2, textView);
                }
                textView.setText(this.values[i2]);
                textView.setTag(C1803R.C1806id.material_value_index, Integer.valueOf(i2));
