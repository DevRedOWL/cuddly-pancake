...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<AnimatorSet> {
    ...
    public LinearIndeterminateDisjointAnimatorDelegate(Context context2, LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        super(2);
    ...
    private void maybeInitializeAnimators() {
        if (this.animatorSet == null) {
            ...
            ofFloat.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1803R.animator.linear_indeterminate_line1_head_interpolator));
            ...
            ofFloat2.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1803R.animator.linear_indeterminate_line1_tail_interpolator));
            ...
            ofFloat3.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1803R.animator.linear_indeterminate_line2_head_interpolator));
            ...
            ofFloat4.setInterpolator(AnimationUtilsCompat.loadInterpolator(this.context, C1803R.animator.linear_indeterminate_line2_tail_interpolator));
