...
class Camera2 extends CameraViewImpl implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(android.media.ImageReader r6) {
            ...
            L_0x0056:
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.cameraview.Camera2.C17324.onImageAvailable(android.media.ImageReader):void");
        }
    };
    ...
    public void setFocusArea(float f, float f2) {
        if (this.mCaptureSession != null) {
            C17368 r2 = new CameraCaptureSession.CaptureCallback() {
    ...
    private MeteringRectangle calculateFocusArea(float f, float f2) {
        Rect rect = (Rect) this.mCameraCharacteristics.get(CameraCharacteristics.SENSOR_INFO_ACTIVE_ARRAY_SIZE);
        return new MeteringRectangle(Math.max(((int) (f * ((float) rect.width()))) - 150, 0), Math.max(((int) (f2 * ((float) rect.height()))) - 150, 0), 300, 300, RoomDatabase.MAX_BIND_PARAMETER_CNT);
    }
