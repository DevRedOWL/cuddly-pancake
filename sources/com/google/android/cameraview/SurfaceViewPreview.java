...
import org.reactnative.camera.C5544R;
...
class SurfaceViewPreview extends PreviewImpl {
    ...
    SurfaceViewPreview(Context context, ViewGroup viewGroup) {
        this.mSurfaceView = (SurfaceView) View.inflate(context, C5544R.layout.surface_view, viewGroup).findViewById(C5544R.C5547id.surface_view);
