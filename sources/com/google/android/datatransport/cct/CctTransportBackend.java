...
final class CctTransportBackend implements TransportBackend {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m711e(LOG_TAG, "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal2 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m705of("proto"))) {
                    builder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m705of("json"))) {
                    builder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m713w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public com.google.android.datatransport.cct.CctTransportBackend.HttpResponse doSend(com.google.android.datatransport.cct.CctTransportBackend.HttpRequest r13) throws java.io.IOException {
        /*
            ...
            com.google.android.datatransport.runtime.logging.Logging.m708d((java.lang.String) r1, (java.lang.String) r2, (java.lang.Object) r0)
            java.net.URL r0 = r13.url
            ...
            java.lang.String r2 = r13.apiKey
        ...
        L_0x007c:
            ...
            com.google.android.datatransport.runtime.logging.Logging.m712i(r1, r7)
            java.lang.StringBuilder r7 = new java.lang.StringBuilder
            r7.<init>()
            ...
            com.google.android.datatransport.runtime.logging.Logging.m712i(r1, r4)
            java.lang.StringBuilder r4 = new java.lang.StringBuilder
            r4.<init>()
            java.lang.String r7 = "Content-Encoding: "
            r4.append(r7)
            java.lang.String r7 = r0.getHeaderField(r3)
            r4.append(r7)
        ...
        L_0x00db:
            ...
            java.lang.String r0 = r0.getHeaderField(r3)     // Catch:{ all -> 0x0110 }
            java.io.InputStream r0 = maybeUnGzip(r1, r0)     // Catch:{ all -> 0x0110 }
            java.io.BufferedReader r3 = new java.io.BufferedReader     // Catch:{ all -> 0x0109 }
            java.io.InputStreamReader r4 = new java.io.InputStreamReader     // Catch:{ all -> 0x0109 }
            r4.<init>(r0)     // Catch:{ all -> 0x0109 }
            r3.<init>(r4)     // Catch:{ all -> 0x0109 }
            com.google.android.datatransport.cct.internal.LogResponse r3 = com.google.android.datatransport.cct.internal.LogResponse.fromJson(r3)     // Catch:{ all -> 0x0109 }
            long r3 = r3.getNextRequestWaitMillis()     // Catch:{ all -> 0x0109 }
            com.google.android.datatransport.cct.CctTransportBackend$HttpResponse r5 = new com.google.android.datatransport.cct.CctTransportBackend$HttpResponse     // Catch:{ all -> 0x0109 }
            r5.<init>(r13, r2, r3)     // Catch:{ all -> 0x0109 }
        ...
        L_0x0137:
            ...
            com.google.android.datatransport.runtime.logging.Logging.m711e(r1, r0, r13)
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (httpResponse.code == 200) {
                return BackendResponse.m706ok(httpResponse.nextRequestMillis);
            }
            ...
            Logging.m711e(LOG_TAG, "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m708d(LOG_TAG, "Following redirect to: %s", (Object) httpResponse.redirectUrl);
