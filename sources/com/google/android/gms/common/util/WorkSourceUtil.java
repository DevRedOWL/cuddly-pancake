...
public class WorkSourceUtil {
    ...
    private static Method zza() {
        try {
            return WorkSource.class.getMethod(Scenario.ADD, new Class[]{Integer.TYPE});
    ...
    private static Method zzb() {
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            try {
                return WorkSource.class.getMethod(Scenario.ADD, new Class[]{Integer.TYPE, String.class});
            } catch (Exception unused) {
            }
        }
        return null;
