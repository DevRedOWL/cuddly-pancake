...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C1787R.string.common_google_play_services_unknown_issue);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0006, code lost:
        r1 = ((android.os.UserManager) com.google.android.gms.common.internal.Preconditions.checkNotNull(r1.getSystemService("user"))).getApplicationRestrictions(r1.getPackageName());
     */
