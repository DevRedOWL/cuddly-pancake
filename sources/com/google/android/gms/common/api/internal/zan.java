...
final class zan implements Runnable {
    ...
    public final void run() {
        if (this.zaa.zaa) {
            ...
            if (zab2.hasResolution()) {
            ...
            } else if (this.zaa.zac.getErrorResolutionIntent(this.zaa.getActivity(), zab2.getErrorCode(), (String) null) != null) {
                ...
                this.zaa.zac.zaa(this.zaa.getActivity().getApplicationContext(), (zabm) new zam(this, GoogleApiAvailability.zaa(this.zaa.getActivity(), (DialogInterface.OnCancelListener) this.zaa)));
            } else {
