...
public final class zzas {
    ...
    public static zzej<Boolean> zzaw = zza("measurement.quality.checksum", false, false, (zzeh) null);
    ...
    static {
        ...
        zzc = zza("measurement.config.cache_time", valueOf, valueOf2, zzbh.zza);
        zzr = zza("measurement.upload.window_interval", valueOf2, valueOf2, zzbc.zza);
        zzs = zza("measurement.upload.interval", valueOf2, valueOf2, zzbf.zza);
        Long valueOf3 = Long.valueOf(DateUtils.MILLIS_PER_MINUTE);
        zzw = zza("measurement.alarm_manager.minimum_interval", valueOf3, valueOf3, zzbi.zza);
        zzx = zza("measurement.upload.stale_data_deletion_interval", valueOf, valueOf, zzbl.zza);
        Long valueOf4 = Long.valueOf(GCMRegistrar.DEFAULT_ON_SERVER_LIFESPAN_MS);
        zzy = zza("measurement.upload.refresh_blacklisted_config_interval", valueOf4, valueOf4, zzbk.zza);
        Long valueOf5 = Long.valueOf(CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS);
        zzaa = zza("measurement.upload.retry_time", valueOf5, valueOf5, zzbm.zza);
        Double valueOf6 = Double.valueOf(-3.0d);
        zzan = zza("measurement.test.double_flag", valueOf6, valueOf6, zzbz.zza);
        Long valueOf7 = Long.valueOf(GCMRegistrar.DEFAULT_ON_SERVER_LIFESPAN_MS);
        zzcd = zza("measurement.sdk.attribution.cache.ttl", valueOf7, valueOf7, zzdt.zza);
    }
}
