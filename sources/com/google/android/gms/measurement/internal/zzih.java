    ...
    public final byte[] zza(zzaq zzaq, String str) {
        ...
        if (!zzs().zze(str2, zzas.zzav)) {
            ...
            if (zzb2 == null) {
                ...
                zzcd.zzg.zza zza3 = zzcd.zzg.zzbh().zza(1).zza(AbstractSpiCall.ANDROID_CLIENT_TYPE);
                ...
                try {
                    ...
                    for (int i = 0; i < zza6.size(); i++) {
                        ...
                        mo29467f_().zza(zza7, zza6.get(i).zze);
                    ...
                    while (it3.hasNext()) {
                        ...
                        mo29467f_().zza(zza10, zzan.zze.zza(next));
                        zzb3.zza(zza10);
                    }
                    ...
                    zzf.zzv();
                    zza11.zzg((int) zzf.zzs()).zzg(33025).zza(zzl().currentTimeMillis()).zzb(Boolean.TRUE.booleanValue());
                    ...
                    zzi().mo29304b_();
                    try {
                        return mo29467f_().zzc(((zzcd.zzf) ((zzhy) zza12.zzy())).zzbk());
