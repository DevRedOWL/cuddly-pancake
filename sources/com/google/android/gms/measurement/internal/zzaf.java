...
final class zzaf extends zzki {
    ...
    public final void zze() {
        zzaj();
        mo29305c_().beginTransaction();
    }

    /* renamed from: b_ */
    public final void mo29304b_() {
        zzaj();
        mo29305c_().setTransactionSuccessful();
    }

    public final void zzg() {
        zzaj();
        mo29305c_().endTransaction();
    }

    private final long zzb(String str, String[] strArr) {
        Cursor cursor = null;
        try {
            cursor = mo29305c_().rawQuery(str, strArr);
    ...
    private final long zza(String str, String[] strArr, long j) {
        Cursor cursor = null;
        try {
            Cursor rawQuery = mo29305c_().rawQuery(str, strArr);
    ...
    /* renamed from: c_ */
    public final SQLiteDatabase mo29305c_() {
        zzc();
        try {
    ...
    public final com.google.android.gms.measurement.internal.zzam zza(java.lang.String r26, java.lang.String r27) {
        /*
            ...
            r0.<init>(r1)
            r18 = 0
            android.database.sqlite.SQLiteDatabase r1 = r25.mo29305c_()     // Catch:{ SQLiteException -> 0x0120, all -> 0x011c }
        ...
        L_0x00d9:
            ...
            r8 = r1
        L_0x00de:
            com.google.android.gms.measurement.internal.zzam r22 = new com.google.android.gms.measurement.internal.zzam     // Catch:{ SQLiteException -> 0x0118, all -> 0x0114 }
            r1 = r22
            r2 = r26
            r3 = r27
            r10 = r11
            ...
            com.google.android.gms.measurement.internal.zzeq r0 = r25.zzq()     // Catch:{ SQLiteException -> 0x0112 }
            com.google.android.gms.measurement.internal.zzes r0 = r0.zze()     // Catch:{ SQLiteException -> 0x0112 }
            java.lang.String r1 = "Got multiple records for event aggregates, expected one. appId"
            java.lang.Object r2 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r26)     // Catch:{ SQLiteException -> 0x0112 }
        ...
        L_0x0120:
            ...
            r23 = r18
        L_0x0123:
            com.google.android.gms.measurement.internal.zzeq r1 = r25.zzq()     // Catch:{ all -> 0x0144 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x0144 }
            java.lang.String r2 = "Error querying events. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r26)     // Catch:{ all -> 0x0144 }
            com.google.android.gms.measurement.internal.zzeo r4 = r25.zzn()     // Catch:{ all -> 0x0144 }
            r5 = r27
    ...
    public final void zza(zzam zzam) {
        ...
        try {
            if (mo29305c_().insertWithOnConflict("events", (String) null, contentValues, 5) == -1) {
    ...
    public final void zzb(String str, String str2) {
        ...
        zzaj();
        try {
            mo29305c_().delete("user_attributes", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
    ...
    public final boolean zza(zzkw zzkw) {
        ...
        try {
            if (mo29305c_().insertWithOnConflict("user_attributes", (String) null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzkw zzc(java.lang.String r19, java.lang.String r20) {
        /*
            ...
            r18.zzaj()
            r9 = 0
            android.database.sqlite.SQLiteDatabase r10 = r18.mo29305c_()     // Catch:{ SQLiteException -> 0x0083, all -> 0x007e }
        ...
        L_0x003f:
            ...
            com.google.android.gms.measurement.internal.zzkw r0 = new com.google.android.gms.measurement.internal.zzkw     // Catch:{ SQLiteException -> 0x0074 }
            r1 = r0
            r2 = r19
            r4 = r20
            ...
            com.google.android.gms.measurement.internal.zzeq r1 = r18.zzq()     // Catch:{ SQLiteException -> 0x0074 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ SQLiteException -> 0x0074 }
            java.lang.String r2 = "Got multiple records for user property, expected one. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r19)     // Catch:{ SQLiteException -> 0x0074 }
        ...
        L_0x0083:
            ...
            r10 = r9
        L_0x0087:
            com.google.android.gms.measurement.internal.zzeq r1 = r18.zzq()     // Catch:{ all -> 0x00a6 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x00a6 }
            java.lang.String r2 = "Error querying user property. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r19)     // Catch:{ all -> 0x00a6 }
            com.google.android.gms.measurement.internal.zzeo r4 = r18.zzn()     // Catch:{ all -> 0x00a6 }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzkw> zza(java.lang.String r14) {
        /*
            ...
            r0.<init>()
            r1 = 0
            android.database.sqlite.SQLiteDatabase r2 = r13.mo29305c_()     // Catch:{ SQLiteException -> 0x0085, all -> 0x0082 }
        ...
        L_0x004b:
            ...
            com.google.android.gms.measurement.internal.zzeq r3 = r13.zzq()     // Catch:{ SQLiteException -> 0x0080 }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ SQLiteException -> 0x0080 }
            java.lang.String r4 = "Read invalid user property value, ignoring it. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r14)     // Catch:{ SQLiteException -> 0x0080 }
            r3.zza(r4, r5)     // Catch:{ SQLiteException -> 0x0080 }
            goto L_0x0074
        L_0x006a:
            com.google.android.gms.measurement.internal.zzkw r3 = new com.google.android.gms.measurement.internal.zzkw     // Catch:{ SQLiteException -> 0x0080 }
            r4 = r3
            r5 = r14
        ...
        L_0x0085:
            ...
            r2 = r1
        L_0x0087:
            com.google.android.gms.measurement.internal.zzeq r3 = r13.zzq()     // Catch:{ all -> 0x00ba }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ all -> 0x00ba }
            java.lang.String r4 = "Error querying user properties. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r14)     // Catch:{ all -> 0x00ba }
            r3.zza(r4, r5, r0)     // Catch:{ all -> 0x00ba }
            boolean r0 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ all -> 0x00ba }
            if (r0 == 0) goto L_0x00b4
            com.google.android.gms.measurement.internal.zzab r0 = r13.zzs()     // Catch:{ all -> 0x00ba }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r3 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ all -> 0x00ba }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzkw> zza(java.lang.String r21, java.lang.String r22, java.lang.String r23) {
        ...
        L_0x004c:
            ...
            android.database.sqlite.SQLiteDatabase r11 = r20.mo29305c_()     // Catch:{ SQLiteException -> 0x00f7, all -> 0x00fb }
        ...
        L_0x0087:
            ...
            com.google.android.gms.measurement.internal.zzeq r1 = r20.zzq()     // Catch:{ SQLiteException -> 0x00f3, all -> 0x00ef }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ SQLiteException -> 0x00f3, all -> 0x00ef }
        ...
        L_0x00a3:
            ...
            com.google.android.gms.measurement.internal.zzeq r1 = r20.zzq()     // Catch:{ SQLiteException -> 0x00ea }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ SQLiteException -> 0x00ea }
            java.lang.String r2 = "(2)Read invalid user property value, ignoring it"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r21)     // Catch:{ SQLiteException -> 0x00ea }
            r14 = r23
            r1.zza(r2, r3, r13, r14)     // Catch:{ SQLiteException -> 0x00ea }
            goto L_0x00dc
        L_0x00ce:
            r14 = r23
            com.google.android.gms.measurement.internal.zzkw r15 = new com.google.android.gms.measurement.internal.zzkw     // Catch:{ SQLiteException -> 0x00ea }
            r1 = r15
            r2 = r21
            r3 = r13
        ...
        L_0x0104:
            r11 = r9
        L_0x0105:
            com.google.android.gms.measurement.internal.zzeq r1 = r20.zzq()     // Catch:{ all -> 0x0138 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x0138 }
            java.lang.String r2 = "(2)Error querying user properties"
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r21)     // Catch:{ all -> 0x0138 }
            r1.zza(r2, r4, r3, r0)     // Catch:{ all -> 0x0138 }
            boolean r0 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ all -> 0x0138 }
            if (r0 == 0) goto L_0x0132
            com.google.android.gms.measurement.internal.zzab r0 = r20.zzs()     // Catch:{ all -> 0x0138 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r1 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ all -> 0x0138 }
    ...
    public final boolean zza(zzz zzz) {
        ...
        try {
            if (mo29305c_().insertWithOnConflict("conditional_properties", (String) null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzz zzd(java.lang.String r30, java.lang.String r31) {
        /*
            ...
            r29.zzaj()
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r29.mo29305c_()     // Catch:{ SQLiteException -> 0x00ff, all -> 0x00fa }
        ...
        L_0x0063:
            ...
            com.google.android.gms.measurement.internal.zzkr r0 = r29.mo29467f_()     // Catch:{ SQLiteException -> 0x00f0 }
            r1 = 5
            ...
            com.google.android.gms.measurement.internal.zzku r17 = new com.google.android.gms.measurement.internal.zzku     // Catch:{ SQLiteException -> 0x00f0 }
            r1 = r17
            r2 = r31
            r6 = r16
            r1.<init>(r2, r3, r5, r6)     // Catch:{ SQLiteException -> 0x00f0 }
            com.google.android.gms.measurement.internal.zzz r0 = new com.google.android.gms.measurement.internal.zzz     // Catch:{ SQLiteException -> 0x00f0 }
            r14 = r0
            r15 = r30
            ...
            com.google.android.gms.measurement.internal.zzeq r1 = r29.zzq()     // Catch:{ SQLiteException -> 0x00f0 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ SQLiteException -> 0x00f0 }
            java.lang.String r2 = "Got multiple records for conditional property, expected one"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r30)     // Catch:{ SQLiteException -> 0x00f0 }
            com.google.android.gms.measurement.internal.zzeo r4 = r29.zzn()     // Catch:{ SQLiteException -> 0x00f0 }
        ...
        L_0x00ff:
            ...
            r9 = r8
        L_0x0103:
            com.google.android.gms.measurement.internal.zzeq r1 = r29.zzq()     // Catch:{ all -> 0x0122 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x0122 }
            java.lang.String r2 = "Error querying conditional property"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r30)     // Catch:{ all -> 0x0122 }
            com.google.android.gms.measurement.internal.zzeo r4 = r29.zzn()     // Catch:{ all -> 0x0122 }
    ...
    public final int zze(String str, String str2) {
        ...
        zzaj();
        try {
            return mo29305c_().delete("conditional_properties", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
        ...
        try {
            ...
            while (true) {
                if (arrayList.size() < 1000) {
                    ...
                    boolean z2 = z;
                    zzz zzz = r3;
                    zzz zzz2 = new zzz(string, string2, new zzku(string3, j3, zza, string2), j2, z2, string4, (zzaq) mo29467f_().zza(cursor.getBlob(7), zzaq.CREATOR), j, (zzaq) mo29467f_().zza(cursor.getBlob(9), zzaq.CREATOR), cursor.getLong(11), (zzaq) mo29467f_().zza(cursor.getBlob(12), zzaq.CREATOR));
                    arrayList.add(zzz);
    ...
    public final com.google.android.gms.measurement.internal.zzf zzb(java.lang.String r35) {
        /*
            ...
            r34.zzaj()
            r2 = 0
            android.database.sqlite.SQLiteDatabase r3 = r34.mo29305c_()     // Catch:{ SQLiteException -> 0x020f, all -> 0x020a }
        ...
        L_0x006b:
            ...
            r5 = r34
            com.google.android.gms.measurement.internal.zzkl r6 = r5.zza     // Catch:{ SQLiteException -> 0x0200 }
            com.google.android.gms.measurement.internal.zzfu r6 = r6.zzu()     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x0124:
            ...
            com.google.android.gms.measurement.internal.zzab r6 = r34.zzs()     // Catch:{ SQLiteException -> 0x0200 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r7 = com.google.android.gms.measurement.internal.zzas.zzbx     // Catch:{ SQLiteException -> 0x0200 }
            boolean r6 = r6.zza((com.google.android.gms.measurement.internal.zzej<java.lang.Boolean>) r7)     // Catch:{ SQLiteException -> 0x0200 }
            r7 = 0
        ...
        L_0x01c5:
            boolean r0 = com.google.android.gms.internal.measurement.zznv.zzb()     // Catch:{ SQLiteException -> 0x0200 }
            if (r0 == 0) goto L_0x01e0
            com.google.android.gms.measurement.internal.zzab r0 = r34.zzs()     // Catch:{ SQLiteException -> 0x0200 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r6 = com.google.android.gms.measurement.internal.zzas.zzbi     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x01e0:
            ...
            com.google.android.gms.measurement.internal.zzeq r0 = r34.zzq()     // Catch:{ SQLiteException -> 0x0200 }
            com.google.android.gms.measurement.internal.zzes r0 = r0.zze()     // Catch:{ SQLiteException -> 0x0200 }
            java.lang.String r6 = "Got multiple records for app, expected one. appId"
            java.lang.Object r7 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r35)     // Catch:{ SQLiteException -> 0x0200 }
        ...
        L_0x020f:
            ...
            r3 = r2
        L_0x0213:
            com.google.android.gms.measurement.internal.zzeq r4 = r34.zzq()     // Catch:{ all -> 0x022a }
            com.google.android.gms.measurement.internal.zzes r4 = r4.zze()     // Catch:{ all -> 0x022a }
            java.lang.String r6 = "Error querying app. appId"
            java.lang.Object r1 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r35)     // Catch:{ all -> 0x022a }
    ...
    public final long zzc(String str) {
        ...
        zzaj();
        try {
            return (long) mo29305c_().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(1000000, zzs().zzb(str, zzas.zzo))))});
        } catch (SQLiteException e) {
    ...
    public final byte[] zzd(java.lang.String r11) {
        /*
            ...
            r10.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r10.mo29305c_()     // Catch:{ SQLiteException -> 0x0057, all -> 0x0054 }
        ...
        L_0x0031:
            ...
            com.google.android.gms.measurement.internal.zzeq r3 = r10.zzq()     // Catch:{ SQLiteException -> 0x0052 }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ SQLiteException -> 0x0052 }
            java.lang.String r4 = "Got multiple records for app config, expected one. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r11)     // Catch:{ SQLiteException -> 0x0052 }
        ...
        L_0x0057:
            ...
            r1 = r0
        L_0x0059:
            com.google.android.gms.measurement.internal.zzeq r3 = r10.zzq()     // Catch:{ all -> 0x0070 }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ all -> 0x0070 }
            java.lang.String r4 = "Error querying remote config. appId"
            java.lang.Object r11 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r11)     // Catch:{ all -> 0x0070 }
    ...
    public final boolean zza(zzcd.zzg zzg2, boolean z) {
        ...
        try {
            byte[] zzc2 = mo29467f_().zzc(zzg2.zzbk());
            ...
            try {
                if (mo29305c_().insert("queue", (String) null, contentValues) != -1) {
                    return true;
                }
    ...
    /* renamed from: d_ */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.String mo29306d_() {
        /*
            r6 = this;
            android.database.sqlite.SQLiteDatabase r0 = r6.mo29305c_()
            r1 = 0
        ...
        L_0x0044:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzaf.mo29306d_():java.lang.String");
    }

    /* renamed from: e_ */
    public final boolean mo29307e_() {
    ...
    public final List<Pair<zzcd.zzg, Long>> zza(String str, int i, int i2) {
        ...
        Cursor cursor = null;
        try {
            cursor = mo29305c_().query("queue", new String[]{"rowid", "data", "retry_count"}, "app_id=?", new String[]{str}, (String) null, (String) null, "rowid", String.valueOf(i));
            if (!cursor.moveToFirst()) {
            ...
            do {
                long j = cursor.getLong(0);
                try {
                    byte[] zzb2 = mo29467f_().zzb(cursor.getBlob(1));
    ...
    public final void zzu() {
        ...
        if (zzal()) {
            ...
            if (Math.abs(elapsedRealtime - zza) > zzas.zzx.zza(null).longValue()) {
                ...
                zzc();
                zzaj();
                if (zzal() && (delete = mo29305c_().delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(zzl().currentTimeMillis()), String.valueOf(zzab.zzu())})) > 0) {
    ...
    private final boolean zza(String str, int i, zzbv.zzb zzb2) {
        ...
        try {
            if (mo29305c_().insertWithOnConflict("event_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    private final boolean zza(String str, int i, zzbv.zze zze2) {
        ...
        contentValues.put("data", zzbk);
        try {
            if (mo29305c_().insertWithOnConflict("property_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.zzbv.zzb>> zzf(java.lang.String r13, java.lang.String r14) {
        /*
            ...
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r12.mo29305c_()
            r9 = 0
        ...
        L_0x0042:
            ...
            com.google.android.gms.internal.measurement.zzji r1 = com.google.android.gms.measurement.internal.zzkr.zza(r2, (byte[]) r1)     // Catch:{ IOException -> 0x0078 }
            ...
            com.google.android.gms.internal.measurement.zzjj r1 = r1.zzy()     // Catch:{ IOException -> 0x0078 }
            com.google.android.gms.internal.measurement.zzhy r1 = (com.google.android.gms.internal.measurement.zzhy) r1     // Catch:{ IOException -> 0x0078 }
        ...
        L_0x0078:
            r1 = move-exception
            com.google.android.gms.measurement.internal.zzeq r2 = r12.zzq()     // Catch:{ SQLiteException -> 0x0096 }
            com.google.android.gms.measurement.internal.zzes r2 = r2.zze()     // Catch:{ SQLiteException -> 0x0096 }
            java.lang.String r3 = "Failed to merge filter. appId"
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r13)     // Catch:{ SQLiteException -> 0x0096 }
        ...
        L_0x009b:
            ...
            r14 = r9
        L_0x009d:
            com.google.android.gms.measurement.internal.zzeq r1 = r12.zzq()     // Catch:{ all -> 0x00d0 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x00d0 }
            java.lang.String r2 = "Database error querying filters. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r13)     // Catch:{ all -> 0x00d0 }
            r1.zza(r2, r3, r0)     // Catch:{ all -> 0x00d0 }
            boolean r0 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ all -> 0x00d0 }
            if (r0 == 0) goto L_0x00ca
            com.google.android.gms.measurement.internal.zzab r0 = r12.zzs()     // Catch:{ all -> 0x00d0 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r1 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ all -> 0x00d0 }
    ...
    public final Map<Integer, List<zzbv.zzb>> zze(String str) {
        ...
        Cursor cursor = null;
        try {
            cursor = mo29305c_().query("event_filters", new String[]{"audience_id", "data"}, "app_id=?", new String[]{str}, (String) null, (String) null, (String) null);
            if (!cursor.moveToFirst()) {
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<java.lang.Integer>> zzf(java.lang.String r8) {
        /*
            ...
            androidx.collection.ArrayMap r0 = new androidx.collection.ArrayMap
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r7.mo29305c_()
            r2 = 0
        ...
        L_0x006a:
            ...
            r1 = r2
        L_0x006c:
            com.google.android.gms.measurement.internal.zzeq r3 = r7.zzq()     // Catch:{ all -> 0x009f }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ all -> 0x009f }
            java.lang.String r4 = "Database error querying scoped filters. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r8)     // Catch:{ all -> 0x009f }
            r3.zza(r4, r5, r0)     // Catch:{ all -> 0x009f }
            boolean r0 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ all -> 0x009f }
            if (r0 == 0) goto L_0x0099
            com.google.android.gms.measurement.internal.zzab r0 = r7.zzs()     // Catch:{ all -> 0x009f }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r3 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ all -> 0x009f }
    ...
    private final boolean zzb(String str, List<Integer> list) {
        ...
        try {
            ...
            int max = Math.max(0, Math.min(MessageHandler.WHAT_SMOOTH_SCROLL, zzs().zzb(str, zzas.zzae)));
            if (zzb2 <= ((long) max)) {
                return false;
            }
            ArrayList arrayList = new ArrayList();
    ...
    public final java.util.Map<java.lang.Integer, com.google.android.gms.internal.measurement.zzcd.zzi> zzg(java.lang.String r12) {
        /*
            ...
            android.database.sqlite.SQLiteDatabase r0 = r11.mo29305c_()
            r8 = 0
            ...
            boolean r1 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ SQLiteException -> 0x0098 }
            if (r1 == 0) goto L_0x0049
            com.google.android.gms.measurement.internal.zzab r1 = r11.zzs()     // Catch:{ SQLiteException -> 0x0098 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r2 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ SQLiteException -> 0x0098 }
        ...
        L_0x0054:
            ...
            com.google.android.gms.internal.measurement.zzji r3 = com.google.android.gms.measurement.internal.zzkr.zza(r4, (byte[]) r3)     // Catch:{ IOException -> 0x0076 }
            ...
            com.google.android.gms.internal.measurement.zzjj r3 = r3.zzy()     // Catch:{ IOException -> 0x0076 }
            com.google.android.gms.internal.measurement.zzhy r3 = (com.google.android.gms.internal.measurement.zzhy) r3     // Catch:{ IOException -> 0x0076 }
        ...
        L_0x0076:
            r3 = move-exception
            com.google.android.gms.measurement.internal.zzeq r4 = r11.zzq()     // Catch:{ SQLiteException -> 0x0098 }
            com.google.android.gms.measurement.internal.zzes r4 = r4.zze()     // Catch:{ SQLiteException -> 0x0098 }
            java.lang.String r5 = "Failed to merge filter results. appId, audienceId, error"
            java.lang.Object r6 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r12)     // Catch:{ SQLiteException -> 0x0098 }
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ SQLiteException -> 0x0098 }
        ...
        L_0x009d:
            ...
            r0 = r8
        L_0x009f:
            com.google.android.gms.measurement.internal.zzeq r2 = r11.zzq()     // Catch:{ all -> 0x00d2 }
            com.google.android.gms.measurement.internal.zzes r2 = r2.zze()     // Catch:{ all -> 0x00d2 }
            java.lang.String r3 = "Database error querying filter results. appId"
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r12)     // Catch:{ all -> 0x00d2 }
            r2.zza(r3, r4, r1)     // Catch:{ all -> 0x00d2 }
            boolean r1 = com.google.android.gms.internal.measurement.zznd.zzb()     // Catch:{ all -> 0x00d2 }
            if (r1 == 0) goto L_0x00cc
            com.google.android.gms.measurement.internal.zzab r1 = r11.zzs()     // Catch:{ all -> 0x00d2 }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r2 = com.google.android.gms.measurement.internal.zzas.zzce     // Catch:{ all -> 0x00d2 }
    ...
    public final long zza(zzcd.zzg zzg2) throws IOException {
        ...
        Preconditions.checkNotEmpty(zzg2.zzx());
        byte[] zzbk = zzg2.zzbk();
        long zza = mo29467f_().zza(zzbk);
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", zzg2.zzx());
        contentValues.put("metadata_fingerprint", Long.valueOf(zza));
        contentValues.put("metadata", zzbk);
        try {
            mo29305c_().insertWithOnConflict("raw_events_metadata", (String) null, contentValues, 4);
            return zza;
        } catch (SQLiteException e) {
    ...
    public final java.lang.String zza(long r5) {
        /*
            ...
            r4.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r4.mo29305c_()     // Catch:{ SQLiteException -> 0x0043, all -> 0x0040 }
        ...
        L_0x0043:
            ...
            r5 = r0
        L_0x0045:
            com.google.android.gms.measurement.internal.zzeq r1 = r4.zzq()     // Catch:{ all -> 0x0058 }
            com.google.android.gms.measurement.internal.zzes r1 = r1.zze()     // Catch:{ all -> 0x0058 }
    ...
    public final long zzz() {
        Cursor cursor = null;
        try {
            cursor = mo29305c_().rawQuery("select rowid from raw_events order by rowid desc limit 1;", (String[]) null);
            if (!cursor.moveToFirst()) {
                if (cursor != null) {
                    cursor.close();
                }
    ...
    public final android.util.Pair<com.google.android.gms.internal.measurement.zzcd.zzc, java.lang.Long> zza(java.lang.String r8, java.lang.Long r9) {
        /*
            ...
            r7.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.mo29305c_()     // Catch:{ SQLiteException -> 0x007c, all -> 0x0079 }
            ...
            com.google.android.gms.measurement.internal.zzeq r8 = r7.zzq()     // Catch:{ SQLiteException -> 0x0077 }
            com.google.android.gms.measurement.internal.zzes r8 = r8.zzw()     // Catch:{ SQLiteException -> 0x0077 }
        ...
        L_0x0037:
            ...
            com.google.android.gms.internal.measurement.zzji r2 = com.google.android.gms.measurement.internal.zzkr.zza(r4, (byte[]) r2)     // Catch:{ IOException -> 0x005f }
            ...
            com.google.android.gms.internal.measurement.zzjj r2 = r2.zzy()     // Catch:{ IOException -> 0x005f }
            com.google.android.gms.internal.measurement.zzhy r2 = (com.google.android.gms.internal.measurement.zzhy) r2     // Catch:{ IOException -> 0x005f }
        ...
        L_0x005f:
            r2 = move-exception
            com.google.android.gms.measurement.internal.zzeq r3 = r7.zzq()     // Catch:{ SQLiteException -> 0x0077 }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ SQLiteException -> 0x0077 }
            java.lang.String r4 = "Failed to merge main event. appId, eventId"
            java.lang.Object r8 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r8)     // Catch:{ SQLiteException -> 0x0077 }
        ...
        L_0x007c:
            ...
            r1 = r0
        L_0x007e:
            com.google.android.gms.measurement.internal.zzeq r9 = r7.zzq()     // Catch:{ all -> 0x0091 }
            com.google.android.gms.measurement.internal.zzes r9 = r9.zze()     // Catch:{ all -> 0x0091 }
    ...
    public final boolean zza(String str, Long l, long j, zzcd.zzc zzc2) {
        ...
        try {
            if (mo29305c_().insertWithOnConflict("main_event_params", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(String str, Bundle bundle) {
        zzc();
        zzaj();
        byte[] zzbk = mo29467f_().zza(new zzan(this.zzy, "", str, "dep", 0, 0, bundle)).zzbk();
        ...
        try {
            if (mo29305c_().insertWithOnConflict("default_event_params", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final android.os.Bundle zzi(java.lang.String r8) {
        /*
            ...
            r7.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.mo29305c_()     // Catch:{ SQLiteException -> 0x00c1, all -> 0x00be }
            ...
            com.google.android.gms.measurement.internal.zzeq r8 = r7.zzq()     // Catch:{ SQLiteException -> 0x00bc }
            com.google.android.gms.measurement.internal.zzes r8 = r8.zzw()     // Catch:{ SQLiteException -> 0x00bc }
        ...
        L_0x0030:
            ...
            com.google.android.gms.internal.measurement.zzji r2 = com.google.android.gms.measurement.internal.zzkr.zza(r3, (byte[]) r2)     // Catch:{ IOException -> 0x00a4 }
            ...
            com.google.android.gms.internal.measurement.zzjj r2 = r2.zzy()     // Catch:{ IOException -> 0x00a4 }
            com.google.android.gms.internal.measurement.zzhy r2 = (com.google.android.gms.internal.measurement.zzhy) r2     // Catch:{ IOException -> 0x00a4 }
            ...
            r7.mo29467f_()     // Catch:{ SQLiteException -> 0x00bc }
        ...
        L_0x00a4:
            r2 = move-exception
            com.google.android.gms.measurement.internal.zzeq r3 = r7.zzq()     // Catch:{ SQLiteException -> 0x00bc }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zze()     // Catch:{ SQLiteException -> 0x00bc }
            java.lang.String r4 = "Failed to retrieve default event parameters. appId"
            java.lang.Object r8 = com.google.android.gms.measurement.internal.zzeq.zza((java.lang.String) r8)     // Catch:{ SQLiteException -> 0x00bc }
        ...
        L_0x00c1:
            ...
            r1 = r0
        L_0x00c3:
            com.google.android.gms.measurement.internal.zzeq r2 = r7.zzq()     // Catch:{ all -> 0x00d6 }
            com.google.android.gms.measurement.internal.zzes r2 = r2.zze()     // Catch:{ all -> 0x00d6 }
    ...
    public final boolean zza(zzan zzan, long j, boolean z) {
        ...
        byte[] zzbk = mo29467f_().zza(zzan).zzbk();
        ContentValues contentValues = new ContentValues();
        ...
        try {
            if (mo29305c_().insert("raw_events", (String) null, contentValues) != -1) {
                return true;
            }
    ...
    public final void zza(String str, List<zzbv.zza> list) {
        ...
        Preconditions.checkNotNull(list);
        for (int i = 0; i < list.size(); i++) {
            zzbv.zza.C6487zza zza = (zzbv.zza.C6487zza) list2.get(i).zzbo();
            if (zza.zzb() != 0) {
                zzbv.zza.C6487zza zza2 = zza;
                for (int i2 = 0; i2 < zza2.zzb(); i2++) {
                    zzbv.zzb.zza zza3 = (zzbv.zzb.zza) zza2.zzb(i2).zzbo();
                    zzbv.zzb.zza zza4 = (zzbv.zzb.zza) ((zzhy.zzb) zza3.clone());
                    String zzb2 = zzgv.zzb(zza3.zza());
                    if (zzb2 != null) {
                        zza4.zza(zzb2);
                        z2 = true;
                    } else {
                    ...
                    for (int i3 = 0; i3 < zza3.zzb(); i3++) {
                        zzbv.zzc zza5 = zza3.zza(i3);
                        String zza6 = zzgu.zza(zza5.zzh());
                        if (zza6 != null) {
                            zza4.zza(i3, (zzbv.zzc) ((zzhy) ((zzbv.zzc.zza) zza5.zzbo()).zza(zza6).zzy()));
                            z3 = true;
                        }
                    }
                    if (z3) {
                        zza2 = zza2.zza(i2, zza4);
                        list2.set(i, (zzbv.zza) ((zzhy) zza2.zzy()));
                    }
                }
                zza = zza2;
            }
            if (zza.zza() != 0) {
                for (int i4 = 0; i4 < zza.zza(); i4++) {
                    zzbv.zze zza7 = zza.zza(i4);
                    String zza8 = zzgx.zza(zza7.zzc());
                    if (zza8 != null) {
                        zza = zza.zza(i4, ((zzbv.zze.zza) zza7.zzbo()).zza(zza8));
