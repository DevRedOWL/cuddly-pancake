...
public final class zzfr extends zzgq {
    ...
    public final <V> Future<V> zza(Callable<V> callable) throws IllegalStateException {
        ...
        zzfs zzfs = new zzfs(this, callable, false, "Task exception on worker thread");
        if (Thread.currentThread() == this.zza) {
            if (!this.zzc.isEmpty()) {
    ...
    public final <V> Future<V> zzb(Callable<V> callable) throws IllegalStateException {
        zzab();
        Preconditions.checkNotNull(callable);
        zzfs zzfs = new zzfs(this, callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zza) {
            zzfs.run();
        } else {
            zza((zzfs<?>) zzfs);
    ...
    public final void zza(Runnable runnable) throws IllegalStateException {
        ...
        zza((zzfs<?>) new zzfs(this, runnable, false, "Task exception on worker thread"));
    }
    ...
    public final <T> T zza(java.util.concurrent.atomic.AtomicReference<T> r2, long r3, java.lang.String r5, java.lang.Runnable r6) {
        /*
            r1 = this;
            monitor-enter(r2)
            com.google.android.gms.measurement.internal.zzfr r0 = r1.zzp()     // Catch:{ all -> 0x005a }
            ...
            com.google.android.gms.measurement.internal.zzeq r3 = r1.zzq()
        ...
        L_0x0034:
            return r2
        L_0x0035:
            com.google.android.gms.measurement.internal.zzeq r3 = r1.zzq()     // Catch:{ all -> 0x005a }
            com.google.android.gms.measurement.internal.zzes r3 = r3.zzh()     // Catch:{ all -> 0x005a }
        ...
        L_0x005a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfr.zza(java.util.concurrent.atomic.AtomicReference, long, java.lang.String, java.lang.Runnable):java.lang.Object");
    }

    public final void zzb(Runnable runnable) throws IllegalStateException {
        zzab();
        Preconditions.checkNotNull(runnable);
        zza((zzfs<?>) new zzfs(this, runnable, true, "Task exception on worker thread"));
    }
    ...
    public final void zzc(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.zzg) {
            this.zzd.add(zzfs);
            if (this.zzb == null) {
                this.zzb = new zzfv(this, "Measurement Network", this.zzd);
