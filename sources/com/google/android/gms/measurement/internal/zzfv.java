...
final class zzfv extends Thread {
    ...
    public final void run() {
        ...
        L_0x0001:
            ...
            com.google.android.gms.measurement.internal.zzfr r1 = r5.zzd     // Catch:{ InterruptedException -> 0x000e }
        ...
        L_0x001b:
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfs<?>> r1 = r5.zzb     // Catch:{ all -> 0x0081 }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x0081 }
            com.google.android.gms.measurement.internal.zzfs r1 = (com.google.android.gms.measurement.internal.zzfs) r1     // Catch:{ all -> 0x0081 }
        ...
        L_0x0034:
            ...
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfs<?>> r2 = r5.zzb     // Catch:{ all -> 0x007e }
            java.lang.Object r2 = r2.peek()     // Catch:{ all -> 0x007e }
            if (r2 != 0) goto L_0x0053
            com.google.android.gms.measurement.internal.zzfr r2 = r5.zzd     // Catch:{ all -> 0x007e }
        ...
        L_0x0053:
            ...
            com.google.android.gms.measurement.internal.zzfr r1 = r5.zzd     // Catch:{ all -> 0x0081 }
            java.lang.Object r1 = r1.zzg     // Catch:{ all -> 0x0081 }
            monitor-enter(r1)     // Catch:{ all -> 0x0081 }
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfs<?>> r2 = r5.zzb     // Catch:{ all -> 0x007b }
            java.lang.Object r2 = r2.peek()     // Catch:{ all -> 0x007b }
            if (r2 != 0) goto L_0x0079
            com.google.android.gms.measurement.internal.zzfr r0 = r5.zzd     // Catch:{ all -> 0x007b }
            com.google.android.gms.measurement.internal.zzab r0 = r0.zzs()     // Catch:{ all -> 0x007b }
            com.google.android.gms.measurement.internal.zzej<java.lang.Boolean> r2 = com.google.android.gms.measurement.internal.zzas.zzbq     // Catch:{ all -> 0x007b }
            boolean r0 = r0.zza((com.google.android.gms.measurement.internal.zzej<java.lang.Boolean>) r2)     // Catch:{ all -> 0x007b }
        ...
        L_0x0081:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfv.run():void");
    }
        ...
        synchronized (this.zzd.zzg) {
            if (!this.zzc) {
                ...
                if (this == this.zzd.zza) {
                    zzfv unused = this.zzd.zza = null;
                } else if (this == this.zzd.zzb) {
                    zzfv unused2 = this.zzd.zzb = null;
                } else {
