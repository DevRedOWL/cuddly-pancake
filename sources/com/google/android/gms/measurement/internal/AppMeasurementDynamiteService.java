...
public class AppMeasurementDynamiteService extends zzu {
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, zzw zzw, long j) throws RemoteException {
        ...
        bundle2.putString("_o", GCMConstants.EXTRA_APPLICATION_PENDING_INTENT);
        this.zza.zzp().zza((Runnable) new zzj(this, zzw, new zzaq(str2, new zzap(bundle), GCMConstants.EXTRA_APPLICATION_PENDING_INTENT, j), str));
    }
