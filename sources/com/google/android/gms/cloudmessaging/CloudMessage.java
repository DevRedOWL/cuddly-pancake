...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    public final String getTo() {
        return this.zza.getStringExtra(Constants.MessagePayloadKeys.f2238TO);
    }
            ...
            if (extras != null) {
                for (String str : extras.keySet()) {
                    ...
                    if (obj instanceof String) {
                        ...
                        if (!str.startsWith(Constants.MessagePayloadKeys.RESERVED_PREFIX) && !str.equals(Constants.MessagePayloadKeys.FROM) && !str.equals("message_type") && !str.equals(Constants.MessagePayloadKeys.COLLAPSE_KEY)) {
