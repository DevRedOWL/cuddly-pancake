...
public final class zzjk {
    ...
    public final int zzdt() throws IOException {
        ...
        byte b = zzdy & ByteCompanionObject.MAX_VALUE;
        byte zzdy2 = zzdy();
        if (zzdy2 >= 0) {
            i = zzdy2 << 7;
        } else {
            b |= (zzdy2 & ByteCompanionObject.MAX_VALUE) << 7;
            byte zzdy3 = zzdy();
            if (zzdy3 >= 0) {
                i = zzdy3 << 14;
            } else {
                b |= (zzdy3 & ByteCompanionObject.MAX_VALUE) << 14;
                byte zzdy4 = zzdy();
                if (zzdy4 >= 0) {
                    i = zzdy4 << 21;
                } else {
                    byte b2 = b | ((zzdy4 & ByteCompanionObject.MAX_VALUE) << 21);
                    byte zzdy5 = zzdy();
                    byte b3 = b2 | (zzdy5 << 28);
                    if (zzdy5 >= 0) {
                        return b3;
