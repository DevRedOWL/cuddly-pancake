...
public final class C2299i {
    /* renamed from: a */
    static Pair<ByteBuffer, Long> m1290a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> h = m1297h(randomAccessFile, 0);
        return h != null ? h : m1297h(randomAccessFile, 65535);
    }

    /* renamed from: b */
    public static long m1291b(ByteBuffer byteBuffer) {
        m1298i(byteBuffer);
        return m1299j(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: c */
    public static void m1292c(ByteBuffer byteBuffer, long j) {
        m1298i(byteBuffer);
    ...
    /* renamed from: d */
    public static long m1293d(ByteBuffer byteBuffer) {
        m1298i(byteBuffer);
        return m1299j(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: e */
    public static String m1294e(String str, String str2) {
    ...
    /* renamed from: f */
    public static String m1295f(String str, String str2, String str3) {
    ...
    /* renamed from: g */
    public static X509Certificate[][] m1296g(String str) throws C2296f, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m1290a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C2296f("ZIP64 APK not supported");
                    }
                }
                long b = m1291b(byteBuffer2);
                if (b >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C2296f(sb.toString());
                } else if (m1293d(byteBuffer2) + b != longValue) {
                    throw new C2296f("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (b >= 32) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        throw new C2296f(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] k = m1300k(randomAccessFile.getChannel(), new C2295e(m1307r(slice, i4 - 4), longValue2, b, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i2);
                                                    throw new C2296f(sb5.toString());
                                                }
                                            }
                                            throw new C2296f("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C2296f(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: h */
    private static Pair<ByteBuffer, Long> m1297h(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
        long length = randomAccessFile.length();
        if (length < 22) {
            return null;
    ...
    /* renamed from: i */
    private static void m1298i(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }
    ...
    /* renamed from: j */
    private static long m1299j(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & 4294967295L;
    }

    /* renamed from: k */
    private static X509Certificate[][] m1300k(FileChannel fileChannel, C2295e eVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer s = m1308s(eVar.f1970a);
                int i = 0;
                while (s.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m1301l(m1308s(s), hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m1302m(hashMap, fileChannel, eVar.f1971b, eVar.f1972c, eVar.f1973d, eVar.f1974e);
    ...
    private static java.security.cert.X509Certificate[] m1301l(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m1308s(r22)
            java.nio.ByteBuffer r1 = m1308s(r22)
            byte[] r2 = m1309t(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m1308s(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m1304o(r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m1304o(r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m1309t(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m1308s(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m1308s(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m1309t(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x0278:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C2299i.m1301l(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: m */
    private static void m1302m(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C2294d dVar = new C2294d(fileChannel, 0, j);
            C2294d dVar2 = new C2294d(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m1292c(duplicate, j);
            C2261b bVar = new C2261b(duplicate);
            ...
            try {
                byte[][] n = m1303n(iArr, new C2288c[]{dVar, dVar2, bVar});
                while (i < iArr.length) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), n[i])) {
                        ...
                        throw new SecurityException(m1305p(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    /* renamed from: n */
    private static byte[][] m1303n(int[] iArr, C2288c[] cVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (cVarArr[i2].mo33834a() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m1306q(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m1310u(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C2288c cVar = cVarArr[i6];
                int i9 = i6;
                int i10 = i7;
                long a = cVar.mo33834a();
                long j4 = j2;
                while (a > j2) {
                    ...
                    try {
                        cVar.mo33835b(messageDigestArr, j4, min);
                        int i11 = 0;
                        while (i11 < iArr2.length) {
                            ...
                            int digest = messageDigest.digest(bArr4, (i10 * q) + 5, q);
                            if (digest == q) {
                                i11++;
                                bArr3 = bArr5;
            ...
            while (i13 < iArr2.length) {
                int i14 = iArr2[i13];
                byte[] bArr9 = bArr[i13];
                String p2 = m1305p(i14);
                try {
                    bArr8[i13] = MessageDigest.getInstance(p2).digest(bArr9);
                    i13++;
    ...
    /* renamed from: o */
    private static int m1304o(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: p */
    private static String m1305p(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: q */
    private static int m1306q(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: r */
    private static ByteBuffer m1307r(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: s */
    private static ByteBuffer m1308s(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m1307r(byteBuffer, i);
            } else {
    ...
    /* renamed from: t */
    private static byte[] m1309t(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
    ...
    /* renamed from: u */
    private static void m1310u(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
