...
public final class C2256av {

    /* renamed from: a */
    private final C2332c f1940a;

    /* renamed from: b */
    private final Context f1941b;

    /* renamed from: c */
    private final C2255au f1942c;

    /* renamed from: d */
    private PackageInfo f1943d;

    /* renamed from: e */
    private final C2258ax f1944e;

    public C2256av(Context context, C2332c cVar, C2258ax axVar, byte[] bArr) {
        C2255au auVar = new C2255au(new C2330a(cVar));
        this.f1940a = cVar;
        this.f1944e = axVar;
        this.f1941b = context;
        this.f1942c = auVar;
    ...
    /* renamed from: d */
    private final PackageInfo m1173d() {
        if (this.f1943d == null) {
            try {
                this.f1943d = this.f1941b.getPackageManager().getPackageInfo(this.f1941b.getPackageName(), 64);
    ...
    /* renamed from: e */
    private static X509Certificate m1174e(Signature signature) {
        try {
    ...
    public final boolean mo33827a(java.io.File[] r13) {
        /*
            r12 = this;
            java.lang.String r0 = " is not signed."
            java.lang.String r1 = "Downloaded split "
            android.content.pm.PackageInfo r2 = r12.m1173d()
            r3 = 0
            r4 = 0
        ...
        L_0x001a:
            ...
            r7 = r2[r6]
            java.security.cert.X509Certificate r7 = m1174e(r7)
        ...
        L_0x0037:
            ...
            java.security.cert.X509Certificate[][] r7 = com.google.android.play.core.internal.C2299i.m1296g(r6)     // Catch:{ Exception -> 0x00a0 }
        ...
        L_0x00cf:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C2256av.mo33827a(java.io.File[]):boolean");
    }

    /* renamed from: b */
    public final boolean mo33828b(File[] fileArr) throws IOException, XmlPullParserException {
        PackageInfo d = m1173d();
        long longVersionCode = Build.VERSION.SDK_INT >= 28 ? d.getLongVersionCode() : (long) d.versionCode;
        AssetManager assetManager = (AssetManager) C2269bh.m1213c(AssetManager.class);
        ...
        do {
            ...
            this.f1942c.mo33825a(assetManager, fileArr[length]);
        } while (longVersionCode == this.f1942c.mo33826b());
        return false;
    }

    /* renamed from: c */
    public final boolean mo33829c(List<Intent> list) throws IOException {
        for (Intent stringExtra : list) {
            if (!this.f1940a.mo33948c(stringExtra.getStringExtra("split_id")).exists()) {
                return false;
            }
        }
        return true;
