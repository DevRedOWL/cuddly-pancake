...
final class C2194cv {
    ...
    /* renamed from: a */
    private static final C2241ag f1783a = new C2241ag("PackageStateCache");
    ...
    public final synchronized int mo33740a() {
        /*
            r3 = this;
            monitor-enter(r3)
            int r0 = r3.f1785c     // Catch:{ all -> 0x0029 }
            r1 = -1
            if (r0 != r1) goto L_0x0025
            r0 = 0
            android.content.Context r1 = r3.f1784b     // Catch:{ NameNotFoundException -> 0x001c }
            java.lang.String r1 = r1.getPackageName()     // Catch:{ NameNotFoundException -> 0x001c }
            android.content.Context r2 = r3.f1784b     // Catch:{ NameNotFoundException -> 0x001c }
            ...
            r3.f1785c = r1     // Catch:{ NameNotFoundException -> 0x001c }
            goto L_0x0025
        L_0x001c:
            com.google.android.play.core.internal.ag r1 = f1783a     // Catch:{ all -> 0x0029 }
            ...
            r1.mo33809b(r2, r0)     // Catch:{ all -> 0x0029 }
        L_0x0025:
            int r0 = r3.f1785c     // Catch:{ all -> 0x0029 }
            monitor-exit(r3)
            return r0
        L_0x0029:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.assetpacks.C2194cv.mo33740a():int");
    }
}
