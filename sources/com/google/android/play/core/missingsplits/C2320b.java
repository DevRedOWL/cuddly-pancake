...
final class C2320b implements MissingSplitsManager {

    /* renamed from: a */
    private static final C2241ag f1990a = new C2241ag("MissingSplitsManagerImpl");

    /* renamed from: b */
    private final Context f1991b;

    /* renamed from: c */
    private final Runtime f1992c;

    /* renamed from: d */
    private final C2319a f1993d;

    /* renamed from: e */
    private final AtomicReference<Boolean> f1994e;

    C2320b(Context context, Runtime runtime, C2319a aVar, AtomicReference<Boolean> atomicReference) {
        this.f1991b = context;
        this.f1992c = runtime;
        this.f1993d = aVar;
        this.f1994e = atomicReference;
    }

    /* renamed from: a */
    private final boolean m1384a() {
        try {
            ApplicationInfo applicationInfo = this.f1991b.getPackageManager().getApplicationInfo(this.f1991b.getPackageName(), 128);
            ...
            f1990a.mo33812e("App '%s' is not found in the PackageManager", this.f1991b.getPackageName());
            return false;
        }
    }

    /* renamed from: b */
    private final Set<String> m1385b() {
        if (Build.VERSION.SDK_INT < 21) {
            return Collections.emptySet();
        }
        try {
            PackageInfo packageInfo = this.f1991b.getPackageManager().getPackageInfo(this.f1991b.getPackageName(), 0);
            ...
            f1990a.mo33812e("App '%s' is not found in PackageManager", this.f1991b.getPackageName());
            return Collections.emptySet();
        }
    }

    /* renamed from: c */
    private static boolean m1386c(Set<String> set) {
        if (!set.isEmpty()) {
    ...
    /* renamed from: d */
    private final List<ActivityManager.AppTask> m1387d() {
        List<ActivityManager.AppTask> appTasks = ((ActivityManager) this.f1991b.getSystemService("activity")).getAppTasks();
        return appTasks != null ? appTasks : Collections.emptyList();
    }

    /* JADX WARNING: Can't wrap try/catch for region: R(2:29|30) */
    /* JADX WARNING: Code restructure failed: missing block: B:30:?, code lost:
        f1990a.mo33812e("App '%s' is not found in PackageManager", r8.f1991b.getPackageName());
     */
    ...
    public final boolean disableAppIfMissingRequiredSplits() {
        /*
            ...
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r0 = r8.f1994e
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r3 = r8.f1994e     // Catch:{ all -> 0x01cf }
        ...
        L_0x001b:
            ...
            goto L_0x00ac
        L_0x001e:
            android.content.Context r5 = r8.f1991b     // Catch:{ all -> 0x01cf }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x01cf }
            android.content.Context r6 = r8.f1991b     // Catch:{ NameNotFoundException -> 0x0099 }
        ...
        L_0x004a:
            ...
            goto L_0x0083
        L_0x004f:
            android.content.Context r1 = r8.f1991b     // Catch:{ NameNotFoundException -> 0x0071 }
            android.content.pm.PackageManager r1 = r1.getPackageManager()     // Catch:{ NameNotFoundException -> 0x0071 }
            android.content.Context r5 = r8.f1991b     // Catch:{ NameNotFoundException -> 0x0071 }
        ...
        L_0x006f:
            ...
            goto L_0x0083
        L_0x0071:
            com.google.android.play.core.internal.ag r1 = f1990a     // Catch:{ all -> 0x01cf }
            java.lang.Object[] r5 = new java.lang.Object[r4]     // Catch:{ all -> 0x01cf }
            android.content.Context r6 = r8.f1991b     // Catch:{ all -> 0x01cf }
            ...
            r1.mo33812e(r6, r5)     // Catch:{ all -> 0x01cf }
            goto L_0x004a
        L_0x0083:
        ...
        L_0x00b3:
            java.util.concurrent.atomic.AtomicReference<java.lang.Boolean> r1 = r8.f1994e     // Catch:{ all -> 0x01cf }
        ...
        L_0x0154:
            ...
            goto L_0x0140
        L_0x0156:
            com.google.android.play.core.internal.ag r5 = f1990a
            java.lang.Object[] r6 = new java.lang.Object[r4]
            r6[r2] = r3
            java.lang.String r3 = "ClassNotFoundException when scanning class hierarchy of '%s'"
            r5.mo33812e(r3, r6)
            android.content.Context r3 = r8.f1991b     // Catch:{ NameNotFoundException -> 0x016e }
        ...
        L_0x0170:
            r0 = 0
        L_0x0171:
            com.google.android.play.core.missingsplits.a r1 = r8.f1993d
            r1.mo33930b()
            java.util.List r1 = r8.m1387d()
        ...
        L_0x018e:
            ...
            android.content.Context r0 = r8.f1991b
            android.content.pm.PackageManager r0 = r0.getPackageManager()
            android.content.ComponentName r1 = new android.content.ComponentName
            android.content.Context r3 = r8.f1991b
            ...
            android.content.Context r1 = r8.f1991b
            java.lang.Class<com.google.android.play.core.missingsplits.PlayCoreMissingSplitsActivity> r3 = com.google.android.play.core.missingsplits.PlayCoreMissingSplitsActivity.class
            r0.<init>(r1, r3)
            ...
            r1.startActivity(r0)
        L_0x01b6:
            java.lang.Runtime r0 = r8.f1992c
            r0.exit(r2)
        L_0x01bb:
            return r4
        L_0x01bc:
            com.google.android.play.core.missingsplits.a r0 = r8.f1993d
            boolean r0 = r0.mo33929a()
        ...
        L_0x01d2:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.missingsplits.C2320b.disableAppIfMissingRequiredSplits():boolean");
    }

    public final boolean isMissingRequiredSplits() {
        boolean booleanValue;
        synchronized (this.f1994e) {
            if (this.f1994e.get() == null) {
                AtomicReference<Boolean> atomicReference = this.f1994e;
                boolean z = false;
                if (Build.VERSION.SDK_INT >= 21) {
                    if (m1384a() && m1386c(m1385b())) {
                        z = true;
                    }
                }
                atomicReference.set(Boolean.valueOf(z));
            }
            booleanValue = this.f1994e.get().booleanValue();
        }
        return booleanValue;
    }
}
