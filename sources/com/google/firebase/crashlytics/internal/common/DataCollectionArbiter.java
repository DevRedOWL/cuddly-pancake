...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().mo34251d(String.format("Crashlytics automatic data collection %s by %s.", new Object[]{str2, str}));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().mo34252d("Unable to get PackageManager. Falling through", e);
            return null;
        }
    }
