...
class MetaDataStore {
    ...
    public void writeUserData(String str, UserMetadata userMetadata) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo34254e("Error serializing user metadata.", e);
    ...
    public UserMetadata readUserData(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo34254e("Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Logger.getLogger().mo34254e("Error serializing key/value metadata.", e);
    ...
    public File getKeysFileForSession(String str) {
        File file = this.filesDir;
        return new File(file, str + "keys" + METADATA_EXT);
    }
