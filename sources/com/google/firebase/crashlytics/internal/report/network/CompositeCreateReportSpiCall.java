...
public class CompositeCreateReportSpiCall implements CreateReportSpiCall {
    ...
    static /* synthetic */ class C25241 {
        ...
        static final /* synthetic */ int[] f2231xc221d5a6 = new int[Report.Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f2231xc221d5a6 = r0
                int[] r0 = f2231xc221d5a6     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f2231xc221d5a6     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.internal.report.network.CompositeCreateReportSpiCall.C25241.<clinit>():void");
        }
    }

    public boolean invoke(CreateReportRequest createReportRequest, boolean z) {
        int i = C25241.f2231xc221d5a6[createReportRequest.report.getType().ordinal()];
        if (i == 1) {
