...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C2509x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C2491xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2511xce3d994b.class, (ObjectEncoder<? super U>) C2491xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C2490x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2505xc2f5febc.class, (ObjectEncoder<? super U>) C2490x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C2507x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C2489x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C2503xfe724d07.class, (ObjectEncoder<? super U>) C2489x99c932db.INSTANCE);
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        public void encode(CrashlyticsReport.Session session, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(GCMConstants.EXTRA_APPLICATION_PENDING_INTENT, (Object) session.getApp());
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        public void encode(CrashlyticsReport.Session.Application application, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ClientCookie.VERSION_ATTR, (Object) application.getVersion());
            ...
            objectEncoderContext.add("developmentPlatform", (Object) application.getDevelopmentPlatform());
            objectEncoderContext.add("developmentPlatformVersion", (Object) application.getDevelopmentPlatformVersion());
        }
    }
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        public void encode(CrashlyticsReport.Session.OperatingSystem operatingSystem, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(ClientCookie.VERSION_ATTR, (Object) operatingSystem.getVersion());
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        public void encode(CrashlyticsReport.Session.Event event, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(GCMConstants.EXTRA_APPLICATION_PENDING_INTENT, (Object) event.getApp());
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        ...
        public void encode(CrashlyticsReport.Session.Event.Application application, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(AppStateModule.APP_STATE_BACKGROUND, (Object) application.getBackground());
    ...
    private static final class C2491xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C2491xc3999712 INSTANCE = new C2491xc3999712();

        private C2491xc3999712() {
        }
        ...
        public void encode(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame frame, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(UriUtil.LOCAL_FILE_SCHEME, (Object) frame.getFile());
    ...
    private static final class C2490x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C2490x55689506 INSTANCE = new C2490x55689506();

        private C2490x55689506() {
        }
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        public void encode(CrashlyticsReport.Session.Event.Application.Execution.Signal signal, ObjectEncoderContext objectEncoderContext) throws IOException {
            ...
            objectEncoderContext.add(Contact.Type.address, signal.getAddress());
        }
    }
    ...
    private static final class C2489x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C2489x99c932db INSTANCE = new C2489x99c932db();

        private C2489x99c932db() {
        }
