...
public abstract class RandomAccessReader {
    ...
    public int getInt24(int i) throws IOException {
        ...
        validateIndex(i, 3);
        if (this._isMotorolaByteOrder) {
            b = ((getByte(i) << 16) & 16711680) | (65280 & (getByte(i + 1) << 8));
            b2 = getByte(i + 2);
        } else {
            b = ((getByte(i + 2) << 16) & 16711680) | (65280 & (getByte(i + 1) << 8));
            b2 = getByte(i);
        }
        return (b2 & 255) | b;
    }
    ...
    public int getInt32(int i) throws IOException {
        ...
        validateIndex(i, 4);
        if (this._isMotorolaByteOrder) {
            b = ((getByte(i) << 24) & -16777216) | (16711680 & (getByte(i + 1) << 16)) | (65280 & (getByte(i + 2) << 8));
            b2 = getByte(i + 3);
        } else {
            b = ((getByte(i + 3) << 24) & -16777216) | (16711680 & (getByte(i + 2) << 16)) | (65280 & (getByte(i + 1) << 8));
            b2 = getByte(i);
        }
        return (b2 & 255) | b;
    }
