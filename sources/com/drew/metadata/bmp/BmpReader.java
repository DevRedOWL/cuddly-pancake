...
public class BmpReader {
    ...
    public void readFileHeader(SequentialReader sequentialReader, Metadata metadata, boolean z) {
        try {
    ...
    /* access modifiers changed from: protected */
    public void readBitmapHeader(SequentialReader sequentialReader, BmpHeaderDirectory bmpHeaderDirectory, Metadata metadata) {
    ...
    /* access modifiers changed from: protected */
    public void addError(String str, Metadata metadata) {
