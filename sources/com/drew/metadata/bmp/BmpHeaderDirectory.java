...
public class BmpHeaderDirectory extends Directory {
    ...
    public enum RenderingHalftoningAlgorithm {
        ...
        public String toString() {
            int i = C12001.f1299x161283b7[ordinal()];
            if (i == 1) {
    ...
    public enum ColorSpaceType {
        ...
        public String toString() {
            int i = C12001.f1298xfa95b2b3[ordinal()];
            if (i == 1) {
    ...
    public enum RenderingIntent {
        ...
        public String toString() {
            int i = C12001.f1300x34cafd92[ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C12001 {
        ...
        static final /* synthetic */ int[] f1298xfa95b2b3 = new int[ColorSpaceType.values().length];

        /* renamed from: $SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingHalftoningAlgorithm */
        static final /* synthetic */ int[] f1299x161283b7 = new int[RenderingHalftoningAlgorithm.values().length];

        /* renamed from: $SwitchMap$com$drew$metadata$bmp$BmpHeaderDirectory$RenderingIntent */
        static final /* synthetic */ int[] f1300x34cafd92 = new int[RenderingIntent.values().length];
        ...
        static {
            /*
                ...
                f1300x34cafd92 = r0
                r0 = 1
                int[] r1 = f1300x34cafd92     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f1300x34cafd92     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f1300x34cafd92     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                r3 = 4
                int[] r4 = f1300x34cafd92     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                ...
                int[] r4 = new int[r4]
                f1298xfa95b2b3 = r4
                int[] r4 = f1298xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0048 }
            ...
            L_0x0048:
                int[] r4 = f1298xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0052 }
            ...
            L_0x0052:
                int[] r4 = f1298xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x005c }
            ...
            L_0x005c:
                int[] r4 = f1298xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0066 }
            ...
            L_0x0066:
                r4 = 5
                int[] r5 = f1298xfa95b2b3     // Catch:{ NoSuchFieldError -> 0x0071 }
            ...
            L_0x0071:
                ...
                int[] r5 = new int[r5]
                f1299x161283b7 = r5
                int[] r5 = f1299x161283b7     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r5 = f1299x161283b7     // Catch:{ NoSuchFieldError -> 0x008e }
            ...
            L_0x008e:
                int[] r5 = f1299x161283b7     // Catch:{ NoSuchFieldError -> 0x0098 }
            ...
            L_0x0098:
                int[] r5 = f1299x161283b7     // Catch:{ NoSuchFieldError -> 0x00a2 }
            ...
            L_0x0174:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.drew.metadata.bmp.BmpHeaderDirectory.C12001.<clinit>():void");
        }
    }
}
