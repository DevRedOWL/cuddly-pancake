...
public class QuickTimeDescriptor extends TagDescriptor<QuickTimeDirectory> {
    ...
    private String getDurationDescription() {
        ...
        return String.format("%1$02d:%2$02d:%3$02d", new Object[]{valueOf, valueOf2, Integer.valueOf((int) Math.ceil((((double) longObject.longValue()) / Math.pow(60.0d, Utils.DOUBLE_EPSILON)) - ((double) (valueOf2.intValue() * 60))))});
    }
}
