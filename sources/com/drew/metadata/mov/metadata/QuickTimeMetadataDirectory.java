...
public class QuickTimeMetadataDirectory extends QuickTimeDirectory {
    ...
    static {
        ...
        Integer valueOf = Integer.valueOf(OlympusCameraSettingsMakernoteDirectory.TagModifiedSaturation);
        hashMap.put("com.apple.quicktime.comment", valueOf);
        HashMap<String, Integer> hashMap2 = _tagIntegerMap;
        Integer valueOf2 = Integer.valueOf(OlympusCameraSettingsMakernoteDirectory.TagContrastSetting);
        hashMap2.put("com.apple.quicktime.copyright", valueOf2);
        HashMap<String, Integer> hashMap3 = _tagIntegerMap;
        Integer valueOf3 = Integer.valueOf(OlympusCameraSettingsMakernoteDirectory.TagSharpnessSetting);
        ...
        _tagNameMap.put(1283, ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
        _tagNameMap.put(valueOf, ru_unicorn_ujin_data_realm_marketplace_CommentRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
        _tagNameMap.put(valueOf2, ExifInterface.TAG_COPYRIGHT);
        _tagNameMap.put(valueOf3, "Creation Date");
        ...
        _tagNameMap.put(Integer.valueOf(PhotoshopDirectory.TAG_ICC_PROFILE_BYTES), ru_unicorn_ujin_data_entities_chats_AuthorRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
        _tagNameMap.put(1040, ru_unicorn_ujin_data_realm_marketplace_CategoryRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
        ...
        _tagNameMap.put(1091, ru_unicorn_ujin_data_realm_marketplace_CommentRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
