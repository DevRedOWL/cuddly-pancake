...
public class PhotoshopDescriptor extends TagDescriptor<PhotoshopDirectory> {
    ...
    public String getResolutionInfoDescription() {
        try {
            ...
            return decimalFormat.format((double) s15Fixed16) + MapPoint.JsonFields.f6911x + decimalFormat.format((double) s15Fixed162) + " DPI";
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public String getPathString(int i) {
        ...
        try {
                ...
                try {
                    ...
                    switch (int16) {
                        ...
                        case 2:
                            ...
                            while (i5 < 6) {
                                int i6 = i5 * 4;
                                knot.setPoint(i5, ((double) byteArrayReader2.getInt8(i6 + 2 + i4)) + (((double) byteArrayReader2.getInt24((i6 + 3) + i4)) / Math.pow(2.0d, 24.0d)));
                                i5++;
                        ...
                        case 5:
                            ...
                            while (i7 < 6) {
                                int i8 = i7 * 4;
                                knot2.setPoint(i7, ((double) byteArrayReader2.getInt8(i8 + 2 + i4)) + (((double) byteArrayReader2.getInt24((i8 + 3) + i4)) / Math.pow(2.0d, 24.0d)));
                                i7++;
            ...
            String str9 = str6;
            if (subpath5.size() != 0) {
                arrayList5.add(subpath5);
            }
            if (subpath9.size() != 0) {
                arrayList5.add(subpath9);
            }
            ...
            sb.append(arrayList5.size() == 1 ? " subpath:" : " subpaths:");
            ...
            while (it.hasNext()) {
                ...
                sb.append(" with ");
                sb.append(arrayList5.size());
                sb.append(arrayList5.size() == 1 ? " knot:" : " knots:");
