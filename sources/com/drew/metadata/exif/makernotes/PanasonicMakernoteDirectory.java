...
public class PanasonicMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(107, C4656xbdeaa6ca.ClassNameHelper.INTERNAL_CLASS_NAME);
        _tagNameMap.put(109, ru_unicorn_ujin_data_realm_CityRealmProxy.ClassNameHelper.INTERNAL_CLASS_NAME);
        _tagNameMap.put(111, "Landmark");
        _tagNameMap.put(112, "Intelligent Resolution");
        _tagNameMap.put(119, "Burst Speed");
        _tagNameMap.put(121, "Intelligent D-Range");
        _tagNameMap.put(124, "Clear Retouch");
    ...
    public Face[] getRecognizedFaces() {
        ...
        try {
            ...
            for (int i = 0; i < uInt16; i++) {
                int i2 = (i * 44) + 4;
                faceArr[i] = new Face(byteArrayReader.getUInt16(i2 + 20), byteArrayReader.getUInt16(i2 + 22), byteArrayReader.getUInt16(i2 + 24), byteArrayReader.getUInt16(i2 + 26), byteArrayReader.getString(i2, 20, HTTP.ASCII).trim(), Age.fromPanasonicString(byteArrayReader.getString(i2 + 28, 20, HTTP.ASCII).trim()));
            }
            return faceArr;
        } catch (IOException unused) {
            return null;
