...
public class CanonMakernoteDescriptor extends TagDescriptor<CanonMakernoteDirectory> {
    ...
    static {
        ...
        _lensTypeById.put(Integer.valueOf(DimensionsKt.TVDPI), "Canon EF 90-300mm f/4.5-5.6 USM or Tamron Lens");
        _lensTypeById.put(Integer.valueOf(BuildConfig.VERSION_CODE), "Canon EF-S 18-55mm f/3.5-5.6 USM");
        ...
        _lensTypeById.put(Integer.valueOf(DimensionsKt.HDPI), "Canon EF-S 17-55mm f/2.8 IS USM");
        ...
        _lensTypeById.put(Integer.valueOf(HttpStatus.SC_BAD_GATEWAY), "Canon EF 28mm f/2.8 IS USM");
        _lensTypeById.put(Integer.valueOf(HttpStatus.SC_SERVICE_UNAVAILABLE), "Canon EF 24mm f/2.8 IS USM");
        _lensTypeById.put(Integer.valueOf(HttpStatus.SC_GATEWAY_TIMEOUT), "Canon EF 24-70mm f/4L IS USM");
        _lensTypeById.put(Integer.valueOf(HttpStatus.SC_HTTP_VERSION_NOT_SUPPORTED), "Canon EF 35mm f/2 IS USM");
        _lensTypeById.put(506, "Canon EF 400mm f/4 DO IS II USM");
        _lensTypeById.put(Integer.valueOf(HttpStatus.SC_INSUFFICIENT_STORAGE), "Canon EF 16-35mm f/4L IS USM");
