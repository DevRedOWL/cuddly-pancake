...
public class OlympusMakernoteDescriptor extends TagDescriptor<OlympusMakernoteDirectory> {
    ...
    public String getExposureModeDescription() {
        return getIndexedDescription(OlympusMakernoteDirectory.CameraSettings.TAG_EXPOSURE_MODE, PersonalKey.DEFAULT_PREFIX, ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, ExifInterface.LATITUDE_SOUTH, "M");
    }
