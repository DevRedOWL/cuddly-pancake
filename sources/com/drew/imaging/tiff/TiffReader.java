...
public class TiffReader {
    ...
    public static void processIfd(com.drew.imaging.tiff.TiffHandler r28, com.drew.lang.RandomAccessReader r29, java.util.Set<java.lang.Integer> r30, int r31, int r32) throws java.io.IOException {
        /*
            ...
            r11 = r32
            r1 = 0
            java.lang.Integer r2 = java.lang.Integer.valueOf(r31)     // Catch:{ all -> 0x0206 }
            boolean r2 = r0.contains(r2)     // Catch:{ all -> 0x0206 }
        ...
        L_0x0019:
            ...
            long r2 = (long) r10     // Catch:{ all -> 0x0206 }
            long r4 = r29.getLength()     // Catch:{ all -> 0x0206 }
            int r6 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r6 >= 0) goto L_0x01fd
            if (r10 >= 0) goto L_0x002d
            goto L_0x01fd
        L_0x002d:
            int r2 = r9.getUInt16(r10)     // Catch:{ all -> 0x0206 }
            r3 = 255(0xff, float:3.57E-43)
            if (r2 <= r3) goto L_0x004f
            r3 = r2 & 255(0xff, float:3.57E-43)
            if (r3 != 0) goto L_0x004f
            boolean r3 = r29.isMotorolaByteOrder()     // Catch:{ all -> 0x0206 }
            java.lang.Boolean r1 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x0206 }
            int r2 = r2 >> 8
            boolean r3 = r29.isMotorolaByteOrder()     // Catch:{ all -> 0x0206 }
        ...
        L_0x004b:
            r3 = 0
        L_0x004c:
            r9.setMotorolaByteOrder(r3)     // Catch:{ all -> 0x0206 }
        L_0x004f:
            r15 = r1
            r14 = r2
            int r1 = r14 * 12
            ...
            int r1 = r1 + r10
            long r1 = (long) r1
            long r3 = r29.getLength()     // Catch:{ all -> 0x01f9 }
            int r5 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r5 <= 0) goto L_0x0073
            java.lang.String r0 = "Illegally sized IFD"
            r8.error(r0)     // Catch:{ all -> 0x01f9 }
            r28.endingIFD()
        ...
        L_0x0076:
            ...
            int r1 = calculateTagOffset(r10, r6)     // Catch:{ all -> 0x01f9 }
            int r5 = r9.getUInt16(r1)     // Catch:{ all -> 0x01f9 }
            int r2 = r1 + 2
            int r4 = r9.getUInt16(r2)     // Catch:{ all -> 0x01f9 }
            com.drew.imaging.tiff.TiffDataFormat r2 = com.drew.imaging.tiff.TiffDataFormat.fromTiffFormatCode(r4)     // Catch:{ all -> 0x01f9 }
            int r3 = r1 + 4
            long r12 = r9.getUInt32(r3)     // Catch:{ all -> 0x01f9 }
            if (r2 != 0) goto L_0x00df
            java.lang.Long r2 = r8.tryCustomProcessFormat(r5, r4, r12)     // Catch:{ all -> 0x01f9 }
            if (r2 != 0) goto L_0x00d6
            java.lang.String r1 = "Invalid TIFF tag format code %d for tag 0x%04X"
            java.lang.Object[] r2 = new java.lang.Object[r7]     // Catch:{ all -> 0x01f9 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r4)     // Catch:{ all -> 0x01f9 }
            r18 = 0
            r2[r18] = r3     // Catch:{ all -> 0x01f9 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r5)     // Catch:{ all -> 0x01f9 }
            r17 = 1
            r2[r17] = r3     // Catch:{ all -> 0x01f9 }
            java.lang.String r1 = java.lang.String.format(r1, r2)     // Catch:{ all -> 0x01f9 }
        ...
        L_0x00d6:
            r17 = 1
            r18 = 0
            long r2 = r2.longValue()     // Catch:{ all -> 0x01f9 }
            goto L_0x00ea
        L_0x00df:
            r17 = 1
            r18 = 0
            int r2 = r2.getComponentSizeBytes()     // Catch:{ all -> 0x01f9 }
            long r2 = (long) r2
            long r2 = r2 * r12
        L_0x00ea:
            ...
            int r1 = r1 + 8
            long r22 = r9.getUInt32(r1)     // Catch:{ all -> 0x01f9 }
            long r24 = r22 + r2
        ...
        L_0x0115:
            ...
            long r26 = r29.getLength()     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0134:
            ...
            r21 = 0
        L_0x013f:
            long r6 = (long) r1     // Catch:{ all -> 0x01f7 }
            int r22 = (r6 > r12 ? 1 : (r6 == r12 ? 0 : -1))
            if (r22 >= 0) goto L_0x015e
            boolean r6 = r8.tryEnterSubIfd(r5)     // Catch:{ all -> 0x01f7 }
            if (r6 == 0) goto L_0x0159
            int r6 = r1 * 4
            long r6 = (long) r6     // Catch:{ all -> 0x01f7 }
            long r6 = r6 + r14
            int r7 = (int) r6     // Catch:{ all -> 0x01f7 }
            int r6 = r9.getInt32(r7)     // Catch:{ all -> 0x01f7 }
            int r6 = r6 + r11
            processIfd(r8, r9, r0, r6, r11)     // Catch:{ all -> 0x01f7 }
            r21 = 1
        L_0x0159:
            int r1 = r1 + 1
            goto L_0x013f
        ...
        L_0x015e:
            ...
            int r15 = (int) r14     // Catch:{ all -> 0x01f7 }
            int r7 = (int) r2     // Catch:{ all -> 0x01f7 }
            r1 = r28
            r2 = r15
            r3 = r30
            r14 = r4
            ...
            r6 = r21
            r19 = 2
            boolean r1 = r1.customProcessTag(r2, r3, r4, r5, r6, r7)     // Catch:{ all -> 0x01f7 }
            if (r1 != 0) goto L_0x01a5
            int r4 = (int) r12     // Catch:{ all -> 0x01f7 }
            r1 = r28
            r2 = r21
            r3 = r15
            r5 = r14
            r6 = r29
            processTag(r1, r2, r3, r4, r5, r6)     // Catch:{ all -> 0x01f7 }
            goto L_0x01a5
        L_0x0185:
            r20 = r6
            r19 = 2
            ...
            r1.append(r4)     // Catch:{ all -> 0x01f7 }
            r1.append(r2)     // Catch:{ all -> 0x01f7 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x01f7 }
            r8.error(r1)     // Catch:{ all -> 0x01f7 }
            goto L_0x01a5
        L_0x019e:
            r20 = r6
            r19 = 2
            r8.error(r7)     // Catch:{ all -> 0x01f7 }
        L_0x01a5:
            int r6 = r20 + 1
            r14 = r24
            r15 = r25
        ...
        L_0x01ae:
            r2 = r14
            r25 = r15
            int r1 = calculateTagOffset(r10, r2)     // Catch:{ all -> 0x01f7 }
            int r1 = r9.getInt32(r1)     // Catch:{ all -> 0x01f7 }
            if (r1 == 0) goto L_0x01ea
            int r1 = r1 + r11
            long r2 = (long) r1     // Catch:{ all -> 0x01f7 }
            long r4 = r29.getLength()     // Catch:{ all -> 0x01f7 }
            int r6 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
        ...
        L_0x01e0:
            return
        L_0x01e1:
            boolean r2 = r28.hasFollowerIfd()     // Catch:{ all -> 0x01f7 }
            if (r2 == 0) goto L_0x01ea
            processIfd(r8, r9, r0, r1, r11)     // Catch:{ all -> 0x01f7 }
        L_0x01ea:
            r28.endingIFD()
