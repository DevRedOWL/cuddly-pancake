...
public final class CodeScanner {
    ...
    public void setFormats(List<BarcodeFormat> list) {
        ...
        synchronized (this.mInitializeLock) {
            this.mFormats = (List) Objects.requireNonNull(list);
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(5:2|3|(4:9|10|11|(3:16|(2:18|(1:20)(1:21))|22))|23|24) */
    ...
    public void performTouchFocus(com.budiyev.android.codescanner.Rect r9) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r8.mInitialized     // Catch:{ all -> 0x0067 }
            if (r1 == 0) goto L_0x0065
            boolean r1 = r8.mPreviewActive     // Catch:{ all -> 0x0067 }
            if (r1 == 0) goto L_0x0065
            boolean r1 = r8.mTouchFocusing     // Catch:{ all -> 0x0067 }
            if (r1 != 0) goto L_0x0065
            r1 = 0
            r8.setAutoFocusEnabled(r1)     // Catch:{ Exception -> 0x0065 }
            com.budiyev.android.codescanner.DecoderWrapper r1 = r8.mDecoderWrapper     // Catch:{ Exception -> 0x0065 }
            boolean r2 = r8.mPreviewActive     // Catch:{ Exception -> 0x0065 }
            if (r2 == 0) goto L_0x0065
            if (r1 == 0) goto L_0x0065
            boolean r2 = r1.isAutoFocusSupported()     // Catch:{ Exception -> 0x0065 }
            if (r2 == 0) goto L_0x0065
            com.budiyev.android.codescanner.Point r2 = r1.getImageSize()     // Catch:{ Exception -> 0x0065 }
            int r3 = r2.getX()     // Catch:{ Exception -> 0x0065 }
            int r2 = r2.getY()     // Catch:{ Exception -> 0x0065 }
            int r4 = r1.getDisplayOrientation()     // Catch:{ Exception -> 0x0065 }
            r5 = 90
        ...
        L_0x003a:
            ...
            r2 = r7
        L_0x003d:
            com.budiyev.android.codescanner.Point r5 = r1.getPreviewSize()     // Catch:{ Exception -> 0x0065 }
            com.budiyev.android.codescanner.Point r6 = r1.getViewSize()     // Catch:{ Exception -> 0x0065 }
            com.budiyev.android.codescanner.Rect r9 = com.budiyev.android.codescanner.Utils.getImageFrameRect(r2, r3, r9, r5, r6)     // Catch:{ Exception -> 0x0065 }
            android.hardware.Camera r1 = r1.getCamera()     // Catch:{ Exception -> 0x0065 }
            r1.cancelAutoFocus()     // Catch:{ Exception -> 0x0065 }
            android.hardware.Camera$Parameters r5 = r1.getParameters()     // Catch:{ Exception -> 0x0065 }
            com.budiyev.android.codescanner.Utils.configureFocusArea(r5, r9, r2, r3, r4)     // Catch:{ Exception -> 0x0065 }
            com.budiyev.android.codescanner.Utils.configureFocusModeForTouch(r5)     // Catch:{ Exception -> 0x0065 }
            r1.setParameters(r5)     // Catch:{ Exception -> 0x0065 }
            android.hardware.Camera$AutoFocusCallback r9 = r8.mTouchFocusCallback     // Catch:{ Exception -> 0x0065 }
            r1.autoFocus(r9)     // Catch:{ Exception -> 0x0065 }
            r9 = 1
            r8.mTouchFocusing = r9     // Catch:{ Exception -> 0x0065 }
        L_0x0065:
    ...
    private void setFlashEnabledInternal(boolean r3) {
        /*
            r2 = this;
            com.budiyev.android.codescanner.DecoderWrapper r0 = r2.mDecoderWrapper     // Catch:{ Exception -> 0x0020 }
            if (r0 == 0) goto L_0x0020
            android.hardware.Camera r0 = r0.getCamera()     // Catch:{ Exception -> 0x0020 }
            android.hardware.Camera$Parameters r1 = r0.getParameters()     // Catch:{ Exception -> 0x0020 }
            if (r1 != 0) goto L_0x000f
            return
        L_0x000f:
            if (r3 == 0) goto L_0x0018
            java.lang.String r3 = "torch"
            com.budiyev.android.codescanner.Utils.setFlashMode(r1, r3)     // Catch:{ Exception -> 0x0020 }
            goto L_0x001d
        L_0x0018:
            java.lang.String r3 = "off"
            com.budiyev.android.codescanner.Utils.setFlashMode(r1, r3)     // Catch:{ Exception -> 0x0020 }
        L_0x001d:
            r0.setParameters(r1)     // Catch:{ Exception -> 0x0020 }
        L_0x0020:
            return
        */
    ...
    private final class InitializationThread extends Thread {
        ...
        private void initialize() {
            ...
            L_0x0104:
                ...
                monitor-enter(r19)
                com.budiyev.android.codescanner.Decoder r0 = new com.budiyev.android.codescanner.Decoder     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r5 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner$DecoderStateListener r5 = r5.mDecoderStateListener     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r6 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                java.util.List r6 = r6.mFormats     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r7 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.DecodeCallback r7 = r7.mDecodeCallback     // Catch:{ all -> 0x016a }
                r0.<init>(r5, r6, r7)     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r10 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.DecoderWrapper r9 = new com.budiyev.android.codescanner.DecoderWrapper     // Catch:{ all -> 0x016a }
                r8 = r2
                r2 = r9
                r5 = r0
                r6 = r16
                ...
                r15 = r10
                r10 = r17
                r2.<init>(r3, r4, r5, r6, r7, r8, r9, r10, r11)     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.DecoderWrapper unused = r15.mDecoderWrapper = r13     // Catch:{ all -> 0x016a }
                r0.start()     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r0 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                boolean unused = r0.mInitialization = r14     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r0 = com.budiyev.android.codescanner.CodeScanner.this     // Catch:{ all -> 0x016a }
                r2 = 1
                boolean unused = r0.mInitialized = r2     // Catch:{ all -> 0x016a }
                monitor-exit(r19)     // Catch:{ all -> 0x016a }
                com.budiyev.android.codescanner.CodeScanner r0 = com.budiyev.android.codescanner.CodeScanner.this
