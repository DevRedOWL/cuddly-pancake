...
public final class CodeScannerView extends ViewGroup {
    ...
    private void initialize(android.content.Context r11, android.util.AttributeSet r12, int r13, int r14) {
        /*
            ...
            r0.<init>(r11)
            r10.mPreviewView = r0
            android.view.SurfaceView r0 = r10.mPreviewView
            ...
            com.budiyev.android.codescanner.ViewFinderView r0 = r10.mViewFinderView
            android.view.ViewGroup$LayoutParams r1 = new android.view.ViewGroup$LayoutParams
            r1.<init>(r2, r2)
            r0.setLayoutParams(r1)
            ...
            r1.setScaleType(r3)
            android.widget.ImageView r1 = r10.mAutoFocusButton
            int r3 = com.budiyev.android.codescanner.C1094R.C1095drawable.ic_code_scanner_auto_focus_on
            ...
            r1.setScaleType(r3)
            android.widget.ImageView r1 = r10.mFlashButton
            int r3 = com.budiyev.android.codescanner.C1094R.C1095drawable.ic_code_scanner_flash_on
            r1.setImageResource(r3)
            android.widget.ImageView r1 = r10.mFlashButton
            ...
            goto L_0x017c
        L_0x00f1:
            android.content.res.Resources$Theme r11 = r11.getTheme()     // Catch:{ all -> 0x0191 }
            int[] r9 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView     // Catch:{ all -> 0x0191 }
            android.content.res.TypedArray r4 = r11.obtainStyledAttributes(r12, r9, r13, r14)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_maskColor     // Catch:{ all -> 0x0191 }
            int r11 = r4.getColor(r11, r7)     // Catch:{ all -> 0x0191 }
            r10.setMaskColor(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameColor     // Catch:{ all -> 0x0191 }
            int r11 = r4.getColor(r11, r2)     // Catch:{ all -> 0x0191 }
            r10.setFrameColor(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameThickness     // Catch:{ all -> 0x0191 }
            float r6 = r6 * r0
            int r12 = java.lang.Math.round(r6)     // Catch:{ all -> 0x0191 }
            int r11 = r4.getDimensionPixelOffset(r11, r12)     // Catch:{ all -> 0x0191 }
            r10.setFrameThickness(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameCornersSize     // Catch:{ all -> 0x0191 }
            float r5 = r5 * r0
            int r12 = java.lang.Math.round(r5)     // Catch:{ all -> 0x0191 }
            int r11 = r4.getDimensionPixelOffset(r11, r12)     // Catch:{ all -> 0x0191 }
            r10.setFrameCornersSize(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameCornersRadius     // Catch:{ all -> 0x0191 }
            float r0 = r0 * r3
            int r12 = java.lang.Math.round(r0)     // Catch:{ all -> 0x0191 }
            int r11 = r4.getDimensionPixelOffset(r11, r12)     // Catch:{ all -> 0x0191 }
            r10.setFrameCornersRadius(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameAspectRatioWidth     // Catch:{ all -> 0x0191 }
            float r11 = r4.getFloat(r11, r8)     // Catch:{ all -> 0x0191 }
            int r12 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameAspectRatioHeight     // Catch:{ all -> 0x0191 }
            float r12 = r4.getFloat(r12, r8)     // Catch:{ all -> 0x0191 }
            r10.setFrameAspectRatio(r11, r12)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_frameSize     // Catch:{ all -> 0x0191 }
            float r11 = r4.getFloat(r11, r1)     // Catch:{ all -> 0x0191 }
            r10.setFrameSize(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_autoFocusButtonVisible     // Catch:{ all -> 0x0191 }
            r12 = 1
            boolean r11 = r4.getBoolean(r11, r12)     // Catch:{ all -> 0x0191 }
            r10.setAutoFocusButtonVisible(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_flashButtonVisible     // Catch:{ all -> 0x0191 }
            boolean r11 = r4.getBoolean(r11, r12)     // Catch:{ all -> 0x0191 }
            r10.setFlashButtonVisible(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_autoFocusButtonColor     // Catch:{ all -> 0x0191 }
            int r11 = r4.getColor(r11, r2)     // Catch:{ all -> 0x0191 }
            r10.setAutoFocusButtonColor(r11)     // Catch:{ all -> 0x0191 }
            int r11 = com.budiyev.android.codescanner.C1094R.styleable.CodeScannerView_flashButtonColor     // Catch:{ all -> 0x0191 }
            int r11 = r4.getColor(r11, r2)     // Catch:{ all -> 0x0191 }
            r10.setFlashButtonColor(r11)     // Catch:{ all -> 0x0191 }
    ...
    public void setAutoFocusEnabled(boolean z) {
        this.mAutoFocusButton.setImageResource(z ? C1094R.C1095drawable.ic_code_scanner_auto_focus_on : C1094R.C1095drawable.ic_code_scanner_auto_focus_off);
    }

    /* access modifiers changed from: package-private */
    public void setFlashEnabled(boolean z) {
        this.mFlashButton.setImageResource(z ? C1094R.C1095drawable.ic_code_scanner_flash_on : C1094R.C1095drawable.ic_code_scanner_flash_off);
    }
