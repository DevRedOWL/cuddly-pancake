...
final class Utils {
    ...
    public static byte[] rotateYuv(byte[] bArr, int i, int i2, int i3) {
        ...
        for (int i8 = 0; i8 < i5; i8++) {
            for (int i9 = 0; i9 < i4; i9++) {
                ...
                bArr3[i17 + 1] = (byte) (bArr2[i12] & 255);
            }
        }
        return bArr3;
    }
    ...
    private static int mapCoordinate(int i, int i2) {
        return ((i * MessageHandler.WHAT_SMOOTH_SCROLL) / i2) + NotificationManagerCompat.IMPORTANCE_UNSPECIFIED;
    }
