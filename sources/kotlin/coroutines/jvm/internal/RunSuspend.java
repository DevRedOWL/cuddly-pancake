...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m8107getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m6939boximpl(obj);
            notifyAll();
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m6949unboximpl());
                }
            }
        }
    }
