...
public final class DurationKt {
    ...
    private static final double m8255timesmvk6XK0(int i, double d) {
        return Duration.m8235timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m8254timeskIfJnKk(double d, double d2) {
        return Duration.m8234timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m8208constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
