...
/* renamed from: me.relex.circleindicator.Config */
public class Config {
    int animatorResId = C5070R.animator.scale_with_alpha;
    int animatorReverseResId = 0;
    int backgroundResId = C5070R.C5071drawable.white_radius;
    int gravity = 17;
    int height = -1;
    int margin = -1;
    int orientation = 0;
    ...
    /* renamed from: me.relex.circleindicator.Config$Builder */
