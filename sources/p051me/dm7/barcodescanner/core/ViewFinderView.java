...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderColor = getResources().getColor(C5046R.C5047color.viewfinder_border);
    private final int mDefaultBorderLineLength = getResources().getInteger(C5046R.integer.viewfinder_border_length);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(C5046R.integer.viewfinder_border_width);
    private final int mDefaultLaserColor = getResources().getColor(C5046R.C5047color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(C5046R.C5047color.viewfinder_mask);
