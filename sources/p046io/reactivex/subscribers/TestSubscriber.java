...
import p046io.reactivex.observers.BaseTestConsumer;
...
public class TestSubscriber<T> extends BaseTestConsumer<T, TestSubscriber<T>> implements FlowableSubscriber<T>, Subscription, Disposable {
    ...
    /* renamed from: qs */
    private QueueSubscription<T> f6170qs;
    ...
    public void onSubscribe(Subscription subscription2) {
        ...
        if (subscription2 == null) {
            ...
            if (this.initialFusionMode != 0 && (subscription2 instanceof QueueSubscription)) {
                this.f6170qs = (QueueSubscription) subscription2;
                int requestFusion = this.f6170qs.requestFusion(this.initialFusionMode);
