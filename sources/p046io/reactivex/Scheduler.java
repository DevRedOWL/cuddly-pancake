...
import p046io.reactivex.internal.schedulers.NewThreadWorker;
import p046io.reactivex.internal.schedulers.SchedulerWhen;
import p046io.reactivex.internal.util.ExceptionHelper;
import p046io.reactivex.plugins.RxJavaPlugins;
import p046io.reactivex.schedulers.SchedulerRunnableIntrospection;
        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.f5753sd.isDisposed()) {
                    ...
                    this.f5753sd.replace(Worker.this.schedule(this, j - now, TimeUnit.NANOSECONDS));
                }
            }
