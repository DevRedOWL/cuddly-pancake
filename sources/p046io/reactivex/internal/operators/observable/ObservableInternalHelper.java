...
import p046io.reactivex.Emitter;
...
public final class ObservableInternalHelper {
    ...
    static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u) throws Exception {
            return this.combiner.apply(this.f6011t, u);
        }
    }
    ...
    public static <T, R> p046io.reactivex.Observable<R> switchMapSingle(p046io.reactivex.Observable<T> r1, p046io.reactivex.functions.Function<? super T, ? extends p046io.reactivex.SingleSource<? extends R>> r2) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p046io.reactivex.internal.operators.observable.ObservableInternalHelper.switchMapSingle(io.reactivex.Observable, io.reactivex.functions.Function):io.reactivex.Observable");
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T, R> p046io.reactivex.Observable<R> switchMapSingleDelayError(p046io.reactivex.Observable<T> r1, p046io.reactivex.functions.Function<? super T, ? extends p046io.reactivex.SingleSource<? extends R>> r2) {
        /*
            io.reactivex.functions.Function r2 = convertSingleMapperToObservableMapper(r2)
            r0 = 1
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p046io.reactivex.internal.operators.observable.ObservableInternalHelper.switchMapSingleDelayError(io.reactivex.Observable, io.reactivex.functions.Function):io.reactivex.Observable");
    }
