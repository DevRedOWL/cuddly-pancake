...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public void connect(p046io.reactivex.functions.Consumer<? super p046io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0000:
            ...
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p046io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x0040:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p046io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        /* renamed from: s */
        final AtomicReference<Disposable> f6018s = new AtomicReference<>();
        ...
        public void dispose() {
            ...
            if (innerDisposableArr != innerDisposableArr2 && ((InnerDisposable[]) this.observers.getAndSet(innerDisposableArr2)) != TERMINATED) {
                ...
                DisposableHelper.dispose(this.f6018s);
            }
        }
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f6018s, disposable);
        }
