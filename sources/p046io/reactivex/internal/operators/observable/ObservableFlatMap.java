...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f5999s, disposable)) {
                this.f5999s = disposable;
        ...
        public void drainLoop() {
            ...
            L_0x0023:
                ...
                io.reactivex.internal.operators.observable.ObservableFlatMap$InnerObserver[] r5 = (p046io.reactivex.internal.operators.observable.ObservableFlatMap.InnerObserver[]) r5
                int r6 = r5.length
            ...
            L_0x003a:
                ...
                java.lang.Throwable r2 = p046io.reactivex.internal.util.ExceptionHelper.TERMINATED
            ...
            L_0x00f1:
                ...
                io.reactivex.ObservableSource r3 = (p046io.reactivex.ObservableSource) r3     // Catch:{ all -> 0x0113 }
            ...
            L_0x0116:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p046io.reactivex.internal.operators.observable.ObservableFlatMap.MergeObserver.drainLoop():void");
        }
