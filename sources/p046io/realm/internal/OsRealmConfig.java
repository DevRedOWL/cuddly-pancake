...
import p046io.realm.CompactOnLaunchCallback;
...
public class OsRealmConfig implements NativeObject {
    ...
    /* synthetic */ OsRealmConfig(RealmConfiguration realmConfiguration2, String str, boolean z, OsSchemaInfo osSchemaInfo, OsSharedRealm.MigrationCallback migrationCallback2, OsSharedRealm.InitializationCallback initializationCallback2, C45501 r7) {
    ...
    public static class Builder {
        ...
        public OsRealmConfig build() {
            return new OsRealmConfig(this.configuration, this.fifoFallbackDir, this.autoUpdateNotification, this.schemaInfo, this.migrationCallback, this.initializationCallback, (C45501) null);
        }
    ...
    private OsRealmConfig(RealmConfiguration realmConfiguration2, String str, boolean z, @Nullable OsSchemaInfo osSchemaInfo, @Nullable OsSharedRealm.MigrationCallback migrationCallback2, @Nullable OsSharedRealm.InitializationCallback initializationCallback2) {
            ...
            if (!(uri == null || proxySelector == null)) {
                ...
                if (select != null && !select.isEmpty()) {
                    ...
                    if (proxy.type() != Proxy.Type.DIRECT) {
                        byte b3 = C45501.$SwitchMap$java$net$Proxy$Type[proxy.type().ordinal()] == 1 ? (byte) 0 : -1;
        ...
        this.resolvedRealmURI = uri3;
    }

    /* renamed from: io.realm.internal.OsRealmConfig$1 */
    static /* synthetic */ class C45501 {
