...
class BaseModuleMediator extends RealmProxyMediator {
    ...
    public String getSimpleClassNameImpl(Class<? extends RealmModel> cls) {
        checkClass(cls);
        if (cls.equals(PermissionUser.class)) {
            return C4586xa102e1bc.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(RealmPermissions.class)) {
            return C4588xa165cb7.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(ClassPermissions.class)) {
            return C4583x3a7fdb6e.INTERNAL_CLASS_NAME;
        }
        if (cls.equals(Permission.class)) {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E e, boolean z, Map<RealmModel, RealmObjectProxy> map, Set<ImportFlag> set) {
        ...
        if (superclass.equals(PermissionUser.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_PermissionUserRealmProxy.copyOrUpdate(realm, (C4587xf217bf53) realm.getSchema().getColumnInfo((Class<? extends RealmModel>) PermissionUser.class), (PermissionUser) e, z, map, set));
        } else if (superclass.equals(RealmPermissions.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_RealmPermissionsRealmProxy.copyOrUpdate(realm, (C4589x864ed6b3) realm.getSchema().getColumnInfo((Class<? extends RealmModel>) RealmPermissions.class), (RealmPermissions) e, z, map, set));
        } else if (superclass.equals(ClassPermissions.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_ClassPermissionsRealmProxy.copyOrUpdate(realm, (C4584xc9bb9c53) realm.getSchema().getColumnInfo((Class<? extends RealmModel>) ClassPermissions.class), (ClassPermissions) e, z, map, set));
        } else if (superclass.equals(Permission.class)) {
            return (RealmModel) superclass.cast(io_realm_sync_permissions_PermissionRealmProxy.copyOrUpdate(realm, (C4585x7a514df3) realm.getSchema().getColumnInfo((Class<? extends RealmModel>) Permission.class), (Permission) e, z, map, set));
