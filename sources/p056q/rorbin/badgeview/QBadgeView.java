...
public class QBadgeView extends View implements Badge {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0045:
            ...
            int r0 = p056q.rorbin.badgeview.DisplayUtil.dp2px(r0, r3)
            float r0 = (float) r0
        ...
        L_0x00b9:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p056q.rorbin.badgeview.QBadgeView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void drawDragging(Canvas canvas, float f, float f2) {
        ...
        if (f7 != 0.0f) {
            ...
            MathUtil.getInnertangentPoints(this.mDragCenter, f2, Double.valueOf(Utils.DOUBLE_EPSILON), this.mInnertangentPoints);
            MathUtil.getInnertangentPoints(this.mRowBadgeCenter, f, Double.valueOf(Utils.DOUBLE_EPSILON), this.mInnertangentPoints);
        }
    ...
    private void findBadgeCenter() {
        ...
        switch (this.mBadgeGravity) {
            ...
            case BadgeDrawable.BOTTOM_START:
                ...
                pointF8.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f6) + (this.mBadgeTextRect.height() / 2.0f));
                break;
            case BadgeDrawable.BOTTOM_END:
                PointF pointF9 = this.mBadgeCenter;
                float f7 = this.mGravityOffsetX;
                float f8 = this.mBadgePadding;
                pointF9.x = ((float) this.mWidth) - ((f7 + f8) + (height / 2.0f));
                pointF9.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f8) + (this.mBadgeTextRect.height() / 2.0f));
                break;
        }
        initRowBadgeCenter();
    }
