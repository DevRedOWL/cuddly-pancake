package p048it.sephiroth.android.library.imagezoom;
...
import p048it.sephiroth.android.library.easing.Cubic;
import p048it.sephiroth.android.library.easing.Easing;
import p048it.sephiroth.android.library.imagezoom.graphics.FastBitmapDrawable;
import p048it.sephiroth.android.library.imagezoom.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            pointF.x = ((float) i13) / 2.0f;
            pointF.y = ((float) i14) / 2.0f;
        } else {
            i6 = 0;
            i5 = 0;
        }
    ...
    public android.graphics.RectF getCenter(android.graphics.Matrix r6, boolean r7, boolean r8) {
        ...
        L_0x006a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p048it.sephiroth.android.library.imagezoom.ImageViewTouchBase.getCenter(android.graphics.Matrix, boolean, boolean):android.graphics.RectF");
    }
    ...
    public void scrollBy(float f, float f2, double d) {
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                double d = min;
                double easeOut = ImageViewTouchBase.this.mEasing.easeOut(d, Utils.DOUBLE_EPSILON, d2, d4);
                double easeOut2 = ImageViewTouchBase.this.mEasing.easeOut(d, Utils.DOUBLE_EPSILON, d3, d4);
    ...
    public void zoomTo(float f, float f2, float f3, float f4) {
        ...
        this.mHandler.post(new Runnable() {
            public void run() {
                ...
                ImageViewTouchBase.this.zoomTo(scale + ((float) ImageViewTouchBase.this.mEasing.easeInOut((double) min, Utils.DOUBLE_EPSILON, (double) f5, (double) f8)), f6, f7);
                if (min < f8) {
                    ImageViewTouchBase.this.mHandler.post(this);
                    return;
                }
