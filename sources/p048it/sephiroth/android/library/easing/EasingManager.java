package p048it.sephiroth.android.library.easing;
...
public final class EasingManager {
    ...
    static /* synthetic */ class C48851 {

        /* renamed from: $SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType */
        static final /* synthetic */ int[] f6171xa5f66278 = new int[EaseType.values().length];
        ...
        static {
            /*
                it.sephiroth.android.library.easing.EasingManager$EaseType[] r0 = p048it.sephiroth.android.library.easing.EasingManager.EaseType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f6171xa5f66278 = r0
                int[] r0 = f6171xa5f66278     // Catch:{ NoSuchFieldError -> 0x0014 }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = p048it.sephiroth.android.library.easing.EasingManager.EaseType.EaseIn     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f6171xa5f66278     // Catch:{ NoSuchFieldError -> 0x001f }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = p048it.sephiroth.android.library.easing.EasingManager.EaseType.EaseInOut     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = f6171xa5f66278     // Catch:{ NoSuchFieldError -> 0x002a }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = p048it.sephiroth.android.library.easing.EasingManager.EaseType.EaseNone     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = f6171xa5f66278     // Catch:{ NoSuchFieldError -> 0x0035 }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = p048it.sephiroth.android.library.easing.EasingManager.EaseType.EaseOut     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p048it.sephiroth.android.library.easing.EasingManager.C48851.<clinit>():void");
        }
    }

    /* access modifiers changed from: package-private */
    public String getMethodName(EaseType easeType) {
        int i = C48851.f6171xa5f66278[easeType.ordinal()];
        if (i == 1) {
            return "easeIn";
        }
        if (i == 2) {
