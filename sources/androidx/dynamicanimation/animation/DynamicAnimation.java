...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f67X = new ViewProperty(MapPoint.JsonFields.f6911x) {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f68Y = new ViewProperty(MapPoint.JsonFields.f6912y) {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f69Z = new ViewProperty("z") {
        public void setValue(View view, float f) {
