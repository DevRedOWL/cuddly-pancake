...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() {
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f70x - diagonal2.f70x;
        }
    };
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        int i4;
        Range range2 = range;
        CenteredArray centeredArray3 = centeredArray;
        int i5 = i;
        boolean z = true;
        ...
        for (int i7 = i6; i7 <= i5; i7 += 2) {
            if (i7 == i6 || (i7 != i5 && centeredArray3.get(i7 + 1) > centeredArray3.get(i7 - 1))) {
                i3 = centeredArray3.get(i7 + 1);
                i2 = i3;
            } else {
                int i8 = centeredArray3.get(i7 - 1);
                i2 = i8;
                i3 = i8 + 1;
            }
            int i9 = (range2.newListStart + (i3 - range2.oldListStart)) - i7;
            int i10 = (i5 == 0 || i3 != i2) ? i9 : i9 - 1;
            while (true) {
                if (i3 < range2.oldListEnd && i9 < range2.newListEnd) {
                    if (!callback.areItemsTheSame(i3, i9)) {
                        break;
                    }
                    i3++;
                    i9++;
            ...
            centeredArray3.set(i7, i3);
            if (!z || (i4 = oldSize - i7) < i6 + 1 || i4 > i5 - 1) {
                CenteredArray centeredArray4 = centeredArray2;
            } else if (centeredArray2.get(i4) <= i3) {
    ...
    private static Snake backward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        int i4;
        Range range2 = range;
        CenteredArray centeredArray3 = centeredArray2;
        int i5 = i;
        ...
        for (int i7 = i6; i7 <= i5; i7 += 2) {
            ...
            int i9 = range2.newListEnd - ((range2.oldListEnd - i3) - i7);
            int i10 = (i5 == 0 || i3 != i2) ? i9 : i9 + 1;
            while (true) {
                if (i3 > range2.oldListStart && i9 > range2.newListStart) {
                    if (!callback.areItemsTheSame(i3 - 1, i9 - 1)) {
                        break;
                    }
                    i3--;
                    i9--;
            ...
            centeredArray3.set(i7, i3);
            if (!z || (i4 = oldSize - i7) < i6 || i4 > i5) {
                CenteredArray centeredArray4 = centeredArray;
            } else if (centeredArray.get(i4) >= i3) {
                Snake snake = new Snake();
                snake.startX = i3;
                snake.startY = i9;
                snake.endX = i2;
    ...
    static class Diagonal {
        ...
        /* renamed from: x */
        public final int f70x;

        /* renamed from: y */
        public final int f71y;
        ...
        public int endX() {
            return this.f70x + this.size;
        }

        /* access modifiers changed from: package-private */
        public int endY() {
            return this.f71y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (!(diagonal != null && diagonal.f70x == 0 && diagonal.f71y == 0)) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i10 = diagonal.f70x;
                int i11 = diagonal.f71y;
