    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i17) {
                ...
                if (this.mOrientation == 1) {
                    i10 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i21, layoutParams.width, false);
                    i9 = View.MeasureSpec.makeMeasureSpec(i17 - i20, BasicMeasure.EXACTLY);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i17 - i21, BasicMeasure.EXACTLY);
                    i9 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i20, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
