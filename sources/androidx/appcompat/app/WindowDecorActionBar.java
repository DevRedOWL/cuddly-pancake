...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0041R.C0044id.decor_content_parent);
        ...
        this.mContainerView = (ActionBarContainer) view.findViewById(C0041R.C0044id.action_bar_container);
