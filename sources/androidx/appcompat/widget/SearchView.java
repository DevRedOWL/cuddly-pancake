...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0041R.C0044id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0041R.C0044id.search_edit_frame);
        this.mSearchPlate = findViewById(C0041R.C0044id.search_plate);
        this.mSubmitArea = findViewById(C0041R.C0044id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0041R.C0044id.search_button);
        this.mGoButton = (ImageView) findViewById(C0041R.C0044id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0041R.C0044id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0041R.C0044id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0041R.C0044id.search_mag_icon);
