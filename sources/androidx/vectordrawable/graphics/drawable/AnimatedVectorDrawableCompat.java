...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat create(android.content.Context r6, int r7) {
        ...
        L_0x0033:
            ...
            android.content.res.XmlResourceParser r7 = r2.getXml(r7)     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
        L_0x003f:
            int r3 = r7.next()     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            r4 = 2
        ...
        L_0x004a:
            ...
            android.content.res.Resources r3 = r6.getResources()     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            android.content.res.Resources$Theme r4 = r6.getTheme()     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat r6 = createFromXmlInner(r6, r3, r7, r2, r4)     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            return r6
        L_0x0059:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
            throw r6     // Catch:{ XmlPullParserException -> 0x0066, IOException -> 0x0061 }
        L_0x0061:
            r6 = move-exception
