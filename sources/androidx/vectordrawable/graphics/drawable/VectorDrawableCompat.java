...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat create(android.content.res.Resources r6, int r7, android.content.res.Resources.Theme r8) {
        /*
            ...
            return r0
        L_0x0024:
            android.content.res.XmlResourceParser r7 = r6.getXml(r7)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
            android.util.AttributeSet r2 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
        L_0x002c:
            int r3 = r7.next()     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
            r4 = 2
        ...
        L_0x0037:
            ...
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat r6 = createFromXmlInner(r6, r7, r2, r8)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
            return r6
        L_0x003e:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
            throw r6     // Catch:{ XmlPullParserException -> 0x004b, IOException -> 0x0046 }
        L_0x0046:
            r6 = move-exception
