...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f44x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f45y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f44x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f45y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f44x;
        rectF.top = this.mStartMotionPath.f45y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f44x;
        rectF2.top = this.mEndMotionPath.f45y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f44x - this.mStartMotionPath.f44x;
        float f4 = this.mEndMotionPath.f45y - this.mStartMotionPath.f45y;
        float f5 = this.mStartMotionPath.f44x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f45y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr = (double[][]) Array.newInstance(cls, new int[]{motionPathsArr.length, this.mInterpolateVariables.length});
            ...
            for (int i16 = 0; i16 < motionPathsArr.length; i16++) {
                if (motionPathsArr[i16].hasCustomData(str7)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance(cls, new int[]{motionPathsArr.length, motionPathsArr[i16].getCustomDataCount(str7)});
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                ...
                dArr6[i17][0] = (double) motionPathsArr[i17].f44x;
                dArr6[i17][1] = (double) motionPathsArr[i17].f45y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f44x + " y: " + this.mStartMotionPath.f45y + " end: x: " + this.mEndMotionPath.f44x + " y: " + this.mEndMotionPath.f45y;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v63, resolved type: androidx.constraintlayout.motion.widget.TimeCycleSplineSet} */
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f44x - this.mStartMotionPath.f44x;
        float f6 = this.mEndMotionPath.f45y - this.mStartMotionPath.f45y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f44x - this.mStartMotionPath.f44x;
            float f8 = this.mEndMotionPath.f45y - this.mStartMotionPath.f45y;
