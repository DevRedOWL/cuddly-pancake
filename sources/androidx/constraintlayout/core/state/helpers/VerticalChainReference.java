...
public class VerticalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = C01581.$SwitchMap$androidx$constraintlayout$core$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01581 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.helpers.VerticalChainReference.C01581.<clinit>():void");
        }
    }
