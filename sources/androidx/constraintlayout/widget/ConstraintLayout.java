...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:186:0x02a5  */
        /* JADX WARNING: Removed duplicated region for block: B:188:0x02ab  */
        /* JADX WARNING: Removed duplicated region for block: B:189:0x02b0  */
        ...
        public final void measure(androidx.constraintlayout.core.widgets.ConstraintWidget r18, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measure r19) {
            ...
            L_0x0026:
                ...
                int[] r11 = androidx.constraintlayout.widget.ConstraintLayout.C01841.f48x6d00e4a2
                int r12 = r3.ordinal()
                r11 = r11[r12]
                r12 = 4
                r13 = 3
            ...
            L_0x00b4:
                ...
                int r6 = android.view.View.MeasureSpec.makeMeasureSpec(r6, r9)
            L_0x00ba:
                int[] r9 = androidx.constraintlayout.widget.ConstraintLayout.C01841.f48x6d00e4a2
                int r11 = r4.ordinal()
                r9 = r9[r11]
    ...
    static /* synthetic */ class C01841 {
        ...
        static final /* synthetic */ int[] f48x6d00e4a2 = new int[ConstraintWidget.DimensionBehaviour.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f48x6d00e4a2 = r0
                int[] r0 = f48x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0014 }
                androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour r1 = androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.FIXED     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f48x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x001f }
                androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour r1 = androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = f48x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x002a }
                androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour r1 = androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_PARENT     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = f48x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0035 }
                androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour r1 = androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintLayout.C01841.<clinit>():void");
        }
    }
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0185R.styleable.ConstraintLayout_Layout, i, i2);
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                } else if (index == C0185R.styleable.ConstraintLayout_Layout_layoutDescription) {
    ...
    public void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (layoutParams2.isGuideline) {
            ...
            if (layoutParams2.circleConstraint != -1) {
                ...
                } else if (!(i3 == -1 || (constraintWidget5 = sparseArray2.get(i3)) == null)) {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private static class Table {
            ...
            static {
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_width, 62);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_height, 63);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintWidth, 64);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintHeight, 65);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                ...
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toTopOf, 52);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBottomOf, 53);
                ...
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_goneMarginBaseline, 55);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_marginBaseline, 54);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginLeft, 56);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginRight, 57);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginTop, 58);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginBottom, 59);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginStart, 60);
                map.append(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginEnd, 61);
                ...
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_constraintTag, 51);
                map.append(C0185R.styleable.ConstraintLayout_Layout_layout_wrapBehaviorInParent, 66);
            }
        }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            int i;
            int i2;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0185R.styleable.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0185R.styleable.ConstraintLayout_Layout_android_layout_margin, -1);
            if (dimensionPixelSize >= 0) {
                ...
                i2 = obtainStyledAttributes.getDimensionPixelSize(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginHorizontal, -1);
                i = obtainStyledAttributes.getDimensionPixelSize(C0185R.styleable.ConstraintLayout_Layout_android_layout_marginVertical, -1);
                if (i2 >= 0) {
                    this.originalLeftMargin = i2;
                    this.originalRightMargin = i2;
                }
                if (i >= 0) {
                    this.topMargin = i;
                    this.bottomMargin = i;
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (Table.map.get(index)) {
                    ...
                    case 62:
                        this.width = obtainStyledAttributes.getLayoutDimension(C0185R.styleable.ConstraintLayout_Layout_android_layout_width, "layout_width");
                        this.widthSet = true;
                        break;
                    case 63:
                        this.height = obtainStyledAttributes.getLayoutDimension(C0185R.styleable.ConstraintLayout_Layout_android_layout_height, "layout_height");
                        this.heightSet = true;
                        break;
                    case 64:
        ...
        public void resolveLayoutDirection(int r6) {
            ...
            L_0x000f:
                r5.isRtl = r6
            L_0x0011:
                int r6 = r5.originalLeftMargin
                r5.leftMargin = r6
                int r0 = r5.originalRightMargin
                r5.rightMargin = r0
                boolean r3 = r5.isRtl
                r4 = -1
            ...
            L_0x0035:
                ...
                r5.rightMargin = r6
            L_0x003b:
                r5.resolvedRightToLeft = r4
                r5.resolvedRightToRight = r4
                r5.resolvedLeftToLeft = r4
                r5.resolvedLeftToRight = r4
                r5.resolveGoneLeftMargin = r4
                r5.resolveGoneRightMargin = r4
                int r6 = r5.goneLeftMargin
                r5.resolveGoneLeftMargin = r6
                int r6 = r5.goneRightMargin
                r5.resolveGoneRightMargin = r6
                float r6 = r5.horizontalBias
                r5.resolvedHorizontalBias = r6
                int r6 = r5.guideBegin
                r5.resolvedGuideBegin = r6
                int r6 = r5.guideEnd
                r5.resolvedGuideEnd = r6
                float r6 = r5.guidePercent
                r5.resolvedGuidePercent = r6
                boolean r6 = r5.isRtl
                if (r6 == 0) goto L_0x00c4
                int r6 = r5.startToEnd
            ...
            L_0x0079:
                ...
                r1 = 1
            L_0x0080:
                int r6 = r5.goneStartMargin
                if (r6 == r4) goto L_0x0086
                r5.resolveGoneRightMargin = r6
            L_0x0086:
                int r6 = r5.goneEndMargin
                if (r6 == r4) goto L_0x008c
                r5.resolveGoneLeftMargin = r6
            L_0x008c:
                r6 = 1065353216(0x3f800000, float:1.0)
                if (r1 == 0) goto L_0x0096
                float r0 = r5.horizontalBias
                float r0 = r6 - r0
                r5.resolvedHorizontalBias = r0
            L_0x0096:
                boolean r0 = r5.isGuideline
                ...
                float r6 = r6 - r0
                r5.resolvedGuidePercent = r6
                r5.resolvedGuideBegin = r4
                r5.resolvedGuideEnd = r4
                goto L_0x00e8
            L_0x00ae:
                int r6 = r5.guideBegin
            ...
            L_0x00e8:
                ...
                int r6 = r5.startToEnd
                if (r6 != r4) goto L_0x013a
                int r6 = r5.rightToLeft
                if (r6 == r4) goto L_0x0109
                r5.resolvedRightToLeft = r6
                int r6 = r5.rightMargin
                if (r6 > 0) goto L_0x0119
                int r6 = r5.originalRightMargin
                if (r6 <= 0) goto L_0x0119
                r5.rightMargin = r6
                goto L_0x0119
            L_0x0109:
                int r6 = r5.rightToRight
