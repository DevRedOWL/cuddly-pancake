...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        if (obtainAttributes.hasValue(C0196R.styleable.FontFamilyFont_fontWeight)) {
            i = C0196R.styleable.FontFamilyFont_fontWeight;
        } else {
            i = C0196R.styleable.FontFamilyFont_android_fontWeight;
        }
        int i6 = obtainAttributes.getInt(i, 400);
        if (obtainAttributes.hasValue(C0196R.styleable.FontFamilyFont_fontStyle)) {
            i2 = C0196R.styleable.FontFamilyFont_fontStyle;
        } else {
            i2 = C0196R.styleable.FontFamilyFont_android_fontStyle;
        }
        boolean z = 1 == obtainAttributes.getInt(i2, 0);
        if (obtainAttributes.hasValue(C0196R.styleable.FontFamilyFont_ttcIndex)) {
            i3 = C0196R.styleable.FontFamilyFont_ttcIndex;
        } else {
            i3 = C0196R.styleable.FontFamilyFont_android_ttcIndex;
        }
        if (obtainAttributes.hasValue(C0196R.styleable.FontFamilyFont_fontVariationSettings)) {
            i4 = C0196R.styleable.FontFamilyFont_fontVariationSettings;
        } else {
            i4 = C0196R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        String string = obtainAttributes.getString(i4);
        int i7 = obtainAttributes.getInt(i3, 0);
        if (obtainAttributes.hasValue(C0196R.styleable.FontFamilyFont_font)) {
            i5 = C0196R.styleable.FontFamilyFont_font;
        } else {
            i5 = C0196R.styleable.FontFamilyFont_android_font;
        }
