...
import androidx.databinding.library.C0301R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    public void setRootTag(View view) {
        view.setTag(C0301R.C0302id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0301R.C0302id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0301R.C0302id.dataBinding);
        }
        return null;
    }
