...
public final class ScriptGroup extends BaseObj {
    ...
    static class C0533IO {
        Allocation mAllocation;
        Script.KernelID mKID;

        C0533IO(Script.KernelID kernelID) {
            this.mKID = kernelID;
        }
    }
    ...
    public void execute() {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                for (C0533IO io2 : this.mOutputs) {
                    if (io2.mKID == next2) {
                        allocation4 = io2.mAllocation;
                    }
                }
            ...
            if (this.mNodes.size() != 0) {
                ...
                while (i2 < this.mNodes.size()) {
                    ...
                    while (i5 < node.mKernels.size()) {
                        ...
                        if (!z) {
                            arrayList.add(new C0533IO(kernelID));
                        }
                        if (!z2) {
                            arrayList2.add(new C0533IO(kernelID));
                        }
                        i5++;
                        i4 = i6;
                    }
                ...
                if (i3 == this.mKernelCount) {
                    ...
                    scriptGroup.mOutputs = new C0533IO[arrayList2.size()];
                    for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                        scriptGroup.mOutputs[i10] = (C0533IO) arrayList2.get(i10);
                    }
                    scriptGroup.mInputs = new C0533IO[arrayList.size()];
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        scriptGroup.mInputs[i11] = (C0533IO) arrayList.get(i11);
                    }
