...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public void setAdd(Float4 float4) {
        this.mAdd.f103x = float4.f103x;
        this.mAdd.f104y = float4.f104y;
        this.mAdd.f105z = float4.f105z;
        this.mAdd.f102w = float4.f102w;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(float4.f103x);
        fieldPacker.addF32(float4.f104y);
        fieldPacker.addF32(float4.f105z);
        fieldPacker.addF32(float4.f102w);
    ...
    public void setAdd(float f, float f2, float f3, float f4) {
        ...
        float4.f102w = f4;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(this.mAdd.f103x);
        fieldPacker.addF32(this.mAdd.f104y);
        fieldPacker.addF32(this.mAdd.f105z);
        fieldPacker.addF32(this.mAdd.f102w);
        setVar(1, fieldPacker);
    }
