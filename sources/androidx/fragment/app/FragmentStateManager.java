...
import androidx.fragment.C0338R;
...
class FragmentStateManager {
    ...
    public int computeMaxState() {
        ...
        int i2 = C03631.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i2 == 1) {
            return i;
        }
        if (i2 == 2) {
    ...
    static /* synthetic */ class C03631 {
        ...
        static {
            /*
                ...
                int[] r0 = $SwitchMap$androidx$lifecycle$Lifecycle$State     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = $SwitchMap$androidx$lifecycle$Lifecycle$State     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = $SwitchMap$androidx$lifecycle$Lifecycle$State     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C03631.<clinit>():void");
        }
    }
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0338R.C0341id.fragment_container_view_tag, this.mFragment);
    ...
    public void createView(androidx.fragment.app.FragmentContainer r5) {
        ...
        L_0x00b5:
            ...
            androidx.fragment.app.Fragment r5 = r4.mFragment
            android.view.View r5 = r5.mView
            int r2 = androidx.fragment.C0338R.C0341id.fragment_container_view_tag
