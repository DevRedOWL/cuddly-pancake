...
public class WorkTypeConverters {
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C07011.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    static /* synthetic */ class C07011 {
        ...
        static {
            ...
            L_0x00a3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C07011.<clinit>():void");
        }
    }

    public static int networkTypeToInt(NetworkType networkType) {
        int i = C07011.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
