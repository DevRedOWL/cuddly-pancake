                ...
                taskExecutor.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C07061.this.mCurrentOutput == null && apply != null) {
                                C07061.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C07061.this.mCurrentOutput != null && !C07061.this.mCurrentOutput.equals(apply)) {
                                C07061.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
