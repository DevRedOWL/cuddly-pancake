...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f138id);
    ...
    static /* synthetic */ class C06781 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C06781.<clinit>():void");
        }
    }

    static int convertNetworkType(NetworkType networkType) {
        int i = C06781.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
