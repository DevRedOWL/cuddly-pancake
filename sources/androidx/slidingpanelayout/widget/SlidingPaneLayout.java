        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i16, BasicMeasure.EXACTLY);
                } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i17;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i19, BasicMeasure.EXACTLY);
                                    if (i7 != i19) {
