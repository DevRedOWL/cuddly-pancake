...
/* renamed from: ru.unicorn.databinding.FragmentPassFaceSecondBindingImpl */
public class FragmentPassFaceSecondBindingImpl extends FragmentPassFaceSecondBinding {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.previewVideoView, 4);
        sViewsWithIds.put(R.id.makePhoto, 5);
        sViewsWithIds.put(R.id.confirm, 6);
    }

    public FragmentPassFaceSecondBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, sIncludes, sViewsWithIds));
    }

    private FragmentPassFaceSecondBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, objArr[3], objArr[6], objArr[2], objArr[5], objArr[4]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassFaceSecondBindingImpl.hasPendingBindings():boolean");
    }
