...
/* renamed from: ru.unicorn.databinding.FragmentPassFingerFirstBindingImpl */
public class FragmentPassFingerFirstBindingImpl extends FragmentPassFingerFirstBinding {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addFinger, 7);
    }

    public FragmentPassFingerFirstBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 8, sIncludes, sViewsWithIds));
    }

    private FragmentPassFingerFirstBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 4, objArr[7], objArr[3], objArr[4], objArr[5], objArr[2], objArr[6]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0033:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassFingerFirstBindingImpl.hasPendingBindings():boolean");
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 32) != 0) {
            ...
            this.choose1.setSubtitle(getRoot().getResources().getString(R.string.label_id_first_stage_subtitle));
            ...
            this.choose3.setSubtitle(getRoot().getResources().getString(R.string.label_id_third_stage_subtitle));
