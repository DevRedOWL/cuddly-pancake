...
/* renamed from: ru.unicorn.databinding.FragmentPassSettingsCardInfoBindingImpl */
public class FragmentPassSettingsCardInfoBindingImpl extends FragmentPassSettingsCardInfoBinding {
    ...
    public FragmentPassSettingsCardInfoBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 4, sIncludes, sViewsWithIds));
    }

    private FragmentPassSettingsCardInfoBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, objArr[2], objArr[3]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassSettingsCardInfoBindingImpl.hasPendingBindings():boolean");
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.id1.setLabel(getRoot().getResources().getString(R.string.label_card_request));
