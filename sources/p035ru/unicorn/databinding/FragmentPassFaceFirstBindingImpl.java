...
/* renamed from: ru.unicorn.databinding.FragmentPassFaceFirstBindingImpl */
public class FragmentPassFaceFirstBindingImpl extends FragmentPassFaceFirstBinding {
    ...
    static {
        sIncludes.setIncludes(0, new String[]{"item_pass_id_title_with_image", "item_id_pass_title_subtitle"}, new int[]{1, 2}, new int[]{R.layout.item_pass_id_title_with_image, R.layout.item_id_pass_title_subtitle});
        sViewsWithIds.put(R.id.my_pass_item, 3);
        sViewsWithIds.put(R.id.addFinger, 4);
    }

    public FragmentPassFaceFirstBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 5, sIncludes, sViewsWithIds));
    }

    private FragmentPassFaceFirstBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, objArr[4], objArr[2], objArr[1], objArr[3]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassFaceFirstBindingImpl.hasPendingBindings():boolean");
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 8) != 0) {
            this.choose1.setSubtitle(getRoot().getResources().getString(R.string.label_id_first_stage_subtitle_face));
            this.choose1.setTitle(getRoot().getResources().getString(R.string.label_id_first_stage_title));
            this.id1.setLabel(getRoot().getResources().getString(R.string.label_id_face));
            this.id1.setRes(getDrawableFromResource(getRoot(), R.drawable.ic_svg_id_face));
        }
