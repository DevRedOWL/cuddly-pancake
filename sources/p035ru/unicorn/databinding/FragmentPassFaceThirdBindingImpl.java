...
/* renamed from: ru.unicorn.databinding.FragmentPassFaceThirdBindingImpl */
public class FragmentPassFaceThirdBindingImpl extends FragmentPassFaceThirdBinding {
    ...
    public FragmentPassFaceThirdBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 5, sIncludes, sViewsWithIds));
    }

    private FragmentPassFaceThirdBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, objArr[3], objArr[2], objArr[4]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassFaceThirdBindingImpl.hasPendingBindings():boolean");
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 8) != 0) {
            this.choose1.setSubtitle(getRoot().getResources().getString(R.string.label_id_third_stage_subtitle_face));
            this.choose1.setTitle(getRoot().getResources().getString(R.string.label_id_third_stage_title));
