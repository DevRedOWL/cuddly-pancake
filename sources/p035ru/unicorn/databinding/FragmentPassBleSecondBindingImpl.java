...
/* renamed from: ru.unicorn.databinding.FragmentPassBleSecondBindingImpl */
public class FragmentPassBleSecondBindingImpl extends FragmentPassBleSecondBinding {
    ...
    public FragmentPassBleSecondBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 6, sIncludes, sViewsWithIds));
    }

    private FragmentPassBleSecondBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, objArr[5], objArr[3], objArr[2], objArr[4]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.databinding.FragmentPassBleSecondBindingImpl.hasPendingBindings():boolean");
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 8) != 0) {
            this.choose1.setSubtitle(getRoot().getResources().getString(R.string.label_id_fourth_stage_subtitle_ble));
