...
/* renamed from: ru.unicorn.ujin.ble.BleRepo$loadBleByInterfaceType$2 */
/* compiled from: BleRepo.kt */
final class BleRepo$loadBleByInterfaceType$2<T> implements Predicate<BleReader> {
    final /* synthetic */ String $type;

    BleRepo$loadBleByInterfaceType$2(String str) {
        this.$type = str;
    }

    public final boolean test(BleReader bleReader) {
        Intrinsics.checkNotNullParameter(bleReader, "it");
        return StringsKt.contains((CharSequence) bleReader.getInterfaceType(), (CharSequence) this.$type, true);
    }
}
