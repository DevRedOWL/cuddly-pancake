...
/* renamed from: ru.unicorn.ujin.ble.BleRepo$loadGateReader$3 */
/* compiled from: BleRepo.kt */
final class BleRepo$loadGateReader$3<T, R> implements Function<Throwable, List<BleReader>> {
    public static final BleRepo$loadGateReader$3 INSTANCE = new BleRepo$loadGateReader$3();

    BleRepo$loadGateReader$3() {
    }
