...
/* renamed from: ru.unicorn.ujin.ble.BleRepo$loadBleBySn$1 */
/* compiled from: BleRepo.kt */
final class BleRepo$loadBleBySn$1<T> implements Predicate<RealmModel> {
    public static final BleRepo$loadBleBySn$1 INSTANCE = new BleRepo$loadBleBySn$1();

    BleRepo$loadBleBySn$1() {
    }
