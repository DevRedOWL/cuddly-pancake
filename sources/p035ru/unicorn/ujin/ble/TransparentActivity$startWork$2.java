...
/* renamed from: ru.unicorn.ujin.ble.TransparentActivity$startWork$2 */
/* compiled from: TransparentActivity.kt */
final class TransparentActivity$startWork$2 extends Lambda implements Function1<MaterialDialog, Unit> {
    final /* synthetic */ TransparentActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TransparentActivity$startWork$2(TransparentActivity transparentActivity) {
        super(1);
