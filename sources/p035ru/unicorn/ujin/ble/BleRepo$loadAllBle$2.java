...
/* renamed from: ru.unicorn.ujin.ble.BleRepo$loadAllBle$2 */
/* compiled from: BleRepo.kt */
final class BleRepo$loadAllBle$2<T, R> implements Function<Throwable, List<BleReader>> {
    public static final BleRepo$loadAllBle$2 INSTANCE = new BleRepo$loadAllBle$2();

    BleRepo$loadAllBle$2() {
    }
