...
/* renamed from: ru.unicorn.ujin.util.GlideOptions */
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    public p035ru.unicorn.ujin.util.GlideOptions transform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            ru.unicorn.ujin.util.GlideOptions r1 = (p035ru.unicorn.ujin.util.GlideOptions) r1
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.util.GlideOptions.transform(com.bumptech.glide.load.Transformation):ru.unicorn.ujin.util.GlideOptions");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public p035ru.unicorn.ujin.util.GlideOptions optionalTransform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.util.GlideOptions.optionalTransform(com.bumptech.glide.load.Transformation):ru.unicorn.ujin.util.GlideOptions");
    }
