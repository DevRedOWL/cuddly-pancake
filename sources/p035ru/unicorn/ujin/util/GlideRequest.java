...
/* renamed from: ru.unicorn.ujin.util.GlideRequest */
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
    ...
    public p035ru.unicorn.ujin.util.GlideRequest<TranscodeType> transform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            ru.unicorn.ujin.util.GlideRequest r1 = (p035ru.unicorn.ujin.util.GlideRequest) r1
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.util.GlideRequest.transform(com.bumptech.glide.load.Transformation):ru.unicorn.ujin.util.GlideRequest");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public p035ru.unicorn.ujin.util.GlideRequest<TranscodeType> optionalTransform(com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r1) {
        /*
            r0 = this;
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.util.GlideRequest.optionalTransform(com.bumptech.glide.load.Transformation):ru.unicorn.ujin.util.GlideRequest");
    }
