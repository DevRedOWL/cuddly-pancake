...
/* renamed from: ru.unicorn.ujin.data.profile.ProfileViewModel$loadPassDeviceRemote$2 */
/* compiled from: ProfileViewModel.kt */
final class ProfileViewModel$loadPassDeviceRemote$2<T, R> implements Function<BleReader, MaybeSource<? extends BleKeyData>> {
    final /* synthetic */ BleRepo $bleRepo;

    ProfileViewModel$loadPassDeviceRemote$2(BleRepo bleRepo) {
