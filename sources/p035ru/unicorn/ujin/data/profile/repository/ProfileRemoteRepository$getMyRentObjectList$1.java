...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileRemoteRepository$getMyRentObjectList$1 */
/* compiled from: ProfileRemoteRepository.kt */
final class ProfileRemoteRepository$getMyRentObjectList$1<T, R> implements Function<Resource<RentObjectListResponse>, Resource<RentObjectListResponse>> {
    public static final ProfileRemoteRepository$getMyRentObjectList$1 INSTANCE = new ProfileRemoteRepository$getMyRentObjectList$1();

    ProfileRemoteRepository$getMyRentObjectList$1() {
    }
