...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$saveAidToProfile$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$saveAidToProfile$1 implements Realm.Transaction {
    final /* synthetic */ String $aid;

    ProfileLocalRepository$saveAidToProfile$1(String str) {
        this.$aid = str;
    }
