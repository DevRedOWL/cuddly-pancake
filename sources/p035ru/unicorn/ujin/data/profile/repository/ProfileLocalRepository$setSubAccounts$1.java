...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$setSubAccounts$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$setSubAccounts$1 implements Realm.Transaction {
    final /* synthetic */ RealmList $subAccountList;

    ProfileLocalRepository$setSubAccounts$1(RealmList realmList) {
    ...
    public final void execute(Realm realm) {
        ...
        RealmList<SubAccount> subAccountList = user.getSubAccountList();
        if (subAccountList != null) {
            subAccountList.clear();
        }
        user.setSubAccountList(new RealmList());
        RealmList<SubAccount> subAccountList2 = user.getSubAccountList();
        if (subAccountList2 != null) {
            subAccountList2.addAll(this.$subAccountList);
        }
