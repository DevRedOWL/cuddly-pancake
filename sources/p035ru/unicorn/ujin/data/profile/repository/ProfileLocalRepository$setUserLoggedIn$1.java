...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$setUserLoggedIn$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$setUserLoggedIn$1 implements Realm.Transaction {
    final /* synthetic */ boolean $loggedIn;

    ProfileLocalRepository$setUserLoggedIn$1(boolean z) {
        this.$loggedIn = z;
    }
    ...
    public final void execute(Realm realm) {
        ...
        user.setUserLoggenIn(this.$loggedIn);
