...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileRemoteRepository$getRentObjectList$2 */
/* compiled from: ProfileRemoteRepository.kt */
final class ProfileRemoteRepository$getRentObjectList$2<T, R> implements Function<Throwable, Resource<RentObjectListResponse>> {
    public static final ProfileRemoteRepository$getRentObjectList$2 INSTANCE = new ProfileRemoteRepository$getRentObjectList$2();

    ProfileRemoteRepository$getRentObjectList$2() {
    }
