...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$saveFirebaseToProfile$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$saveFirebaseToProfile$1 implements Realm.Transaction {
    final /* synthetic */ String $tokenFCM;

    ProfileLocalRepository$saveFirebaseToProfile$1(String str) {
        this.$tokenFCM = str;
    }
    ...
    public final void execute(Realm realm) {
        ...
        user.setFcmToken(this.$tokenFCM);
