...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileRemoteRepository$requestRegister1core$1 */
/* compiled from: ProfileRemoteRepository.kt */
final class ProfileRemoteRepository$requestRegister1core$1<T, R> implements Function<SimpleResponse, Resource<String>> {
    public static final ProfileRemoteRepository$requestRegister1core$1 INSTANCE = new ProfileRemoteRepository$requestRegister1core$1();

    ProfileRemoteRepository$requestRegister1core$1() {
    }
