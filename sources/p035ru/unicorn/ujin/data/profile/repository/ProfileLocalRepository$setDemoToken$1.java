...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$setDemoToken$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$setDemoToken$1 implements Realm.Transaction {
    final /* synthetic */ String $token;

    ProfileLocalRepository$setDemoToken$1(String str) {
        this.$token = str;
    }
