...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$registerGhostUser$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$registerGhostUser$1 implements Realm.Transaction {
    final /* synthetic */ String $token;

    ProfileLocalRepository$registerGhostUser$1(String str) {
        this.$token = str;
    }
