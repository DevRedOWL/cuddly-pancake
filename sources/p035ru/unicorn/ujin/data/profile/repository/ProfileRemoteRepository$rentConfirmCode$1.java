...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileRemoteRepository$rentConfirmCode$1 */
/* compiled from: ProfileRemoteRepository.kt */
final class ProfileRemoteRepository$rentConfirmCode$1<T> implements Consumer<RentConfirmCodeResponse> {
    final /* synthetic */ ProfileRemoteRepository this$0;

    ProfileRemoteRepository$rentConfirmCode$1(ProfileRemoteRepository profileRemoteRepository) {
        this.this$0 = profileRemoteRepository;
    }

    public final void accept(RentConfirmCodeResponse rentConfirmCodeResponse) {
        User user;
        this.this$0.getRealm().executeTransaction(C57401.INSTANCE);
        RentConfirmCodeData data = rentConfirmCodeResponse.getData();
        boolean z = true;
        if (!(data == null || (user = data.getUser()) == null)) {
            user.setStage(3);
            user.setUserLoggenIn(true);
            this.this$0.getRealm().executeTransaction(new ProfileRemoteRepository$rentConfirmCode$1$2$1(user));
        }
