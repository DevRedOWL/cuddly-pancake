...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileLocalRepository$setDemoUser$1 */
/* compiled from: ProfileLocalRepository.kt */
final class ProfileLocalRepository$setDemoUser$1 implements Realm.Transaction {
    final /* synthetic */ DemoUser $user;

    ProfileLocalRepository$setDemoUser$1(DemoUser demoUser) {
        this.$user = demoUser;
    }

    public final void execute(Realm realm) {
        realm.delete(DemoUser.class);
