...
/* renamed from: ru.unicorn.ujin.data.profile.repository.ProfileRemoteRepository$markNotificationsAsRead$1 */
/* compiled from: ProfileRemoteRepository.kt */
final class ProfileRemoteRepository$markNotificationsAsRead$1<T, R> implements Function<SimpleResponse, Resource<String>> {
    public static final ProfileRemoteRepository$markNotificationsAsRead$1 INSTANCE = new ProfileRemoteRepository$markNotificationsAsRead$1();

    ProfileRemoteRepository$markNotificationsAsRead$1() {
    }
