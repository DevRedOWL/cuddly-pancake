...
/* renamed from: ru.unicorn.ujin.data.repository.RealmRepository$applyForMortgage$2 */
/* compiled from: RealmRepository.kt */
final class RealmRepository$applyForMortgage$2<T, R> implements Function<Throwable, Resource<SimpleResponse>> {
    public static final RealmRepository$applyForMortgage$2 INSTANCE = new RealmRepository$applyForMortgage$2();

    RealmRepository$applyForMortgage$2() {
    }
