...
/* renamed from: ru.unicorn.ujin.data.repository.RealmRepository$requestUpdateFlatList$1 */
/* compiled from: RealmRepository.kt */
final class RealmRepository$requestUpdateFlatList$1<T> implements Consumer<GetFlatsResponse> {
    final /* synthetic */ String $complexId;
    final /* synthetic */ int $roomCount;
    final /* synthetic */ RealmRepository this$0;

    RealmRepository$requestUpdateFlatList$1(RealmRepository realmRepository, String str, int i) {
    ...
    public final void accept(GetFlatsResponse getFlatsResponse) {
        ...
        if (getFlatsResponse.getError() == 0) {
            ...
            data.setId(this.$complexId + this.$roomCount);
            realmRepository.getRealm().executeTransaction(new RealmRepository$requestUpdateFlatList$1$1$2(data));
