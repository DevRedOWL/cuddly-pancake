...
/* renamed from: ru.unicorn.ujin.data.repository.RealmRepository$requestDeleteUser$1 */
/* compiled from: RealmRepository.kt */
final class RealmRepository$requestDeleteUser$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ RealmRepository this$0;

    RealmRepository$requestDeleteUser$1(RealmRepository realmRepository) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        ...
        if (simpleResponse.getError() == 0) {
            realmRepository.getProfileDeleteSubject().onNext(new ProfileDeleteEvent(true, ""));
        } else {
            realmRepository.getProfileDeleteSubject().onNext(new ProfileDeleteEvent(false, simpleResponse.getMessage()));
        }
    }
}
