...
/* renamed from: ru.unicorn.ujin.data.repository.RealmRepository$getContextBannerList$1 */
/* compiled from: RealmRepository.kt */
final class RealmRepository$getContextBannerList$1<T, R> implements Function<Resource<GetBannerResponse>, Resource<List<? extends ContextBanner>>> {
    public static final RealmRepository$getContextBannerList$1 INSTANCE = new RealmRepository$getContextBannerList$1();

    RealmRepository$getContextBannerList$1() {
    }
