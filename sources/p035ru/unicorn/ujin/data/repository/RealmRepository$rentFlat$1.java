...
/* renamed from: ru.unicorn.ujin.data.repository.RealmRepository$rentFlat$1 */
/* compiled from: RealmRepository.kt */
final class RealmRepository$rentFlat$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ RealmRepository this$0;

    RealmRepository$rentFlat$1(RealmRepository realmRepository) {
        this.this$0 = realmRepository;
    }

    public final void accept(SimpleResponse simpleResponse) {
        String str;
        PublishSubject<UpdateEvent> rentFlatSubject = this.this$0.getRentFlatSubject();
        boolean z = simpleResponse.getError() == 0;
        if (simpleResponse == null || (str = simpleResponse.getMessage()) == null) {
            str = "";
        }
        rentFlatSubject.onNext(new UpdateEvent(z, str));
    }
}
