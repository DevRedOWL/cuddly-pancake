...
public final class OfferListResponseData {
    ...
    public final OfferListResponseData copy(RealmList<Offer> realmList, LinksData linksData, MetaData metaData) {
        Intrinsics.checkNotNullParameter(linksData, "links");
        Intrinsics.checkNotNullParameter(metaData, "meta");
        return new OfferListResponseData(realmList, linksData, metaData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OfferListResponseData)) {
            return false;
        }
        OfferListResponseData offerListResponseData = (OfferListResponseData) obj;
        return Intrinsics.areEqual((Object) this.offers, (Object) offerListResponseData.offers) && Intrinsics.areEqual((Object) this.links, (Object) offerListResponseData.links) && Intrinsics.areEqual((Object) this.meta, (Object) offerListResponseData.meta);
    }
    ...
    public String toString() {
        return "OfferListResponseData(offers=" + this.offers + ", links=" + this.links + ", meta=" + this.meta + ")";
    }

    public OfferListResponseData(RealmList<Offer> realmList, LinksData linksData, MetaData metaData) {
        Intrinsics.checkNotNullParameter(linksData, "links");
        Intrinsics.checkNotNullParameter(metaData, "meta");
