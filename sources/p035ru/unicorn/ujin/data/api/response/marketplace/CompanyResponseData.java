...
public final class CompanyResponseData {
    ...
    public static /* synthetic */ CompanyResponseData copy$default(CompanyResponseData companyResponseData, RealmList<Company> realmList, LinksData linksData, MetaData metaData, int i, Object obj) {
        if ((i & 1) != 0) {
            realmList = companyResponseData.companies;
        }
        if ((i & 2) != 0) {
            linksData = companyResponseData.links;
        }
        if ((i & 4) != 0) {
            metaData = companyResponseData.meta;
        }
        return companyResponseData.copy(realmList, linksData, metaData);
    }
    ...
    public final CompanyResponseData copy(RealmList<Company> realmList, LinksData linksData, MetaData metaData) {
        Intrinsics.checkNotNullParameter(linksData, "links");
        Intrinsics.checkNotNullParameter(metaData, "meta");
        return new CompanyResponseData(realmList, linksData, metaData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.companies, (Object) companyResponseData.companies) && Intrinsics.areEqual((Object) this.links, (Object) companyResponseData.links) && Intrinsics.areEqual((Object) this.meta, (Object) companyResponseData.meta);
    }
    ...
    public String toString() {
        return "CompanyResponseData(companies=" + this.companies + ", links=" + this.links + ", meta=" + this.meta + ")";
    }

    public CompanyResponseData(RealmList<Company> realmList, LinksData linksData, MetaData metaData) {
        Intrinsics.checkNotNullParameter(linksData, "links");
        Intrinsics.checkNotNullParameter(metaData, "meta");
