...
/* renamed from: ru.unicorn.ujin.market.model.MarketViewModel$setCart$3 */
/* compiled from: MarketViewModel.kt */
final class MarketViewModel$setCart$3<T> implements Consumer<Resource<CartResponse>> {
    final /* synthetic */ MarketViewModel this$0;

    MarketViewModel$setCart$3(MarketViewModel marketViewModel) {
    ...
    public final void accept(p035ru.unicorn.ujin.data.realm.Resource<p035ru.unicorn.ujin.data.api.response.marketplace.CartResponse> r5) {
        ...
        L_0x0059:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.market.model.MarketViewModel$setCart$3.accept(ru.unicorn.ujin.data.realm.Resource):void");
    }
}
