...
/* renamed from: ru.unicorn.ujin.market.company.CompanyFragment$handleEvent$1 */
/* compiled from: CompanyFragment.kt */
final class CompanyFragment$handleEvent$1 implements Runnable {
    final /* synthetic */ CompanyFragment this$0;

    CompanyFragment$handleEvent$1(CompanyFragment companyFragment) {
    ...
    public final void run() {
        ...
        if (textView.getLineCount() > 5) {
            ...
            ((TextView) this.this$0._$_findCachedViewById(C5619R.C5622id.tvExpand)).setOnClickListener(new View.OnClickListener(this) {
                final /* synthetic */ CompanyFragment$handleEvent$1 this$0;
