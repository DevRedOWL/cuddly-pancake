...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getCategoryList$1 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getCategoryList$1<T, R> implements Function<Resource<CategoryListResponseData>, Resource<CategoryListResponseData>> {
    public static final MarketRemoteRepository$getCategoryList$1 INSTANCE = new MarketRemoteRepository$getCategoryList$1();

    MarketRemoteRepository$getCategoryList$1() {
    }
