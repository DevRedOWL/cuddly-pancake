...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getTagList$1$1$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getTagList$1$1$2 implements Realm.Transaction {
    final /* synthetic */ Tag $tag;

    MarketRemoteRepository$getTagList$1$1$2(Tag tag) {
        this.$tag = tag;
    }

    public final void execute(Realm realm) {
        realm.insertOrUpdate((RealmModel) this.$tag);
    }
}
