...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$setCart$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$setCart$2<T, R> implements Function<Throwable, Resource<CartResponse>> {
    public static final MarketRemoteRepository$setCart$2 INSTANCE = new MarketRemoteRepository$setCart$2();

    MarketRemoteRepository$setCart$2() {
    }
