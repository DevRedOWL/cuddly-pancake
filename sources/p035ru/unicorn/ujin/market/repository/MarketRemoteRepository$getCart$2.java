...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getCart$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getCart$2<T, R> implements Function<Throwable, Resource<CartResponse>> {
    public static final MarketRemoteRepository$getCart$2 INSTANCE = new MarketRemoteRepository$getCart$2();

    MarketRemoteRepository$getCart$2() {
    }
