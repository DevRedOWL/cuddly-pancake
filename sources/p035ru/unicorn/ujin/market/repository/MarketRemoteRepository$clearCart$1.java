...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$clearCart$1 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$clearCart$1<T, R> implements Function<Resource<CartResponse>, Resource<CartResponse>> {
    public static final MarketRemoteRepository$clearCart$1 INSTANCE = new MarketRemoteRepository$clearCart$1();

    MarketRemoteRepository$clearCart$1() {
    }
