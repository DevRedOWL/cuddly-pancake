...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getOffer$1$1$1 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getOffer$1$1$1 implements Realm.Transaction {
    final /* synthetic */ Offer $offer;

    MarketRemoteRepository$getOffer$1$1$1(Offer offer) {
        this.$offer = offer;
    }

    public final void execute(Realm realm) {
        realm.insertOrUpdate((RealmModel) this.$offer);
    }
}
