...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getCompanyDetails$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getCompanyDetails$2<T> implements Consumer<Throwable> {
    final /* synthetic */ MarketRemoteRepository this$0;

    MarketRemoteRepository$getCompanyDetails$2(MarketRemoteRepository marketRemoteRepository) {
