...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$redeemCouponCode$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$redeemCouponCode$2<T> implements Consumer<Throwable> {
    final /* synthetic */ MarketRemoteRepository this$0;

    MarketRemoteRepository$redeemCouponCode$2(MarketRemoteRepository marketRemoteRepository) {
        this.this$0 = marketRemoteRepository;
    }

    public final void accept(Throwable th) {
        this.this$0.getRedeemCouponSubject().onNext(new RedeemCouponEvent(false, "", (RedeemedCode) null));
    }
}
