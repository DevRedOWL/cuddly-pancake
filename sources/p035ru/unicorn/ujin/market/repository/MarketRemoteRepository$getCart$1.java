...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$getCart$1 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$getCart$1<T, R> implements Function<Resource<CartResponse>, Resource<CartResponse>> {
    public static final MarketRemoteRepository$getCart$1 INSTANCE = new MarketRemoteRepository$getCart$1();

    MarketRemoteRepository$getCart$1() {
    }
