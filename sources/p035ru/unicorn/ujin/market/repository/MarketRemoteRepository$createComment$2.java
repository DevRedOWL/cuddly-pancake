...
/* renamed from: ru.unicorn.ujin.market.repository.MarketRemoteRepository$createComment$2 */
/* compiled from: MarketRemoteRepository.kt */
final class MarketRemoteRepository$createComment$2<T> implements Consumer<Throwable> {
    final /* synthetic */ MarketRemoteRepository this$0;

    MarketRemoteRepository$createComment$2(MarketRemoteRepository marketRemoteRepository) {
