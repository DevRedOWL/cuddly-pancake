...
/* renamed from: ru.unicorn.ujin.market.offer.ServiceViewHolder$bind$2$onResourceReady$1 */
/* compiled from: ServiceViewHolder.kt */
final class ServiceViewHolder$bind$2$onResourceReady$1 implements Runnable {
    final /* synthetic */ Drawable $resource;
    final /* synthetic */ ServiceViewHolder$bind$2 this$0;

    ServiceViewHolder$bind$2$onResourceReady$1(ServiceViewHolder$bind$2 serviceViewHolder$bind$2, Drawable drawable) {
    ...
    public final void run() {
        ...
        ((ImageView) view2.findViewById(C5619R.C5622id.ivIcon)).setImageDrawable(this.$resource);
    }
}
