...
/* renamed from: ru.unicorn.ujin.market.loan.DynamicLoanFragment$handleApiCallV2$1 */
/* compiled from: DynamicLoanFragment.kt */
final class DynamicLoanFragment$handleApiCallV2$1<T> implements Observer<ResourceV2<Object>> {
    final /* synthetic */ String $handleAction;
    final /* synthetic */ DynamicLoanFragment this$0;

    DynamicLoanFragment$handleApiCallV2$1(DynamicLoanFragment dynamicLoanFragment, String str) {
    ...
    public final void onChanged(ResourceV2<Object> resourceV2) {
        ...
        int i = DynamicLoanFragment.WhenMappings.$EnumSwitchMapping$0[resourceV2.getStatus().ordinal()];
        if (i == 1) {
            ...
            if (StringsKt.toIntOrNull(this.$handleAction) == null) {
                ...
                if ((service != null ? service.getError() : null) == null) {
                    new AlertDialog.Builder(dynamicLoanFragment.getBaseActivity()).setMessage(this.$handleAction).setPositiveButton(R.string.ok, new DynamicLoanFragment$handleApiCallV2$1$1$1(dynamicLoanFragment)).show();
                    return;
                }
                return;
            }
            ...
            dynamicLoanFragment.showMessage(str);
        } else if (i == 3) {
            ...
            dynamicLoanFragment.showMessage(str2);
        }
    }
}
