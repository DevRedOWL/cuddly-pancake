...
/* renamed from: ru.unicorn.ujin.market.order.OrderedOfferListAdapter$ViewHolder$bind$5 */
/* compiled from: OrderedOfferListAdapter.kt */
final class OrderedOfferListAdapter$ViewHolder$bind$5 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ OrderedOfferListAdapter.ViewHolder this$0;

    OrderedOfferListAdapter$ViewHolder$bind$5(OrderedOfferListAdapter.ViewHolder viewHolder, int i) {
    ...
    public final void onClick(View view) {
        ...
        AppCompatImageButton appCompatImageButton = (AppCompatImageButton) view4.findViewById(C5619R.C5622id.btnSubtract);
        Intrinsics.checkNotNullExpressionValue(appCompatImageButton, "this");
        appCompatImageButton.setColorFilter(ContextCompat.getColor(appCompatImageButton.getContext(), R.color.marketEnabledOfferColor));
        appCompatImageButton.setEnabled(true);
        new Handler().postDelayed(new Runnable(this) {
            final /* synthetic */ OrderedOfferListAdapter$ViewHolder$bind$5 this$0;
