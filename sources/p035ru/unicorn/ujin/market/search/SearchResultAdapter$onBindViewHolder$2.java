...
/* renamed from: ru.unicorn.ujin.market.search.SearchResultAdapter$onBindViewHolder$2 */
/* compiled from: SearchResultAdapter.kt */
final class SearchResultAdapter$onBindViewHolder$2 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ SearchResultAdapter this$0;

    SearchResultAdapter$onBindViewHolder$2(SearchResultAdapter searchResultAdapter, int i) {
    ...
    public final void onClick(View view) {
        ...
        if (searchResultType != null) {
            onItemClickListener.onCategoryClicked((Category) searchResultType);
            return;
        }
