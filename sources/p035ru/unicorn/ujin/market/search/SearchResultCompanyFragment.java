...
@Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000`\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 (2\u00020\u0001:\u0001(B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0011\u001a\u00020\u0012H\u0002J\b\u0010\u0013\u001a\u00020\u0012H\u0002J\u0018\u0010\u0014\u001a\u00020\u00122\u000e\u0010\u0015\u001a\n\u0012\u0004\u0012\u00020\u0017\u0018\u00010\u0016H\u0002J\u0010\u0010\u0018\u001a\u00020\u00122\u0006\u0010\u0010\u001a\u00020\u0004H\u0002J\b\u0010\u0019\u001a\u00020\u0012H\u0002J\b\u0010\u001a\u001a\u00020\u0004H\u0014J$\u0010\u001b\u001a\u00020\u001c2\u0006\u0010\u001d\u001a\u00020\u001e2\b\u0010\u001f\u001a\u0004\u0018\u00010 2\b\u0010!\u001a\u0004\u0018\u00010\"H\u0016J\u001a\u0010#\u001a\u00020\u00122\u0006\u0010$\u001a\u00020\u001c2\b\u0010!\u001a\u0004\u0018\u00010\"H\u0016J\b\u0010%\u001a\u00020\u0012H\u0014J\u0010\u0010&\u001a\u00020\u00122\u0006\u0010'\u001a\u00020\bH\u0002R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX.¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u0010\u001a\u0004\u0018\u00010\u0004X\u000e¢\u0006\u0002\n\u0000¨\u0006)"}, mo51343d2 = {"Lru/unicorn/ujin/market/search/SearchResultCompanyFragment;", "Lru/unicorn/ujin/market/MarketBaseFragment;", "()V", "categoryId", "", "currentPage", "", "isResultListLoaded", "", "lastPage", "resultList", "", "Lru/unicorn/ujin/market/search/SearchResultType;", "searchResultAdapter", "Lru/unicorn/ujin/market/search/SearchResultAdapter;", "searchType", "searchValue", "checkDataCount", "", "clearResults", "handleCompanyEvent", "resource", "Lru/unicorn/ujin/data/realm/Resource;", "Lru/unicorn/ujin/data/api/response/marketplace/CompanyListResponseData;", "handleSearchCompanyEvent", "loadData", "metricsScreenName", "onCreateView", "Landroid/view/View;", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "showToolbar", "toggleProgressVisibility", "isLoading", "Companion", "app_kortrosRelease"}, mo51344k = 1, mo51345mv = {1, 4, 1})
/* renamed from: ru.unicorn.ujin.market.search.SearchResultCompanyFragment */
/* compiled from: SearchResultCompanyFragment.kt */
public final class SearchResultCompanyFragment extends MarketBaseFragment {
    ...
    /* renamed from: ru.unicorn.ujin.market.search.SearchResultCompanyFragment$WhenMappings */
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        this.searchResultAdapter = new SearchResultAdapter(new ArrayList(), new SearchResultCompanyFragment$onViewCreated$1(this));
        ((NestedScrollView) _$_findCachedViewById(C5619R.C5622id.resultListScrollView)).setOnScrollChangeListener(new SearchResultCompanyFragment$onViewCreated$2(this));
        ...
        getMarketViewModel().getShowProgressLiveData().observe(getViewLifecycleOwner(), new SearchResultCompanyFragment$onViewCreated$4(this));
        getMarketViewModel().getSearchCompanyValueLiveData().observe(getViewLifecycleOwner(), new SearchResultCompanyFragment$onViewCreated$5(this));
    }

    /* access modifiers changed from: private */
    public final void handleSearchCompanyEvent(String str) {
        if (!StringsKt.isBlank(str)) {
            this.searchValue = str;
            this.currentPage = 1;
            clearResults();
            getMarketViewModel().getCompanyListLiveData().removeObserver(new SearchResultCompanyFragment$handleSearchCompanyEvent$1(this));
            loadData();
            getMarketViewModel().getCompanyListLiveData().observe(getViewLifecycleOwner(), new SearchResultCompanyFragment$handleSearchCompanyEvent$2(this));
        }
    }
    ...
    public final void loadData() {
        if (this.categoryId != null) {
            ...
            getMarketViewModel().loadCompanyList(CollectionsKt.emptyList(), this.currentPage, this.searchValue);
        }
    }
    ...
    public final void handleCompanyEvent(p035ru.unicorn.ujin.data.realm.Resource<p035ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData> r7) {
        /*
            r6 = this;
            ...
            goto L_0x0138
        L_0x000a:
            int[] r1 = p035ru.unicorn.ujin.market.search.SearchResultCompanyFragment.WhenMappings.$EnumSwitchMapping$0
            int r0 = r0.ordinal()
            r0 = r1[r0]
        ...
        L_0x0022:
            ...
            goto L_0x0138
        L_0x0027:
            r6.toggleProgressVisibility(r3)
        ...
        L_0x0061:
            ...
            ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData r0 = (p035ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData) r0
            io.realm.RealmList r0 = r0.getCompanies()
        ...
        L_0x0090:
            ...
            ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData r1 = (p035ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData) r1
            ru.unicorn.ujin.data.realm.MetaData r1 = r1.getMeta()
            int r1 = r1.getTotal()
            r2.updateTabLayout(r4, r1)
            goto L_0x00bc
        L_0x00b6:
            java.lang.NullPointerException r7 = new java.lang.NullPointerException
            r7.<init>(r1)
        ...
        L_0x00bc:
            ...
            int r2 = r6.currentPage
            java.lang.String r5 = "searchResultAdapter"
            if (r2 != r4) goto L_0x0113
            java.lang.Object r7 = r7.getData()
            ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData r7 = (p035ru.unicorn.ujin.data.api.response.marketplace.CompanyListResponseData) r7
        ...
        L_0x011c:
            ...
            ru.unicorn.ujin.data.realm.marketplace.Company r0 = (p035ru.unicorn.ujin.data.realm.marketplace.Company) r0
        ...
        L_0x0138:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p035ru.unicorn.ujin.market.search.SearchResultCompanyFragment.handleCompanyEvent(ru.unicorn.ujin.data.realm.Resource):void");
    }
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u0004R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, mo51343d2 = {"Lru/unicorn/ujin/market/search/SearchResultCompanyFragment$Companion;", "", "()V", "PARENT_ID", "", "newInstance", "Lru/unicorn/ujin/market/search/SearchResultCompanyFragment;", "id", "app_kortrosRelease"}, mo51344k = 1, mo51345mv = {1, 4, 1})
    /* renamed from: ru.unicorn.ujin.market.search.SearchResultCompanyFragment$Companion */
    /* compiled from: SearchResultCompanyFragment.kt */
    public static final class Companion {
        ...
        public final SearchResultCompanyFragment newInstance(String str) {
            SearchResultCompanyFragment searchResultCompanyFragment = new SearchResultCompanyFragment();
            if (str == null) {
                str = "0";
            }
            searchResultCompanyFragment.categoryId = str;
