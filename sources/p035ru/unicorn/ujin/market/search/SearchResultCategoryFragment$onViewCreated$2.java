...
/* renamed from: ru.unicorn.ujin.market.search.SearchResultCategoryFragment$onViewCreated$2 */
/* compiled from: SearchResultCategoryFragment.kt */
final class SearchResultCategoryFragment$onViewCreated$2 implements NestedScrollView.OnScrollChangeListener {
    final /* synthetic */ SearchResultCategoryFragment this$0;

    SearchResultCategoryFragment$onViewCreated$2(SearchResultCategoryFragment searchResultCategoryFragment) {
    ...
    public final void onScrollChange(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
        ...
        if (childAt != null) {
            ...
            if (i2 >= measuredHeight - nestedScrollView3.getMeasuredHeight() && i2 > i4 && this.this$0.currentPage < this.this$0.lastPage && this.this$0.isResultListLoaded) {
                ...
                searchResultCategoryFragment.currentPage = searchResultCategoryFragment.currentPage + 1;
