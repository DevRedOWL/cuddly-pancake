...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.adapters.RadioSectionAdapter$ViewHolder$bind$clickListener$1 */
/* compiled from: RadioSectionAdapter.kt */
final class RadioSectionAdapter$ViewHolder$bind$clickListener$1 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ RadioSectionAdapter.ViewHolder this$0;

    RadioSectionAdapter$ViewHolder$bind$clickListener$1(RadioSectionAdapter.ViewHolder viewHolder, int i) {
    ...
    public final void onClick(View view) {
        ...
        this.this$0.this$0.getOnSectionSelectedListener$app_kortrosRelease().onSectionSelected(this.$position);
