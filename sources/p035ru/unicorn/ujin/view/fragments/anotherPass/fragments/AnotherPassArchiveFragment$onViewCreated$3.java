...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.fragments.AnotherPassArchiveFragment$onViewCreated$3 */
/* compiled from: AnotherPassArchiveFragment.kt */
final class AnotherPassArchiveFragment$onViewCreated$3<T> implements Observer<AnotherArchivePassListEvent> {
    final /* synthetic */ AnotherPassArchiveFragment this$0;

    AnotherPassArchiveFragment$onViewCreated$3(AnotherPassArchiveFragment anotherPassArchiveFragment) {
    ...
    public final void onChanged(AnotherArchivePassListEvent anotherArchivePassListEvent) {
        ...
        anotherPassArchiveFragment.handleArchivePassListEvent(anotherArchivePassListEvent);
    }
}
