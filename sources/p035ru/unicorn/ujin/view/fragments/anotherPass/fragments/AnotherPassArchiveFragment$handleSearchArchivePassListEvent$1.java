...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.fragments.AnotherPassArchiveFragment$handleSearchArchivePassListEvent$1 */
/* compiled from: AnotherPassArchiveFragment.kt */
final class AnotherPassArchiveFragment$handleSearchArchivePassListEvent$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ ArrayList $list;
    final /* synthetic */ AnotherPassArchiveFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AnotherPassArchiveFragment$handleSearchArchivePassListEvent$1(AnotherPassArchiveFragment anotherPassArchiveFragment, ArrayList arrayList) {
        super(1);
