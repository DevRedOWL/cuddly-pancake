...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.fragments.new_iteration.AnotherPassNewFragment$onViewCreated$2 */
/* compiled from: AnotherPassNewFragment.kt */
final class AnotherPassNewFragment$onViewCreated$2 implements View.OnClickListener {
    final /* synthetic */ AnotherPassViewModel $viewModell;
    final /* synthetic */ AnotherPassNewFragment this$0;

    AnotherPassNewFragment$onViewCreated$2(AnotherPassNewFragment anotherPassNewFragment, AnotherPassViewModel anotherPassViewModel) {
    ...
    public final void onClick(View view) {
        ...
        anotherPassNewFragment.setCalendarDateFrom(instance);
        ...
        anotherPassNewFragment2.setCalendarDateTo(instance2);
        ...
        ((FragmentAnotherPassBinding) this.this$0.getViewDataBinding()).data11.value.setText(DateUtils.formatDate(new Date()));
        ((FragmentAnotherPassBinding) this.this$0.getViewDataBinding()).data12.value.setText(DateUtils.formatDate(new Date()));
        ...
        if (anotherPassViewModel3 != null) {
            anotherPassViewModel3.setOnetimeStrategy();
        }
