...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.fragments.new_iteration.AnotherPassNewFragment$onViewCreated$9 */
/* compiled from: AnotherPassNewFragment.kt */
final class AnotherPassNewFragment$onViewCreated$9 implements View.OnClickListener {
    final /* synthetic */ AnotherPassViewModel $viewModell;
    final /* synthetic */ AnotherPassNewFragment this$0;

    AnotherPassNewFragment$onViewCreated$9(AnotherPassNewFragment anotherPassNewFragment, AnotherPassViewModel anotherPassViewModel) {
    ...
    public final void onClick(View view) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this.this$0.getBaseActivity(), new AnotherPassNewFragment$onViewCreated$9$datePickerDialog$1(this), this.this$0.getCalendarDateFrom().get(1), this.this$0.getCalendarDateFrom().get(2), this.this$0.getCalendarDateFrom().get(5));
