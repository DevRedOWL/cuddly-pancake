...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.AnotherPassViewModel$createAnotherPass$4 */
/* compiled from: AnotherPassViewModel.kt */
final class AnotherPassViewModel$createAnotherPass$4<T> implements Consumer<Resource<AnotherPassResponse>> {
    final /* synthetic */ AnotherPassViewModel this$0;

    AnotherPassViewModel$createAnotherPass$4(AnotherPassViewModel anotherPassViewModel) {
        this.this$0 = anotherPassViewModel;
    }

    public final void accept(Resource<AnotherPassResponse> resource) {
        this.this$0.getCreateAnotherPassMutableLiveData().setValue(resource);
    }
}
