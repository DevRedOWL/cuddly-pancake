...
/* renamed from: ru.unicorn.ujin.view.fragments.anotherPass.AnotherPassViewModel$getArchivePassList$1 */
/* compiled from: AnotherPassViewModel.kt */
final class AnotherPassViewModel$getArchivePassList$1<T> implements Consumer<AnotherArchivePassListEvent> {
    final /* synthetic */ AnotherPassViewModel this$0;

    AnotherPassViewModel$getArchivePassList$1(AnotherPassViewModel anotherPassViewModel) {
    ...
    public final void accept(AnotherArchivePassListEvent anotherArchivePassListEvent) {
        ...
        anotherPassViewModel.getMyArchivePassListMutableLiveData().postValue(anotherArchivePassListEvent);
    }
}
