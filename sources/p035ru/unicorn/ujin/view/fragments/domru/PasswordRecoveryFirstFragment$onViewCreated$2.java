...
/* renamed from: ru.unicorn.ujin.view.fragments.domru.PasswordRecoveryFirstFragment$onViewCreated$2 */
/* compiled from: PasswordRecoveryFirstFragment.kt */
final class PasswordRecoveryFirstFragment$onViewCreated$2 implements View.OnClickListener {
    final /* synthetic */ PasswordRecoveryFirstFragment this$0;

    PasswordRecoveryFirstFragment$onViewCreated$2(PasswordRecoveryFirstFragment passwordRecoveryFirstFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (activity != null) {
            ((PasswordRecoveryActivity) activity).goToAuthActivity();
            return;
        }
