...
/* renamed from: ru.unicorn.ujin.view.fragments.domru.PasswordRecoverySecondFragment$onViewCreated$1 */
/* compiled from: PasswordRecoverySecondFragment.kt */
final class PasswordRecoverySecondFragment$onViewCreated$1 implements View.OnClickListener {
    final /* synthetic */ PasswordRecoverySecondFragment this$0;

    PasswordRecoverySecondFragment$onViewCreated$1(PasswordRecoverySecondFragment passwordRecoverySecondFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (activity != null) {
            ((PasswordRecoveryActivity) activity).sendPassword();
            return;
        }
