...
/* renamed from: ru.unicorn.ujin.view.fragments.providerService.ProviderServiceFragment$onViewCreated$4 */
/* compiled from: ProviderServiceFragment.kt */
final class ProviderServiceFragment$onViewCreated$4<T> implements Observer<UpdateEvent> {
    final /* synthetic */ ProviderServiceFragment this$0;

    ProviderServiceFragment$onViewCreated$4(ProviderServiceFragment providerServiceFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        providerServiceFragment.handleDeleteActiveProviderInfo(updateEvent);
    }
}
