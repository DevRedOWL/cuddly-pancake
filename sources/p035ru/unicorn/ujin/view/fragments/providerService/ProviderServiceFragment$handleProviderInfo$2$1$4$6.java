...
/* renamed from: ru.unicorn.ujin.view.fragments.providerService.ProviderServiceFragment$handleProviderInfo$2$1$4$6 */
/* compiled from: ProviderServiceFragment.kt */
final class ProviderServiceFragment$handleProviderInfo$2$1$4$6 extends Lambda implements Function2<SingleLiveEvent<Resource<Object>>, String, Unit> {
    public static final ProviderServiceFragment$handleProviderInfo$2$1$4$6 INSTANCE = new ProviderServiceFragment$handleProviderInfo$2$1$4$6();

    ProviderServiceFragment$handleProviderInfo$2$1$4$6() {
        super(2);
    }
