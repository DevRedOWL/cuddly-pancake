...
/* renamed from: ru.unicorn.ujin.view.fragments.providerService.ProviderServiceFragment$handleActiveProviderInfo$1$6 */
/* compiled from: ProviderServiceFragment.kt */
final class ProviderServiceFragment$handleActiveProviderInfo$1$6 extends Lambda implements Function2<SingleLiveEvent<Resource<Object>>, String, Unit> {
    public static final ProviderServiceFragment$handleActiveProviderInfo$1$6 INSTANCE = new ProviderServiceFragment$handleActiveProviderInfo$1$6();

    ProviderServiceFragment$handleActiveProviderInfo$1$6() {
        super(2);
    }
