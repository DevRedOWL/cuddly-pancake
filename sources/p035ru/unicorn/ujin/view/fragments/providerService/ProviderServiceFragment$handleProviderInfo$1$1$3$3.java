...
/* renamed from: ru.unicorn.ujin.view.fragments.providerService.ProviderServiceFragment$handleProviderInfo$1$1$3$3 */
/* compiled from: ProviderServiceFragment.kt */
final class ProviderServiceFragment$handleProviderInfo$1$1$3$3 extends Lambda implements Function2<SingleLiveEvent<Resource<Object>>, String, Unit> {
    public static final ProviderServiceFragment$handleProviderInfo$1$1$3$3 INSTANCE = new ProviderServiceFragment$handleProviderInfo$1$1$3$3();

    ProviderServiceFragment$handleProviderInfo$1$1$3$3() {
        super(2);
    }
