...
/* renamed from: ru.unicorn.ujin.view.fragments.profileselection.data.ProfileSelectionRep$getCitiesWithUK$remoteData$1 */
/* compiled from: ProfileSelectionRep.kt */
final class ProfileSelectionRep$getCitiesWithUK$remoteData$1<T> implements Predicate<Resource<CityList>> {
    public static final ProfileSelectionRep$getCitiesWithUK$remoteData$1 INSTANCE = new ProfileSelectionRep$getCitiesWithUK$remoteData$1();

    ProfileSelectionRep$getCitiesWithUK$remoteData$1() {
    }
