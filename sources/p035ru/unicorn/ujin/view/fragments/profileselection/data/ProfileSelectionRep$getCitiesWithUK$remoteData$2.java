...
/* renamed from: ru.unicorn.ujin.view.fragments.profileselection.data.ProfileSelectionRep$getCitiesWithUK$remoteData$2 */
/* compiled from: ProfileSelectionRep.kt */
final class ProfileSelectionRep$getCitiesWithUK$remoteData$2<T, R> implements Function<Resource<CityList>, List<CityDTO>> {
    public static final ProfileSelectionRep$getCitiesWithUK$remoteData$2 INSTANCE = new ProfileSelectionRep$getCitiesWithUK$remoteData$2();

    ProfileSelectionRep$getCitiesWithUK$remoteData$2() {
    }
