...
/* renamed from: ru.unicorn.ujin.view.fragments.profileselection.data.ProfileSelectionRep$loadBusCenter$1 */
/* compiled from: ProfileSelectionRep.kt */
final class ProfileSelectionRep$loadBusCenter$1<T, R> implements Function<Throwable, Resource<BusinessCenterList>> {
    public static final ProfileSelectionRep$loadBusCenter$1 INSTANCE = new ProfileSelectionRep$loadBusCenter$1();

    ProfileSelectionRep$loadBusCenter$1() {
    }
