...
/* renamed from: ru.unicorn.ujin.view.fragments.profileselection.data.ProfileSelectionRep$getCities$remoteData$3 */
/* compiled from: ProfileSelectionRep.kt */
final class ProfileSelectionRep$getCities$remoteData$3<T> implements Consumer<List<CityDTO>> {
    final /* synthetic */ ProfileSelectionRep this$0;

    ProfileSelectionRep$getCities$remoteData$3(ProfileSelectionRep profileSelectionRep) {
