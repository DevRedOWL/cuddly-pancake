...
/* renamed from: ru.unicorn.ujin.view.fragments.profileselection.domain.ProfileSelectionInteractorImpl$joinUk$2 */
/* compiled from: ProfileSelectionInteractorImpl.kt */
final class ProfileSelectionInteractorImpl$joinUk$2<T> implements Consumer<Resource<User>> {
    public static final ProfileSelectionInteractorImpl$joinUk$2 INSTANCE = new ProfileSelectionInteractorImpl$joinUk$2();

    ProfileSelectionInteractorImpl$joinUk$2() {
    }
