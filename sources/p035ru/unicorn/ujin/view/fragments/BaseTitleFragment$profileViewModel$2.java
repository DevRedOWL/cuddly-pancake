...
/* renamed from: ru.unicorn.ujin.view.fragments.BaseTitleFragment$profileViewModel$2 */
/* compiled from: BaseTitleFragment.kt */
final class BaseTitleFragment$profileViewModel$2 extends Lambda implements Function0<ProfileViewModel> {
    final /* synthetic */ BaseTitleFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseTitleFragment$profileViewModel$2(BaseTitleFragment baseTitleFragment) {
        super(0);
        this.this$0 = baseTitleFragment;
    }

    public final ProfileViewModel invoke() {
        ViewModel viewModel = ViewModelProviders.m11of((Fragment) this.this$0, (ViewModelProvider.Factory) ViewmodelFactorys.getInstance()).get(ProfileViewModel.class);
