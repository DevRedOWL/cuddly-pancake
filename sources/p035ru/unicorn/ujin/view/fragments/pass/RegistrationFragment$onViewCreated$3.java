...
/* renamed from: ru.unicorn.ujin.view.fragments.pass.RegistrationFragment$onViewCreated$3 */
...
final class RegistrationFragment$onViewCreated$3 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        this.this$0.currentLoginMode = 0;
        TextInputLayout textInputLayout = (TextInputLayout) this.this$0._$_findCachedViewById(C5619R.C5622id.tilPhone);
        Intrinsics.checkNotNullExpressionValue(textInputLayout, "tilPhone");
        textInputLayout.setVisibility(0);
        TextInputLayout textInputLayout2 = (TextInputLayout) this.this$0._$_findCachedViewById(C5619R.C5622id.tilEmail);
        Intrinsics.checkNotNullExpressionValue(textInputLayout2, "tilEmail");
        ...
        registrationFragment2.underline(textView2, "электронную почту");
    }
}
