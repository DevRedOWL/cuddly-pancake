...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.OssRemoteRepository$getOssList$2 */
/* compiled from: OssRemoteRepository.kt */
final class OssRemoteRepository$getOssList$2<T> implements Consumer<Throwable> {
    final /* synthetic */ OssRemoteRepository this$0;

    OssRemoteRepository$getOssList$2(OssRemoteRepository ossRemoteRepository) {
        this.this$0 = ossRemoteRepository;
    }

    public final void accept(Throwable th) {
        this.this$0.getOssListSubject().onNext(new OssListEvent(false, OssRemoteRepository.Companion.getUNABLE_TO_LOAD_OSS_LIST(), (OssListResponseData) null));
    }
}
