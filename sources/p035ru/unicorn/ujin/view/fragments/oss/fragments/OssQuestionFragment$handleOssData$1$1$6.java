...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.fragments.OssQuestionFragment$handleOssData$1$1$6 */
/* compiled from: OssQuestionFragment.kt */
final class OssQuestionFragment$handleOssData$1$1$6 extends Lambda implements Function2<SingleLiveEvent<Resource<Object>>, String, Unit> {
    public static final OssQuestionFragment$handleOssData$1$1$6 INSTANCE = new OssQuestionFragment$handleOssData$1$1$6();

    OssQuestionFragment$handleOssData$1$1$6() {
        super(2);
    }
