...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.fragments.OssQuestionFragment$loadQuestion$1$1$8 */
/* compiled from: OssQuestionFragment.kt */
final class OssQuestionFragment$loadQuestion$1$1$8 extends Lambda implements Function2<SingleLiveEvent<Resource<Object>>, String, Unit> {
    public static final OssQuestionFragment$loadQuestion$1$1$8 INSTANCE = new OssQuestionFragment$loadQuestion$1$1$8();

    OssQuestionFragment$loadQuestion$1$1$8() {
        super(2);
    }
