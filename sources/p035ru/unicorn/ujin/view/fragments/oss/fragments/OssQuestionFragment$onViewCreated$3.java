...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.fragments.OssQuestionFragment$onViewCreated$3 */
/* compiled from: OssQuestionFragment.kt */
final class OssQuestionFragment$onViewCreated$3<T> implements Observer<UpdateEvent> {
    final /* synthetic */ OssQuestionFragment this$0;

    OssQuestionFragment$onViewCreated$3(OssQuestionFragment ossQuestionFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        ossQuestionFragment.handleVote(updateEvent);
    }
}
