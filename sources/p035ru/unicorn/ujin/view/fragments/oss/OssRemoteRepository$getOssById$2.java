...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.OssRemoteRepository$getOssById$2 */
/* compiled from: OssRemoteRepository.kt */
final class OssRemoteRepository$getOssById$2<T> implements Consumer<Throwable> {
    final /* synthetic */ OssRemoteRepository this$0;

    OssRemoteRepository$getOssById$2(OssRemoteRepository ossRemoteRepository) {
        this.this$0 = ossRemoteRepository;
    }

    public final void accept(Throwable th) {
        this.this$0.getOssDataSubject().onNext(new OssDataEvent(false, OssRemoteRepository.Companion.getUNABLE_TO_LOAD_OSS_DATA(), (OssData) null));
    }
}
