...
/* renamed from: ru.unicorn.ujin.view.fragments.oss.OssRemoteRepository$vote$1 */
/* compiled from: OssRemoteRepository.kt */
final class OssRemoteRepository$vote$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ OssRemoteRepository this$0;

    OssRemoteRepository$vote$1(OssRemoteRepository ossRemoteRepository) {
        this.this$0 = ossRemoteRepository;
    }

    public final void accept(SimpleResponse simpleResponse) {
        this.this$0.getOssVoteSubject().onNext(new UpdateEvent(simpleResponse.getError() == 0, simpleResponse.getMessage()));
    }
}
