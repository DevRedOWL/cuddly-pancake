...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.ParkingRemoteRepository$attachVehicle$1 */
/* compiled from: ParkingRemoteRepository.kt */
final class ParkingRemoteRepository$attachVehicle$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ boolean $startFlag;
    final /* synthetic */ MyVehicle $vehicle;
    final /* synthetic */ ParkingRemoteRepository this$0;

    ParkingRemoteRepository$attachVehicle$1(ParkingRemoteRepository parkingRemoteRepository, boolean z, MyVehicle myVehicle) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        this.this$0.getAttachVehicleSubject().onNext(new AttachVehicleEvent(simpleResponse.getError() == 0, simpleResponse.getMessage(), this.$startFlag, this.$vehicle));
    }
}
