...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.ParkingViewModel$freeRent$2 */
/* compiled from: ParkingViewModel.kt */
final class ParkingViewModel$freeRent$2<T> implements Consumer<Resource<SimpleResponse>> {
    final /* synthetic */ ParkingViewModel this$0;

    ParkingViewModel$freeRent$2(ParkingViewModel parkingViewModel) {
        this.this$0 = parkingViewModel;
    }

    public final void accept(Resource<SimpleResponse> resource) {
        this.this$0.getFreeRentMutableLiveData().setValue(resource);
    }
}
