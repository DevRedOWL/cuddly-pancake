...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.fragments.ParkingAddVehicleToSlotFragment$onViewCreated$2 */
/* compiled from: ParkingAddVehicleToSlotFragment.kt */
final class ParkingAddVehicleToSlotFragment$onViewCreated$2<T> implements Observer<MyVehiclesEvent> {
    final /* synthetic */ ParkingAddVehicleToSlotFragment this$0;

    ParkingAddVehicleToSlotFragment$onViewCreated$2(ParkingAddVehicleToSlotFragment parkingAddVehicleToSlotFragment) {
    ...
    public final void onChanged(MyVehiclesEvent myVehiclesEvent) {
        ...
        parkingAddVehicleToSlotFragment.handleVehicleList(myVehiclesEvent);
    }
}
