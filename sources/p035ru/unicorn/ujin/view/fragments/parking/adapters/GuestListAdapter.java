...
@Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0018B1\u0012\u0016\u0010\u0003\u001a\u0012\u0012\u0004\u0012\u00020\u00050\u0004j\b\u0012\u0004\u0012\u00020\u0005`\u0006\u0012\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\t0\b¢\u0006\u0002\u0010\nJ\b\u0010\u000f\u001a\u00020\u0010H\u0016J\u0018\u0010\u0011\u001a\u00020\t2\u0006\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0010H\u0016J\u0018\u0010\u0014\u001a\u00020\u00022\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u0010H\u0016R!\u0010\u0003\u001a\u0012\u0012\u0004\u0012\u00020\u00050\u0004j\b\u0012\u0004\u0012\u00020\u0005`\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u001d\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\t0\b¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u0019"}, mo51343d2 = {"Lru/unicorn/ujin/view/fragments/parking/adapters/GuestListAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lru/unicorn/ujin/view/fragments/parking/adapters/GuestListAdapter$ViewHolder;", "guestList", "Ljava/util/ArrayList;", "Lru/unicorn/ujin/view/fragments/parking/response/Guest;", "Lkotlin/collections/ArrayList;", "onClickListener", "Lkotlin/Function1;", "", "(Ljava/util/ArrayList;Lkotlin/jvm/functions/Function1;)V", "getGuestList", "()Ljava/util/ArrayList;", "getOnClickListener", "()Lkotlin/jvm/functions/Function1;", "getItemCount", "", "onBindViewHolder", "holder", "position", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "ViewHolder", "app_kortrosRelease"}, mo51344k = 1, mo51345mv = {1, 4, 1})
/* renamed from: ru.unicorn.ujin.view.fragments.parking.adapters.GuestListAdapter */
/* compiled from: GuestListAdapter.kt */
public final class GuestListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public GuestListAdapter(ArrayList<Guest> arrayList, Function1<? super Guest, Unit> function1) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_parking_guest, viewGroup, false);
        Intrinsics.checkNotNullExpressionValue(inflate, "LayoutInflater.from(pare…ing_guest, parent, false)");
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(Guest guest) {
            ...
            Calendar parseDate = DateUtils.parseDate(guest.getDateStart(), "yyyy-MM-dd hh:mm:ss");
            if (parseDate != null) {
                ...
                textView2.setText(DateUtils.formatDateFromCalendar(parseDate, DatePickerViewHolder.DATE_FORMAT));
            }
            View view3 = this.itemView;
            Intrinsics.checkNotNullExpressionValue(view3, "itemView");
            TextView textView3 = (TextView) view3.findViewById(C5619R.C5622id.tvStatus);
            Intrinsics.checkNotNullExpressionValue(textView3, "itemView.tvStatus");
            textView3.setText(Intrinsics.areEqual((Object) guest.isActive(), (Object) true) ? "Активно" : "Не активно");
        }
    }
}
