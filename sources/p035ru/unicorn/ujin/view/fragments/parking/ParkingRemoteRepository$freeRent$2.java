...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.ParkingRemoteRepository$freeRent$2 */
/* compiled from: ParkingRemoteRepository.kt */
final class ParkingRemoteRepository$freeRent$2<T, R> implements Function<Throwable, Resource<SimpleResponse>> {
    public static final ParkingRemoteRepository$freeRent$2 INSTANCE = new ParkingRemoteRepository$freeRent$2();

    ParkingRemoteRepository$freeRent$2() {
    }
