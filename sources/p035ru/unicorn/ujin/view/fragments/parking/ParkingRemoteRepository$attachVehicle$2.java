...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.ParkingRemoteRepository$attachVehicle$2 */
/* compiled from: ParkingRemoteRepository.kt */
final class ParkingRemoteRepository$attachVehicle$2<T> implements Consumer<Throwable> {
    final /* synthetic */ boolean $startFlag;
    final /* synthetic */ ParkingRemoteRepository this$0;

    ParkingRemoteRepository$attachVehicle$2(ParkingRemoteRepository parkingRemoteRepository, boolean z) {
        this.this$0 = parkingRemoteRepository;
        this.$startFlag = z;
    }

    public final void accept(Throwable th) {
        this.this$0.getAttachVehicleSubject().onNext(new AttachVehicleEvent(false, ParkingRemoteRepository.Companion.getUNABLE_TO_LOAD(), this.$startFlag, (MyVehicle) null));
    }
}
