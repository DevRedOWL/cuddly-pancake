...
/* renamed from: ru.unicorn.ujin.view.fragments.parking.ParkingRemoteRepository$freeRent$1 */
/* compiled from: ParkingRemoteRepository.kt */
final class ParkingRemoteRepository$freeRent$1<T, R> implements Function<Resource<SimpleResponse>, Resource<SimpleResponse>> {
    public static final ParkingRemoteRepository$freeRent$1 INSTANCE = new ParkingRemoteRepository$freeRent$1();

    ParkingRemoteRepository$freeRent$1() {
    }
