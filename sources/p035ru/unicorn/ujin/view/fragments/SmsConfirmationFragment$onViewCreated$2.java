...
/* renamed from: ru.unicorn.ujin.view.fragments.SmsConfirmationFragment$onViewCreated$2 */
/* compiled from: SmsConfirmationFragment.kt */
final class SmsConfirmationFragment$onViewCreated$2<T> implements Observer<UpdateEvent> {
    final /* synthetic */ SmsConfirmationFragment this$0;

    SmsConfirmationFragment$onViewCreated$2(SmsConfirmationFragment smsConfirmationFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        smsConfirmationFragment.handleSms(updateEvent);
    }
}
