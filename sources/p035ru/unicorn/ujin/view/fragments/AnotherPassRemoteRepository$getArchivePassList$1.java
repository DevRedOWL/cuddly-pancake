...
/* renamed from: ru.unicorn.ujin.view.fragments.AnotherPassRemoteRepository$getArchivePassList$1 */
/* compiled from: AnotherPassRemoteRepository.kt */
final class AnotherPassRemoteRepository$getArchivePassList$1<T> implements Consumer<AnotherPassListResponse> {
    final /* synthetic */ AnotherPassRemoteRepository this$0;

    AnotherPassRemoteRepository$getArchivePassList$1(AnotherPassRemoteRepository anotherPassRemoteRepository) {
    ...
    public final void accept(AnotherPassListResponse anotherPassListResponse) {
        ...
        Data data;
        PublishSubject<AnotherArchivePassListEvent> myArchivePassListSubject = this.this$0.getMyArchivePassListSubject();
        ...
        myArchivePassListSubject.onNext(new AnotherArchivePassListEvent(z, message, arrayList));
    }
}
