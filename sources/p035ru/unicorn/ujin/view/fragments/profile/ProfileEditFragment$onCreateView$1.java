...
/* renamed from: ru.unicorn.ujin.view.fragments.profile.ProfileEditFragment$onCreateView$1 */
/* compiled from: ProfileEditFragment.kt */
final class ProfileEditFragment$onCreateView$1<T> implements Observer<UpdateEvent> {
    final /* synthetic */ ProfileEditFragment this$0;

    ProfileEditFragment$onCreateView$1(ProfileEditFragment profileEditFragment) {
        this.this$0 = profileEditFragment;
    }

    public final void onChanged(UpdateEvent updateEvent) {
        this.this$0.handleProfileUpdate(updateEvent);
    }
}
