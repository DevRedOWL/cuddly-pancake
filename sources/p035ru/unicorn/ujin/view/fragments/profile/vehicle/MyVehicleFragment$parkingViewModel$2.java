...
/* renamed from: ru.unicorn.ujin.view.fragments.profile.vehicle.MyVehicleFragment$parkingViewModel$2 */
/* compiled from: MyVehicleFragment.kt */
final class MyVehicleFragment$parkingViewModel$2 extends Lambda implements Function0<ParkingViewModel> {
    final /* synthetic */ MyVehicleFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MyVehicleFragment$parkingViewModel$2(MyVehicleFragment myVehicleFragment) {
        super(0);
