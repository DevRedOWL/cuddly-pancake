...
/* renamed from: ru.unicorn.ujin.view.fragments.profile.vehicle.MyVehicleListFragment$parkingViewModel$2 */
/* compiled from: MyVehicleListFragment.kt */
final class MyVehicleListFragment$parkingViewModel$2 extends Lambda implements Function0<ParkingViewModel> {
    final /* synthetic */ MyVehicleListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MyVehicleListFragment$parkingViewModel$2(MyVehicleListFragment myVehicleListFragment) {
        super(0);
