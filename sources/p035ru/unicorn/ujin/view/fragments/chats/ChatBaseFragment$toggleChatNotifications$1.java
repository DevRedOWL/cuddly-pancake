...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.ChatBaseFragment$toggleChatNotifications$1 */
/* compiled from: ChatBaseFragment.kt */
final class ChatBaseFragment$toggleChatNotifications$1<T> implements Observer<UpdateEvent> {
    final /* synthetic */ boolean $checked;
    final /* synthetic */ Chat $dialog;
    final /* synthetic */ ChatBaseFragment this$0;

    ChatBaseFragment$toggleChatNotifications$1(ChatBaseFragment chatBaseFragment, boolean z, Chat chat) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        chatBaseFragment.handleSettingsChange(updateEvent, this.$checked, this.$dialog);
    }
}
