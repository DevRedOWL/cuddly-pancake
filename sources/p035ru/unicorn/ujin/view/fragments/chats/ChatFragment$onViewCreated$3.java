...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.ChatFragment$onViewCreated$3 */
/* compiled from: ChatFragment.kt */
final class ChatFragment$onViewCreated$3<T> implements Observer<UpdateEvent> {
    final /* synthetic */ ChatFragment this$0;

    ChatFragment$onViewCreated$3(ChatFragment chatFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        chatFragment.handleChatDelete(updateEvent);
    }
}
