...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestSendMessage$2 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestSendMessage$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestSendMessage$2(ChatsRemoteRepository chatsRemoteRepository) {
