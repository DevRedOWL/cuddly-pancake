...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestDeleteChat$1 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestDeleteChat$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestDeleteChat$1(ChatsRemoteRepository chatsRemoteRepository) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        ...
        chatsRemoteRepository.getChatDeleteSubject().onNext(new UpdateEvent(simpleResponse.getError() == 0, simpleResponse.getMessage()));
    }
}
