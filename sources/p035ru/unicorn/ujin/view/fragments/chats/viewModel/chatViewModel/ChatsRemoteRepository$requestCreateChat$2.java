...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestCreateChat$2 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestCreateChat$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestCreateChat$2(ChatsRemoteRepository chatsRemoteRepository) {
