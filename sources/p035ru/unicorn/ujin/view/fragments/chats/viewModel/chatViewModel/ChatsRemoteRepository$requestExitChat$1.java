...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestExitChat$1 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestExitChat$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestExitChat$1(ChatsRemoteRepository chatsRemoteRepository) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        ...
        chatsRemoteRepository.getChatExitSubject().onNext(new UpdateEvent(simpleResponse.getError() == 0, simpleResponse.getMessage()));
    }
}
