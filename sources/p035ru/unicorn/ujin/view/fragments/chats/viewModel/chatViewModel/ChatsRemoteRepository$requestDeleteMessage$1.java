...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestDeleteMessage$1 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestDeleteMessage$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ Message $message;
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestDeleteMessage$1(ChatsRemoteRepository chatsRemoteRepository, Message message) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        ...
        chatsRemoteRepository.getMessageDeleteSubject().onNext(new MessageDeleteEvent(simpleResponse.getError() == 0, simpleResponse.getMessage(), this.$message));
    }
}
