...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestChangeChatSettings$1 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestChangeChatSettings$1<T> implements Consumer<SimpleResponse> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestChangeChatSettings$1(ChatsRemoteRepository chatsRemoteRepository) {
    ...
    public final void accept(SimpleResponse simpleResponse) {
        ...
        chatsRemoteRepository.getChatSettingsSubject().onNext(new UpdateEvent(simpleResponse.getError() == 0, simpleResponse.getMessage()));
    }
}
