...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.ChatsRemoteRepository$requestUploadFile$2 */
/* compiled from: ChatsRemoteRepository.kt */
final class ChatsRemoteRepository$requestUploadFile$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ChatsRemoteRepository this$0;

    ChatsRemoteRepository$requestUploadFile$2(ChatsRemoteRepository chatsRemoteRepository) {
