...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.viewModel.chatViewModel.RozmarinRemoteRepository$requestBuy$2 */
/* compiled from: RozmarinRemoteRepository.kt */
final class RozmarinRemoteRepository$requestBuy$2<T> implements Consumer<Throwable> {
    final /* synthetic */ RozmarinRemoteRepository this$0;

    RozmarinRemoteRepository$requestBuy$2(RozmarinRemoteRepository rozmarinRemoteRepository) {
