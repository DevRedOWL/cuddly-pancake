...
/* renamed from: ru.unicorn.ujin.view.fragments.chats.ChatFragment$onViewCreated$6 */
/* compiled from: ChatFragment.kt */
final class ChatFragment$onViewCreated$6<T> implements Observer<UpdateEvent> {
    final /* synthetic */ ChatFragment this$0;

    ChatFragment$onViewCreated$6(ChatFragment chatFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        chatFragment.handleChatExit(updateEvent);
    }
}
