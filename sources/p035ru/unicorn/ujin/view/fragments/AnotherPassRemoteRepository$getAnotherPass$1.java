...
/* renamed from: ru.unicorn.ujin.view.fragments.AnotherPassRemoteRepository$getAnotherPass$1 */
/* compiled from: AnotherPassRemoteRepository.kt */
final class AnotherPassRemoteRepository$getAnotherPass$1<T, R> implements Function<Resource<AnotherPassResponse>, Resource<AnotherPassResponse>> {
    public static final AnotherPassRemoteRepository$getAnotherPass$1 INSTANCE = new AnotherPassRemoteRepository$getAnotherPass$1();

    AnotherPassRemoteRepository$getAnotherPass$1() {
    }
