...
/* renamed from: ru.unicorn.ujin.view.fragments.makearecord.ListOfRecordFragment$onViewCreated$2 */
/* compiled from: ListOfRecordFragment.kt */
final class ListOfRecordFragment$onViewCreated$2<T> implements Observer<List<? extends Appointment>> {
    final /* synthetic */ ListOfRecordFragment this$0;

    ListOfRecordFragment$onViewCreated$2(ListOfRecordFragment listOfRecordFragment) {
