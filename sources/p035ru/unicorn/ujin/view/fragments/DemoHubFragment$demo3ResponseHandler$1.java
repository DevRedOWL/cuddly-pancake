...
public final class DemoHubFragment$demo3ResponseHandler$1 extends JsonHttpResponseHandler {
    ...
    public void onSuccess(int i, Header[] headerArr, JSONObject jSONObject) {
        ...
        if (demoLoginResponse.getError() == 0) {
            ...
            this.this$0.getBaseActivity().showDemo3Stage();
            return;
        }
