...
/* renamed from: ru.unicorn.ujin.view.fragments.base.attach.AttachRepo$uploadFile$2 */
/* compiled from: AttachRepo.kt */
final class AttachRepo$uploadFile$2<T, R> implements Function<Throwable, Resource<AttachFileData>> {
    public static final AttachRepo$uploadFile$2 INSTANCE = new AttachRepo$uploadFile$2();

    AttachRepo$uploadFile$2() {
    }
