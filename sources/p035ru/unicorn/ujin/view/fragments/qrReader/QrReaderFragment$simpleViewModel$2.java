...
/* renamed from: ru.unicorn.ujin.view.fragments.qrReader.QrReaderFragment$simpleViewModel$2 */
/* compiled from: QrReaderFragment.kt */
final class QrReaderFragment$simpleViewModel$2 extends Lambda implements Function0<SimpleViewModel> {
    final /* synthetic */ QrReaderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    QrReaderFragment$simpleViewModel$2(QrReaderFragment qrReaderFragment) {
        super(0);
