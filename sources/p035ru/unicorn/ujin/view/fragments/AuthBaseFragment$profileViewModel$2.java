...
/* renamed from: ru.unicorn.ujin.view.fragments.AuthBaseFragment$profileViewModel$2 */
/* compiled from: AuthBaseFragment.kt */
final class AuthBaseFragment$profileViewModel$2 extends Lambda implements Function0<ProfileViewModel> {
    final /* synthetic */ AuthBaseFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AuthBaseFragment$profileViewModel$2(AuthBaseFragment authBaseFragment) {
        super(0);
        this.this$0 = authBaseFragment;
    }
