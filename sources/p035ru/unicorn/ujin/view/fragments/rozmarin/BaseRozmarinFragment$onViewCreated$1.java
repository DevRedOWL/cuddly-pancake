...
/* renamed from: ru.unicorn.ujin.view.fragments.rozmarin.BaseRozmarinFragment$onViewCreated$1 */
/* compiled from: BaseRozmarinFragment.kt */
final class BaseRozmarinFragment$onViewCreated$1<T> implements Observer<UpdateEvent> {
    final /* synthetic */ BaseRozmarinFragment this$0;

    BaseRozmarinFragment$onViewCreated$1(BaseRozmarinFragment baseRozmarinFragment) {
    ...
    public final void onChanged(UpdateEvent updateEvent) {
        ...
        baseRozmarinFragment.showResponse(updateEvent);
    }
}
