...
/* renamed from: ru.unicorn.ujin.view.fragments.development.DeveloperBuildingStagesFragment$developmentViewModel$2 */
/* compiled from: DeveloperBuildingStagesFragment.kt */
final class DeveloperBuildingStagesFragment$developmentViewModel$2 extends Lambda implements Function0<DeveloperViewModel> {
    final /* synthetic */ DeveloperBuildingStagesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DeveloperBuildingStagesFragment$developmentViewModel$2(DeveloperBuildingStagesFragment developerBuildingStagesFragment) {
        super(0);
