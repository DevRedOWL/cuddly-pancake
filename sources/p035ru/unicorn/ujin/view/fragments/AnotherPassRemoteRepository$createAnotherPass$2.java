...
/* renamed from: ru.unicorn.ujin.view.fragments.AnotherPassRemoteRepository$createAnotherPass$2 */
/* compiled from: AnotherPassRemoteRepository.kt */
final class AnotherPassRemoteRepository$createAnotherPass$2<T, R> implements Function<Throwable, Resource<AnotherPassResponse>> {
    public static final AnotherPassRemoteRepository$createAnotherPass$2 INSTANCE = new AnotherPassRemoteRepository$createAnotherPass$2();

    AnotherPassRemoteRepository$createAnotherPass$2() {
    }
