...
/* renamed from: ru.unicorn.ujin.view.fragments.SmsConfirmationFragment$handleConfirm$1 */
/* compiled from: SmsConfirmationFragment.kt */
final class SmsConfirmationFragment$handleConfirm$1 implements DialogInterface.OnClickListener {
    final /* synthetic */ SmsConfirmationFragment this$0;

    SmsConfirmationFragment$handleConfirm$1(SmsConfirmationFragment smsConfirmationFragment) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        smsConfirmationFragment.getBaseActivity().onBackPressed();
    }
}
