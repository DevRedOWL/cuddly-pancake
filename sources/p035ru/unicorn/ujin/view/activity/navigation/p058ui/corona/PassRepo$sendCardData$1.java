...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$sendCardData$1 */
/* compiled from: PassRepo.kt */
final class PassRepo$sendCardData$1<T, R> implements Function<Resource<Unit>, Resource<Unit>> {
    public static final PassRepo$sendCardData$1 INSTANCE = new PassRepo$sendCardData$1();

    PassRepo$sendCardData$1() {
    }
