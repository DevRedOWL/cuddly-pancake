...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$sendToMail$2 */
/* compiled from: PassRepo.kt */
final class PassRepo$sendToMail$2<T, R> implements Function<Throwable, Resource<QRIn>> {
    public static final PassRepo$sendToMail$2 INSTANCE = new PassRepo$sendToMail$2();

    PassRepo$sendToMail$2() {
    }
