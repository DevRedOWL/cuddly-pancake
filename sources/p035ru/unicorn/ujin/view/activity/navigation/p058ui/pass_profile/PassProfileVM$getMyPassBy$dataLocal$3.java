...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileVM$getMyPassBy$dataLocal$3 */
/* compiled from: PassProfileVM.kt */
final class PassProfileVM$getMyPassBy$dataLocal$3<T> implements Predicate<BleKeyData> {
    public static final PassProfileVM$getMyPassBy$dataLocal$3 INSTANCE = new PassProfileVM$getMyPassBy$dataLocal$3();

    PassProfileVM$getMyPassBy$dataLocal$3() {
    }
