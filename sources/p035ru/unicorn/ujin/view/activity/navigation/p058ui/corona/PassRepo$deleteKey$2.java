...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$deleteKey$2 */
/* compiled from: PassRepo.kt */
final class PassRepo$deleteKey$2<T, R> implements Function<Resource<Unit>, Resource<Unit>> {
    public static final PassRepo$deleteKey$2 INSTANCE = new PassRepo$deleteKey$2();

    PassRepo$deleteKey$2() {
    }
