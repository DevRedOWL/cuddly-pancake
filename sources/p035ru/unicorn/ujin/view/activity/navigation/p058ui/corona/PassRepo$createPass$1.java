...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$createPass$1 */
/* compiled from: PassRepo.kt */
final class PassRepo$createPass$1<T, R> implements Function<Resource<PassDetailIn>, Resource<Pass>> {
    public static final PassRepo$createPass$1 INSTANCE = new PassRepo$createPass$1();

    PassRepo$createPass$1() {
    }
