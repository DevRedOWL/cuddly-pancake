...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$destroyContact$7 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$destroyContact$7<T, R> implements Function<UserProfile, TeamMapper> {
    public static final MyProfileViewModel$destroyContact$7 INSTANCE = new MyProfileViewModel$destroyContact$7();

    MyProfileViewModel$destroyContact$7() {
    }
