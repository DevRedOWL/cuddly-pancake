...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.addhardware.create.CreateDeviceRemoteRepository$addRoom$1 */
/* compiled from: CreateDeviceRemoteRepository.kt */
final class CreateDeviceRemoteRepository$addRoom$1<T, R> implements Function<Resource<Void>, Resource<Void>> {
    public static final CreateDeviceRemoteRepository$addRoom$1 INSTANCE = new CreateDeviceRemoteRepository$addRoom$1();

    CreateDeviceRemoteRepository$addRoom$1() {
    }
