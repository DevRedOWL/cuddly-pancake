...
@Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u001a\u0010\u0002\u001a\u0016\u0012\u0004\u0012\u00020\u0004 \u0005*\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0006"}, mo51343d2 = {"<anonymous>", "", "data", "Lru/unicorn/ujin/data/realm/Resource;", "", "kotlin.jvm.PlatformType", "accept"}, mo51344k = 3, mo51345mv = {1, 4, 1})
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass.company.PassCompanyVM$connectTo$s$1 */
/* compiled from: PassCompanyVM.kt */
final class PassCompanyVM$connectTo$s$1<T> implements Consumer<Resource<Object>> {
    final /* synthetic */ PassCompanyVM this$0;

    PassCompanyVM$connectTo$s$1(PassCompanyVM passCompanyVM) {
    ...
    public final void accept(Resource<Object> resource) {
        ...
        if (resource.getStatus() == Resource.Status.SUCCESS) {
            this.this$0.getShowSuccess().setValue("Вы присоеденились к компании");
            return;
        }
