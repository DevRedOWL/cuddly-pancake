...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$loadProfileData$5 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$loadProfileData$5<T> implements Consumer<Resource<ProfileData>> {
    final /* synthetic */ MyProfileViewModel this$0;

    MyProfileViewModel$loadProfileData$5(MyProfileViewModel myProfileViewModel) {
        this.this$0 = myProfileViewModel;
    }

    public final void accept(Resource<ProfileData> resource) {
        SingleLiveEvent<Resource<List<FullProfileMapper>>> getProfileLiveData = this.this$0.getGetProfileLiveData();
        Intrinsics.checkNotNullExpressionValue(resource, "data");
        getProfileLiveData.setValue(Resource.success(0, "", FullProfileMapper.mapTo(resource.getData().getProfile(), false)));
    }
}
