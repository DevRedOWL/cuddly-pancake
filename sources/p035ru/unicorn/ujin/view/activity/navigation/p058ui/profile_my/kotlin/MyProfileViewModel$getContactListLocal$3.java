...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$getContactListLocal$3 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$getContactListLocal$3<T, R> implements Function<UserProfile, TeamMapper> {
    public static final MyProfileViewModel$getContactListLocal$3 INSTANCE = new MyProfileViewModel$getContactListLocal$3();

    MyProfileViewModel$getContactListLocal$3() {
    }
