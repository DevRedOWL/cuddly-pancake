...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileVM$getMyPassBy$dataLocal$2 */
/* compiled from: PassProfileVM.kt */
final class PassProfileVM$getMyPassBy$dataLocal$2<T> implements Predicate<BleKeyData> {
    final /* synthetic */ String $passType;

    PassProfileVM$getMyPassBy$dataLocal$2(String str) {
        this.$passType = str;
    }
