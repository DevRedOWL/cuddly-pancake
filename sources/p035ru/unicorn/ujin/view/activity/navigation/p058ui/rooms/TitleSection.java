...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.rooms.TitleSection */
public class TitleSection extends SingleSection<SomeString, TitleHolder> {
    int fontSize = 20;
    boolean isBold = true;
    private int layout;
    ...
    public TitleSection(boolean z, int i) {
        this.isBold = z;
        this.fontSize = i;
    }
    ...
    public int getLayoutId() {
        int i = this.layout;
        return i != 0 ? i : R.layout.item_title;
    }
    ...
    /* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.rooms.TitleSection$TitleHolder */
