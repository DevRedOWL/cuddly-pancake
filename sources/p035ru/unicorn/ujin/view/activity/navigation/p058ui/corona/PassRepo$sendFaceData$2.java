...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$sendFaceData$2 */
/* compiled from: PassRepo.kt */
final class PassRepo$sendFaceData$2<T, R> implements Function<Resource<Unit>, Resource<Unit>> {
    public static final PassRepo$sendFaceData$2 INSTANCE = new PassRepo$sendFaceData$2();

    PassRepo$sendFaceData$2() {
    }
