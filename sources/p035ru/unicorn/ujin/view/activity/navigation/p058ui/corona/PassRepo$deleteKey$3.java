...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$deleteKey$3 */
/* compiled from: PassRepo.kt */
final class PassRepo$deleteKey$3<T, R> implements Function<Resource<Unit>, Resource<Unit>> {
    public static final PassRepo$deleteKey$3 INSTANCE = new PassRepo$deleteKey$3();

    PassRepo$deleteKey$3() {
    }
