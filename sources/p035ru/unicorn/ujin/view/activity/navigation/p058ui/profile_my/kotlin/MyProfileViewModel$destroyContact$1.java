...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$destroyContact$1 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$destroyContact$1<T, R> implements Function<Resource<ContactData>, Resource<ContactData>> {
    final /* synthetic */ MyProfileViewModel this$0;

    MyProfileViewModel$destroyContact$1(MyProfileViewModel myProfileViewModel) {
    ...
    public final Resource<ContactData> apply(Resource<ContactData> resource) {
        ...
        if (resource.getStatus() == Resource.Status.ERROR || ((error = resource.getError()) != null && error.intValue() == 1)) {
            this.this$0.getDestroyContactLiveData().postValue(Resource.error(String.valueOf(resource.getError().intValue())));
        } else {
            this.this$0.getDestroyContactLiveData().postValue(Resource.success(0, "", true));
        }
        return resource;
    }
}
