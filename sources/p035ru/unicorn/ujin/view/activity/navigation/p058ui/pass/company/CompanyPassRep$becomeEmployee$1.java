...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass.company.CompanyPassRep$becomeEmployee$1 */
/* compiled from: CompanyPassRep.kt */
final class CompanyPassRep$becomeEmployee$1<T, R> implements Function<SimpleResponse, Resource<SimpleResponse>> {
    public static final CompanyPassRep$becomeEmployee$1 INSTANCE = new CompanyPassRep$becomeEmployee$1();

    CompanyPassRep$becomeEmployee$1() {
    }
