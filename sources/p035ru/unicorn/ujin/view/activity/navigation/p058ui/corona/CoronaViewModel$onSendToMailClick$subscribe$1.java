...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.CoronaViewModel$onSendToMailClick$subscribe$1 */
/* compiled from: CoronaViewModel.kt */
final class CoronaViewModel$onSendToMailClick$subscribe$1<T> implements Consumer<Resource<QRIn>> {
    final /* synthetic */ CoronaViewModel this$0;

    CoronaViewModel$onSendToMailClick$subscribe$1(CoronaViewModel coronaViewModel) {
