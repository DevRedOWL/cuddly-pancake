...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileRemoteRepository$inviteContact$1 */
/* compiled from: MyProfileRemoteRepository.kt */
final class MyProfileRemoteRepository$inviteContact$1<T, R> implements Function<Resource<ContactData>, Resource<ContactData>> {
    public static final MyProfileRemoteRepository$inviteContact$1 INSTANCE = new MyProfileRemoteRepository$inviteContact$1();

    MyProfileRemoteRepository$inviteContact$1() {
    }
