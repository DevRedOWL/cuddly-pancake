...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileVM$getAssignKey$1 */
/* compiled from: PassProfileVM.kt */
final class PassProfileVM$getAssignKey$1<T> implements Consumer<List<BleKeyData>> {
    final /* synthetic */ PassProfileVM this$0;

    PassProfileVM$getAssignKey$1(PassProfileVM passProfileVM) {
        this.this$0 = passProfileVM;
    }

    public final void accept(List<BleKeyData> list) {
        this.this$0.getAssignKeys().setValue(list);
    }
}
