...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileRemoteRepository$inviteContact$3 */
/* compiled from: MyProfileRemoteRepository.kt */
final class MyProfileRemoteRepository$inviteContact$3<T, R> implements Function<Resource<ContactData>, Resource<ContactData>> {
    public static final MyProfileRemoteRepository$inviteContact$3 INSTANCE = new MyProfileRemoteRepository$inviteContact$3();

    MyProfileRemoteRepository$inviteContact$3() {
    }
