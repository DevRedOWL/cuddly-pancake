...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileRemoteRepository$inviteContact$2 */
/* compiled from: MyProfileRemoteRepository.kt */
final class MyProfileRemoteRepository$inviteContact$2<T, R> implements Function<Throwable, Resource<ContactData>> {
    public static final MyProfileRemoteRepository$inviteContact$2 INSTANCE = new MyProfileRemoteRepository$inviteContact$2();

    MyProfileRemoteRepository$inviteContact$2() {
    }
