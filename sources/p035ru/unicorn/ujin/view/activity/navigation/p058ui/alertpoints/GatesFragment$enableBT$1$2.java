...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.alertpoints.GatesFragment$enableBT$1$2 */
/* compiled from: GatesFragment.kt */
final class GatesFragment$enableBT$1$2 extends Lambda implements Function1<MaterialDialog, Unit> {
    public static final GatesFragment$enableBT$1$2 INSTANCE = new GatesFragment$enableBT$1$2();

    GatesFragment$enableBT$1$2() {
        super(1);
    }
