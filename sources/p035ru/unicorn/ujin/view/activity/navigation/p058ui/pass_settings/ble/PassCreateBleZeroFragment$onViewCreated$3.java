...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_settings.ble.PassCreateBleZeroFragment$onViewCreated$3 */
/* compiled from: PassCreateBleZeroFragment.kt */
final class PassCreateBleZeroFragment$onViewCreated$3 implements CompoundButton.OnCheckedChangeListener {
    final /* synthetic */ PassCreateBleZeroFragment this$0;

    PassCreateBleZeroFragment$onViewCreated$3(PassCreateBleZeroFragment passCreateBleZeroFragment) {
        this.this$0 = passCreateBleZeroFragment;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        PassCreateBleZeroFragment passCreateBleZeroFragment = this.this$0;
        CheckBox checkBox = ((FragmentPassBleZeroBinding) passCreateBleZeroFragment.getViewDataBinding()).cbReader;
        ...
        dynamicBackgroundButton.setText(passCreateBleZeroFragment.getString(R.string.button_make_qr));
        ...
        textView.setText(passCreateBleZeroFragment.getString(R.string.label_ble_qr_));
    }
}
