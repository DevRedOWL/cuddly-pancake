...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassDetailFragment$onViewCreated$1 */
/* compiled from: PassDetailFragment.kt */
final class PassDetailFragment$onViewCreated$1<T> implements Observer<Resource<Pass>> {
    final /* synthetic */ PassDetailFragment this$0;

    PassDetailFragment$onViewCreated$1(PassDetailFragment passDetailFragment) {
        this.this$0 = passDetailFragment;
    }

    public final void onChanged(Resource<Pass> resource) {
        this.this$0.showDetail(resource);
    }
}
