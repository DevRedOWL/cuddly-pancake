...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$inviteContact$6 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$inviteContact$6<T, R> implements Function<Resource<ContactDataList>, Iterable<? extends UserProfile>> {
    public static final MyProfileViewModel$inviteContact$6 INSTANCE = new MyProfileViewModel$inviteContact$6();

    MyProfileViewModel$inviteContact$6() {
    }
