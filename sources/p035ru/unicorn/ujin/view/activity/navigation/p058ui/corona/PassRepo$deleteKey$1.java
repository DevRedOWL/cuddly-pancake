...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.corona.PassRepo$deleteKey$1 */
/* compiled from: PassRepo.kt */
final class PassRepo$deleteKey$1<T, R> implements Function<BleKeyData, Publisher<? extends Resource<Unit>>> {
    final /* synthetic */ String $interfaceType;
    final /* synthetic */ PassRepo this$0;

    PassRepo$deleteKey$1(PassRepo passRepo, String str) {
    ...
    public final Publisher<? extends Resource<Unit>> apply(BleKeyData bleKeyData) {
        ...
        return this.this$0.getApi().deletePassKey(String.valueOf(bleKeyData.getSerialNumber()), this.$interfaceType, 1, this.this$0.getToken());
    }
}
