...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileVM$loadAllBleDevice$1 */
/* compiled from: PassProfileVM.kt */
final class PassProfileVM$loadAllBleDevice$1<T> implements Consumer<List<BleReader>> {
    final /* synthetic */ PassProfileVM this$0;

    PassProfileVM$loadAllBleDevice$1(PassProfileVM passProfileVM) {
