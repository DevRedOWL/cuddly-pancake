...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileViewModel$loadContactList$6 */
/* compiled from: MyProfileViewModel.kt */
final class MyProfileViewModel$loadContactList$6<T, R> implements Function<UserProfile, TeamMapper> {
    public static final MyProfileViewModel$loadContactList$6 INSTANCE = new MyProfileViewModel$loadContactList$6();

    MyProfileViewModel$loadContactList$6() {
    }
