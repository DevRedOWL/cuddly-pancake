...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileRemoteRepository$destroyContact$2 */
/* compiled from: MyProfileRemoteRepository.kt */
final class MyProfileRemoteRepository$destroyContact$2<T, R> implements Function<Throwable, Resource<ContactData>> {
    public static final MyProfileRemoteRepository$destroyContact$2 INSTANCE = new MyProfileRemoteRepository$destroyContact$2();

    MyProfileRemoteRepository$destroyContact$2() {
    }
