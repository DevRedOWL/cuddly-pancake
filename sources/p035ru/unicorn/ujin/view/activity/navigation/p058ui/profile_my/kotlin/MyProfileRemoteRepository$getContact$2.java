...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.profile_my.kotlin.MyProfileRemoteRepository$getContact$2 */
/* compiled from: MyProfileRemoteRepository.kt */
final class MyProfileRemoteRepository$getContact$2<T, R> implements Function<Throwable, Resource<ContactData>> {
    public static final MyProfileRemoteRepository$getContact$2 INSTANCE = new MyProfileRemoteRepository$getContact$2();

    MyProfileRemoteRepository$getContact$2() {
    }
