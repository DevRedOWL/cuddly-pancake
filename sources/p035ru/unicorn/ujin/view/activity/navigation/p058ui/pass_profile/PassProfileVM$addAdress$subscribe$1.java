...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileVM$addAdress$subscribe$1 */
/* compiled from: PassProfileVM.kt */
final class PassProfileVM$addAdress$subscribe$1<T> implements Consumer<Resource<List<? extends ProfileAdress>>> {
    final /* synthetic */ PassProfileVM this$0;

    PassProfileVM$addAdress$subscribe$1(PassProfileVM passProfileVM) {
