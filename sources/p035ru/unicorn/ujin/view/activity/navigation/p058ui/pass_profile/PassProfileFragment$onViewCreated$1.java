...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.pass_profile.PassProfileFragment$onViewCreated$1 */
/* compiled from: PassProfileFragment.kt */
final class PassProfileFragment$onViewCreated$1<T> implements Observer<Resource<List<? extends ProfileAdress>>> {
    final /* synthetic */ PassProfileFragment this$0;

    PassProfileFragment$onViewCreated$1(PassProfileFragment passProfileFragment) {
