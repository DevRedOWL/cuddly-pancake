...
/* renamed from: ru.unicorn.ujin.view.activity.navigation.ui.addhardware.create.CreateDeviceRemoteRepository$updateDevice$1 */
/* compiled from: CreateDeviceRemoteRepository.kt */
final class CreateDeviceRemoteRepository$updateDevice$1<T, R> implements Function<Resource<Void>, Resource<Void>> {
    public static final CreateDeviceRemoteRepository$updateDevice$1 INSTANCE = new CreateDeviceRemoteRepository$updateDevice$1();

    CreateDeviceRemoteRepository$updateDevice$1() {
    }
