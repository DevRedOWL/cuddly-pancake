...
/* renamed from: ru.unicorn.ujin.view.activity.domru.RegisterDomruActivity$onCreate$8 */
/* compiled from: RegisterDomruActivity.kt */
final class RegisterDomruActivity$onCreate$8<T> implements Observer<CitiesProviderEvent> {
    final /* synthetic */ RegisterDomruActivity this$0;

    RegisterDomruActivity$onCreate$8(RegisterDomruActivity registerDomruActivity) {
    ...
    public final void onChanged(CitiesProviderEvent citiesProviderEvent) {
        ...
        registerDomruActivity.handleEvent(citiesProviderEvent);
    }
}
