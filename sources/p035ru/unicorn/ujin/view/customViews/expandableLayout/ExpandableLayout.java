package p035ru.unicorn.ujin.view.customViews.expandableLayout;
...
/* renamed from: ru.unicorn.ujin.view.customViews.expandableLayout.ExpandableLayout */
public class ExpandableLayout extends FrameLayout {
    ...
    /* renamed from: ru.unicorn.ujin.view.customViews.expandableLayout.ExpandableLayout$OnExpansionUpdateListener */
    public interface OnExpansionUpdateListener {
        void onExpansionUpdate(float f, int i);
    }

    /* renamed from: ru.unicorn.ujin.view.customViews.expandableLayout.ExpandableLayout$State */
    ...
    public ExpandableLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C5619R.styleable.ExpandableLayout);
            ...
            this.state = this.expansion == 0.0f ? 0 : i;
    ...
    /* renamed from: ru.unicorn.ujin.view.customViews.expandableLayout.ExpandableLayout$ExpansionListener */
