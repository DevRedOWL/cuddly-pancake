...
/* renamed from: ru.unicorn.ujin.view.customViews.photoView.CustomGestureDetector */
    ...
    CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() {
            ...
            public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
                ...
                if ((CustomGestureDetector.this.currentScale == 1.0f && scaleFactor >= 1.0f) || (CustomGestureDetector.this.currentScale > 1.0f && scaleFactor >= 0.0f)) {
                    CustomGestureDetector.this.mListener.onScale(scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
                }
                if (CustomGestureDetector.this.currentScale >= 1.0f) {
                    return true;
                }
                float unused = CustomGestureDetector.this.currentScale = 1.0f;
                return true;
            }
        });
    }
