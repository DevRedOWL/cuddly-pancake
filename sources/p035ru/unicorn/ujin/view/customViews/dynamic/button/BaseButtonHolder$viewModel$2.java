...
/* renamed from: ru.unicorn.ujin.view.customViews.dynamic.button.BaseButtonHolder$viewModel$2 */
/* compiled from: BaseButtonHolder.kt */
final class BaseButtonHolder$viewModel$2 extends Lambda implements Function0<DynamicFormViewModel> {
    final /* synthetic */ View $itemView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BaseButtonHolder$viewModel$2(View view) {
        super(0);
        this.$itemView = view;
    }
