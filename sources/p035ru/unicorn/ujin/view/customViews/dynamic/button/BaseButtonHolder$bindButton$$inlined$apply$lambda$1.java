...
@Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005¨\u0006\u0007"}, mo51343d2 = {"<anonymous>", "", "it", "Landroid/view/View;", "kotlin.jvm.PlatformType", "onClick", "ru/unicorn/ujin/view/customViews/dynamic/button/BaseButtonHolder$bindButton$1$1$1", "ru/unicorn/ujin/view/customViews/dynamic/button/BaseButtonHolder$$special$$inlined$also$lambda$1"}, mo51344k = 3, mo51345mv = {1, 4, 1})
/* renamed from: ru.unicorn.ujin.view.customViews.dynamic.button.BaseButtonHolder$bindButton$$inlined$apply$lambda$1 */
/* compiled from: BaseButtonHolder.kt */
final class BaseButtonHolder$bindButton$$inlined$apply$lambda$1 implements View.OnClickListener {
    ...
    BaseButtonHolder$bindButton$$inlined$apply$lambda$1(DynamicBackgroundButton dynamicBackgroundButton, BaseButtonHolder baseButtonHolder, ButtonField buttonField) {
            ...
            if (!(data == null || (confirmMessage = data.getConfirmMessage()) == null)) {
                if (confirmMessage.length() > 0) {
                    ...
                    builder.setMessage((CharSequence) data2 != null ? data2.getConfirmMessage() : null).setPositiveButton((CharSequence) "Да", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener(this) {
                        final /* synthetic */ BaseButtonHolder$bindButton$$inlined$apply$lambda$1 this$0;
                    ...
                    }).setNegativeButton((CharSequence) "Нет", (DialogInterface.OnClickListener) BaseButtonHolder$bindButton$1$1$1$2.INSTANCE).show();
                    return;
                }
            }
