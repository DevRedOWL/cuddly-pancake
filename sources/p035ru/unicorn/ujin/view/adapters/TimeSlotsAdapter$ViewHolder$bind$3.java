...
/* renamed from: ru.unicorn.ujin.view.adapters.TimeSlotsAdapter$ViewHolder$bind$3 */
/* compiled from: TimeSlotsAdapter.kt */
final class TimeSlotsAdapter$ViewHolder$bind$3 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ TimeSlotsAdapter.ViewHolder this$0;

    TimeSlotsAdapter$ViewHolder$bind$3(TimeSlotsAdapter.ViewHolder viewHolder, int i) {
