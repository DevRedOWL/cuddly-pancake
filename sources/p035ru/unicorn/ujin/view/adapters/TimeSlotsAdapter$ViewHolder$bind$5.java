...
/* renamed from: ru.unicorn.ujin.view.adapters.TimeSlotsAdapter$ViewHolder$bind$5 */
/* compiled from: TimeSlotsAdapter.kt */
final class TimeSlotsAdapter$ViewHolder$bind$5 implements View.OnClickListener {
    final /* synthetic */ int $position;
    final /* synthetic */ TimeSlotsAdapter.ViewHolder this$0;

    TimeSlotsAdapter$ViewHolder$bind$5(TimeSlotsAdapter.ViewHolder viewHolder, int i) {
