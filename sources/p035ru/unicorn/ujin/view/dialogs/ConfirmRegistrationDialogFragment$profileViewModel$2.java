...
/* renamed from: ru.unicorn.ujin.view.dialogs.ConfirmRegistrationDialogFragment$profileViewModel$2 */
/* compiled from: ConfirmRegistrationDialogFragment.kt */
final class ConfirmRegistrationDialogFragment$profileViewModel$2 extends Lambda implements Function0<ProfileViewModel> {
    final /* synthetic */ ConfirmRegistrationDialogFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfirmRegistrationDialogFragment$profileViewModel$2(ConfirmRegistrationDialogFragment confirmRegistrationDialogFragment) {
        super(0);
