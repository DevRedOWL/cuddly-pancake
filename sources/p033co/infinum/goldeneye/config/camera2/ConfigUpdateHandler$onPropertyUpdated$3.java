...
/* renamed from: co.infinum.goldeneye.config.camera2.ConfigUpdateHandler$onPropertyUpdated$3 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$3 extends Lambda implements Function1<CaptureRequest.Builder, Unit> {
    final /* synthetic */ ConfigUpdateHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$onPropertyUpdated$3(ConfigUpdateHandler configUpdateHandler) {
        super(1);
    ...
    public final void invoke(CaptureRequest.Builder builder) {
        ...
        builder.set(CaptureRequest.CONTROL_EFFECT_MODE, Integer.valueOf(this.this$0.config.getColorEffectMode().toCamera2()));
    }
}
