...
/* renamed from: co.infinum.goldeneye.config.camera2.ConfigUpdateHandler$onPropertyUpdated$6 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$6 extends Lambda implements Function1<CaptureRequest.Builder, Unit> {
    ...
    public final void invoke(CaptureRequest.Builder builder) {
        ...
        this.this$0.updateZoom(builder);
    }
}
