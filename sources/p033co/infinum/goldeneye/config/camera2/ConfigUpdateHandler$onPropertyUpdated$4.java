...
/* renamed from: co.infinum.goldeneye.config.camera2.ConfigUpdateHandler$onPropertyUpdated$4 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$4 extends Lambda implements Function1<CaptureRequest.Builder, Unit> {
    ...
    public final void invoke(CaptureRequest.Builder builder) {
        ...
        builder.set(CaptureRequest.CONTROL_AE_ANTIBANDING_MODE, Integer.valueOf(this.this$0.config.getAntibandingMode().toCamera2()));
    }
}
