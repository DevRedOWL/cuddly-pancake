...
/* renamed from: co.infinum.goldeneye.config.camera2.ConfigUpdateHandler$onPropertyUpdated$1 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$1 extends Lambda implements Function1<CaptureRequest.Builder, Unit> {
    final /* synthetic */ ConfigUpdateHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$onPropertyUpdated$1(ConfigUpdateHandler configUpdateHandler) {
        super(1);
    ...
    public final void invoke(CaptureRequest.Builder builder) {
        ...
        builder.set(CaptureRequest.CONTROL_AF_MODE, Integer.valueOf(this.this$0.config.getFocusMode().toCamera2()));
    }
}
