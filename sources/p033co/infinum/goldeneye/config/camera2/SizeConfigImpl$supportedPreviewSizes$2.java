...
/* renamed from: co.infinum.goldeneye.config.camera2.SizeConfigImpl$supportedPreviewSizes$2 */
    ...
    public final List<Size> invoke() {
        ...
        if (!(streamConfigurationMap == null || (outputSizes = streamConfigurationMap.getOutputSizes(SurfaceTexture.class)) == null)) {
            ...
            for (Object next : (List) arrayList) {
                if (!((Size) next).isOver1080p()) {
                    arrayList2.add(next);
                }
            }
            List<Size> sorted = CollectionsKt.sorted((List) arrayList2);
            if (sorted != null) {
                return sorted;
            }
        }
