...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$6 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$6 extends Lambda implements Function1<Camera.Parameters, Unit> {
    final /* synthetic */ ConfigUpdateHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$onPropertyUpdated$6(ConfigUpdateHandler configUpdateHandler) {
        super(1);
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        parameters.setZoom(parameters.getZoomRatios().indexOf(Integer.valueOf(this.this$0.config.getZoom())));
    }
}
