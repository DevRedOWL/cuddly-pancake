...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$updatePreviewSize$1 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$updatePreviewSize$1 extends Lambda implements Function1<Camera.Parameters, Unit> {
    final /* synthetic */ Size $previewSize;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$updatePreviewSize$1(Size size) {
        super(1);
