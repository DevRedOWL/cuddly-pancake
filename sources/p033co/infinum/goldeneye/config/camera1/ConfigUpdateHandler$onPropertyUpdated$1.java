...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$1 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$1 extends Lambda implements Function1<Camera.Parameters, Unit> {
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        parameters.setFocusMode(this.this$0.config.getFocusMode().toCamera1());
    }
}
