...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$7 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$7 extends Lambda implements Function1<Camera.Parameters, Unit> {
    final /* synthetic */ ConfigUpdateHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$onPropertyUpdated$7(ConfigUpdateHandler configUpdateHandler) {
        super(1);
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        if (Build.VERSION.SDK_INT >= 15) {
            parameters.setVideoStabilization(this.this$0.config.getVideoStabilizationEnabled());
        }
    }
}
