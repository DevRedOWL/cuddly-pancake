...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$updatePictureSize$1 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$updatePictureSize$1 extends Lambda implements Function1<Camera.Parameters, Unit> {
    final /* synthetic */ Size $pictureSize;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConfigUpdateHandler$updatePictureSize$1(Size size) {
        super(1);
