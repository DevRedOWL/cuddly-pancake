...
/* renamed from: co.infinum.goldeneye.config.camera1.SizeConfigImpl$supportedPictureSizes$2 */
...
final class SizeConfigImpl$supportedPictureSizes$2 extends Lambda implements Function0<List<? extends Size>> {
    ...
    public final List<Size> invoke() {
        List<Camera.Size> supportedPictureSizes = ((Camera.Parameters) this.this$0.getCharacteristics()).getSupportedPictureSizes();
        if (supportedPictureSizes != null) {
            Iterable<Camera.Size> iterable = supportedPictureSizes;
