...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$3 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$3 extends Lambda implements Function1<Camera.Parameters, Unit> {
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        parameters.setColorEffect(this.this$0.config.getColorEffectMode().toCamera1());
    }
}
