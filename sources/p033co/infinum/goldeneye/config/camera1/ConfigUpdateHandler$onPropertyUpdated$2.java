...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$2 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$2 extends Lambda implements Function1<Camera.Parameters, Unit> {
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        parameters.setFlashMode(this.this$0.config.getFlashMode().toCamera1());
    }
}
