...
/* renamed from: co.infinum.goldeneye.config.camera1.VideoConfigImpl$isVideoStabilizationSupported$2 */
...
final class VideoConfigImpl$isVideoStabilizationSupported$2 extends Lambda implements Function0<Boolean> {
    ...
    public final boolean invoke() {
        return Build.VERSION.SDK_INT >= 15 && ((Camera.Parameters) this.this$0.getCharacteristics()).isVideoStabilizationSupported();
    }
}
