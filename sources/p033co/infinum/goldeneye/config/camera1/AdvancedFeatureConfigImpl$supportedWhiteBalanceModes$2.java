...
/* renamed from: co.infinum.goldeneye.config.camera1.AdvancedFeatureConfigImpl$supportedWhiteBalanceModes$2 */
...
final class AdvancedFeatureConfigImpl$supportedWhiteBalanceModes$2 extends Lambda implements Function0<List<? extends WhiteBalanceMode>> {
    ...
    public final List<WhiteBalanceMode> invoke() {
        List<String> supportedWhiteBalance = ((Camera.Parameters) this.this$0.getCharacteristics()).getSupportedWhiteBalance();
        if (supportedWhiteBalance == null) {
            return CollectionsKt.emptyList();
        }
        Iterable<String> iterable = supportedWhiteBalance;
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterable, 10));
        for (String fromCamera1 : iterable) {
            arrayList.add(WhiteBalanceMode.Companion.fromCamera1(fromCamera1));
        }
