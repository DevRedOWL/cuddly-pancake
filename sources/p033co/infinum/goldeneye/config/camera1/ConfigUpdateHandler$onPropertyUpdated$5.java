...
/* renamed from: co.infinum.goldeneye.config.camera1.ConfigUpdateHandler$onPropertyUpdated$5 */
/* compiled from: ConfigUpdateHandler.kt */
final class ConfigUpdateHandler$onPropertyUpdated$5 extends Lambda implements Function1<Camera.Parameters, Unit> {
    ...
    public final void invoke(Camera.Parameters parameters) {
        ...
        parameters.setWhiteBalance(this.this$0.config.getWhiteBalanceMode().toCamera1());
    }
}
