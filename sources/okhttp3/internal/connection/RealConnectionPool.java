...
public final class RealConnectionPool {
    ...
    public final boolean transmitterAcquirePooledConnection(Address address, Transmitter transmitter, List<Route> list, boolean z) {
        Intrinsics.checkParameterIsNotNull(address, Contact.Type.address);
    ...
    public final long cleanup(long r12) {
        /*
            ...
            monitor-enter(r11)
            java.util.ArrayDeque<okhttp3.internal.connection.RealConnection> r1 = r11.connections     // Catch:{ all -> 0x006c }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ all -> 0x006c }
            r2 = 0
            ...
            r6 = 0
        L_0x0010:
            boolean r7 = r1.hasNext()     // Catch:{ all -> 0x006c }
            if (r7 == 0) goto L_0x0039
            java.lang.Object r7 = r1.next()     // Catch:{ all -> 0x006c }
            okhttp3.internal.connection.RealConnection r7 = (okhttp3.internal.connection.RealConnection) r7     // Catch:{ all -> 0x006c }
            java.lang.String r8 = "connection"
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r7, r8)     // Catch:{ all -> 0x006c }
            int r8 = r11.pruneAndGetAllocationCount(r7, r12)     // Catch:{ all -> 0x006c }
            if (r8 <= 0) goto L_0x002a
            int r6 = r6 + 1
            goto L_0x0010
        L_0x002a:
            int r0 = r0 + 1
            long r8 = r7.getIdleAtNanos$okhttp()     // Catch:{ all -> 0x006c }
            long r8 = r12 - r8
            ...
            goto L_0x0010
        L_0x0039:
            long r12 = r11.keepAliveDurationNs     // Catch:{ all -> 0x006c }
            int r1 = (r3 > r12 ? 1 : (r3 == r12 ? 0 : -1))
            if (r1 >= 0) goto L_0x0057
            int r12 = r11.maxIdleConnections     // Catch:{ all -> 0x006c }
        ...
        L_0x004b:
            ...
            return r12
        L_0x0051:
            r11.cleanupRunning = r2     // Catch:{ all -> 0x006c }
            r12 = -1
            monitor-exit(r11)
            return r12
        L_0x0057:
            java.util.ArrayDeque<okhttp3.internal.connection.RealConnection> r12 = r11.connections     // Catch:{ all -> 0x006c }
            r12.remove(r5)     // Catch:{ all -> 0x006c }
            monitor-exit(r11)
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, mo51343d2 = {"Lokhttp3/internal/connection/RealConnectionPool$Companion;", "", "()V", "executor", "Ljava/util/concurrent/ThreadPoolExecutor;", "get", "Lokhttp3/internal/connection/RealConnectionPool;", "connectionPool", "Lokhttp3/ConnectionPool;", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: RealConnectionPool.kt */
