...
public final class Transmitter {
    ...
    public final <E extends java.io.IOException> E exchangeMessageDone$okhttp(okhttp3.internal.connection.Exchange r3, boolean r4, boolean r5, E r6) {
        /*
            ...
            monitor-enter(r0)
            okhttp3.internal.connection.Exchange r1 = r2.exchange     // Catch:{ all -> 0x005a }
            boolean r3 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r3, (java.lang.Object) r1)     // Catch:{ all -> 0x005a }
            r1 = 1
            r3 = r3 ^ r1
        ...
        L_0x0014:
            ...
            boolean r4 = r2.exchangeRequestDone     // Catch:{ all -> 0x005a }
            r4 = r4 ^ r1
            r2.exchangeRequestDone = r1     // Catch:{ all -> 0x005a }
            goto L_0x001e
        L_0x001d:
            r4 = 0
        L_0x001e:
            if (r5 == 0) goto L_0x0027
            boolean r5 = r2.exchangeResponseDone     // Catch:{ all -> 0x005a }
            if (r5 != 0) goto L_0x0025
            r4 = 1
        L_0x0025:
            r2.exchangeResponseDone = r1     // Catch:{ all -> 0x005a }
        L_0x0027:
            boolean r5 = r2.exchangeRequestDone     // Catch:{ all -> 0x005a }
            if (r5 == 0) goto L_0x004f
            boolean r5 = r2.exchangeResponseDone     // Catch:{ all -> 0x005a }
            if (r5 == 0) goto L_0x004f
            if (r4 == 0) goto L_0x004f
            okhttp3.internal.connection.Exchange r4 = r2.exchange     // Catch:{ all -> 0x005a }
            if (r4 != 0) goto L_0x0038
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x005a }
        L_0x0038:
            okhttp3.internal.connection.RealConnection r4 = r4.connection()     // Catch:{ all -> 0x005a }
            if (r4 != 0) goto L_0x0041
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x005a }
        L_0x0041:
            int r5 = r4.getSuccessCount$okhttp()     // Catch:{ all -> 0x005a }
            int r5 = r5 + r1
            r4.setSuccessCount$okhttp(r5)     // Catch:{ all -> 0x005a }
            r4 = 0
            okhttp3.internal.connection.Exchange r4 = (okhttp3.internal.connection.Exchange) r4     // Catch:{ all -> 0x005a }
            r2.exchange = r4     // Catch:{ all -> 0x005a }
            goto L_0x0050
        L_0x004f:
            r1 = 0
        L_0x0050:
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x005a }
            monitor-exit(r0)
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006R\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, mo51343d2 = {"Lokhttp3/internal/connection/Transmitter$TransmitterReference;", "Ljava/lang/ref/WeakReference;", "Lokhttp3/internal/connection/Transmitter;", "referent", "callStackTrace", "", "(Lokhttp3/internal/connection/Transmitter;Ljava/lang/Object;)V", "getCallStackTrace", "()Ljava/lang/Object;", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: Transmitter.kt */
