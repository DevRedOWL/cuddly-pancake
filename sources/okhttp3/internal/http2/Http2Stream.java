...
public final class Http2Stream {
    ...
    public final boolean isLocallyInitiated() {
        if (this.connection.getClient$okhttp() == ((this.f6282id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public final void writeHeaders(List<Header> list, boolean z, boolean z2) throws IOException {
        ...
        if (!_Assertions.ENABLED || z4) {
            ...
            this.connection.writeHeaders$okhttp(this.f6282id, z, list);
            if (z2) {
    ...
    public final void close(ErrorCode errorCode2, IOException iOException) throws IOException {
        ...
        if (closeInternal(errorCode2, iOException)) {
            this.connection.writeSynReset$okhttp(this.f6282id, errorCode2);
        }
    }
    ...
    public final void closeLater(ErrorCode errorCode2) {
        ...
        if (closeInternal(errorCode2, (IOException) null)) {
            this.connection.writeSynResetLater$okhttp(this.f6282id, errorCode2);
        }
    }
    ...
    private final boolean closeInternal(ErrorCode errorCode2, IOException iOException) {
        ...
        if (!_Assertions.ENABLED || z) {
            synchronized (this) {
                ...
                notifyAll();
                Unit unit = Unit.INSTANCE;
                this.connection.removeStream$okhttp(this.f6282id);
                return true;
            }
        }
        throw new AssertionError("Assertion failed");
    ...
    public final void receiveHeaders(okhttp3.Headers r4, boolean r5) {
        ...
        L_0x001c:
            monitor-enter(r3)
            boolean r0 = r3.hasResponseHeaders     // Catch:{ all -> 0x0051 }
            if (r0 == 0) goto L_0x002a
            if (r5 != 0) goto L_0x0024
            goto L_0x002a
        L_0x0024:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r3.source     // Catch:{ all -> 0x0051 }
            r0.setTrailers(r4)     // Catch:{ all -> 0x0051 }
            goto L_0x0033
        L_0x002a:
            r3.hasResponseHeaders = r1     // Catch:{ all -> 0x0051 }
            java.util.ArrayDeque<okhttp3.Headers> r0 = r3.headersQueue     // Catch:{ all -> 0x0051 }
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x0051 }
            r0.add(r4)     // Catch:{ all -> 0x0051 }
        L_0x0033:
            if (r5 == 0) goto L_0x003a
            okhttp3.internal.http2.Http2Stream$FramingSource r4 = r3.source     // Catch:{ all -> 0x0051 }
            r4.setFinished$okhttp(r1)     // Catch:{ all -> 0x0051 }
        L_0x003a:
            boolean r4 = r3.isOpen()     // Catch:{ all -> 0x0051 }
            r5 = r3
            java.lang.Object r5 = (java.lang.Object) r5     // Catch:{ all -> 0x0051 }
            r5.notifyAll()     // Catch:{ all -> 0x0051 }
            kotlin.Unit r5 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0051 }
            monitor-exit(r3)
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0017\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\u001a\u001a\u00020\u001bH\u0016J\u0018\u0010\u001c\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000f2\u0006\u0010\u001e\u001a\u00020\u0003H\u0016J\u001d\u0010\u001f\u001a\u00020\u001b2\u0006\u0010 \u001a\u00020!2\u0006\u0010\u001e\u001a\u00020\u0003H\u0000¢\u0006\u0002\b\"J\b\u0010#\u001a\u00020$H\u0016J\u0010\u0010%\u001a\u00020\u001b2\u0006\u0010\u001c\u001a\u00020\u0003H\u0002R\u001a\u0010\u0007\u001a\u00020\u0005X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u001a\u0010\u0004\u001a\u00020\u0005X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\t\"\u0004\b\r\u0010\u000bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u000e\u001a\u00020\u000f¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0011\u0010\u0012\u001a\u00020\u000f¢\u0006\b\n\u0000\u001a\u0004\b\u0013\u0010\u0011R\u001c\u0010\u0014\u001a\u0004\u0018\u00010\u0015X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019¨\u0006&"}, mo51343d2 = {"Lokhttp3/internal/http2/Http2Stream$FramingSource;", "Lokio/Source;", "maxByteCount", "", "finished", "", "(Lokhttp3/internal/http2/Http2Stream;JZ)V", "closed", "getClosed$okhttp", "()Z", "setClosed$okhttp", "(Z)V", "getFinished$okhttp", "setFinished$okhttp", "readBuffer", "Lokio/Buffer;", "getReadBuffer", "()Lokio/Buffer;", "receiveBuffer", "getReceiveBuffer", "trailers", "Lokhttp3/Headers;", "getTrailers", "()Lokhttp3/Headers;", "setTrailers", "(Lokhttp3/Headers;)V", "close", "", "read", "sink", "byteCount", "receive", "source", "Lokio/BufferedSource;", "receive$okhttp", "timeout", "Lokio/Timeout;", "updateConnectionFlowControl", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: Http2Stream.kt */
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\u0010\u0010\u0016\u001a\u00020\u00152\u0006\u0010\u0017\u001a\u00020\u0003H\u0002J\b\u0010\u0018\u001a\u00020\u0015H\u0016J\b\u0010\u0019\u001a\u00020\u001aH\u0016J\u0018\u0010\u001b\u001a\u00020\u00152\u0006\u0010\u001c\u001a\u00020\r2\u0006\u0010\u001d\u001a\u00020\u001eH\u0016R\u001a\u0010\u0005\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\tR\u001a\u0010\u0002\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0007\"\u0004\b\u000b\u0010\tR\u000e\u0010\f\u001a\u00020\rX\u0004¢\u0006\u0002\n\u0000R\u001c\u0010\u000e\u001a\u0004\u0018\u00010\u000fX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013¨\u0006\u001f"}, mo51343d2 = {"Lokhttp3/internal/http2/Http2Stream$FramingSink;", "Lokio/Sink;", "finished", "", "(Lokhttp3/internal/http2/Http2Stream;Z)V", "closed", "getClosed", "()Z", "setClosed", "(Z)V", "getFinished", "setFinished", "sendBuffer", "Lokio/Buffer;", "trailers", "Lokhttp3/Headers;", "getTrailers", "()Lokhttp3/Headers;", "setTrailers", "(Lokhttp3/Headers;)V", "close", "", "emitFrame", "outFinishedOnLastFrame", "flush", "timeout", "Lokio/Timeout;", "write", "source", "byteCount", "", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: Http2Stream.kt */
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x002d, code lost:
            if (r8.this$0.getSink$okhttp().finished != false) goto L_0x0094;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0041, code lost:
            if (r8.trailers == null) goto L_0x0045;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0050, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x0056;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:0x007b, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x0094;
         */
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x0019:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                boolean r2 = r8.closed     // Catch:{ all -> 0x00ae }
                if (r2 == 0) goto L_0x0022
                monitor-exit(r0)
                return
            L_0x0022:
                kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00ae }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo51343d2 = {"Lokhttp3/internal/http2/Http2Stream$Companion;", "", "()V", "EMIT_BUFFER_SIZE", "", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: Http2Stream.kt */
    ...
    @Metadata(mo51341bv = {1, 0, 3}, mo51342d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0014J\b\u0010\b\u001a\u00020\u0004H\u0014¨\u0006\t"}, mo51343d2 = {"Lokhttp3/internal/http2/Http2Stream$StreamTimeout;", "Lokio/AsyncTimeout;", "(Lokhttp3/internal/http2/Http2Stream;)V", "exitAndThrowIfTimedOut", "", "newTimeoutException", "Ljava/io/IOException;", "cause", "timedOut", "okhttp"}, mo51344k = 1, mo51345mv = {1, 1, 15})
    /* compiled from: Http2Stream.kt */
